// HtmlAgilityPack V1.0 - Simon Mourier <simon underscore mourier at hotmail dot
// com>
using System;
...
#region Properties
  ...
  public HtmlAttribute this[string name] {
    get {
      ...
      return Hashitems.ContainsKey(name.ToLower()) ? Hashitems[name.ToLower()]
                                                   : null;
    }
    set { Append(value); }
  }
...
#region IList < HtmlAttribute> Members
  ...
  public void Add(HtmlAttribute item) { Append(item); }

  /// <summary>
  /// Explicit clear
  /// </summary>
  void ICollection<HtmlAttribute>.Clear() { items.Clear(); }
  ...
  /// <param name="item"></param>
  /// <returns></returns>
  public bool Contains(HtmlAttribute item) { return items.Contains(item); }
  ...
  /// <param name="item"></param>
  /// <returns></returns>
  public int IndexOf(HtmlAttribute item) { return items.IndexOf(item); }
...
#region Public Methods
  ...
  /// </summary>
  /// <param name="newAttribute">The attribute to insert. May not be
  /// null.</param> <returns>The appended attribute.</returns>
  ...
  /// <summary>
  /// Creates and inserts a new attribute as the last attribute in the
  /// collection.
  /// </summary>
  ...
  /// </summary>
  /// <param name="newAttribute">The attribute to insert. May not be
  /// null.</param> <returns>The prepended attribute.</returns>
  ...
  /// <summary>
  /// Removes an attribute from the list, using its name. If there are more than
  /// one attributes with this name, they will all be removed.
  /// </summary>
...
#region LINQ Methods
  ...
  /// </summary>
  public void Remove() { foreach(HtmlAttribute item in items) item.Remove(); }
