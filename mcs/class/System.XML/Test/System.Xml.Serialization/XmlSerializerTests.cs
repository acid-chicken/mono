  ...
  public class XmlSerializerTests {
    ...
    private void SerializeEncoded(object o, SoapAttributeOverrides ao,
      ...
      XmlTypeMapping mapping =
          CreateSoapMapping(o.GetType(), ao, defaultNamespace);
      SetUpWriter();
      xs = new XmlSerializer(mapping);
      xs.Serialize(xtw, o);
    }
    ...
    [Test]
    public void
    TestSerializeEnumeration_FromValue() {
    ...
    public void
    TestSerializeEnumeration_FromValue_Encoded() {
      SerializeEncoded((int) SimpleEnumeration.SECOND,
                       typeof (SimpleEnumeration));
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
    ...
    [Test]
    public void
    TestSerializeEnumeration() {
      Serialize(SimpleEnumeration.FIRST);
      Assert.AreEqual(Infoset("<SimpleEnumeration>FIRST</SimpleEnumeration>"),
                      WriterText, "#1");

      Serialize(SimpleEnumeration.SECOND);
      Assert.AreEqual(Infoset("<SimpleEnumeration>SECOND</SimpleEnumeration>"),
                      WriterText, "#2");
    }

    [Test]
    public void
    TestSerializeEnumeration_Encoded() {
    ...
    TestSerializeEnumDefaultValue() {
      ...
      Assert.AreEqual(Infoset("<EnumDefaultValue>e3</EnumDefaultValue>"),
                      WriterText, "#3");
      ...
      Serialize(EnumDefaultValue.e1 | EnumDefaultValue.e2,
                typeof (EnumDefaultValue));
      Assert.AreEqual(Infoset("<EnumDefaultValue>e3</EnumDefaultValue>"),
                      WriterText, "#5");

      Serialize(EnumDefaultValue.e1 | EnumDefaultValue.e2 | EnumDefaultValue.e3,
                typeof (EnumDefaultValue));
      Assert.AreEqual(Infoset("<EnumDefaultValue>e3</EnumDefaultValue>"),
                      WriterText, "#6");

      Serialize(EnumDefaultValue.e1 | EnumDefaultValue.e3,
                typeof (EnumDefaultValue));
      Assert.AreEqual(Infoset("<EnumDefaultValue>e3</EnumDefaultValue>"),
                      WriterText, "#7");

      Serialize(EnumDefaultValue.e2 | EnumDefaultValue.e3,
                typeof (EnumDefaultValue));
      Assert.AreEqual(Infoset("<EnumDefaultValue>e3</EnumDefaultValue>"),
                      WriterText, "#8");

      Serialize(3, typeof (FlagEnum));
      Assert.AreEqual(Infoset("<FlagEnum>one two</FlagEnum>"), WriterText,
                      "#9");

      Serialize(5, typeof (FlagEnum));
      Assert.AreEqual(Infoset("<FlagEnum>one four</FlagEnum>"), WriterText,
                      "#10");
      ...
      Assert.AreEqual(Infoset("<FlagEnum>one two four</FlagEnum>"), WriterText,
                      "#13");
      ...
      Assert.AreEqual(Infoset("<FlagEnum>two four</FlagEnum>"), WriterText,
                      "#15");

      Serialize(3, typeof (EnumDefaultValueNF));
      Assert.AreEqual(Infoset("<EnumDefaultValueNF>e3</EnumDefaultValueNF>"),
                      WriterText, "#16");

      Serialize(EnumDefaultValueNF.e2, typeof (EnumDefaultValueNF));
      Assert.AreEqual(Infoset("<EnumDefaultValueNF>e2</EnumDefaultValueNF>"),
                      WriterText, "#17");

      Serialize(2, typeof (ZeroFlagEnum));
      Assert.AreEqual(Infoset("<ZeroFlagEnum>tns:t&lt;w&gt;o</ZeroFlagEnum>"),
                      WriterText, "#18");

      Serialize(new ZeroFlagEnum()); // enum actually has a field with value 0
      Assert.AreEqual(Infoset("<ZeroFlagEnum>zero</ZeroFlagEnum>"), WriterText,
                      "#19");
    }
    ...
    [Category("MobileNotWorking")]
    public void
    TestSerializeEnumDefaultValue_Encoded() {
      ...
      SerializeEncoded(EnumDefaultValue.e1 | EnumDefaultValue.e2,
                       typeof (EnumDefaultValue));
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
      ...
      SerializeEncoded(EnumDefaultValue.e1 | EnumDefaultValue.e3,
                       typeof (EnumDefaultValue));
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
      ...
      SerializeEncoded(EnumDefaultValue.e2 | EnumDefaultValue.e3,
                       typeof (EnumDefaultValue));
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
      ...
      SerializeEncoded(FlagEnum.e1 | FlagEnum.e2 | FlagEnum.e4,
                       typeof (FlagEnum));
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
      ...
      SerializeEncoded(
          new ZeroFlagEnum()); // enum actually has a field with value 0
      Assert.AreEqual(
          string.Format(
              CultureInfo.InvariantCulture,
              "<?xml version='1.0' encoding='utf-16'?>" +
    ...
    [Test]
    public void
    TestSerializeEnumDefaultValue_InvalidValue1() {
      try {
        Serialize("b", typeof (EnumDefaultValue));
        Assert.Fail("#A1");
      } catch (InvalidOperationException ex) {
        Assert.IsNotNull(ex.InnerException, "#A2");
        Assert.AreEqual(typeof (InvalidCastException),
                        ex.InnerException.GetType(), "#A3");
      }
      ...
      try {
        ...
        Assert.AreEqual(typeof (InvalidCastException),
                        ex.InnerException.GetType(), "#G3");
      }
    }

    [Test]
    public void
    TestSerializeEnumDefaultValue_InvalidValue2() {
      try {
        ...
        Assert.AreEqual(typeof (InvalidOperationException),
                        ex.InnerException.GetType(), "#4");
        Assert.IsNotNull(ex.InnerException.Message, "#5");
        Assert.IsTrue(ex.InnerException.Message.IndexOf("'5'") != -1, "#6");
        Assert.IsTrue(ex.InnerException.Message.IndexOf(
                          typeof (EnumDefaultValue).FullName) != -1,
                      "#7");
      }
    }
    ...
    [Test]
    public void
    TestSerializeEnumDefaultValueNF_InvalidValue1() {
      try {
        ...
        Assert.IsTrue(ex.InnerException.Message.IndexOf(
                          typeof (EnumDefaultValueNF).FullName) != -1,
                      "#7");
      }
    }
    ...
    [Test]
    public void
    TestSerializeEnumDefaultValueNF_InvalidValue2() {
      try {
    ...
    [Test]
    public void
    TestSerializeEnumDefaultValueNF_InvalidValue3() {
      try {
    ...
    [Test]
    public void
    TestSerializeZeroFlagEnum_InvalidValue() {
      try {
        Serialize(
            4,
            typeof (
                ZeroFlagEnum)); // corresponding enum field is marked XmlIgnore
        Assert.Fail("#1");
      } catch (InvalidOperationException ex) {
        Assert.AreEqual(typeof (InvalidOperationException), ex.GetType(), "#2");
        Assert.IsNotNull(ex.InnerException, "#3");
        ...
        Assert.IsTrue(ex.InnerException.Message.IndexOf(
                          typeof (ZeroFlagEnum).FullName) != -1,
                      "#7");
      }
    }
    ...
    [Test]
    public void
    TestSerializeQualifiedName() {
      Serialize(new XmlQualifiedName("me", "home.urn"));
      Assert.AreEqual(Infoset("<QName xmlns:q1='home.urn'>q1:me</QName>"),
                      WriterText);
    }
    ...
    TestSerializeDateTime() {
      ...
      string sp = string.Format("{0}{1:00}:{2:00}", off.Ticks >= 0 ? "+" : "",
                                off.Hours, off.Minutes);
      Assert.AreEqual(Infoset("<dateTime>0001-01-01T00:00:00</dateTime>"),
                      WriterText);
    }
    ...
    */
    ...
    TestSerializeSimpleClass() {
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><something>hello</something></SimpleClass>"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeStringCollection() {
      ...
      Assert.AreEqual(
          Infoset(
              "<ArrayOfString xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><string>hello</string><string>goodbye</string></ArrayOfString>"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeOptionalValueTypeContainer() {
      XmlAttributeOverrides overrides = new XmlAttributeOverrides();
      XmlAttributes attr;
      OptionalValueTypeContainer optionalValue =
          new OptionalValueTypeContainer();
      ...
      Assert.AreEqual(
          string.Format(
              ...
              "<?xml version='1.0' encoding='utf-16'?>" +
                  "<optionalValue xmlns:xsd='{0}' xmlns:xsi='{1}' xmlns='{2}'>" +
                  "<Attributes xmlns='{3}'>one four</Attributes>" +
                  "<Flags xmlns='{3}'>one</Flags>" + "</optionalValue>",
              XmlSchema.Namespace, XmlSchema.InstanceNamespace,
              AnotherNamespace, ANamespace),
          sw.ToString(), "#3");
    }
    ...
    [Test]
    public void
    TestRoundTripSerializeOptionalValueTypeContainer() {
    ...
    [Test]
    public void
    TestSerializePlainContainer() {
      StringCollectionContainer container = new StringCollectionContainer();
      Serialize(container);
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Messages /></StringCollectionContainer>"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Messages><string>hello</string><string>goodbye</string></Messages></StringCollectionContainer>"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeArrayContainer() {
      ArrayContainer container = new ArrayContainer();
      Serialize(container);
      Assert.AreEqual(
          Infoset(
              "<ArrayContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<ArrayContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' ><items><anyType xsi:type='xsd:int'>10</anyType><anyType xsi:type='xsd:int'>20</anyType></items></ArrayContainer>"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<ArrayContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' ><items><anyType xsi:type='xsd:int'>10</anyType><anyType xsi:type='xsd:string'>hello</anyType></items></ArrayContainer>"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeClassArrayContainer() {
      ClassArrayContainer container = new ClassArrayContainer();
      Serialize(container);
      Assert.AreEqual(
          Infoset(
              "<ClassArrayContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<ClassArrayContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' ><items><SimpleClass><something>hello</something></SimpleClass><SimpleClass><something>hello</something></SimpleClass></items></ClassArrayContainer>"),
          WriterText);
    }
    ...
    [Test]
    public void
    TestSerializeSimpleClassWithXmlAttributes() {
      SimpleClassWithXmlAttributes simple = new SimpleClassWithXmlAttributes();
      Serialize(simple);
      Assert.AreEqual(
          Infoset(
              "<simple xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
      ...
      Assert.AreEqual(
          Infoset(
              "<simple xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' member='hello' />"),
          WriterText);
    }
    ...
    [Test]
    public void
    TestSerializeSimpleClassWithOverrides() {
      ...
      Assert.AreEqual(
          string.Format(
              ...
              "<?xml version='1.0' encoding='utf-16'?>{0}" +
                  ...
                  "  <xsd:attribute />{0}" + "  <xsd:attributeGroup />{0}" +
                  "  <xsd:complexType />{0}" + "  <xsd:notation />{0}" +
                  "  <xsd:simpleType />{0}" + "  <xsd:group />{0}" +
                  "  <xsd:element />{0}" + "</xsd:schema>",
              Environment.NewLine),
          sw.ToString());
    }
    ...
    TestSerializeXmlTextAttribute() {
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>hello</SimpleClass>"),
          WriterText, "#1");
      ...
      try {
        ...
        Serialize(simple, overrides);
        Assert.Fail(
            "#A1: XmlText.Type does not match the type it serializes: this should have failed");
      } catch (InvalidOperationException ex) {
      ...
      try {
        ...
        Serialize(simple, overrides);
        Assert.Fail(
            "#B1: XmlText.DataType does not match the type it serializes: this should have failed");
      } catch (InvalidOperationException ex) {
        // There was an error reflecting type
        // 'MonoTests.System.Xml.TestClasses.SimpleClass'.
        Assert.AreEqual(typeof (InvalidOperationException), ex.GetType(),
        ...
        Assert.AreEqual (typeof (InvalidOperationException),
        ex.InnerException.InnerException.GetType (), "#B10"); Assert.IsNotNull
        (ex.InnerException.InnerException.Message, "#B11"); Assert.IsTrue
        (ex.InnerException.InnerException.Message.IndexOf (typeof
        (string).FullName) != -1, "#B12"); Assert.IsNotNull
        (ex.InnerException.InnerException.InnerException, "#B13");

        // Value 'sometype' cannot be used for the XmlElementAttribute.DataType
        property.
        ...
        Assert.IsNotNull
        (ex.InnerException.InnerException.InnerException.Message, "#B15");
        Assert.IsTrue
        (ex.InnerException.InnerException.InnerException.Message.IndexOf
    ...
    [Test]
    public void
    TestSerializeXmlRootAttribute() {
      // constructor override & element name
      XmlRootAttribute root = new XmlRootAttribute();
      root.ElementName = "renamed";

      SimpleClassWithXmlAttributes simpleWithAttributes =
          new SimpleClassWithXmlAttributes();
      Serialize(simpleWithAttributes, root);
      Assert.AreEqual(
          Infoset(
              "<renamed xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
      ...
      try {
        ...
        Assert.Fail(
            "Cannot serialize null object if XmlRoot's IsNullable == false");
      ...
      try {
        Serialize(simple, root);
        Assert.Fail(
            "Cannot serialize null object if XmlRoot's IsNullable == true");
      } catch (NullReferenceException) {
      }
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns='some.urn' />"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeXmlRootAttributeOnMember() {
      // nested root
      XmlAttributeOverrides overrides = new XmlAttributeOverrides();
      ...
      Assert.AreEqual(
          Infoset(
              "<simple xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' ><items><SimpleClass /></items></simple>"),
          WriterText);
    ...
    [Test]
    public void
    TestSerializeXmlAttributeAttribute() {
      // null
      XmlAttributeOverrides overrides = new XmlAttributeOverrides();
      XmlAttributes attr = new XmlAttributes();
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' something='hello' />"),
          WriterText, "#2");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' somethingelse='hello' />"),
          WriterText, "#3");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' d1p1:somethingelse='hello' xmlns:d1p1='some:urn' />"),
          WriterText, "#4");
    ...
    [Test]
    public void
    TestSerializeXmlElementAttribute() {
      XmlAttributeOverrides overrides = new XmlAttributeOverrides();
      XmlAttributes attr = new XmlAttributes();
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><saying>hello</saying></SimpleClass>"),
          WriterText, "#3");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><saying xsi:nil='true' /></SimpleClass>"),
          WriterText, "#5");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><something xmlns='some:urn'>hello</something></SimpleClass>"),
          WriterText, "#6");
    ...
    [Test]
    public void
    TestSerializeCollectionWithXmlElementAttribute() {
      // the rule is:
      ...
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#1");
      ...
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Messages>hello</Messages></StringCollectionContainer>"),
          WriterText, "#2");
      ...
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Messages><string>hello</string></Messages></StringCollectionContainer>"),
          WriterText, "#3");
      ...
      Assert.AreEqual(
          Infoset(
              "<StringCollectionContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Messages>hello</Messages><Messages>goodbye</Messages></StringCollectionContainer>"),
          WriterText, "#5");
    }
    ...
    [Test]
    public void
    TestSerializeDefaultValueAttribute() {
      XmlAttributeOverrides overrides = new XmlAttributeOverrides();
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass something='hello' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#B3");
      ...
      Assert.AreEqual(
          Infoset(
              "<testDefault xmlns='urn:myNS' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#C1");
      ...
      Assert.AreEqual(
          Infoset(
              "<testDefault flagenc='e1 e4' xmlns='urn:myNS' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#C2");

      overrides = new XmlAttributeOverrides();
      attr = new XmlAttributes();
      attr.XmlAttribute = new XmlAttributeAttribute("flagenc");
      attr.XmlDefaultValue =
          (FlagEnum_Encoded.e1 | FlagEnum_Encoded.e4); // add default again
      overrides.Add(typeof (TestDefault), "flagencoded", attr);
      ...
      Assert.AreEqual(
          Infoset(string.Format(
              ...
              "<testDefault xmlns='urn:myNS' xmlns:xsd='{0}' xmlns:xsi='{1}'>" +
                  ...
                  "    <boolT>false</boolT>" + "    <boolF>true</boolF>" +
                  "    <decimalval>20</decimalval>" + "    <flag>two</flag>" +
                  "    <flagencoded>e1 e2</flagencoded>" + "</testDefault>",
              XmlSchema.Namespace, XmlSchema.InstanceNamespace)),
          WriterText, "#C5");
    ...
    [Test]
    public void
    TestSerializeDefaultValueAttribute_Encoded() {
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass id='id1' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#A1");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass id='id1' something='hello' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText, "#A3");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass id='id1' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><something xsi:type='xsd:string'>nothing</something></SimpleClass>"),
          WriterText, "#B2");
      ...
      Assert.AreEqual(
          Infoset(
              "<SimpleClass id='id1' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><something xsi:type='xsd:string'>hello</something></SimpleClass>"),
          WriterText, "#B3");
    ...
    [Test]
    public void
    TestSerializeXmlEnumAttribute() {
      Serialize(XmlSchemaForm.Qualified);
      Assert.AreEqual(Infoset("<XmlSchemaForm>qualified</XmlSchemaForm>"),
                      WriterText, "#1");

      Serialize(XmlSchemaForm.Unqualified);
      Assert.AreEqual(Infoset("<XmlSchemaForm>unqualified</XmlSchemaForm>"),
                      WriterText, "#2");
    }

    [Test]
    public void
    TestSerializeXmlEnumAttribute_IgnoredValue() {
      ...
      try {
        ...
        Assert.IsTrue(ex.InnerException.Message.IndexOf("'0'") != -1, "#6");
        Assert.IsTrue(ex.InnerException.Message.IndexOf(
                          typeof (XmlSchemaForm).FullName) != -1,
                      "#7");
      }
    }
    ...
    [Test]
    public void
    TestSerializeXmlNodeArray() {
      XmlDocument doc = new XmlDocument();
      Serialize(new XmlNode[]{doc.CreateAttribute("at"),
                              doc.CreateElement("elem1"),
                              doc.CreateElement("elem2")},
                typeof (object));
      Assert.AreEqual(Infoset("<anyType at=\"\"><elem1/><elem2/></anyType>"),
                      WriterText);
    }

    [Test]
    public void
    TestSerializeXmlNodeArray2() {
      XmlDocument doc = new XmlDocument();
      Serialize(
          new XmlNode[]{doc.CreateElement("elem1"), doc.CreateElement("elem2")},
          typeof (XmlNode[]));
      Assert.AreEqual(
          Infoset(String.Format(
              "<ArrayOfXmlNode xmlns:xsd='{0}' xmlns:xsi='{1}'><XmlNode><elem1/></XmlNode><XmlNode><elem2/></XmlNode></ArrayOfXmlNode>",
              XmlSchema.Namespace, XmlSchema.InstanceNamespace)),
          WriterText);
    }
    ...
    [Category("MobileNotWorking")]
    public void
    TestSerializeXmlNodeArrayIncludesAttribute() {
      XmlDocument doc = new XmlDocument();
      Serialize(new XmlNode[]{doc.CreateAttribute("at"),
                              doc.CreateElement("elem1"),
                              doc.CreateElement("elem2")},
    ...
    [Test]
    public void
    TestSerializeXmlElementArray() {
      XmlDocument doc = new XmlDocument();
      Serialize(new XmlElement[]{doc.CreateElement("elem1"),
                                 doc.CreateElement("elem2")},
                typeof (object));
      Assert.AreEqual(Infoset("<anyType><elem1/><elem2/></anyType>"),
                      WriterText);
    }

    [Test]
    [ExpectedException(typeof(InvalidOperationException))] // List<XmlNode> is
                                                           // not supported
        public void
        TestSerializeGenericListOfNode() {
      XmlDocument doc = new XmlDocument();
      Serialize(new List<XmlNode>(new XmlNode[]{doc.CreateAttribute("at"),
                                                doc.CreateElement("elem1"),
                                                doc.CreateElement("elem2")}),
                typeof (object));
      Assert.AreEqual(Infoset("<anyType at=\"\"><elem1/><elem2/></anyType>"),
    ...
    [Test]
    [ExpectedException(typeof(InvalidOperationException))] // List<XmlElement>
                                                           // is not supported
        public void
        TestSerializeGenericListOfElement() {
      XmlDocument doc = new XmlDocument();
      Serialize(new List<XmlElement>(new XmlElement[]{
                    doc.CreateElement("elem1"), doc.CreateElement("elem2")}),
                typeof (object));
      Assert.AreEqual(Infoset("<anyType><elem1/><elem2/></anyType>"),
                      WriterText);
    }
    ...
    [Test]
    public void
    TestSerializeXmlElementSubclass() {
      XmlDocument doc = new XmlDocument();
    ...
    TestSerializeChoice() {
      ...
      Assert.AreEqual(
          Infoset(
              "<Choices xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><ChoiceZero>choice text</ChoiceZero></Choices>"),
          WriterText, "#1");
      ch.ItemType = ItemChoiceType.StrangeOne;
      Serialize(ch);
      Assert.AreEqual(
          Infoset(
              "<Choices xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><ChoiceOne>choice text</ChoiceOne></Choices>"),
          WriterText, "#2");
      ch.ItemType = ItemChoiceType.ChoiceTwo;
      Serialize(ch);
      Assert.AreEqual(
          Infoset(
              "<Choices xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><ChoiceTwo>choice text</ChoiceTwo></Choices>"),
          WriterText, "#3");
    }

    [Test]
    public void
    TestSerializeNamesWithSpaces() {
    ...
    [Test]
    public void
    TestSerializeReadOnlyProps() {
      ReadOnlyProperties ts = new ReadOnlyProperties();
      Serialize(ts);
      Assert.AreEqual(
          Infoset(
              "<ReadOnlyProperties xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' />"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeReadOnlyListProp() {
      ReadOnlyListProperty ts = new ReadOnlyListProperty();
      Serialize(ts);
      Assert.AreEqual(
          Infoset(
              "<ReadOnlyListProperty xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><StrList><string>listString1</string><string>listString2</string></StrList></ReadOnlyListProperty>"),
          WriterText);
    }
    ...
    TestSerializeIList() {
      ...
      Assert.AreEqual(
          Infoset(
              "<clsPerson xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><EmailAccounts><anyType xsi:type=\"xsd:string\">a</anyType><anyType xsi:type=\"xsd:string\">b</anyType></EmailAccounts></clsPerson>"),
          WriterText);
    }

    [Test]
    public void
    TestSerializeArrayEnc() {
    ...
    [Test]
    public void
    TestArrayAttributeWithDataType() {
      Serialize(new ArrayAttributeWithType());
      string res =
          "<ArrayAttributeWithType xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' ";
    ...
    [Test]
    public void
    TestSubclassElementType() {
      SubclassTestContainer c = new SubclassTestContainer();
      c.data = new SubclassTestSub();
      Serialize(c);

      string res =
          "<SubclassTestContainer xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>";
    ...
    [Test] // Covers #36829
        public void
        TestSubclassElementList() {
      var o = new SubclassTestList(){
          Items = new List<object>(){new SubclassTestSub()}};
      Serialize(o);

      string res =
          "<SubclassTestList xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>";
    ...
    [ExpectedException(typeof(InvalidOperationException))]
    public void
    TestArrayAttributeWithWrongDataType() {
    ...
    [Category("NotWorking")]
    public void
    TestSerializePrimitiveTypesContainer() {
      ...
      Assert.AreEqual(
          string.Format(
              ...
              "<?xml version='1.0' encoding='utf-16'?>" +
                  ...
                  "<Number>2004</Number>" + "<Name>some name</Name>" +
                  "<Index>56</Index>" + "<Password>8w8=</Password>" +
      ...
      Assert.AreEqual(
          string.Format(
              ...
              XmlSchema.Namespace, XmlSchema.InstanceNamespace,
              AnotherNamespace, WsdlTypesNamespace),
          sw.ToString(), "#2");
    }
    ...
    TestSchemaForm() {
      ...
      res +=
          "<TestSchemaForm1 xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">";
      res += "  <p1>";
      res += "    <result>";
      res += "      <data>data1</data>";
      res += "    </result>";
      ...
      res += "<?xml version=\"1.0\" encoding=\"utf-8\"?>";
      res +=
          "<TestSchemaForm2 xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">";
      ...
      XmlReflectionImporter imp = new XmlReflectionImporter();
      XmlTypeMapping map =
          imp.ImportTypeMapping(typeof (TestSchemaForm1), "urn:extra");
      Serialize(t1, map);
      res = "";
      res += "<?xml version=\"1.0\" encoding=\"utf-8\"?>";
      res +=
          "<TestSchemaForm1 xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"urn:extra\">";
      res += "  <p1>";
      res += "    <result xmlns=\"\">";
      res += "      <data>data1</data>";
      res += "    </result>";
      ...
      res += "<?xml version=\"1.0\" encoding=\"utf-8\"?>";
      res +=
          "<TestSchemaForm2 xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"urn:extra\">";
      res += "  <p1 xmlns=\"urn:testForm\">";
      res += "    <result xmlns=\"\">";
      res += "      <data>data1</data>";
      res += "    </result>";
...
(?<error>(fatal\s)?error)[^:]+:(?<message>.+$)
    ...
    [Test]
    public void
    GenerateSerializerGenerics() {
      XmlReflectionImporter imp = new XmlReflectionImporter();
      Type type = typeof (List<int>);
      XmlSerializer.GenerateSerializer(
          new Type[]{type}, new XmlTypeMapping[]{imp.ImportTypeMapping(type)});
    }
#endif
    ...
    Nullable() {
        ...
        xtw.Close();
        string expected =
            "<?xml version=\"1.0\" encoding=\"utf-16\"?><int>5</int>";
    ...
    NullableEnums() {
      ...
      string expected =
          ...
          "<nint xsi:nil='true' />" + "<nenum xsi:nil='true' />" +
          "<ndate xsi:nil='true' />" + "</WithNulls>";
      ...
      expected =
          "<?xml version='1.0' encoding='utf-16'?>" +
          "<WithNulls xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema'>" +
          "<nint>4</nint>" + "<nenum>bb</nenum>" +
          "<ndate>2008-04-01T00:00:00</ndate>" + "</WithNulls>";
    ...
    SerializeBase64Binary() {
      ...
      xtw.Close();
      string expected =
          @"<?xml version=" "1.0" " encoding=" "utf-16" "?><Base64Binary xmlns:xsd=" "http://www.w3.org/2001/XMLSchema" " xmlns:xsi=" "http://www.w3.org/2001/XMLSchema-instance" " Data=" "AQID" " />";
      Assert.AreEqual(Infoset(expected), WriterText);
      Base64Binary h =
          (Base64Binary) ser.Deserialize(new StringReader(sw.ToString()));
    ...
    [Test] // bug #79989, #79990
      ...
      xtw.Close();
      string expected =
          @"<?xml version=" "1.0" " encoding=" "utf-16" "?><HexBinary xmlns:xsd=" "http://www.w3.org/2001/XMLSchema" " xmlns:xsi=" "http://www.w3.org/2001/XMLSchema-instance" " Data=" "010203" " />";
      Assert.AreEqual(Infoset(expected), WriterText);
      HexBinary h =
          (HexBinary) ser.Deserialize(new StringReader(sw.ToString()));
      Assert.AreEqual(new byte[]{1, 2, 3}, h.Data);
    }
    ...
    [Category("MobileNotWorking")]
    public void
    XmlArrayAttributeUnqualifiedWithNamespace() {
    ...
    [Category("MobileNotWorking")]
    public void
    XmlArrayItemAttributeUnqualifiedWithNamespace() {
      new XmlSerializer(typeof (XmlArrayItemUnqualifiedWithNamespace));
    }

    [Test] // bug #78042
        public void
        XmlArrayAttributeOnArray() {
      ...
      xtw.Close();
      string
          expected = @"<?xml version=" "1.0" " encoding=" "utf-16" "?><XmlArrayOnArray xmlns:xsd=" "http://www.w3.org/2001/XMLSchema" " xmlns:xsi=" "http://www.w3.org/2001/XMLSchema-instance" " xmlns=" "urn:foo" "><Sane xmlns=" "" "><string xmlns=" "urn:foo" ">foo</string><string xmlns=" "urn:foo" ">bar</string></Sane><Mids xmlns=" "" "><ArrayItemInXmlArray xmlns=" "urn:foo" "><Whee xmlns=" "" "><string xmlns=" "urn:gyabo" ">foo</string><string xmlns=" "urn:gyabo" ">bar</string></Whee></ArrayItemInXmlArray></Mids></XmlArrayOnArray>";
      Assert.AreEqual(Infoset(expected), WriterText);
    }

    [Test]
    public void
    XmlArrayAttributeOnCollection() {
      ...
      xtw.Close();
      string expected =
          @"<?xml version=" "1.0" " encoding=" "utf-16" "?><XmlArrayOnArrayList xmlns:xsd=" "http://www.w3.org/2001/XMLSchema" " xmlns:xsi=" "http://www.w3.org/2001/XMLSchema-instance" " xmlns=" "urn:foo" "><Sane xmlns=" "" "><anyType xsi:type=" "xsd:string" " xmlns=" "urn:foo" ">abc</anyType><anyType xsi:type=" "xsd:int" " xmlns=" "urn:foo" ">1</anyType></Sane></XmlArrayOnArrayList>";
      Assert.AreEqual(Infoset(expected), WriterText);
    }
    ...
    [Test] // bug #338705
        public void
        SerializeTimeSpan() {
      // TimeSpan itself is not for duration. Hence it is just regarded as one
      // of custom types.
    ...
    [Test]
    public void
    SerializeErrorneousIXmlSerializable() {
    ...
    [Test]
    public void
    SupportIXmlSerializableImplicitlyConvertible() {
      ...
      attrOverrides.Add(typeof (XmlSerializableImplicitConvertible), "B",
                        attrs);

      XmlSerializableImplicitConvertible x =
          new XmlSerializableImplicitConvertible();
      new XmlSerializer(typeof (XmlSerializableImplicitConvertible),
                        attrOverrides)
          .Serialize(TextWriter.Null, x);
    }

    [Test] // bug #566370
        public void
        SerializeEnumWithCSharpKeyword() {
    ...
    public enum DoxCompoundKind {
          [XmlEnum("class")] @class,
          [ XmlEnum("struct") ] @struct,
          union,
          [ XmlEnum("interface") ] @interface,
          protocol,
          category,
          exception,
          file,
...
#region GenericsSeralizationTests
    ...
    [Test]
    public void
    TestSerializeGenSimpleClassString() {
    ...
    [Test]
    public void
    TestSerializeGenSimpleClassBool() {
    ...
    [Test]
    public void
    TestSerializeGenSimpleStructInt() {
    ...
    [Test]
    public void
    TestSerializeGenListClassString() {
    ...
    [Test]
    public void
    TestSerializeGenListClassFloat() {
    ...
    [Test]
    public void
    TestSerializeGenListClassList() {
      GenListClass<GenListClass<int>>genlist =
          new GenListClass<GenListClass<int>>();
      Serialize(genlist);
      Assert.AreEqual(
          Infoset(
    ...
    [Test]
    public void
    TestSerializeGenListClassArray() {
      GenListClass<GenArrayClass<char>>genlist =
          new GenListClass<GenArrayClass<char>>();
      Serialize(genlist);
      Assert.AreEqual(
          Infoset(
    ...
    [Test]
    public void
    TestSerializeGenTwoClassCharDouble() {
    ...
    [Test]
    public void
    TestSerializeGenDerivedClassDecimalShort() {
      GenDerivedClass<decimal, short>derived =
          new GenDerivedClass<decimal, short>();
      Serialize(derived);
      Assert.AreEqual(
          Infoset(
    ...
    [Test]
    public void
    TestSerializeGenDerivedSecondClassByteUlong() {
      GenDerived2Class<byte, ulong>derived2 =
          new GenDerived2Class<byte, ulong>();
      Serialize(derived2);
      Assert.AreEqual(
          Infoset(
    ...
    [Test]
    public void
    TestSerializeGenListClassListNested() {
      GenListClass<GenListClass<GenNestedClass<int, int>.InnerClass<string>>>
          genlist = new GenListClass<
              GenListClass<GenNestedClass<int, int>.InnerClass<string>>>();
      Serialize(genlist);
      Assert.AreEqual(
          Infoset(
      ...
      GenNestedClass<int, int>.InnerClass<string>inval1 =
          new GenNestedClass<int, int>.InnerClass<string>();
      inval1.inner = 1;
      inval1.something = "ONE";
      inlist1.somelist.Add(inval1);
      GenNestedClass<int, int>.InnerClass<string>inval2 =
          new GenNestedClass<int, int>.InnerClass<string>();
      inval2.inner = 2;
      ...
      GenListClass<GenNestedClass<int, int>.InnerClass<string>>inlist2 =
          new GenListClass<GenNestedClass<int, int>.InnerClass<string>>();
      GenNestedClass<int, int>.InnerClass<string>inval3 =
          new GenNestedClass<int, int>.InnerClass<string>();
      inval3.inner = 30;
    ...
    [Test]
    public void
    TestSerializeGenArrayClassEnum() {
    ...
    [Test]
    public void
    TestSerializeGenArrayStruct() {
      GenArrayClass<GenSimpleStruct<uint>>genarr =
          new GenArrayClass<GenSimpleStruct<uint>>();
      Serialize(genarr);
      Assert.AreEqual(
          "<:GenArrayClassOfGenSimpleStructOfUInt32 http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:arr><:GenSimpleStructOfUInt32><:something>0</></><:GenSimpleStructOfUInt32><:something>0</></><:GenSimpleStructOfUInt32><:something>0</></></></>",
          WriterText);
      ...
      Serialize(genarr);
      Assert.AreEqual(
          "<:GenArrayClassOfGenSimpleStructOfUInt32 http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:arr><:GenSimpleStructOfUInt32><:something>111</></><:GenSimpleStructOfUInt32><:something>222</></><:GenSimpleStructOfUInt32><:something>333</></></></>",
          WriterText);
    }

    [Test]
    public void
    TestSerializeGenArrayList() {
      GenArrayClass<GenListClass<string>>genarr =
          new GenArrayClass<GenListClass<string>>();
      Serialize(genarr);
      Assert.AreEqual(
          "<:GenArrayClassOfGenListClassOfString http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:arr><:GenListClassOfString http://www.w3.org/2001/XMLSchema-instance:nil='true'></><:GenListClassOfString http://www.w3.org/2001/XMLSchema-instance:nil='true'></><:GenListClassOfString http://www.w3.org/2001/XMLSchema-instance:nil='true'></></></>",
          WriterText);
      ...
      Serialize(genarr);
      Assert.AreEqual(
          "<:GenArrayClassOfGenListClassOfString http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:arr><:GenListClassOfString><:somelist><:string>list1-val1</><:string>list1-val2</></></><:GenListClassOfString><:somelist><:string>list2-val1</><:string>list2-val2</><:string>list2-val3</><:string>list2-val4</></></><:GenListClassOfString><:somelist><:string>list3val</></></></></>",
          WriterText);
    }

    [Test]
    public void
    TestSerializeGenComplexStruct() {
      GenComplexStruct<int, string>complex =
          new GenComplexStruct<int, string>(0);
      Serialize(complex);
      Assert.AreEqual(
          "<:GenComplexStructOfInt32String http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:something>0</><:simpleclass><:something>0</></><:simplestruct><:something>0</></><:listclass><:somelist></></><:arrayclass><:arr><:int>0</><:int>0</><:int>0</></></><:twoclass><:something1>0</></><:derivedclass><:something2>0</><:another1>0</></><:derived2><:something1>0</><:another1>0</></><:nestedouter><:outer>0</></><:nestedinner><:something>0</></></>",
          WriterText);
      ...
      Serialize(complex);
      Assert.AreEqual(
          "<:GenComplexStructOfInt32String http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:something>123</><:simpleclass><:something>456</></><:simplestruct><:something>789</></><:listclass><:somelist><:int>100</><:int>200</></></><:arrayclass><:arr><:int>11</><:int>22</><:int>33</></></><:twoclass><:something1>10</><:something2>Ten</></><:derivedclass><:something1>two</><:something2>2</><:another1>1</><:another2>one</></><:derived2><:something1>4</><:something2>four</><:another1>3</><:another2>three</></><:nestedouter><:outer>5</></><:nestedinner><:inner>six</><:something>6</></></>",
          WriterText);
    }

    [Test]
    public void
    TestSerializeStreamPreserveUTFChars() {
      string foo = "BÄR";
    ...
    [Test] // bug #80759, with fieldSpecified.
        ...
        [Category("NotWorking")]
        public void
        HasFieldSpecifiedButIrrelevant() {
    ...
    [Test]
    public void
    SupportPrivateCtorOnly() {
      XmlSerializer xs = new XmlSerializer(typeof (PrivateCtorOnly));
      StringWriter sw = new StringWriter();
    ...
    [Test]
    public void
    XmlSchemaProviderQNameBecomesRootName() {
      xs =
          new XmlSerializer(typeof (XmlSchemaProviderQNameBecomesRootNameType));
    ...
    [Test]
    public void
    XmlSchemaProviderQNameBecomesRootName2() {
      string xml =
          "<XmlSchemaProviderQNameBecomesRootNameType2 xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><Foo><foo /></Foo></XmlSchemaProviderQNameBecomesRootNameType2>";
      xs = new XmlSerializer(
          typeof (XmlSchemaProviderQNameBecomesRootNameType2));
    ...
    [Test]
    public void
    XmlAnyElementForObjects() // bug #553032
    {
    ...
    [ExpectedException(typeof(InvalidOperationException))]
    public void
    XmlAnyElementForObjects2() // bug #553032-2
    {
      new XmlSerializer(typeof (XmlAnyElementForObjectsType))
          .Serialize(TextWriter.Null, new XmlAnyElementForObjectsType());
    }

    public class Bug2893 {
      public Bug2893() { Contents = new XmlDataDocument(); }
    ...
    [Test]
    public void
    XmlRootOverridesSchemaProviderQName() {
      var obj = new XmlRootOverridesSchemaProviderQNameType();

      XmlSerializer xs = new XmlSerializer(obj.GetType());

      var sw = new StringWriter();
      using(XmlWriter xw = XmlWriter.Create(sw)) xs.Serialize(xw, obj);
    ...
    public class ClassWithArrayList {
      ...
      [XmlElement(Type = typeof(AnotherArrayListType),
                  ElementName = "another_elem")]
      [XmlElement(Type = typeof(DerivedArrayListType),
                  ElementName = "derived_elem")]
    ...
    [Test]
    public void
    MultipleXmlElementAttributesOnArrayList() {
      ...
      Serialize(test);
      var expected_text =
          "<:ClassWithArrayList http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:int_elem>3</><:string_elem>apepe</><:another_elem :another='bbb' :one='aaa'></><:derived_elem :another='bbb' :one='aaa'></></>";
    ...
    [Test]
    public void
    MultipleXmlElementAttributesOnArray() {
      var test = new ClassWithArray();

      test.list = new object[]{3, "apepe", new AnotherArrayListType(),
                               new DerivedArrayListType()};

      Serialize(test);
      var expected_text =
          "<:ClassWithArray http://www.w3.org/2000/xmlns/:xsd='http://www.w3.org/2001/XMLSchema' http://www.w3.org/2000/xmlns/:xsi='http://www.w3.org/2001/XMLSchema-instance'><:int_elem>3</><:string_elem>apepe</><:another_elem :another='bbb' :one='aaa'></><:derived_elem :another='bbb' :one='aaa'></></>";
...
#region XmlInclude on abstract class tests(Bug #18558)
    [Test]
    public void
    TestSerializeIntermediateType() {
      string expectedXml =
          "<ContainerTypeForTest xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><XmlIntermediateType intermediate=\"false\"/></ContainerTypeForTest>";
      var obj = new ContainerTypeForTest();
      obj.MemberToUseInclude = new IntermediateTypeForTest();
      Serialize(obj);
      Assert.AreEqual(Infoset(expectedXml), WriterText,
                      "Serialized Output : " + WriterText);
    }

    [Test]
    public void
    TestSerializeSecondType() {
      string expectedXml =
          "<ContainerTypeForTest xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><XmlSecondType intermediate=\"false\"/></ContainerTypeForTest>";
      var obj = new ContainerTypeForTest();
    ...
    public class CDataTextNodesType { public CDataTextNodesInternal foo; }
    ...
    public class XmlSchemaProviderQNameBecomesRootNameType2 {
      ...
      public object[] Foo =
          new object[]{new XmlSchemaProviderQNameBecomesRootNameType()};
    }
    ...
    void CDataTextNodes_BadNode(object s, XmlNodeEventArgs e) { Assert.Fail(); }
    ...
    static void GetInfoset(XmlNode nod, StringBuilder sb) {
      ...
      case XmlNodeType.Attribute:
        if (nod.LocalName == "xmlns" &&
            nod.NamespaceURI == "http://www.w3.org/2000/xmlns/")
          return;
        sb.Append(" " + nod.NamespaceURI + ":" + nod.LocalName + "='" +
                  nod.Value + "'");
        break;
      ...
      case XmlNodeType.Element:
        ...
        sb.Append(">");
        foreach(XmlNode cn in elem.ChildNodes) GetInfoset(cn, sb);
        sb.Append("</>");
        break;
    ...
    static XmlTypeMapping CreateSoapMapping(Type type,
      ...
      SoapReflectionImporter importer =
          new SoapReflectionImporter(ao, defaultNamespace);
      return importer.ImportTypeMapping(type);
    }
    ...
    public class SubNoParameterlessConstructor : NoParameterlessConstructor {
      public SubNoParameterlessConstructor() : base("") {}
    }
    ...
    [Test]
    public void
    BaseClassWithoutParameterlessConstructor() {
    ...
    [Test] // bug #3211
      ...
      using(var sw = new StringWriter()) ser.Serialize(sw, c);
    }

    [Test]
    public void
    ClassWithImplicitlyConvertibleElement() {
      var ser =
          new XmlSerializer(typeof (ObjectWithElementRequiringImplicitCast));
      ...
      using(var w = new StringWriter()) {
        ...
        using(var r = new StringReader(w.ToString())) {
          var desObj =
              (ObjectWithElementRequiringImplicitCast) ser.Deserialize(r);
    ...
    public class ClassWithOptionalMethods {
      ...
      public ClassWithOptionalMethods(int x, bool shouldSerializeX,
                                      bool xSpecified) {
        this.X = x;
    ...
    OptionalMethods() {
      ...
      var expectedValueWithoutX = Infoset(
      ...
      var expectedValueWithX = Infoset(
          "<?xml version=\"1.0\" encoding=\"utf-16\"?>" + Environment.NewLine +
    ...
    [Test]
    public void
    NotSpecifiedNullableArrayItems() {
      var ser =
          new XmlSerializer(typeof (ObjectWithNotSpecifiedNullableArrayItems));
      ...
      using(var w = new StringWriter()) {
        ...
        using(var r = new StringReader(w.ToString())) {
          var desObj =
              (ObjectWithNotSpecifiedNullableArrayItems) ser.Deserialize(r);
          Assert.IsNull(desObj.Elements[1]);
        }
      }
    }

    private static void TestClassWithDefaultTextNotNullAux(string value,
                                                           string expected) {
      var obj = new ClassWithDefaultTextNotNull(value);
      var ser = new XmlSerializer(typeof (ClassWithDefaultTextNotNull));

      using(var mstream = new MemoryStream()) using(
          var writer = new XmlTextWriter(mstream, Encoding.ASCII)) {
    ...
    [Test]
    public void
    TestClassWithDefaultTextNotNull() {
      TestClassWithDefaultTextNotNullAux("my_text", "my_text");
      TestClassWithDefaultTextNotNullAux(
          "", ClassWithDefaultTextNotNull.DefaultValue);
      TestClassWithDefaultTextNotNullAux(
          null, ClassWithDefaultTextNotNull.DefaultValue);
    }
  }
  ...
  public class XmlSerializerGeneratorTests : XmlSerializerTests {
    ...
    SetUp() {
      ...
      backgroundGeneration =
          typeof (XmlSerializer).GetField("backgroundGeneration", binding);
      generationThreshold =
          typeof (XmlSerializer).GetField("generationThreshold", binding);
      generatorFallback =
          typeof (XmlSerializer).GetField("generatorFallback", binding);
    ...
    public void
    TearDown() {
      if (backgroundGeneration == null || generationThreshold == null ||
          generatorFallback == null)
        return;
...
#region XmlInclude on abstract class test classes
  ...
  public class ContainerTypeForTest {
    ...
    public AbstractTypeForTest MemberToUseInclude {
      get;
      set;
    }
  }
  ...
  public class IntermediateTypeForTest : AbstractTypeForTest {
    ...
    public bool IntermediateMember {
      get;
      set;
    }
  }
