...
#pragma warning restore 0414
    ...
    private class TestClass {
        ...
        public string OneLineProperty {
            get {
                return oneLineProperty;
            }
            set {
                oneLineProperty = value;
            }
        }
    }
...
//		Console.WriteLine (indent + (exiting ? "<--" : "-->") + " " + at + " " + n);
    ...
    */
    ...
    public static void objects () {
        Tests t = new Tests () {
            field_i = 42, field_bool1 = true, field_bool2 = false, field_char = 'A', field_byte = 129, field_sbyte = -33, field_short = Int16.MaxValue - 5, field_ushort = UInt16.MaxValue - 5, field_long = Int64.MaxValue - 5, field_ulong = UInt64.MaxValue - 5, field_float = 3.14f, field_double = 3.14f, field_s = "S", base_field_i = 43, base_field_s = "T", field_enum = AnEnum.B, field_class = null, field_intptr = new IntPtr (Int32.MaxValue - 5), field_nullable = null
        };
        t.o1 (new Tests2 () {
            field_j = 43
        }, new GClass <int> { field = 42 }, new GClass <string> { field = "FOO" });
    ...
    public static void vtypes () {
        Tests t = new Tests () {
            field_struct = new AStruct () { i = 42, s = "S", k = 43 }, generic_field_struct = new GStruct<int> () { i = 42 }, field_boxed_struct = new AStruct () { i = 42 }, boxed_struct_field = new KeyValuePair<int, object> (1, (long)42 )
        };
    ...
    public static void type_info () {
        Tests t = new Tests () {
            field_i = 42, field_s = "S", base_field_i = 43, base_field_s = "T", field_enum = AnEnum.B
        };
        t.ti1 (new Tests2 () {
            field_j = 43
        }, new GClass <int> { field = 42 }, new GClass <string> { field = "FOO" });
        ...
        unsafe {
            ...
            TypedRefTest reftest = new TypedRefTest () {
                MaxValue = 12
            };
    ...
    public static unsafe void pointers () {
        int[] a = new [] {1,2,3};
        BlittableStruct s = new BlittableStruct () {
            i = 2, d = 3.0
        };
        fixed (int* pa = a)
    ...
    static BlittableStruct ref_return_struct = new BlittableStruct () {
        i = 1, d = 2.0
    };
