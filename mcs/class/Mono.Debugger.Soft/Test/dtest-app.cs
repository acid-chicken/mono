...
#pragma warning restore 0169
  ...
  public virtual string virtual_method() { return "V1"; }
}
...
public class AAttribute : Attribute { public int afield; }

public class BAttribute : AAttribute { public int bfield; }
...
public struct TestEnumeratorInsideGenericStruct<TKey, TValue> {
  ...
  private enum Position { BeforeFirst }
}
...
public struct AStruct : ITest2 {
  ...
  */
  ...
  public int invoke_iface() { return i; }
...
public unsafe struct NodeTestFixedArray {
  ...
  public String getBuffer0() {
    fixed(NodeTestFixedArray *p = &this) return Convert.ToString(p->buffer[0]);
  }
  public String getBuffer1() {
    fixed(NodeTestFixedArray *p = &this) return Convert.ToString(p->buffer[1]);
  }
  public String getBuffer2() {
    fixed(NodeTestFixedArray *p = &this) return Convert.ToString(p->buffer[2]);
  }
  public String getBuffer3() {
    fixed(NodeTestFixedArray *p = &this) return Convert.ToString(p->buffer[3]);
  }
  public String getBuffer2_0() {
    fixed(NodeTestFixedArray *p = &this) return Char.ToString(p->buffer2[0]);
  }
  public String getBuffer2_1() {
    fixed(NodeTestFixedArray *p = &this) return Char.ToString(p->buffer2[1]);
  }
  public String getBuffer2_2() {
    fixed(NodeTestFixedArray *p = &this) return Char.ToString(p->buffer2[2]);
  }
  public String getBuffer2_3() {
    fixed(NodeTestFixedArray *p = &this) return Char.ToString(p->buffer2[3]);
  }
}
...
public struct MySpan<T> {
  internal class Pinnable<J> { public J Data; }
  Pinnable<T>_pinnable;
  public MySpan(T[] array) { _pinnable = Unsafe.As<Pinnable<T>>(array); }
  public override string ToString() { return "abc"; }
}
...
public struct NestedStruct { NestedInner nested1, nested2; }

public struct NestedInner {}

public interface IRecStruct { void foo(object o); }

struct RecStruct : IRecStruct {
  public object o;

  public void foo(object o) { this.o = o; }
}
...
class TestIfaces : ITest {
  ...
  TestIfaces<int>Baz() { return null; }
}

public class RuntimeInvokeWithThrowClass {
  public RuntimeInvokeWithThrowClass() {}
  public void RuntimeInvokeThrowMethod() { throw new Exception("thays"); }
}
...
public sealed class DebuggerTaskScheduler : TaskScheduler, IDisposable {
  ...
  // the new task will be executed by a foreground thread ensuring that it will
  // be executed ultil the end.
...
public interface ITest2 { int invoke_iface(); }
...
#pragma warning restore 0414
  ...
  public static int Main(String[] args) {
    ...
    if (args.Length > 0 &&
        args[0] == "unhandled-exception-perform-wait-callback") {
  ...
  public static void if_property_stepping() {
    ...
    if (test.OneLineProperty ==
        "someInvalidValue6049e709-7271-41a1-bc0a-f1f1b80d4125")
      return;
    Console.Write("");
  }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static void
  ss5(int[] arr, Func<int, bool>selector) {
  ...
  public static void
  ss_nested_with_three_args_wrapper() {
    ss_nested_with_three_args(ss_nested_arg1(), ss_nested_arg2(),
                              ss_nested_arg3());
  }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  ss_nested_with_two_args(int a1, int a2) {
    return a1 + a2;
  }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  ss_nested_with_three_args(int a1, int a2, int a3) {
    return a1 + a2 + a3;
  }
  ...
  public static void ss_recursive_chaotic_at(bool exiting, string at, int n){
      ...
      //			indent += "\t";
      //		Console.WriteLine (indent + (exiting ? "<--" : "-->") +
      //" " + at + " " + n);
  }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static void
  ss_recursive_chaotic_buzz(int n) {
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static void
  ss_recursive_chaotic_fizzbuzz(int n) {
  ...
  // Call a complex tree of recursive calls that has tripped up "step out" in
  // the past.
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static void
  ss_recursive_chaotic() {
  ...
  ss_fp_clobber_1(double d) {
    return d + 2.0;
  }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static void
  ss_fp_clobber_2(double d){}
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static async Task<int>
  ss_await_1_exc(bool exc, bool handled) {
    var a = 1;
    await Task.Delay(10);
    if (exc) {
      if (handled) {
  ...
  */
  ...
  public static void
  arguments() {
    arg1(SByte.MaxValue - 5, Byte.MaxValue - 5, true, Int16.MaxValue - 5,
         UInt16.MaxValue - 5, 'F', Int32.MaxValue - 5, UInt32.MaxValue - 5,
         Int64.MaxValue - 5, UInt64.MaxValue - 5, 1.2345f, 6.78910,
         new IntPtr(Int32.MaxValue - 5), new UIntPtr(UInt32.MaxValue - 5));
    int i = 42;
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  arg1(sbyte sb, byte b, bool bl, short s, ushort us, char c, int i, uint ui,
       long l, ulong ul, float f, double d, IntPtr ip, UIntPtr uip) {
    return (int)(sb + b + (bl ? 0 : 1) + s + us + (int) c + i + ui + l +
                 (long) ul + f + d + (int) ip + (int) uip);
  }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static string
  arg2(string s, string s3, object o, ref int i, GClass<int>gc, object o2,
       string s4) {
  ...
  objects() {
    Tests t = new Tests(){field_i = 42,
                          ...
                          field_nullable = null};
    t.o1(new Tests2(){field_j = 43}, new GClass<int>{field = 42},
         new GClass<string>{field = "FOO"});
    o2(new string[]{"BAR", "BAZ"}, new int[]{42, 43},
       new int[, ]{{1, 2}, {3, 4}},
       (int[, ])
           Array.CreateInstance(typeof (int), new int[]{2, 2}, new int[]{1, 3}),
       new int[]{0});
  }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public object
  o1(Tests2 t, GClass<int>gc1, GClass<string>gc2) {
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static string
  o2(string[] s2, int[] s3, int[, ] s4, int[, ] s5, IList<int>s6) {
  ...
  public static void vtypes() {
    Tests t = new Tests(){field_struct = new AStruct(){i = 42, s = "S", k = 43},
                          generic_field_struct = new GStruct<int>(){i = 42},
                          field_boxed_struct = new AStruct(){i = 42},
                          boxed_struct_field =
                              new KeyValuePair<int, object>(1, (long) 42)};
    AStruct s = new AStruct{i = 44, s = "T", k = 45};
    AStruct[] arr = new AStruct[]{new AStruct(){i = 1, s = "S1"},
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public object
  vtypes1(AStruct s, AStruct[] arr, TypedReference typedref) {
    if (arr != null)
      return this;
    else
      return null;
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  static void
  locals11(double a, ref double b){}
  ...
  public static void
  locals2<T>(string[] args, int arg, T t, ref string rs, ref AStruct astruct) {
    long i = 42;
    string s = "AB";
  ...
  public static void
  type_info() {
    Tests t = new Tests(){field_i = 42, field_s = "S", base_field_i = 43,
                          base_field_s = "T", field_enum = AnEnum.B};
    t.ti1(new Tests2(){field_j = 43}, new GClass<int>{field = 42},
          new GClass<string>{field = "FOO"});
    int val = 0;
    unsafe {
      ...
      ti2(new string[]{"BAR", "BAZ"}, new int[]{42, 43},
          new int[, ]{{1, 2}, {3, 4}}, ref val, (int *) IntPtr.Zero, 5, s,
          new Tests(), new Tests2(), new GClass<int>(), AnEnum.B, typedref);
    }
  }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public object
  ti1(Tests2 t, GClass<int>gc1, GClass<string>gc2) {
    if (t == null || gc1 == null || gc2 == null)
      return null;
    else
      return this;
  ...
  ti2(string[] s2, int[] s3, int[, ] s4, ref int ri, int *ptr, int i, AStruct s,
      Tests t, Tests2 t2, GClass<int>g, AnEnum ae, TypedReference typedref) {
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public void
  invoke1(Tests2 t, AStruct s, GStruct<int>g) {
    invoke2();
  }
  ...
  public string invoke_return_ref() { return "ABC"; }

  public object invoke_return_null() { return null; }

  public int invoke_return_primitive() { return 42; }

  public int ? invoke_return_nullable() { return 42; }

    public int invoke_pass_nullable (int? i) {
        return (int)i;
    }

    public int ? invoke_return_nullable_null() { return null; }

    public int invoke_pass_nullable_null (int? i) {
        return i.HasValue ? 1 : 2;
    }

    public void invoke_type_load() { new Class3(); }

    class Class3 {}

    public long invoke_pass_primitive(byte ub, sbyte sb, short ss, ushort us,
                                      int i, uint ui, long l, ulong ul, char c,
                                      bool b, float f, double d) {
      return ub + sb + ss + us + i + ui + l + (long) ul + (int) c + (b ? 1 : 0) +
             (int) f + (int) d;
    }

    public int invoke_pass_primitive2(bool b) { return b ? 1 : 0; }

    public string invoke_pass_ref(string s) { return s; }

    public static string invoke_static_pass_ref(string s) { return s; }

    public static void invoke_static_return_void() {}

    public static void invoke_throws() { throw new Exception(); }

    public int invoke_iface() { return 42; }
    ...
    public static void
    unhandled_exception_endinvoke() {
      Action action = new Action(() => { throw new Exception("thrown"); });
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static void
    crash(){unsafe{Console.WriteLine("{0}", *(int *) - 1);
}
}
...
public static void
unhandled_exception_user() {
  System.Threading.Tasks.Task.Factory.StartNew(() => { Throw(); });
  Thread.Sleep(10000);
}
...
internal static Delegate create_filter_delegate(Delegate dlg,
                                                MethodInfo filter_method) {
  if (dlg == null)
  ...
  var param_types =
      dlg.Method.GetParameters().Select(x => x.ParameterType).ToArray();

  var dynamic = new DynamicMethod(Guid.NewGuid().ToString(), ret_type,
                                  param_types, typeof (object), true);
...
[MethodImplAttribute(MethodImplOptions.NoInlining)]
static int
exception_filter_filter(Exception exc) {
  return 1;
}
...
public static void
dynamic_methods() {
  var m = new DynamicMethod("dyn_method", typeof (void),
                            new Type[]{typeof (int)}, typeof (object).Module);
...
public static void ref_emit() {
  ...
  TypeBuilder tb =
      module.DefineType("foo", TypeAttributes.Public, typeof (object));
  MethodBuilder mb = tb.DefineMethod(
      "ref_emit_method", MethodAttributes.Public | MethodAttributes.Static,
...
[MethodImplAttribute(MethodImplOptions.NoInlining)]
public static void
generic_method<T>() where T : class {}
...
public override string virtual_method() { return "V2"; }
...
[MethodImplAttribute(MethodImplOptions.NoInlining)]
static async void
step_out_void_async(ManualResetEvent wait) {
  await Task.Yield();
...
pointers() {
  ...
  fixed(int *pa = a) pointer_arguments(pa, &s);
}
...
public static ref int get_ref_int() { return ref ret_val; }

static string ref_return_string = "byref";
public static ref string get_ref_string() { return ref ref_return_string; }

static BlittableStruct ref_return_struct =
    new BlittableStruct(){i = 1, d = 2.0};
...
public static unsafe void pointer_arguments2(int *a) { *a = 0; }

[MethodImplAttribute(MethodImplOptions.NoInlining)]
public static unsafe void
pointers2() {
  int[] a = new[]{1, 2, 3};
  fixed(int *pa = a) pointer_arguments2(pa);
}
