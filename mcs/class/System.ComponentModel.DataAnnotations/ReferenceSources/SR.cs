...
namespace System.ComponentModel.DataAnnotations.Resources
{
    partial class DataAnnotationsResources
    {
        ...
        public const string AttributeStore_Type_Must_Be_Public =
            "The type '{0}' must be public.";
        public const string AttributeStore_Unknown_Method =
            "The type '{0}' does not contain a public method named '{1}'.";
        public const string AttributeStore_Unknown_Property =
        ...
        public const string CustomValidationAttribute_Method_Not_Found =
            "The CustomValidationAttribute method '{0}' does not exist in type '{1}' or is not public and static.";
        public const string CustomValidationAttribute_Method_Required =
            "The CustomValidationAttribute.Method was not specified.";
        public const string CustomValidationAttribute_Method_Signature =
        ...
        public const string CustomValidationAttribute_Type_Must_Be_Public =
            "The custom validation type '{0}' must be public.";
        public const string CustomValidationAttribute_ValidationError =
            "{0} is not valid.";
        public const string CustomValidationAttribute_ValidatorType_Required =
            "The CustomValidationAttribute.ValidatorType was not specified.";
        public const string DataTypeAttribute_EmptyDataTypeString =
        ...
        public const string Validator_Property_Value_Wrong_Type =
            "The value for property '{0}' must be of type '{1}'.";
        public const string RangeAttribute_ArbitraryTypeNotIComparable =
            "The type {0} must implement {1}.";
        public const string RangeAttribute_MinGreaterThanMax =
            "The maximum value '{0}' must be greater than or equal to the minimum value '{1}'.";
        public const string RangeAttribute_Must_Set_Min_And_Max =
            "The minimum and maximum values must be set.";
        public const string RangeAttribute_Must_Set_Operand_Type =
            "The OperandType must be set when strings are used for minimum and maximum values.";
        public const string RangeAttribute_ValidationError =
            "The field {0} must be between {1} and {2}.";
        public const string RegexAttribute_ValidationError =
            "The field {0} must match the regular expression '{1}'.";
        public const string RegularExpressionAttribute_Empty_Pattern =
            "The pattern must be set to a valid regular expression.";
        public const string RequiredAttribute_ValidationError =
            "The {0} field is required.";
        public const string StringLengthAttribute_InvalidMaxLength =
            "The maximum length must be a nonnegative integer.";
        public const string StringLengthAttribute_ValidationError =
            "The field {0} must be a string with a maximum length of {1}.";
        public const string UIHintImplementation_ControlParameterKeyIsNotAString =
            "The key parameter at position {0} with value '{1}' is not a string. Every key control parameter must be a string.";
        public const string UIHintImplementation_ControlParameterKeyIsNull =
        ...
        public const string ValidationAttribute_Cannot_Set_ErrorMessage_And_Resource =
            "Either ErrorMessageString or ErrorMessageResourceName must be set, but not both.";
        public const string ValidationAttribute_NeedBothResourceTypeAndResourceName =
            "Both ErrorMessageResourceType and ErrorMessageResourceName need to be set on this attribute.";
        public const string ValidationAttribute_ResourcePropertyNotStringType =
            "The property '{0}' on resource type '{1}' is not a string type.";
        public const string ValidationAttribute_ResourceTypeDoesNotHaveProperty =
            "The resource type '{0}' does not have an accessible static property named '{1}'.";
        public const string ValidationAttribute_ValidationError =
            "The field {0} is invalid.";
        public const string ValidationContext_Must_Be_Method =
            "The ValidationContext for the type '{0}', member name '{1}' must provide the MethodInfo.";
        public const string EnumDataTypeAttribute_TypeNeedsToBeAnEnum =
            "The type '{0}' needs to represent an enumeration type.";
        public const string EnumDataTypeAttribute_TypeCannotBeNull =
        ...
        public const string DisplayAttribute_PropertyNotSet =
        ...
        public const string Validator_InstanceMustMatchValidationContextInstance =
            "The instance provided must match the ObjectInstance on the ValidationContext supplied.";
        public const string ValidationAttribute_IsValid_NotImplemented =
        ...
        public const string MinLengthAttribute_InvalidMinLength =
            "MinLengthAttribute must have a Length value that is zero or greater.";
        public const string MinLengthAttribute_ValidationError =
            "The field {0} must be a string or array type with a minimum length of '{1}'.";
        public const string ArgumentIsNullOrWhitespace =
            "The argument '{0}' cannot be null, empty or contain only white space.";
        public const string LengthAttribute_InvalidValueType =
