...
namespace MonoTests.System.IO {
  ...
  public class DirectoryTest {
    ...
    [Test] // BXC #12461
      ...
      var files1 =
          new List<string>(Directory.EnumerateFiles(TempFolder, "*.src"))
              .ToArray();
      Array.Sort(files1);
      ...
      var files3 = new List<string>(Directory.EnumerateFileSystemEntries(
                                        TempFolder, "*.src"))
                       .ToArray();
      Array.Sort(files3);
    ...
    "#2"); Assert.IsNull (ex.InnerException, "#3"); Assert.IsNotNull
    (ex.Message, "#4"); Assert.IsNull (ex.ParamName, "#5");
        }
        DeleteDirectory (":");
    }
    */
    ...
    [Test]
    public void
    CreateDirectory_Path_Whitespace() {
      try {
    ...
    [Test]
    public void
    CreateDirectory_Path_InvalidChars() {
    ...
    CreateDirectoryAlreadyExists() {
      ...
      try {
        ...
        Assert.IsTrue(info2.FullName.EndsWith("DirectoryTest.Test.Exists"),
                      "#2");
    ...
    [Test]
    public void
    CreateDirectoryAlreadyExistsAsFile() {
    ...
    CreateDirectoryRelativePath() {
      ...
      Assert.IsTrue(Directory.Exists(Path.Combine(TempFolder, "relativepath")),
                    "#2");
    }
    ...
    public void
    DeleteDirectoryNotFoundException() {
    ...
    [Test]
    public void
    DeleteDirectoryOnExistingFileName() {
      string path = TempFolder + DSC + "DirectoryTest.Test.ExistsAsFile";
      DeleteDirectory(path);
      DeleteFile(path);
      try {
    ...
    [Test]  // bug #78239
      ...
      if (!RunningOnUnix)
        Assert.Ignore(
            "Not running on Unix."); // this test does not work on Windows.
      ...
      try {
        ...
        global::Mono.Posix.Syscall.chmod(path,
                                         (global::Mono.Posix.FileMode) 755);
        Directory.Delete(path);
      }
    }
#endif
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetCreationTimeException2() {
      Directory.GetCreationTime(string.Empty);
    }

    [Test]
    public void
    GetCreationTimeException_NonExistingPath() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetCreationTimeUtcException2() {
      Directory.GetCreationTimeUtc(string.Empty);
    }

    [Test]
    public void
    GetCreationTimeUtc_NonExistingPath() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastAccessTimeException2() {
      Directory.GetLastAccessTime(string.Empty);
    }

    [Test]
    public void
    GetLastAccessTime_NonExistingPath() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastAccessTimeUtcException2() {
      Directory.GetLastAccessTimeUtc(string.Empty);
    }

    [Test]
    public void
    GetLastAccessTimeUtc_NonExistingPath() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastAccessTimeUtcException4() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastAccessTimeUtcException5() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastWriteTimeException2() {
      Directory.GetLastWriteTime(string.Empty);
    }

    [Test]
    public void
    GetLastWriteTime_NonExistingPath() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    GetLastWriteTimeUtcException2() {
      Directory.GetLastWriteTimeUtc(string.Empty);
    }

    [Test]
    public void
    GetLastWriteTimeUtc_NonExistingPath() {
    ...
    MoveFile() {
      ...
      using(StreamWriter sw = File.CreateText(tempFile1)) { sw.Write("temp1"); }
    ...
    [Test]
    public void
    MoveFile_DestFile_Exists() {
      string tempFile1 = Path.Combine(TempFolder, "temp1.txt");
      string tempFile2 = Path.Combine(TempFolder, "temp2.txt");

      using(StreamWriter sw = File.CreateText(tempFile1)) { sw.Write("temp1"); }
      using(StreamWriter sw = File.CreateText(tempFile2)) { sw.Write("temp2"); }
    ...
    CreationTime() {
      ...
      try {
        ...
        time = TimeZone.CurrentTimeZone.ToUniversalTime(
    ...
    //"DirectoryTest.SetLastWriteTime.1";
    //
    //		try {
    ...
    //"DirectoryTest.SetLastWriteTimeUtc.1";
    //
    //		if (!Directory.Exists (path))
    //			Directory.CreateDirectory (path);
    //		try {
    ...
    //		DateTime time = new DateTime (1003, 4, 6, 6, 4, 2);
    //		string path = TempFolder + DSC +
    //"DirectoryTest.SetLastAccessTime.1";
    //
    //		if (!Directory.Exists (path))
    //			Directory.CreateDirectory (path);
    //		try {
    ...
    [ExpectedException(typeof(ArgumentNullException))]
    public void
    SetLastAccessTimeUtcException1() {
      DateTime time = new DateTime(2003, 4, 6, 6, 4, 2);
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    SetLastAccessTimeUtcException2() {
      DateTime time = new DateTime(2003, 4, 6, 6, 4, 2);
    ...
    [ExpectedException()]
    public void
    SetLastAccessTimeUtcException3() {
      DateTime time = new DateTime(2003, 4, 6, 6, 4, 2);
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    SetLastAccessTimeUtcException4() {
      DateTime time = new DateTime(2003, 4, 6, 6, 4, 2);
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    SetLastAccessTimeUtcException5() {
      DateTime time = new DateTime(2003, 4, 6, 6, 4, 2);
    ...
    //		DateTime time = new DateTime (1000, 4, 6, 6, 4, 2);
    //		string path = TempFolder + DSC +
    //"DirectoryTest.SetLastAccessTimeUtc.1";
    //
    //		if (!Directory.Exists (path))
    //			Directory.CreateDirectory (path);
    //		try {
    ...
    //		DateTime time = new DateTime (1003, 4, 6, 6, 4, 2);
    //		string path = TempFolder + DSC +
    //"DirectoryTest.SetCreationTime.1";
    //
    //		if (!Directory.Exists (path))
    //			Directory.CreateDirectory (path);
    //		try {
    ...
    GetDirectories() {
      ...
      string DirPath =
          TempFolder + Path.DirectorySeparatorChar + ".GetDirectories";
    ...
    [Test] // bug #346123
      ...
      Assert.IsFalse(File.Exists(Path.Combine(TempFolder, "temp1.file")),
                     "#A2");
    ...
    [Test]
    public void
    GetFiles_SubDirInPattern() {
      string DirPath =
          TempFolder + Path.DirectorySeparatorChar + "GetFiles_SubDirInPattern";
      ...
      Assert.AreEqual(
          new string[]{ Path.Combine(DirPath, "something", "else", "file")}, r);
    }

    [Test]
    [ExpectedException(typeof(ArgumentNullException))]
    public void
    SetCurrentDirectoryNull() {
    ...
    [ExpectedException(typeof(ArgumentException))]
    public void
    SetCurrentDirectoryWhitespace() {
      Directory.SetCurrentDirectory(" ");
    }

    [Test] // https://github.com/mono/mono/issues/13030
        public void
        GetLogicalDrivesNotEmpty() {
    ...
    public void
    GetNoFiles() // Bug 58875. This throwed an exception on windows.
    {
    ...
    [Test]
    public void
    ResolvePathBeforeDirectoryExists() {
      if (!RunningOnUnix)
        Assert.Ignore("Not running on Unix.");
      ...
      try {
        ...
        var partial_path_with_symlink =
            "test3/../test3"; // test3 is a symlink to test/test2
