...
namespace MonoTests.System {
  ...
  public class CharCategoryTest {
    private void CompareWithDump(ComparisonMethod cm, string dump,
                                 bool testTrue) {
      string testDump = CharCategoryUtils.GenerateDump(cm, testTrue);

      //			string filename = Assembly.GetAssembly (typeof
      //(Char)).Location + "/resources/" + dumpfile; 			StreamReader sr = new
      //StreamReader (filename); 			dump = sr.ReadToEnd (); 			sr.Close ();
    ...
    public void
    IsLetterOrDigit() {
      CompareWithDump(new ComparisonMethod(Char.IsLetterOrDigit),
    ...
    public void
    IsSurrogate() {
      CompareWithDump(new ComparisonMethod(Char.IsSurrogate), surrogateChars,
                      true);
    }
    ...
    public void
    IsWhiteSpace() {
      CompareWithDump(new ComparisonMethod(Char.IsWhiteSpace), whitespaceChars,
                      true);
    }
