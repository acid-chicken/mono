...
namespace MonoTests.System {
  ...
  class NewVTable : DeriveVTable {
    ...
    public NewVTable(out int i) { i = 0; }

    public void byref_method(out int i) { i = 0; }
  }
  ...
  class Derived2 : Base1 {
    ...
    public new void Dummy() { E += delegate{}; }
  }
...
public override FieldInfo BindToField(BindingFlags a, FieldInfo[] b, object c,
                                      CultureInfo d) {
  return null;
}
...
public override MethodBase SelectMethod(BindingFlags a, MethodBase[] b,
                                        Type[] c, ParameterModifier[] d) {
  return null;
}

public override PropertyInfo SelectProperty(BindingFlags a, PropertyInfo[] b,
                                            Type c, Type[] d,
                                            ParameterModifier[] e) {
  return null;
}
...
public class TypeTest {
  ...
  private string genTypeName() { return "t" + (typeIndexer++); }
  ...
  private void GenericMethod2<A, B, C, D>() where C : Duper where A
      : B,
        IFace where B : C where D : Baz<object> {}
  ...
  TestIsAssignableFrom() {
    ...
    Assert.AreEqual(typeof (Super).IsAssignableFrom(typeof (Duper)), true,
                    "#01");
    Assert.AreEqual(typeof (Duper).IsAssignableFrom(typeof (Duper)), true,
                    "#02");
    Assert.AreEqual(typeof (Object).IsAssignableFrom(typeof (Duper)), true,
                    "#03");
    Assert.AreEqual(typeof (ICloneable).IsAssignableFrom(typeof (Duper)), true,
                    "#04");

    // Tests for arrays
    Assert.AreEqual(typeof (Super[]).IsAssignableFrom(typeof (Duper[])), true,
                    "#05");
    Assert.AreEqual(typeof (Duper[]).IsAssignableFrom(typeof (Super[])), false,
                    "#06");
    Assert.AreEqual(typeof (Object[]).IsAssignableFrom(typeof (Duper[])), true,
                    "#07");
    Assert.AreEqual(typeof (ICloneable[]).IsAssignableFrom(typeof (Duper[])),
                    true, "#08");

    // Tests for multiple dimensional arrays
    Assert.AreEqual(typeof (Super[][]).IsAssignableFrom(typeof (Duper[][])),
                    true, "#09");
    Assert.AreEqual(typeof (Duper[][]).IsAssignableFrom(typeof (Super[][])),
                    false, "#10");
    Assert.AreEqual(typeof (Object[][]).IsAssignableFrom(typeof (Duper[][])),
                    true, "#11");
    Assert.AreEqual(
        typeof (ICloneable[][]).IsAssignableFrom(typeof (Duper[][])), true,
        "#12");

    // Tests for vectors<->one dimensional arrays */
    Array arr1 = Array.CreateInstance(typeof (int), new int[]{1}, new int[]{0});
    Array arr2 =
        Array.CreateInstance(typeof (int), new int[]{1}, new int[]{10});

    Assert.AreEqual(typeof (int[]).IsAssignableFrom(arr1.GetType()), true,
                    "#13");
    Assert.AreEqual(typeof (int[]).IsAssignableFrom(arr2.GetType()), false,
                    "#14");

    // Test that arrays of enums can be cast to their base types
    Assert.AreEqual(typeof (int[]).IsAssignableFrom(typeof (TypeCode[])), true,
                    "#15");

    // Test that arrays of valuetypes can't be cast to arrays of
    // references
    Assert.AreEqual(typeof (object[]).IsAssignableFrom(typeof (TypeCode[])),
                    false, "#16");
    Assert.AreEqual(typeof (ValueType[]).IsAssignableFrom(typeof (TypeCode[])),
                    false, "#17");
    Assert.AreEqual(typeof (Enum[]).IsAssignableFrom(typeof (TypeCode[])),
                    false, "#18");

    // Test that arrays of enums can't be cast to arrays of references
    Assert.AreEqual(typeof (object[]).IsAssignableFrom(typeof (TheEnum[])),
                    false, "#19");
    Assert.AreEqual(typeof (ValueType[]).IsAssignableFrom(typeof (TheEnum[])),
                    false, "#20");
    Assert.AreEqual(typeof (Enum[]).IsAssignableFrom(typeof (TheEnum[])), false,
                    "#21");

    // Check that ValueType and Enum are recognized as reference types
    Assert.AreEqual(typeof (object).IsAssignableFrom(typeof (ValueType)), true,
                    "#22");
    Assert.AreEqual(typeof (object).IsAssignableFrom(typeof (Enum)), true,
                    "#23");
    Assert.AreEqual(typeof (ValueType).IsAssignableFrom(typeof (Enum)), true,
                    "#24");

    Assert.AreEqual(typeof (object[]).IsAssignableFrom(typeof (ValueType[])),
                    true, "#25");
    Assert.AreEqual(typeof (ValueType[]).IsAssignableFrom(typeof (ValueType[])),
                    true, "#26");
    Assert.AreEqual(typeof (Enum[]).IsAssignableFrom(typeof (ValueType[])),
                    false, "#27");

    Assert.AreEqual(typeof (object[]).IsAssignableFrom(typeof (Enum[])), true,
                    "#28");
    Assert.AreEqual(typeof (ValueType[]).IsAssignableFrom(typeof (Enum[])),
                    true, "#29");
    Assert.AreEqual(typeof (Enum[]).IsAssignableFrom(typeof (Enum[])), true,
                    "#30");

    // Tests for byref types
    MethodInfo mi = typeof (TypeTest).GetMethod(
        "ByrefMethod", BindingFlags.Instance | BindingFlags.NonPublic);
    Assert.IsTrue(mi.GetParameters()[2].ParameterType.IsAssignableFrom(
        mi.GetParameters()[1].ParameterType));
    Assert.IsTrue(mi.GetParameters()[1].ParameterType.IsAssignableFrom(
        mi.GetParameters()[1].ParameterType));

    // Tests for type parameters
    mi = typeof (TypeTest).GetMethod(
        "GenericMethod", BindingFlags.Instance | BindingFlags.NonPublic);
    Assert.IsTrue(mi.GetParameters()[0].ParameterType.IsAssignableFrom(
        mi.GetParameters()[0].ParameterType));
    Assert.IsFalse(
        mi.GetParameters()[0].ParameterType.IsAssignableFrom(typeof (int)));

    // Tests for parameters with generic constraints
    mi = typeof (TypeTest).GetMethod(
        "GenericMethod", BindingFlags.Instance | BindingFlags.NonPublic);
    Assert.IsTrue(
        typeof (IFace).IsAssignableFrom(mi.GetParameters()[1].ParameterType));

    // Transitivity of IsAssignableFrom for type parameters
    mi = typeof (TypeTest).GetMethod(
        "GenericMethod2", BindingFlags.Instance | BindingFlags.NonPublic);
    ...
    var t2 = typeof (SampleGenericConstrained<>)
                 .GetTypeInfo()
  ...
  TestIsSubclassOf() {
    ...
    Type paramType = typeof (TypeTest)
                         .GetMethod("ByrefMethod", BindingFlags.Instance |
  ...
  TestGetMethodImpl() {
    ...
    Assert.AreEqual(typeof (Base),
                    typeof (Base).GetMethod("TestVoid").DeclaringType, "#01");
    Assert.AreEqual(typeof (NewVTable),
    ...
    Assert.AreEqual(typeof (Base),
                    typeof (Base)
                        .GetMethod("TestInt", new Type[]{typeof (int)})
                        .DeclaringType,
                    "#03");
    Assert.AreEqual(typeof (NewVTable),
                    typeof (NewVTable)
  ...
  TestGetPropertyImpl() {
    ...
    Assert.AreEqual(typeof (NewVTable),
                    typeof (NewVTable)
                        .GetProperty("Item", new Type[1]{typeof (Int32)})
                        .DeclaringType,
                    "#01");
    ...
    Assert.AreEqual(typeof (NewVTable),
                    typeof (NewVTable)
                        .GetProperty("Item", new Type[1]{typeof (Int16)})
                        .DeclaringType,
                    "#02");
  ...
  GetEvents() {
    ...
    Assert.AreEqual(typeof (Derived2),
                    typeof (Derived2).GetEvents()[0].DeclaringType);
  }
  ...
  GetProperties() {
    ...
    Assert.AreEqual(typeof (Derived2),
                    typeof (Derived2).GetProperties()[0].DeclaringType, "#2");

    // For generics, hide-by-name-and-signature works on the unexpanded types.
    // The GenericIndexers<T,U> class has two indexers that take different
    // arguments. GetProperties on all instances of this generic type should
    // still have 2 properties, even if T and U are instantiated with the same
    // types.
  ...
  [Test]
  public void
  GetProperties_Overrides() {
    Assert.AreEqual(
        1, typeof (GetProperties_Overrides_Input.IB).GetProperties().Length);

    var prop = typeof (GetProperties_Overrides_Input.TestClass)
                   .GetProperty("TestProperty");
    Assert.AreEqual(typeof (GetProperties_Overrides_Input.TestClass),
                    prop.DeclaringType);

    var prop_2 = typeof (GetProperties_Overrides_Input.TestClass_HiddenProperty)
                     .GetProperty("Prop");
    Assert.AreEqual(
        typeof (GetProperties_Overrides_Input.TestClass_HiddenProperty),
        prop_2.DeclaringType);

    Assert.AreEqual(1, typeof (GetProperties_Overrides_Input.TestClass)
                           .GetProperties()
                           .Length);
    Assert.AreEqual(1, typeof (GetProperties_Overrides_Input.TestClass_Indexer)
                           .GetProperties()
                           .Length);
    Assert.AreEqual(
        1, typeof (GetProperties_Overrides_Input.TestClass_HiddenProperty)
               .GetProperties()
               .Length);
  }
  ...
  [Test] // GetProperty (String, BindingFlags, Binder, Type, Type [],
         // ParameterModifier [])
      public void
      GetProperty7_Name_Null() {
    Type type = typeof (Bar);
    try {
      type.GetProperty((string) null, BindingFlags.Public, null, typeof (int),
  ...
  [Test]
  public void
  GetProperty8_PropertyType() {
    Type type = typeof (Bar);
    Assert.IsNull(type.GetProperty("PubInst",
                                   BindingFlags.Public | BindingFlags.Instance,
                                   null, typeof (int), Type.EmptyTypes, null),
                  "#1");
    Assert.IsNotNull(
        type.GetProperty("PubInst", BindingFlags.Public | BindingFlags.Instance,
                         null, typeof (long), new Type[0], null),
        "#2");
  }

  [Test]
  public void
  GetProperty9_Indexers() {

    var bindingFlags = BindingFlags.Public | BindingFlags.Instance;

    Type type1 = typeof (List<byte>);
    var p1 = type1.GetProperty("Item", bindingFlags, null, typeof (byte),
                               new Type[]{typeof (int)}, null);
    Assert.IsNotNull(p1, "#1");

    Type type2 = typeof (List<string>);
    var p2 = type2.GetProperty("Item", bindingFlags, null, typeof (string),
                               new Type[]{typeof (int)}, null);
    ...
    var p3 =
        type3.GetProperty("Item", bindingFlags, null, typeof (string) /*!*/,
                          new Type[]{typeof (int)}, null);
    Assert.IsNull(p3, "#3");
  }
  ...
  [Test]
  public void Name() {
    Assert.AreEqual("Int32&", typeof (TypeTest)
                                  .GetMethod("Reflected")
                                  .GetParameters()[0]
                                  .ParameterType.Name);
    Assert.AreEqual(
        "String[*]",
        Array.CreateInstance(typeof (string), new int[]{1}, new int[]{1})
            .GetType()
            .Name);
  }
  ...
  [Test]
  public void
  GetInterfacesGenericVarWithConstraints() {
  ...
  public void
  GetFieldIgnoreCase() {
    Assert.IsNotNull(typeof (TypeTest).GetField(
        "afield",
        BindingFlags.Instance | BindingFlags.Public | BindingFlags.IgnoreCase));
  }

  public int Count{internal get{return 0;
}
...
[Test]
public void
GetPropertyAccessorModifiers() {
  Assert.IsNotNull(typeof (TypeTest).GetProperty(
      "Count", BindingFlags.Instance | BindingFlags.Public));
  Assert.IsNull(typeof (TypeTest).GetProperty(
      "Count", BindingFlags.Instance | BindingFlags.NonPublic));
}
...
ByrefTypes() {
  ...
  Assert.AreEqual(
      0, t.GetMethods(BindingFlags.Public | BindingFlags.Instance).Length);
  Assert.AreEqual(
      0, t.GetConstructors(BindingFlags.Public | BindingFlags.Instance).Length);
  Assert.AreEqual(
      0, t.GetEvents(BindingFlags.Public | BindingFlags.Instance).Length);
  Assert.AreEqual(
      0, t.GetProperties(BindingFlags.Public | BindingFlags.Instance).Length);
...
public void
CreateValueTypeNoCtorArgs() {
  typeof (B).InvokeMember("", BindingFlags.CreateInstance, null, null,
                          new object[]{1});
}
...
[ExpectedException(typeof(MissingMethodException))]
public void
InvokeGetPropertyMissing() {
  typeof (B).InvokeMember("", BindingFlags.GetProperty, null, null,
                          new object[]{1});
}
...
[ExpectedException(typeof(MissingMethodException))]
public void
InvokeSetPropertyMissing() {
  typeof (B).InvokeMember("", BindingFlags.SetProperty, null, null,
                          new object[]{1});
}
...
internal static string bug336841(string param1) { return "#B:" + param1; }
...
[Test]
public void
InvokeMember_GetSetField() {
  typeof (X).InvokeMember("Value",
...
[Test]
public void
InvokeMember_MatchPrimitiveTypeWithInterface() {
  object[] invokeargs = {1};
...
[Test]
public void
InvokeMember_NoOperation() {
  try {
    typeof (TypeTest).InvokeMember("Run",
                                   BindingFlags.Public | BindingFlags.Static,
                                   null, null, new object[0]);
    Assert.Fail("#1");
  } catch (ArgumentException ex) {
...
[Test]
public void
InvokeMember_SetField_ProvidedArgs() {
  try {
    typeof (X).InvokeMember("Value",
                            BindingFlags.Public | BindingFlags.Static |
                                BindingFlags.SetField,
...
[Test] // bug #336841
    [Category(
        "NotDotNet")] // https://connect.microsoft.com/VisualStudio/feedback/ViewFeedback.aspx?FeedbackID=306797
    public void
    InvokeMember_VarArgs() {
  BindingFlags flags = BindingFlags.InvokeMethod | BindingFlags.Public |
                       BindingFlags.NonPublic |
                       BindingFlags.OptionalParamBinding | BindingFlags.Static |
                       BindingFlags.FlattenHierarchy | BindingFlags.Instance;

  Type type = typeof (TypeTest);
  string result = (string) type.InvokeMember("bug336841", flags, null, null,
                                             new object[]{"1"});
  Assert.IsNotNull(result, "#A1");
  Assert.AreEqual("#B:1", result, "#A2");

  result = (string) type.InvokeMember("bug336841", flags, null, null,
                                      new object[]{"1", "2", "3", "4"});
...
[Test] // bug #348522
    public void
    InvokeMember_WithoutDefaultValue() {
  BindingFlags flags =
      BindingFlags.Instance | BindingFlags.Public | BindingFlags.InvokeMethod;
  try {
    typeof (Bug348522).InvokeMember(
        "Test", flags, new FirstMethodBinder(), new Bug348522(),
...
[Test]
public void
GetGenericMethodDefinitionOverInflatedMethodOnGTD() {
...
[Test]
public void
InvokeMember_OutParam() {
  object[] args = new object[]{new string[0]};
  typeof (TypeTest).InvokeMember("OutTest",
...
public static void OutTest(out string[] a1) { a1 = new string[10]; }

public class X { public static int Value; }
...
static bool HasAttribute(object[] attrs, Type attributeType) {
  foreach(object attr in attrs) if (attr.GetType() ==
                                    attributeType) return true;
  return false;
}
...
GetCustomAttributes_Type() {
  ...
  attrs =
      typeof (bug82431A1).GetCustomAttributes(typeof (InheritAttribute), false);
  Assert.AreEqual(1, attrs.Length, "#G1");
  Assert.AreEqual(typeof (NotInheritAttribute), attrs[0].GetType(), "#G2");
  attrs =
      typeof (bug82431A1).GetCustomAttributes(typeof (InheritAttribute), true);
  Assert.AreEqual(1, attrs.Length, "#G3");
  Assert.AreEqual(typeof (NotInheritAttribute), attrs[0].GetType(), "#G4");

  attrs = typeof (bug82431A1)
              .GetCustomAttributes(typeof (NotInheritAttribute), false);
  ...
  attrs =
      typeof (bug82431A2).GetCustomAttributes(typeof (InheritAttribute), false);
  Assert.AreEqual(0, attrs.Length, "#I1");
  attrs =
      typeof (bug82431A2).GetCustomAttributes(typeof (InheritAttribute), true);
  Assert.AreEqual(0, attrs.Length, "#I2");

  attrs = typeof (bug82431A2)
              .GetCustomAttributes(typeof (NotInheritAttribute), false);
  Assert.AreEqual(0, attrs.Length, "#J1");
  attrs = typeof (bug82431A2)
              .GetCustomAttributes(typeof (NotInheritAttribute), true);
  Assert.AreEqual(0, attrs.Length, "#J2");

  attrs =
      typeof (bug82431A3).GetCustomAttributes(typeof (InheritAttribute), false);
  ...
  attrs =
      typeof (bug82431A3).GetCustomAttributes(typeof (InheritAttribute), true);
  ...
  attrs =
      typeof (bug82431B2).GetCustomAttributes(typeof (InheritAttribute), false);
  Assert.AreEqual(0, attrs.Length, "#O1");
  attrs =
      typeof (bug82431B2).GetCustomAttributes(typeof (InheritAttribute), true);
  Assert.AreEqual(1, attrs.Length, "#O2");
  Assert.AreEqual(typeof (InheritAttribute), attrs[0].GetType(), "#O3");

  attrs = typeof (bug82431B2)
              .GetCustomAttributes(typeof (NotInheritAttribute), false);
  ...
  attrs =
      typeof (bug82431B3).GetCustomAttributes(typeof (InheritAttribute), false);
  Assert.AreEqual(1, attrs.Length, "#Q1");
  Assert.AreEqual(typeof (NotInheritAttribute), attrs[0].GetType(), "#Q2");
  attrs =
      typeof (bug82431B3).GetCustomAttributes(typeof (InheritAttribute), true);
  ...
  attrs =
      typeof (bug82431B4).GetCustomAttributes(typeof (InheritAttribute), false);
  Assert.AreEqual(0, attrs.Length, "#S1");
  attrs =
      typeof (bug82431B4).GetCustomAttributes(typeof (InheritAttribute), true);
  Assert.AreEqual(1, attrs.Length, "#S2");
  Assert.AreEqual(typeof (InheritAttribute), attrs[0].GetType(), "#S3");

  attrs = typeof (bug82431B4)
              .GetCustomAttributes(typeof (NotInheritAttribute), false);
...
[Test] // bug #76150
  ...
  Assert.IsFalse(typeof (BA).IsDefined(typeof (NemerleAttribute), false),
                 "#B1");
  Assert.IsFalse(typeof (BA).IsDefined(typeof (VolatileModifier), false),
                 "#B2");
...
[Test] // bug #82431
    ...
    public void
    IsDefined_Inherited() {
  Assert.IsFalse(typeof (CA).IsDefined(typeof (NemerleAttribute), false),
                 "#C1");
  Assert.IsFalse(typeof (CA).IsDefined(typeof (VolatileModifier), false),
                 "#C2");
  ...
  Assert.IsFalse(typeof (BBA).IsDefined(typeof (NemerleAttribute), false),
                 "#D1");
  Assert.IsFalse(typeof (BBA).IsDefined(typeof (VolatileModifier), false),
                 "#D2");
  ...
  Assert.IsTrue(typeof (bug82431A1).IsDefined(typeof (InheritAttribute), false),
                "#E1");
  Assert.IsTrue(
      typeof (bug82431A1).IsDefined(typeof (NotInheritAttribute), false),
      "#E2");
  Assert.IsTrue(typeof (bug82431A1).IsDefined(typeof (InheritAttribute), true),
                "#E3");
  Assert.IsTrue(
      typeof (bug82431A1).IsDefined(typeof (NotInheritAttribute), true), "#E4");

  Assert.IsFalse(
      typeof (bug82431A2).IsDefined(typeof (InheritAttribute), false), "#F1");
  Assert.IsFalse(
      typeof (bug82431A2).IsDefined(typeof (NotInheritAttribute), false),
      "#F2");
  Assert.IsFalse(typeof (bug82431A2).IsDefined(typeof (InheritAttribute), true),
                 "#F3");
  Assert.IsFalse(
      typeof (bug82431A2).IsDefined(typeof (NotInheritAttribute), true), "#F4");

  Assert.IsTrue(typeof (bug82431A3).IsDefined(typeof (InheritAttribute), false),
                "#G1");
  Assert.IsTrue(
      typeof (bug82431A3).IsDefined(typeof (NotInheritAttribute), false),
      "#G2");
  Assert.IsTrue(typeof (bug82431A3).IsDefined(typeof (InheritAttribute), true),
                "#G3");
  Assert.IsTrue(
      typeof (bug82431A3).IsDefined(typeof (NotInheritAttribute), true), "#G4");

  Assert.IsTrue(typeof (bug82431B1).IsDefined(typeof (InheritAttribute), false),
                "#H1");
  Assert.IsFalse(
      typeof (bug82431B1).IsDefined(typeof (NotInheritAttribute), false),
      "#H2");
  Assert.IsTrue(typeof (bug82431B1).IsDefined(typeof (InheritAttribute), true),
                "#H3");
  Assert.IsFalse(
      typeof (bug82431B1).IsDefined(typeof (NotInheritAttribute), true), "#H4");

  Assert.IsFalse(
      typeof (bug82431B2).IsDefined(typeof (InheritAttribute), false), "#I1");
  Assert.IsFalse(
      typeof (bug82431B2).IsDefined(typeof (NotInheritAttribute), false),
      "#I2");
  Assert.IsTrue(typeof (bug82431B2).IsDefined(typeof (InheritAttribute), true),
                "#I3");
  Assert.IsFalse(
      typeof (bug82431B2).IsDefined(typeof (NotInheritAttribute), true), "#I4");

  Assert.IsTrue(typeof (bug82431B3).IsDefined(typeof (InheritAttribute), false),
                "#J1");
  Assert.IsTrue(
      typeof (bug82431B3).IsDefined(typeof (NotInheritAttribute), false),
      "#J2");
  Assert.IsTrue(typeof (bug82431B3).IsDefined(typeof (InheritAttribute), true),
                "#J3");
  Assert.IsTrue(
      typeof (bug82431B3).IsDefined(typeof (NotInheritAttribute), true), "#J4");

  Assert.IsFalse(
      typeof (bug82431B4).IsDefined(typeof (InheritAttribute), false), "#K2");
  Assert.IsFalse(
      typeof (bug82431B4).IsDefined(typeof (NotInheritAttribute), false),
      "#K2");
  Assert.IsTrue(typeof (bug82431B4).IsDefined(typeof (InheritAttribute), true),
                "#K3");
  Assert.IsFalse(
      typeof (bug82431B4).IsDefined(typeof (NotInheritAttribute), true), "#K4");
}

class Bug13767Attribute : Attribute {
  public object[] field;

  public Bug13767Attribute(params object[] args) { field = args; }
}
...
[Bug13767("Demo", new[]{Bug13767Enum.Value1, Bug13767Enum.Value0})] public void
Bug13767Method(string attributeName, Bug13767Enum[] options){
...
[Test]
public void
GetType1_TypeName_Empty_nothrow() {
  var t = Type.GetType("");
  Assert.IsNull(t);
}
...
public void
GetType2_TypeName_Empty() {
  Type.GetType("", true);
}

[Test]
public void
GetType2_TypeName_Empty_nothrow() {
...
[ExpectedException(typeof(TypeLoadException))]
public void
GetType3_TypeName_Empty() {
  Type.GetType("", true, false);
}

[Test]
public void
GetType3_TypeName_Empty_nothrow() {
...
GetTypeCode() {
  ...
  Assert.AreEqual(TypeCode.Int32,
                  Type.GetTypeCode(typeof (GenericEnum<int>.TheEnum)));
}

[Test]
public void
GetTypeFromHandle_Handle_Zero() {
...
[Test] // GetConstructor (Type [])
    public void
    GetConstructor1_Types_ItemNull() {
...
[Test] // GetConstructor (BindingFlags, Binder, Type [], ParameterModifier [])
    public void
    GetConstructor2_Types_ItemNull() {
  Type type = typeof (BindingFlags);
  try {
...
[Test] // GetConstructor (BindingFlags, Binder, CallingConventions, Type [],
       // ParameterModifier [])
    public void
    GetConstructor3_Types_ItemNull() {
  Type type = typeof (BindingFlags);
  try {
    type.GetConstructor(BindingFlags.Default, null, CallingConventions.Any,
...
TypeParameterIsNotGeneric() {
  ...
  // LAMESPEC: MSDN claims that this should be false, but .NET v2.0.50727 says
  // it's true
...
IsAssignable() {
  ...
  Assert.IsFalse(foo_type.IsAssignableFrom(foo_int_type),
                 "Foo<int> -!-> Foo<>");
  Assert.IsFalse(foo_int_type.IsAssignableFrom(foo_type),
                 "Foo<> -!-> Foo<int>");
  ...
  Assert.IsTrue(ibar_int_type.IsAssignableFrom(baz_int_type),
                "Baz<int> -> IBar<int>");
  Assert.IsTrue(ibar_short_type.IsAssignableFrom(baz_short_type),
                "Baz<short> -> IBar<short>");

  Assert.IsFalse(ibar_int_type.IsAssignableFrom(baz_short_type),
                 "Baz<short> -!-> IBar<int>");
  Assert.IsFalse(ibar_short_type.IsAssignableFrom(baz_int_type),
                 "Baz<int> -!-> IBar<short>");
  ...
  Assert.IsTrue(
      typeof (Nullable<FooStruct>).IsAssignableFrom(typeof (FooStruct)));
}
...
[Test]
public void
IsInstanceOfArrayOfNullable() {
  Assert.IsTrue(
      typeof (Nullable<int>[]).IsInstanceOfType(new Nullable<int>[ 0 ]));
}

[Test]
public void
IsInstanceOfType_Null() {
...
public void
MakeArrayTypedReferenceInstanceTest() {
  object o = Array.CreateInstance(typeof (global::System.TypedReference), 1);
}

[Test]
public void
MakeArrayTypeLargeRank() {
  Assert.Throws<TypeLoadException>(
      delegate() { typeof (int).MakeArrayType(33); });
}
...
[Test]
public void
GetCustomAttributesGenericInstance() {
  Assert.AreEqual(1, typeof(ComFoo<int>)
                         .GetCustomAttributes(typeof(ComVisibleAttribute), true)
                         .Length);
}
...
interface ByRef3<T>where T : struct {
  void f(ref T? t);
}
interface ByRef4 {
...
public class Bug80242<T>{
  public interface IFoo{} public class Bar : IFoo{} public class
  Baz : Bar{}
}
...
TestNestedTypes() {
  ...
  foreach(Type u in t.GetNestedTypes()) {
    Assert.IsTrue(u.IsGenericTypeDefinition, "{0} isn't a generic definition",
                  u);
...
public void
ReflectionOnlyGetTypeNullTypeName() {
  Type.ReflectionOnlyGetType(null, false, false);
}

[Test]
public void
ReflectionOnlyGetTypeDoNotThrow() {
...
ReflectionOnlyGetType() {
  Type t = Type.ReflectionOnlyGetType(
      typeof (int).AssemblyQualifiedName.ToString(), true, true);
...
[Test]
public void
MakeGenericType_WrongNumOfArguments() {
  try {
...
class GenericClassWithAttributes<[ Doc("T") ] T, [ Doc("B") ] B>where T
    : class,
      new() where B : Attribute{public T Bar{get{return null;
}
}
...
[Test] // bug #377596
    public void
    GetGenericArguments_ArgumentsHaveAttributes() {
  ...
  Assert.AreEqual(
      1, tArgs[0].GetCustomAttributes(typeof (DocAttribute), true).Length,
      "#1");
  Assert.AreEqual(
      1, tArgs[1].GetCustomAttributes(typeof (DocAttribute), true).Length,
      "#1");
  Assert.AreEqual(
      1, mArgs[0].GetCustomAttributes(typeof (DocAttribute), true).Length,
      "#1");
}
...
[Test] // bug #471255
    [Category("StackWalks")]
    public void
    GetTypeCalledUsingReflection() {
  Type expectedType = Type.GetType("NoNamespaceClass");
  Assert.IsNotNull(expectedType, "#1");
  MethodInfo m = typeof (Type).GetMethod(
      "GetType", BindingFlags.Public | BindingFlags.Static, null,
      new Type[]{typeof (string)}, null);
  object r =
      m.Invoke(null, BindingFlags.Default, null,
               new object[]{"NoNamespaceClass"}, CultureInfo.InvariantCulture);
  Assert.AreSame(expectedType, r, "#2");
}

public class BConstrained<Y>where Y : BConstrained<Y> {}

public class AConstrained<X>
    : BConstrained<AConstrained<X>>{}

          [Test] // Bug https://bugzilla.xamarin.com/show_bug.cgi?id=54485
      public void
      MakeGenericType_GTD_Constraint() {
...
public void
GetGenericTypeDefinitionUserType() {
  new UserType(null).GetGenericTypeDefinition();
}

[ExpectedException(typeof(NotSupportedException))]
public void
GetGenericArgumentsUserType() {
...
public void
GenericParameterPositionUserType() {
  Assert.IsTrue(new UserType(null).GenericParameterPosition == 0);
}

[Test]
public void
TypeGetMemberReturnTypeTest() {
  object obj;
  MemberTypes memtype;
  Type testtype;
  ...
  Tuple<MemberTypes, Type>[] flagsandtypes = new Tuple<MemberTypes, Type>[]{
      ...
      Tuple.Create<MemberTypes, Type>(MemberTypes.Constructor,
                                      typeof (ConstructorInfo[])),
      Tuple.Create<MemberTypes, Type>(MemberTypes.Custom,
                                      typeof (MemberInfo[])),
      ...
      Tuple.Create<MemberTypes, Type>(MemberTypes.Method,
                                      typeof (MethodInfo[])),
      Tuple.Create<MemberTypes, Type>(MemberTypes.NestedType, typeof (Type[])),
      Tuple.Create<MemberTypes, Type>(MemberTypes.Property,
                                      typeof (PropertyInfo[])),
...
[Test]
public void
TypeGetMemberWildcardTypeTest() {
  MemberInfo[] obj;
  MemberTypes memType;
  string wildcard;
  Type testType = typeof (FieldInfo[]);

  Tuple<MemberTypes, Type, string>[] flagsandtypes =
      new Tuple<MemberTypes, Type, string>[]{
          Tuple.Create<MemberTypes, Type, string>(MemberTypes.Field,
                                                  typeof (FieldInfo[]), "Fi*"),
          Tuple.Create<MemberTypes, Type, string>(MemberTypes.Event,
                                                  typeof (EventInfo[]), "Ev*"),
          Tuple.Create<MemberTypes, Type, string>(MemberTypes.Method,
                                                  typeof (MethodInfo[]), "Me*"),
          Tuple.Create<MemberTypes, Type, string>(
              MemberTypes.Property, typeof (PropertyInfo[]), "Pr*"),
          Tuple.Create<MemberTypes, Type, string>(MemberTypes.NestedType,
                                                  typeof (Type[]), "Ne*"),
          Tuple.Create<MemberTypes, Type, string>(MemberTypes.TypeInfo,
                                                  typeof (Type[]), "Ne*")};
  ...
  for (int i = 0; i < flagsandtypes.Length; i++) {
    ...
    obj = typeof (DummyReflectionWildcardClass)
              .GetMember("Dummy" + wildcard, memType,
                         BindingFlags.Public | BindingFlags.Instance);
...
Bug506757() {
  ...
  TypeBuilder type0 =
      module.DefineType("Base", TypeAttributes.Public, typeof (object));
  ...
  MethodAttributes attrs1 = MethodAttributes.Virtual |
                            MethodAttributes.HideBySig |
                            MethodAttributes.FamORAssem;

  MethodAttributes attrs2 = MethodAttributes.Virtual |
                            MethodAttributes.HideBySig |
  ...
  foreach(
      var m in t2.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic))
      Assert.IsTrue(m.DeclaringType == typeof (object),
...
public class DeclaringMethodBar<T>{public void Test2(ref T t){}}

[Test]
public void
DeclaringMethodOnlyWorksWithGenericArgs() {
  MethodInfo testMethod = typeof(DeclaringMethodFoo).GetMethod("Test");
  MethodBase otherMethod =
      testMethod.GetParameters()[0].ParameterType.DeclaringMethod;
...
[Test]
public void
GetArrayRankThrowsForNonArrayType() {
...
[Test] // Bug #564379
    public void
    GetMethodsReturnPublicMethodsInInterfaces() {
  ...
  foreach(var m in methods) {
    ...
    else if (m.Name.Equals("Equals") || m.Name.Equals("GetHashCode") ||
...
[Test] // Bug #574696
    public void
    GetMember_DoesntReturnPrivatePropOfParent() {
  BindingFlags flags =
...
[Test] // Bug #484246
    public void
    GetInterfaceCompareAgainstGTDNames() {
  var t = typeof (Dictionary<string, string>);
  var iface = typeof (IDictionary<string, string>);

  Assert.AreSame(
      iface, t.GetInterface("System.Collections.Generic.IDictionary`2"), "#1");
...
[Test]
public void
RuntimeCorrectlyNormalizeGenericTypes() {
...
public struct Size4 { public int field; }

public struct Size4b { public int field; }

[Test]
public void
IsAssignableFromGenericArgumentsWithConstraints() {
...
class GenericWithParamConstraints<A, B, C>where B : Foo<C>where A
    : B{}

      [Test]
      public void
      IsAssignableFromArraySpecialInterfaceGtd() {
  ...
  Assert.IsFalse(il.IsAssignableFrom(typeof(Array)),
                 "System.Array -!-> IList<>");
}

[Test]
public void
IsAssignableFromArrayEnumerator() {
  ...
  Assert.IsFalse(ieStr.IsAssignableFrom(arrStr),
                 "string[] -!-> IEnumerator<string>");
  Assert.IsFalse(ieEqStr.IsAssignableFrom(arrStr),
  ...
  Assert.IsFalse(ieEqInt.IsAssignableFrom(arrInt),
                 "int[] -!-> IEnumerator<IEquatable<int>>");
}

[Test] // Bug #612780
    public void
    CannotMakeDerivedTypesFromTypedByRef() {
  try {
...
[Test] // Bug643890
    public void
    DeclaringTypeOfGenericNestedTypeInstanceIsOpen() {
...
class GetInterfaceMap : IGetInterfaceMap<object>{public string Bar(object t){
...
GetInterfaceMapWorksWithVariantIfaces() {
  InterfaceMapping res =
      typeof (GetInterfaceMap)
          .GetInterfaceMap(typeof (IGetInterfaceMap<object>));
  ...
  res = typeof (GetInterfaceMap)
            .GetInterfaceMap(typeof (IGetInterfaceMap<string>));
...
public enum MyRealEnum : short { A, B, C }

public enum MyRealEnum2 : byte { A, B, C }

public enum MyRealEnum3 : short { A, B, C }

public class MyEnum : TypeDelegator{public bool is_enum{get;
set;
}
public int fields {
  get;
...
public enum OutOfOrderEnum : sbyte { D = -1, C = 2, B = 1, A = 0 }

[Test]
public void
GetEnumNamesSortsByUnsignedValue() {
...
GetEnumValue() {
  ...
  Assert.AreEqual("A", new MyEnum(){fields = 1, is_enum = true}.GetEnumName(0),
                  "#4");
  Assert.AreEqual(
      "A", new MyEnum(){fields = 1, is_enum = true}.GetEnumName(MyRealEnum.A),
      "#5");
  Assert.AreEqual(
      "A", new MyEnum(){fields = 1, is_enum = true}.GetEnumName(MyRealEnum2.A),
      "#6");
...
[Test]
public void
GetTypeWithDelegates() {
  var tname = typeof(MyRealEnum).AssemblyQualifiedName;
  var res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   (asm, name, ignore) => {
                     return asm == null ? Type.GetType(name, false, ignore)
  ...
  tname = string.Format("{0}[{1}][]*&", typeof(Foo<>).FullName,
  ...
  res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   ...
                   false, false);
  Assert.AreEqual(typeof(Foo<MyRealEnum>[]).MakePointerType().MakeByRefType(),
                  res, "#8");
  ...
  res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   ...
                   false, false);
  Assert.AreEqual(typeof(MyRealEnum).MakePointerType().MakeByRefType(), res,
                  "#13");
  ...
  res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   ...
                   false, false);
  Assert.AreEqual(typeof(MyRealEnum).MakeArrayType(2).MakeByRefType(), res,
                  "#14");
  ...
  res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   ...
                   false, false);
  Assert.AreEqual(typeof(MyRealEnum).MakePointerType().MakeArrayType(), res,
                  "#15");
  ...
  res =
      Type.GetType(tname, name => { return Assembly.Load(name); },
                   ...
                   false, false);
  Assert.AreEqual(typeof(MyRealEnum)
                      .MakeArrayType()
                      .MakePointerType()
                      .MakePointerType()
                      .MakeArrayType()
  ...
  res = Type.GetType("System.String,mscorlib", delegate(AssemblyName aname) {
...
[Test]
public void
GetTypeWithDelegatesAndUserTypes() {
...
void MustTLE(string tname) {
  try {
    var res = Type.GetType(
        tname, name => { return Assembly.Load(name); },
        (asm, name, ignore) => {
          return (object) asm == null ? Type.GetType(name, false, ignore)
              : asm.GetType(name, false, ignore);
        },
        true, false);
    Assert.Fail(tname);
...
void MustAE(string typename) {
  MustAE_general(typename, tname => {
    return Type.GetType(tname, name => { return Assembly.Load(name); },
                        (asm, name, ignore) => {
                          return (object) asm ==
                                 null ? Type.GetType(name, false, ignore)
                              : asm.GetType(name, false, ignore);
                        },
                        true, false);
  });
...
NewGetTypeErrors() {
  ...
  MustTLE("");
  MustAE("!@#$%^&*");
  MustAE(string.Format("{0}[{1}&]", typeof (Foo<>).FullName,
                       typeof (MyRealEnum).FullName));
  MustAE(string.Format("{0}[{1}*]", typeof (Foo<>).FullName,
                       typeof (MyRealEnum).FullName));
  ...
  MustAE(string.Format("{0}[[{1}],", typeof (Foo<>).FullName,
                       typeof (MyRealEnum).FullName));
  MustAE(string.Format("{0}[[{1}]_", typeof (Foo<>).FullName,
                       typeof (MyRealEnum).FullName));
...
[Test] // bug #668506
    public void
    IsAssignableFromWithVariantDelegate() {
  Assert.IsFalse(
      typeof (MyAction<string>).IsAssignableFrom(typeof (MyAction<>)), "#1");
}

[Test] // bug #124
    public void
    IsAssignableFromWithNullable() {
        Console.WriteLine(typeof(IEnumerable<int?>).IsAssignableFrom(typeof(IEnumerable<int>)));
}

[Test]
public void
GetTypeParseGenericCorrectly() { // Bug #15124
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1"), typeof (Foo<>), "#1");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[System.Int32]"),
                  typeof (Foo<int>), "#2");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[[System.Int32]]"),
                  typeof (Foo<int>), "#3");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[System.Int32][]"),
                  typeof (Foo<int>[]), "#4");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[][System.Int32]"), null,
                  "#5");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[System.Int32][,]"),
                  typeof (Foo<int>[
                    ,
                  ...
                  "#6");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[]"),
                  typeof (Foo<>).MakeArrayType(), "#7");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[,]"),
                  typeof (Foo<>).MakeArrayType(2), "#8");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[][]"),
                  typeof (Foo<>).MakeArrayType().MakeArrayType(), "#9");
...
[Test]
public void
GetTypeNullDelegatesParseGenericCorrectly() {
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1", null, null),
                  typeof (Foo<>), "#1");
  Assert.AreEqual(
  ...
  Assert.AreEqual(
      ...
      "#5");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[]", null, null),
                  typeof (Foo<>).MakeArrayType(), "#6");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[,]", null, null),
                  typeof (Foo<>).MakeArrayType(2), "#7");
  Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1[][]", null, null),
                  typeof (Foo<>).MakeArrayType().MakeArrayType(), "#8");
...
[Test]
public void
GetTypeAnonymousParseCorrectly() {
  var x = new {X = 1};
  var a = new[]{x};
...
[Category("AndroidNotWorking")] // requires symbol writer
    public void
    FullNameGetTypeParseEscapeRoundtrip() // bug #26384
{
  ...
  var nestedTb = tb.DefineNestedType(
      "Nested,+*&[]\\", TypeAttributes.Class | TypeAttributes.NestedPublic);

  var ty = tb.CreateType();

  var nestedTy = nestedTb.CreateType();

  var escapedNestedName = "NameSpace\\,\\+\\*\\&\\[\\]\\\\" + "." +
                          "Type\\,\\+\\*\\&\\[\\]\\\\" + "+" +
                          "Nested\\,\\+\\*\\&\\[\\]\\\\";

  Assert.AreEqual(escapedNestedName, nestedTy.FullName);

  var lookupNestedTy = Type.GetType(escapedNestedName + "," + nm.FullName,
                                    asmName => {
...
public abstract class Stream : IDisposable {
  public void Dispose() { Console.WriteLine("stream::dispose"); }

  protected virtual void Dispose(bool disposing) {}
}

public class NonClosingStream : Stream, IDisposable {
  void IDisposable.Dispose() { Console.WriteLine("ncs::dispose"); }

  public override string ToString() { return ""; }
}

static bool ContainsProperty(PropertyInfo[] props, string name) {
  foreach(PropertyInfo p in props) if (p.Name == name) return true;
  return false;
}
...
[Test]
public void
NullFullNameForSpecificGenericTypes() {
  var expected = new[]{
      (typeof (Bug59738Class<>).GetFields()[0].FieldType, "Bug59738Interface`1",
       (string) null, "MonoTests.System.TypeTest+Bug59738Interface`1[U]"),
      (typeof (Bug59738Derived<>).BaseType, "Bug59738Class`1", (string) null,
       "MonoTests.System.TypeTest+Bug59738Class`1[U]"),
      (typeof (Bug59738Class<int>), "Bug59738Class`1",
...
[Test]
public void
GetInterfaceCaseInsensitiveTest() {
  var type = typeof (Dictionary<string, object>);

  Assert.NotNull(type.GetInterface("System.Collections.IDictionary", false),
                 "strict named interface must be found (ignoreCase = false)");
  Assert.NotNull(type.GetInterface("System.Collections.IDictionary", true),
...
IsByRefLike_negative() {
  ...
  Assert.IsFalse(typeof (UserByRefLikeStruct).MakeByRefType().IsByRefLike,
                 "#6");
  Assert.IsFalse(typeof (int).MakePointerType().IsByRefLike, "#7");
  Assert.IsFalse(typeof (Span<int>).MakePointerType().IsByRefLike, "#8");
  Assert.IsFalse(typeof (UserByRefLikeStruct).MakePointerType().IsByRefLike,
                 "#9");
}
...
[ExpectedException("System.TypeLoadException")]
public void
IsByRefLike_ArrayOfByrefLike_TLE() {
  typeof (UserByRefLikeStruct).MakeArrayType();
}

[Test]
public void
GetConstructorsOnArrayOfGenericArgumentsToArraySpecialInterfaceGtd() {
  // Regression test for
  // https://github.com/mono/mono/issues/7095#issuecomment-470465597 The
  // assertion here isn't very important; what matters is that the runtime
  // doesn't crash.
...
class UserType : Type {
  ...
  public UserType(Type type) { this.type = type; }
  ...
  protected override TypeAttributes GetAttributeFlagsImpl() { return 0; }
