...
#pragma warning restore 169
    ...
    */
    ...
    public void GetEnumUnderlyingType () {
        ...
        try {
            new MyEnum () {
                is_enum = true, fields = 2
            } .GetEnumUnderlyingType ();
            Assert.Fail ("#3");
        } catch (ArgumentException) {}

        Assert.AreSame (typeof (short), new MyEnum () {
            is_enum = true, fields = 1
        } .GetEnumUnderlyingType ());
    }
    ...
    public void GetEnumValue () {
        ...
        Assert.IsNull (new MyEnum () {
            fields = 1, is_enum = true
        } .GetEnumName (77), "#3");
        Assert.AreEqual ("A", new MyEnum () {
            fields = 1, is_enum = true
        } .GetEnumName (0), "#4");
        Assert.AreEqual ("A", new MyEnum () {
            fields = 1, is_enum = true
        } .GetEnumName (MyRealEnum.A), "#5");
        Assert.AreEqual ("A", new MyEnum () {
            fields = 1, is_enum = true
        } .GetEnumName (MyRealEnum2.A), "#6");
    ...
    public void IsEnumDefined () {
        ...
        Assert.IsFalse  (new MyEnum () {
            is_enum = true, fields = 1
        } .IsEnumDefined ((short)99), "#14");
    }
...
class UserType : Type
{
    ...
    public override Assembly Assembly {
        get {
            return this.type == null ? null : this.type.Assembly;
        }
    }
