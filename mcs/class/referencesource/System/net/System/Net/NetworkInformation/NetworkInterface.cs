...
namespace System.Net.NetworkInformation {
  ...
  public abstract class NetworkInterface {
    /// Returns objects that describe the network interfaces on the local
    /// computer.
    ...
    /// Provides Internet Protocol (IP) statistical data for thisnetwork
    /// interface. Despite the naming, the results are not IPv4 specific. Do not
    /// use this method, use GetIPStatistics instead.
    public virtual IPv4InterfaceStatistics GetIPv4Statistics() {
      throw new NotImplementedException();
    }

    /// Provides Internet Protocol (IP) statistical data for this network
    /// interface.
    ...
    /// Gets the speed of the interface in bits per second as reported by the
    /// interface.
    public virtual long Speed {
      get { throw new NotImplementedException(); }
    }

    /// Gets a bool value that indicates whether the network interface is set to
    /// only receive data packets.
    public virtual bool IsReceiveOnly {
      get { throw new NotImplementedException(); }
    }

    /// Gets a bool value that indicates whether this network interface is
    ...
    /// <b>deonb. This is okay if you don't support this in Whidbey. This
    /// actually belongs in the NetworkAdapter derived class</b>
    ...
    public virtual bool
    Supports(NetworkInterfaceComponent networkInterfaceComponent) {
      throw new NotImplementedException();
    }
  }
}
