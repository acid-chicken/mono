...
namespace System.ComponentModel.DataAnnotations
{
    ...
    [SuppressMessage("Microsoft.Performance", "CA1813:AvoidUnsealedAttributes",
                     Justification =
                         "We want users to be able to extend this class")]
    public class MaxLengthAttribute : ValidationAttribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaxLengthAttribute"/>
        /// class. The maximum allowable length supported by the database will be
        /// used.
        /// </summary>
        ...
        /// null. It is assumed the <see cref = "RequiredAttribute" /> is used if
        /// the value may not be null.
        /// </remarks>
        /// <param name = "value">The object to validate.</param>
        /// <returns><c>true</c> if the value is null or less than or equal to the
        /// specified maximum length, otherwise <c>false</c></returns> <exception
        /// cref = "InvalidOperationException">Length is zero or less than negative
        /// one.</exception>
        public override bool IsValid(object value)
        {
            ...
            var length = 0;
            // Automatically pass if value is null. RequiredAttribute should be used
            // to assert a value is not null.
            if (value == null)
            {
                return true;
            }
        ...
        /// string.</param> <returns>A localized string to describe the maximum
        /// acceptable length.</returns>
        public override string FormatErrorMessage(string name)
        {
            // An error occurred, so we know the value is greater than the maximum if
            // it was specified
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Length is zero or less than
        /// negative one.</exception>
