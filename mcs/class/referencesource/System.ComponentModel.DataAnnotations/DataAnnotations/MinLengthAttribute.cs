...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public class MinLengthAttribute : ValidationAttribute
    {
        ...
        /// <exception cref = "InvalidOperationException">Length is less than
        /// zero.</exception>
        ...
        /// string.</param> <returns>A localized string to describe the minimum
        ...
        private void EnsureLegalLengths()
        {
            if (Length < 0)
            {
                throw new InvalidOperationException(String.Format(
                    ...
                    DataAnnotationsResources.MinLengthAttribute_InvalidMinLength));
            }
        }
    }
}
