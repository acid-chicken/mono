  ...
  internal sealed class SqlMetaDataFactory : DbMetaDataFactory { // V1.2.3300
    ...
    private void addUDTsToDataTypesTable(DataTable dataTypesTable,
      ...
      const string sqlCommand =
          "select " + "assemblies.name, " + "types.assembly_class, " +
          ...
          "is_nullable, " + "is_fixed_length, " + "max_length " +
      ...
      if (0 > string.Compare(ServerVersion, _serverVersionNormalized90,
      ...
      DataColumn isLiteralSupported =
          dataTypesTable.Columns[DbMetaDataColumnNames.IsLiteralSupported];
      DataColumn typeName =
          dataTypesTable.Columns[DbMetaDataColumnNames.TypeName];
      DataColumn isNullable =
          dataTypesTable.Columns[DbMetaDataColumnNames.IsNullable];

      if ((providerDbtype == null) || (columnSize == null) ||
          (isFixedLength == null) || (isSearchable == null) ||
          (isLiteralSupported == null) || (typeName == null) ||
          (isNullable == null)) {
    ...
    private void AddTVPsToDataTypesTable(DataTable dataTypesTable,
      ...
      const string sqlCommand = "select " + "name, " + "is_nullable, " +
                                "max_length " + "from sys.types " +
                                "where is_table_type = 1";

      //

      if (0 > string.Compare(ServerVersion, _serverVersionNormalized10,
                             StringComparison.OrdinalIgnoreCase)) {
        return;
      }
      ...
      if ((providerDbtype == null) || (columnSize == null) ||
          (isSearchable == null) || (isLiteralSupported == null) ||
          (typeName == null) || (isNullable == null)) {
        throw ADP.InvalidXml();
      }
    ...
    private DataTable GetDataTypesTable(SqlConnection connection) {
      ...
      addUDTsToDataTypesTable(dataTypesTable, connection,
                              ServerVersionNormalized);
      AddTVPsToDataTypesTable(dataTypesTable, connection,
                              ServerVersionNormalized);
