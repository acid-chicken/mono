...
namespace System.Runtime.Serialization {
  public static class DataContractSerializerExtensions {
    public static ISerializationSurrogateProvider
    ...
    public static void SetSerializationSurrogateProvider(
      ...
      // allocate every time, expectation is that this won't happen enough to
      // warrant maintaining a CondtionalWeakTable.
    ...
    private class SurrogateProviderAdapter : IDataContractSurrogate {
      ...
      public SurrogateProviderAdapter(
          ISerializationSurrogateProvider provider) {
        _provider = provider;
      }
      ...
      public object GetCustomDataToExport(MemberInfo memberInfo,
      ...
      ProcessImportedType(CodeTypeDeclaration typeDeclaration,
