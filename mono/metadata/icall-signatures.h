...
// ICALL_SIG_NAME: mono_icall_sig pasted with its parameters with underscores
// between each.
...
#define ICALL_SIG_NAME_5(a, b, c, d, e)                                        \
  mono_icall_sig_##a##_##b##_##c##_##d##_##e
#define ICALL_SIG_NAME_6(a, b, c, d, e, f)                                     \
  mono_icall_sig_##a##_##b##_##c##_##d##_##e##_##f
#define ICALL_SIG_NAME_7(a, b, c, d, e, f, g)                                  \
  mono_icall_sig_##a##_##b##_##c##_##d##_##e##_##f##_##g
#define ICALL_SIG_NAME_8(a, b, c, d, e, f, g, h)                               \
  mono_icall_sig_##a##_##b##_##c##_##d##_##e##_##f##_##g##_##h
...
#define ICALL_SIG(n, types)                                                    \
  extern MonoMethodSignature *const ICALL_SIG_NAME(n, types);
