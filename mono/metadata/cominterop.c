...
void ves_icall_Mono_Interop_ComInteropProxy_AddProxy(
    gpointer pUnk, MonoComInteropProxy *volatile *proxy_handle) {
#ifndef DISABLE_COM
  guint32 const gchandle =
      mono_gchandle_new_weakref_internal((MonoObject *)*proxy_handle, FALSE);
...
void ves_icall_Mono_Interop_ComInteropProxy_FindProxy(
    gpointer pUnk, MonoComInteropProxy *volatile *proxy_handle) {
  *proxy_handle = NULL;
