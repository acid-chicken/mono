 ...
 */
guint32 mono_gchandle_new_internal(MonoObject *obj, gboolean pinned) {
 ...
 * unmanaged code.
 */
guint32 mono_gchandle_new_weakref_internal(GCObject *obj,
...
gboolean mono_gchandle_is_in_domain(guint32 gchandle, MonoDomain *domain) {
  MonoDomain *gchandle_domain =
      (MonoDomain *)sgen_gchandle_get_metadata(gchandle);
 ...
 * object wrapped.
 */
void mono_gchandle_free_internal(guint32 gchandle) {
 ...
 */
MonoObject *mono_gchandle_get_target_internal(guint32 gchandle) {
