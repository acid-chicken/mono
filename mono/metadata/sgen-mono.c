...
void mono_gc_init_icalls(void) {
  mono_register_jit_icall(mono_gc_alloc_obj, mono_icall_sig_object_ptr_int,
                          FALSE);
  mono_register_jit_icall(mono_gc_alloc_vector,
                          mono_icall_sig_object_ptr_int_int, FALSE);
  mono_register_jit_icall(mono_gc_alloc_string,
                          mono_icall_sig_object_ptr_int_int32, FALSE);
