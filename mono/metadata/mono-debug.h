...
MONO_API void mono_debug_open_image_from_memory(MonoImage *image,
...
MONO_API MonoDebugMethodJitInfo *mono_debug_find_method(MonoMethod *method,
                                                        MonoDomain *domain);
...
mono_debug_lookup_source_location(MonoMethod *method, uint32_t address,
                                  MonoDomain *domain);

MONO_API int32_t mono_debug_il_offset_from_address(MonoMethod *method,
                                                   MonoDomain *domain,
...
MONO_API char *mono_debug_print_stack_frame(MonoMethod *method,
                                            uint32_t native_offset,
                                            MonoDomain *domain);
...
MONO_API int mono_debugger_insert_breakpoint(const char *method_name,
