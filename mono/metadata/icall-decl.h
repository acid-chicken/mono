...
ves_icall_Mono_Security_Cryptography_KeyPairPersistence_ProtectUser(
    const gunichar2 *);
ICALL_EXPORT gpointer ves_icall_System_Net_Sockets_Socket_Accept_internal(
    gsize, gint32 *, MonoBoolean);
ICALL_EXPORT gint32
ves_icall_System_Net_Sockets_Socket_Available_internal(gsize, gint32 *);
