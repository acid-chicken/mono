...
static MonoExceptionHandle
mono_exception_new_argument_internal(const char *type, const char *arg,
                                     const char *msg, MonoError *error);
 ...
 */
static MonoExceptionHandle mono_exception_new_by_name(MonoImage *image,
                                                      const char *name_space,
                                                      const char *name,
                                                      MonoError *error) {
  return mono_exception_new_by_name_domain(mono_domain_get(), image, name_space,
                                           name, error);
}
...
MonoException *mono_exception_from_name(MonoImage *image,
                                        const char *name_space,
                                        const char *name) {
  return mono_exception_from_name_domain(mono_domain_get(), image, name_space,
                                         name);
}
...
MonoException *mono_exception_from_name_domain(MonoDomain *domain,
  ...
  MonoExceptionHandle ret =
      mono_exception_new_by_name_domain(domain, image, name_space, name, error);
  mono_error_assert_ok(error);
...
static MonoExceptionHandle create_exception_two_strings(MonoClass *klass,
                                                        MonoStringHandle a1,
                                                        MonoStringHandle a2,
                                                        MonoError *error) {
  HANDLE_FUNCTION_ENTER();
...
MonoException *mono_exception_from_name_two_strings(MonoImage *image,
  ...
  MonoExceptionHandle ret = mono_exception_from_name_two_strings_checked(
      image, name_space, name, a1, a2, error);
...
MonoExceptionHandle mono_exception_from_name_two_strings_checked(
    ...
    MonoStringHandle a1, MonoStringHandle a2, MonoError *error) {
  HANDLE_FUNCTION_ENTER();
  ...
  HANDLE_FUNCTION_RETURN_REF(
      MonoException, create_exception_two_strings(klass, a1, a2, error));
}
 ...
 * \returns the initialized exception instance.
 */
MonoExceptionHandle mono_exception_new_by_name_msg(MonoImage *image,
                                                   const char *name_space,
                                                   const char *name,
                                                   const char *msg,
                                                   MonoError *error) {
  ...
  MonoExceptionHandle ex =
      mono_exception_new_by_name(image, name_space, name, error);
  goto_if_nok(error, return_null);

  if (msg) {
    MonoStringHandle msg_str =
        mono_string_new_handle(MONO_HANDLE_DOMAIN(ex), msg, error);
 ...
 *
 *   Same as mono_exception_from_name_two_strings, but lookup the exception
 * class using IMAGE and TOKEN.
 */
MonoException *mono_exception_from_token_two_strings(MonoImage *image,
                                                     guint32 token,
                                                     MonoString *arg1_raw,
                                                     MonoString *arg2_raw) {
  HANDLE_FUNCTION_ENTER();
...
MonoExceptionHandle mono_exception_from_token_two_strings_checked(
    MonoImage *image, guint32 token, MonoStringHandle a1, MonoStringHandle a2,
    MonoError *error) {
  HANDLE_FUNCTION_ENTER();
 ...
 */
MonoException *mono_get_exception_divide_by_zero(void) {
 ...
 */
MonoException *mono_get_exception_security(void) {
...
MonoExceptionHandle mono_exception_new_thread_abort(MonoError *error) {
  return mono_exception_new_by_name(mono_get_corlib(), "System.Threading",
                                    "ThreadAbortException", error);
}
 ...
 * \returns a new instance of the \c System.Threading.ThreadAbortException
 */
MonoException *mono_get_exception_thread_abort(void) {
...
MonoExceptionHandle mono_exception_new_thread_interrupted(MonoError *error) {
  return mono_exception_new_by_name(mono_get_corlib(), "System.Threading",
                                    "ThreadInterruptedException", error);
}
 ...
 * \returns a new instance of the \c System.Threading.ThreadInterruptedException
 */
MonoException *mono_get_exception_thread_interrupted(void) {
  return mono_exception_from_name(mono_get_corlib(), "System.Threading",
 ...
 */
MonoException *mono_get_exception_arithmetic(void) {
  return mono_exception_from_name(mono_get_corlib(), "System",
                                  "ArithmeticException");
}
 ...
 */
MonoException *mono_get_exception_overflow(void) {
  return mono_exception_from_name(mono_get_corlib(), "System",
                                  "OverflowException");
}
 ...
 */
MonoException *mono_get_exception_null_reference(void) {
  return mono_exception_from_name(mono_get_corlib(), "System",
...
MonoException *mono_get_exception_execution_engine(const char *msg) {
  ...
  MONO_ENTER_GC_UNSAFE;
  result = mono_exception_from_name_msg(mono_get_corlib(), "System",
 ...
 * \param msg the message to pass to the user
 * \returns a new instance of the \c
...
MonoExceptionHandle mono_exception_new_invalid_operation(const char *msg,
                                                         MonoError *error) {
  return mono_exception_new_by_name_msg(
      mono_get_corlib(), "System", "InvalidOperationException", msg, error);
}
 ...
 */
MonoException *mono_get_exception_array_type_mismatch(void) {
  return mono_exception_from_name(mono_get_corlib(), "System",
 ...
 */
MonoException *mono_get_exception_type_load(MonoString *class_name_raw,
                                            char *assembly_name) {
  ERROR_DECL(error);
  HANDLE_FUNCTION_ENTER();
  ...
  MonoExceptionHandle ret = mono_exception_from_name_two_strings_checked(
      mono_get_corlib(), "System", "TypeLoadException", class_name, s, error);
  mono_error_assert_ok(error);
  HANDLE_FUNCTION_RETURN_OBJ(ret);
}
 ...
 * \param exception_type the specific exception type for the specific member
 * type, i.e. field or method \param class_name the class where the lookup was
 * performed. \param member_name the name of the missing method. \returns a new
 * instance of the \c exception_type (MissingFieldException or
 * MissingMethodException)
 */
static MonoException *
mono_get_exception_missing_member(const char *exception_type,
  ...
  MonoExceptionHandle ret = mono_exception_from_name_two_strings_checked(
      mono_get_corlib(), "System", exception_type, s1, s2, error);
  mono_error_assert_ok(error);
  HANDLE_FUNCTION_RETURN_OBJ(ret);
}
 ...
 */
MonoException *mono_get_exception_missing_method(const char *class_name,
                                                 const char *member_name) {
  return mono_get_exception_missing_member("MissingMethodException", class_name,
                                           member_name);
}
 ...
 */
MonoException *mono_get_exception_missing_field(const char *class_name,
                                                const char *member_name) {
  return mono_get_exception_missing_member("MissingFieldException", class_name,
                                           member_name);
}
 ...
 */
static MonoException *mono_get_exception_argument_internal(const char *type,
                                                           const char *arg,
                                                           const char *msg) {
  HANDLE_FUNCTION_ENTER();
  ERROR_DECL(error);
  MonoExceptionHandle ex =
      mono_exception_new_argument_internal(type, arg, msg, error);
  mono_error_cleanup(error);
  HANDLE_FUNCTION_RETURN_OBJ(ex);
}
...
mono_exception_new_argument_internal(const char *type, const char *arg,
  ...
  MonoStringHandle arg_str =
      arg ? mono_string_new_handle(mono_domain_get(), arg, error)
          : NULL_HANDLE_STRING;
  MonoStringHandle msg_str =
      msg ? mono_string_new_handle(mono_domain_get(), msg, error)
          : NULL_HANDLE_STRING;

  if (!strcmp(type, "ArgumentException"))
    return mono_exception_from_name_two_strings_checked(
        mono_get_corlib(), "System", type, msg_str, arg_str, error);
  else
    return mono_exception_from_name_two_strings_checked(
        mono_get_corlib(), "System", type, arg_str, msg_str, error);
#else
  MonoExceptionHandle ex = mono_exception_new_by_name_msg(
      mono_get_corlib(), "System", type, msg, error);

  if (arg && !MONO_HANDLE_IS_NULL(ex)) {
    MonoArgumentExceptionHandle argex =
        MONO_HANDLE_CAST(MonoArgumentException, ex);
    MonoStringHandle arg_str =
        mono_string_new_handle(MONO_HANDLE_DOMAIN(ex), arg, error);
...
MonoExceptionHandle mono_exception_new_argument(const char *arg,
                                                const char *msg,
                                                MonoError *error) {
  return mono_exception_new_argument_internal("ArgumentException", arg, msg,
                                              error);
}

MonoExceptionHandle mono_exception_new_argument_null(const char *arg,
                                                     MonoError *error) {
  return mono_exception_new_argument_internal("ArgumentNullException", arg,
                                              NULL, error);
}

MonoExceptionHandle mono_exception_new_argument_out_of_range(const char *arg,
                                                             const char *msg,
                                                             MonoError *error) {
  return mono_exception_new_argument_internal("ArgumentOutOfRangeException",
                                              arg, msg, error);
}

MonoExceptionHandle mono_exception_new_serialization(const char *msg,
                                                     MonoError *error) {
  return mono_exception_new_by_name_msg(
      mono_get_corlib(), "System.Runtime.Serialization",
      "SerializationException", "Could not serialize unhandled exception.",
      error);
}
...
MonoException *mono_get_exception_argument_out_of_range(const char *arg) {
  return mono_get_exception_argument_internal("ArgumentOutOfRangeException",
                                              arg, NULL);
}
...
MonoException *mono_get_exception_thread_state(const char *msg) {
  return mono_exception_from_name_msg(mono_get_corlib(), "System.Threading",
                                      "ThreadStateException", msg);
}
...
MonoException *mono_get_exception_io(const char *msg) {
  return mono_exception_from_name_msg(mono_get_corlib(), "System.IO",
                                      "IOException", msg);
}
 ...
 */
MonoException *mono_get_exception_file_not_found(MonoString *fname_raw) {
  HANDLE_FUNCTION_ENTER();
  ERROR_DECL(error);
 ...
 * \returns a new instance of the \c System.IO.FileNotFoundException
 */
MonoException *mono_get_exception_file_not_found2(const char *msg,
                                                  MonoString *fname_raw) {
  HANDLE_FUNCTION_ENTER();
  ERROR_DECL(error);
  MONO_HANDLE_DCL(MonoString, fname);
  MonoStringHandle s = NULL_HANDLE_STRING;
 ...
 */
MonoException *
mono_get_exception_type_initialization(const gchar *type_name,
                                       MonoException *inner_raw) {
  HANDLE_FUNCTION_ENTER();
...
MonoExceptionHandle mono_get_exception_type_initialization_handle(
    const gchar *type_name, MonoExceptionHandle inner, MonoError *error) {
  HANDLE_FUNCTION_ENTER();
  ...
  klass = mono_class_load_from_name(mono_get_corlib(), "System",
  ...
  while ((method = mono_class_get_methods(klass, &iter))) {
    if (!strcmp(".ctor", mono_method_get_name(method))) {
      ...
      if (sig->param_count == 2 && sig->params[0]->type == MONO_TYPE_STRING &&
          mono_class_from_mono_type_internal(sig->params[1]) ==
  ...
  MonoStringHandle type_name_str =
      mono_string_new_handle(domain, type_name, error);
  mono_error_assert_ok(error);
...
return_null:
  exc = mono_new_null();
exit:
  HANDLE_FUNCTION_RETURN_REF(MonoException,
                             MONO_HANDLE_CAST(MonoException, exc));
}
...
MonoException *mono_get_exception_synchronization_lock(const char *msg) {
  return mono_exception_from_name_msg(mono_get_corlib(), "System.Threading",
                                      "SynchronizationLockException", msg);
}
 ...
 * \returns a new instance of the \c System.BadImageFormatException
 */
MonoException *mono_get_exception_bad_image_format2(const char *msg,
                                                    MonoString *fname_raw) {
  HANDLE_FUNCTION_ENTER();
  ERROR_DECL(error);
  MonoStringHandle s = NULL_HANDLE_STRING;
...
MonoExceptionHandle mono_get_exception_out_of_memory_handle(void) {
  return MONO_HANDLE_NEW(MonoException,
                         mono_exception_from_name(mono_get_corlib(), "System",
                                                  "OutOfMemoryException"));
}
...
MonoException *mono_get_exception_method_access_msg(const char *msg) {
  return mono_exception_from_name_msg(mono_get_corlib(), "System",
                                      "MethodAccessException", msg);
}

/**
 * mono_get_exception_reflection_type_load:
 * \param types an array of types that were defined in the moduled loaded.
 * \param exceptions an array of exceptions that were thrown during the type
 * loading. \returns a new instance of the \c
 * System.Reflection.ReflectionTypeLoadException
 */
MonoException *
mono_get_exception_reflection_type_load(MonoArray *types_raw,
                                        MonoArray *exceptions_raw) {
  HANDLE_FUNCTION_ENTER();
  ERROR_DECL(error);
  MONO_HANDLE_DCL(MonoArray, types);
  MONO_HANDLE_DCL(MonoArray, exceptions);
  MonoExceptionHandle ret =
      mono_get_exception_reflection_type_load_checked(types, exceptions, error);
  if (!is_ok(error))
    ret = MONO_HANDLE_CAST(MonoException, mono_new_null());
  mono_error_cleanup(error);
  HANDLE_FUNCTION_RETURN_OBJ(ret);
...
MonoExceptionHandle mono_get_exception_reflection_type_load_checked(
    MonoArrayHandle types, MonoArrayHandle exceptions, MonoError *error) {
  HANDLE_FUNCTION_ENTER();
  ...
  klass = mono_class_load_from_name(mono_get_corlib(), "System.Reflection",
  ...
  while ((method = mono_class_get_methods(klass, &iter))) {
    if (!strcmp(".ctor", mono_method_get_name(method))) {
      ...
      if (sig->param_count == 2 && sig->params[0]->type == MONO_TYPE_SZARRAY &&
          sig->params[1]->type == MONO_TYPE_SZARRAY)
        break;
    }
    method = NULL;
  }
  ...
  MonoExceptionHandle exc = MONO_HANDLE_CAST(
      MonoException,
      MONO_HANDLE_NEW(MonoObject, mono_object_new_checked(mono_domain_get(),
                                                          klass, error)));
  mono_error_assert_ok(error);
...
MonoExceptionHandle
mono_get_exception_runtime_wrapped_handle(MonoObjectHandle wrapped_exception,
                                          MonoError *error) {
  HANDLE_FUNCTION_ENTER();
  ...
  klass = mono_class_load_from_name(mono_get_corlib(),
...
static gboolean append_frame_and_continue(MonoMethod *method, gpointer ip,
...
char *mono_exception_get_managed_backtrace(MonoException *exc) {
  ...
  if (!mono_get_eh_callbacks()->mono_exception_walk_trace(
          exc, append_frame_and_continue, text))
...
char *mono_exception_handle_get_native_backtrace(MonoExceptionHandle exc) {
  ...
  for (i = 0; i < len; ++i) {
    ...
    if (ji) {
      char *msg = mono_debug_print_stack_frame(
          mono_jit_info_get_method(ji), (char *)ip - (char *)ji->code_start,
          domain);
      g_string_append_printf(text, "%s\n", msg);
      g_free(msg);
    } else {
...
MonoStringHandle
ves_icall_Mono_Runtime_GetNativeStackTrace(MonoExceptionHandle exc,
                                           MonoError *error) {
  char *trace;
 ...
 * Aborts in case of a double fault. This happens when it can't recover from an
 * error caused by trying to construct the first exception object. The error
 * object \p target_error is cleaned up.
 */
 ...
 * If \p error is set, convert it to an exception and set the pending exception
 * for the current icall. \returns TRUE if \p error was set, or FALSE otherwise,
 * so that you can write: if (mono_error_set_pending_exception (error)) { { ...
 * cleanup code ... } return;
 *    }
 */
// For efficiency, call mono_error_set_pending_exception instead of
// mono_error_set_pending_exception_slow.
  ...
  if (unhandled_exception_hook) {
    ...
    if (str && is_ok(inner_error)) {
      ...
      if (!is_ok(inner_error)) {
        msg = g_strdup_printf(
            "Nested exception while formatting original exception");
...
MonoExceptionHandle mono_corlib_exception_new_with_args(const char *name_space,
                                                        const char *name,
                                                        const char *arg_0,
                                                        const char *arg_1,
                                                        MonoError *error) {
  ...
  str_0 =
      arg_0 ? mono_string_new_handle(domain, arg_0, error) : NULL_HANDLE_STRING;
  goto_if_nok(error, return_null);

  str_1 =
      arg_1 ? mono_string_new_handle(domain, arg_1, error) : NULL_HANDLE_STRING;
  goto_if_nok(error, return_null);

  ex = mono_exception_from_name_two_strings_checked(
      mono_defaults.corlib, name_space, name, str_0, str_1, error);
  goto exit;
return_null:
...
void mono_error_set_field_missing(MonoError *error, MonoClass *klass,
                                  const char *field_name, MonoType *sig,
                                  const char *reason, ...) {
  char *result;
  GString *res;
 ...
 */
void mono_error_set_method_missing(MonoError *error, MonoClass *klass,
                                   const char *method_name,
                                   MonoMethodSignature *sig, const char *reason,
                                   ...) {
  int i;
  char *result;
  GString *res;
...
#define SET_ERROR_MSG(STR_VAR, FMT_STR)                                        \
  do {                                                                         \
    va_list __args;                                                            \
 ...
 */
void mono_error_set_bad_image_by_name(MonoError *error, const char *image_name,
...
void mono_error_set_file_not_found(MonoError *error, const char *file_name,
                                   const char *msg_format, ...) {
  char *str;
  SET_ERROR_MSG(str, msg_format);
...
void mono_error_set_simple_file_not_found(MonoError *error,
                                          const char *file_name,
                                          gboolean refection_only) {
  if (refection_only)
    mono_error_set_file_not_found(
        error, file_name,
        "Cannot resolve dependency to assembly '%s' because it has not been "
        "preloaded. When using the ReflectionOnly APIs, dependent assemblies "
...
void mono_error_set_argument_out_of_range(MonoError *error,
