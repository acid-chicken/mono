...
HANDLES(ASSEM_3, "GetEntryAssemblyNative",
...
HANDLES(THREAD_16, "GetCurrentProcessorNumber",
        ves_icall_System_Threading_Thread_GetCurrentProcessorNumber, gint32, 0,
        ())
...
HANDLES(THREAD_4, "InitInternal",
        ...
        (MonoThreadObject))
NOHANDLES(ICALL(THREAD_5, "InitializeCurrentThread_icall",
