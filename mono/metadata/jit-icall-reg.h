...
#define MONO_JIT_ICALL_mono_get_lmf_addr                                       \
  MONO_JIT_ICALL_mono_tls_get_lmf_addr_extern
...
// Indirect mono_jit_icall_info access through a function or macro due to loaded
// LLVM.
//
#if MONO_LLVM_LOADED
