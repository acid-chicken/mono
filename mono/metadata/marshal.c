...
static void mono_string_utf16len_to_builder(MonoStringBuilderHandle sb,
                                            const gunichar2 *text, gsize len,
                                            MonoError *error);
 ...
 *
 * The marshal lock is a non-recursive complex lock that sits below the domain
 * lock in the runtime locking latice. Which means it can take simple locks suck
 * as the image lock.
 */
#define mono_marshal_lock() mono_locks_coop_acquire(&marshal_mutex, MarshalLock)
#define mono_marshal_unlock()                                                  \
  mono_locks_coop_release(&marshal_mutex, MarshalLock)
...
static MonoMarshalCallbacks *get_marshal_cb(void);

static void delegate_hash_table_add(MonoDelegateHandle d);

static void delegate_hash_table_remove(MonoDelegate *d);

/* Lazy class loading functions */
// used by marshal-ilgen.c
GENERATE_TRY_GET_CLASS_WITH_CACHE(stringbuilder, "System.Text",
                                  "StringBuilder");
static GENERATE_TRY_GET_CLASS_WITH_CACHE(unmanaged_function_pointer_attribute,
                                         "System.Runtime.InteropServices",
                                         "UnmanagedFunctionPointerAttribute");

#ifdef ENABLE_NETCORE
static GENERATE_TRY_GET_CLASS_WITH_CACHE(suppress_gc_transition_attribute,
                                         "System.Runtime.InteropServices",
                                         "SuppressGCTransitionAttribute")
#endif

    static MonoImage *get_method_image(MonoMethod *method) {
...
MonoObjectHandle mono_object_isinst_icall_impl(MonoObjectHandle obj,
                                               MonoClass *klass,
                                               MonoError *error) {
  if (!klass)
    return NULL_HANDLE;
...
MonoStringHandle ves_icall_mono_string_from_utf16_impl(const gunichar2 *data,
                                                       MonoError *error) {
...
char *ves_icall_mono_string_to_utf8_impl(MonoStringHandle str,
                                         MonoError *error) {
  return mono_string_handle_to_utf8(str, error);
}

MonoStringHandle ves_icall_string_new_wrapper_impl(const char *text,
                                                   MonoError *error) {
  return text ? mono_string_new_handle(mono_domain_get(), text, error)
              : NULL_HANDLE_STRING;
}
...
void mono_marshal_init(void) {
  ...
  if (!module_initialized) {
    ...
    register_icall(mono_marshal_string_to_utf16_copy, mono_icall_sig_ptr_obj,
                   FALSE);
    register_icall(mono_string_to_utf16_internal, mono_icall_sig_ptr_obj,
                   FALSE);
    register_icall(ves_icall_mono_string_from_utf16, mono_icall_sig_obj_ptr,
                   FALSE);
    register_icall(mono_string_from_byvalstr, mono_icall_sig_obj_ptr_int,
                   FALSE);
    register_icall(mono_string_from_byvalwstr, mono_icall_sig_obj_ptr_int,
                   FALSE);
    register_icall(mono_string_new_wrapper_internal, mono_icall_sig_obj_ptr,
                   FALSE);
    register_icall(ves_icall_string_new_wrapper, mono_icall_sig_obj_ptr, FALSE);
    register_icall(mono_string_new_len_wrapper, mono_icall_sig_obj_ptr_int,
                   FALSE);
    register_icall(ves_icall_mono_string_to_utf8, mono_icall_sig_ptr_obj,
                   FALSE);
    ...
    register_icall(mono_string_builder_to_utf8, mono_icall_sig_ptr_object,
                   FALSE);
    register_icall(mono_string_builder_to_utf16, mono_icall_sig_ptr_object,
                   FALSE);
    ...
    register_icall(mono_byvalarray_to_byte_array,
                   mono_icall_sig_void_object_ptr_int32, FALSE);
    register_icall(mono_array_to_byte_byvalarray,
                   mono_icall_sig_void_ptr_object_int32, FALSE);
    register_icall(mono_delegate_to_ftnptr, mono_icall_sig_ptr_object, FALSE);
    register_icall(mono_ftnptr_to_delegate, mono_icall_sig_object_ptr_ptr,
                   FALSE);
    register_icall(mono_marshal_asany, mono_icall_sig_ptr_object_int32_int32,
                   FALSE);
    register_icall(mono_marshal_free_asany,
                   mono_icall_sig_void_object_ptr_int32_int32, FALSE);
    ...
    register_icall(mono_marshal_set_last_error_windows,
                   mono_icall_sig_void_int32, TRUE);
    register_icall(mono_marshal_clear_last_error, mono_icall_sig_void, TRUE);
    register_icall(mono_string_utf8_to_builder, mono_icall_sig_void_ptr_ptr,
                   FALSE);
    register_icall(mono_string_utf8_to_builder2, mono_icall_sig_object_ptr,
                   FALSE);
    register_icall(mono_string_utf16_to_builder, mono_icall_sig_void_ptr_ptr,
                   FALSE);
    register_icall(mono_string_utf16_to_builder2, mono_icall_sig_object_ptr,
                   FALSE);
    register_icall(mono_marshal_free_array, mono_icall_sig_void_ptr_int32,
                   FALSE);
    register_icall(mono_string_to_byvalstr, mono_icall_sig_void_ptr_ptr_int32,
                   FALSE);
    register_icall(mono_string_to_byvalwstr, mono_icall_sig_void_ptr_ptr_int32,
                   FALSE);
    // Because #define g_free monoeg_g_free.
    register_icall(monoeg_g_free, mono_icall_sig_void_ptr, FALSE);
    register_icall(mono_object_isinst_icall, mono_icall_sig_object_object_ptr,
                   TRUE);
    register_icall(mono_struct_delete_old, mono_icall_sig_void_ptr_ptr, FALSE);
    register_icall(mono_delegate_begin_invoke, mono_icall_sig_object_object_ptr,
                   FALSE);
    register_icall(mono_delegate_end_invoke, mono_icall_sig_object_object_ptr,
                   FALSE);
    register_icall(mono_gc_wbarrier_generic_nostore_internal,
                   mono_icall_sig_void_ptr, FALSE);
    register_icall(mono_gchandle_get_target_internal,
                   mono_icall_sig_object_int32, TRUE);
    register_icall(mono_marshal_isinst_with_cache,
                   mono_icall_sig_object_object_ptr_ptr, FALSE);
    register_icall(mono_threads_enter_gc_safe_region_unbalanced,
                   mono_icall_sig_ptr_ptr, TRUE);
    register_icall(mono_threads_exit_gc_safe_region_unbalanced,
                   mono_icall_sig_void_ptr_ptr, TRUE);
    register_icall(mono_threads_enter_gc_unsafe_region_unbalanced,
                   mono_icall_sig_ptr_ptr, TRUE);
    register_icall(mono_threads_exit_gc_unsafe_region_unbalanced,
                   mono_icall_sig_void_ptr_ptr, TRUE);
    ...
    register_icall(mono_marshal_get_type_object, mono_icall_sig_object_ptr,
                   TRUE);
...
void mono_marshal_lock_internal(void) { mono_marshal_lock(); }

void mono_marshal_unlock_internal(void) { mono_marshal_unlock(); }

// This is a JIT icall, it sets the pending exception (in wrapper) and return
// NULL on error.
gpointer mono_delegate_to_ftnptr_impl(MonoDelegateHandle delegate,
                                      MonoError *error) {
  ...
  if (MONO_HANDLE_GETVAL(delegate, method_is_virtual)) {
    ...
    method =
        mono_object_handle_get_virtual_method(delegate_target, method, error);
  ...
  wrapper =
      mono_marshal_get_managed_wrapper(method, klass, target_handle, error);
  goto_if_nok(error, leave);

  MONO_HANDLE_SETVAL(delegate, delegate_trampoline, gpointer,
...
static GHashTable *delegate_hash_table_new(void) {
...
static void delegate_hash_table_remove(MonoDelegate *d) {
  ...
  gchandle = GPOINTER_TO_UINT(
      g_hash_table_lookup(delegate_hash_table, d->delegate_trampoline));
...
static void delegate_hash_table_add(MonoDelegateHandle d) {
  ...
  if (has_target) {
    ...
    guint32 gchandle = GPOINTER_TO_UINT(
        g_hash_table_lookup(delegate_hash_table, delegate_trampoline));
    if (gchandle) {
      // Somehow, some other thread beat us to it ?
      g_assert(mono_gchandle_target_equal(gchandle,
                                          MONO_HANDLE_CAST(MonoObject, d)));
    } else {
      gchandle = mono_gchandle_new_weakref_from_handle(
          MONO_HANDLE_CAST(MonoObject, d));
      g_hash_table_insert(delegate_hash_table, delegate_trampoline,
                          GUINT_TO_POINTER(gchandle));
    }
  } else {
    if (g_hash_table_lookup(delegate_hash_table, delegate_trampoline) == NULL) {
      guint32 gchandle =
          mono_gchandle_from_handle(MONO_HANDLE_CAST(MonoObject, d), FALSE);
      // This delegate will always be associated with its delegate_trampoline in
      // the table. We don't free this delegate object because it is too
      // expensive to keep track of these pairs and avoid races with the
 ...
 */
void mono_marshal_use_aot_wrappers(gboolean use) { use_aot_wrappers = use; }

static void parse_unmanaged_function_pointer_attr(MonoClass *klass,
  ...
  if (mono_class_try_get_unmanaged_function_pointer_attribute_class()) {
    /*
     * The pinvoke attributes are stored in a real custom attribute so we have
     * to construct it.
     */
    cinfo = mono_custom_attrs_from_class_checked(klass, error);
    if (!is_ok(error)) {
      g_warning("Could not load UnmanagedFunctionPointerAttribute due to %s",
                mono_error_get_message(error));
      mono_error_cleanup(error);
    }
    if (cinfo && !mono_runtime_get_no_exec()) {
      attr = (MonoReflectionUnmanagedFunctionPointerAttribute *)
      ...
      if (attr) {
        piinfo->piflags = (attr->call_conv << 8) |
                          (attr->charset ? (attr->charset - 1) * 2 : 1) |
                          attr->set_last_error;
      } else {
        if (!is_ok(error)) {
          g_warning(
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * NULL on error */
MonoDelegateHandle mono_ftnptr_to_delegate_impl(MonoClass *klass, gpointer ftn,
                                                MonoError *error) {
  guint32 gchandle;
  ...
  if (gchandle)
    MONO_HANDLE_ASSIGN(
        d, MONO_HANDLE_CAST(MonoDelegate,
  ...
  if (MONO_HANDLE_IS_NULL(d)) {
    ...
    if (use_aot_wrappers) {
      ...
      this_obj = MONO_HANDLE_NEW(MonoObject,
      ...
      wrapper = mono_marshal_get_native_func_wrapper(m_class_get_image(klass),
                                                     sig, &piinfo, mspecs, ftn);
    ...
    MONO_HANDLE_ASSIGN(d,
                       mono_object_new_handle(mono_domain_get(), klass, error));
    goto_if_nok(error, leave);
    gpointer compiled_ptr = mono_compile_method_checked(wrapper, error);
    goto_if_nok(error, leave);

    mono_delegate_ctor_with_method(MONO_HANDLE_CAST(MonoObject, d), this_obj,
                                   compiled_ptr, wrapper, error);
    goto_if_nok(error, leave);
  }
  ...
  if (MONO_HANDLE_DOMAIN(d) != mono_domain_get())
    mono_error_set_not_supported(
        error, "Delegates cannot be marshalled from native code into a domain "
               "other than their home domain");
leave:
  return d;
}
...
void mono_delegate_free_ftnptr(MonoDelegate *delegate) {
  ...
  if (ptr) {
    ...
    /*the target gchandle is the first entry after size and the wrapper
     * itself.*/
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * NULL on error */
MonoStringHandle mono_string_from_byvalstr_impl(const char *data, int max_len,
                                                MonoError *error) {
  ...
  // FIXMEcoop
  MonoString *s =
      mono_string_new_len_checked(mono_domain_get(), data, len, error);
  return_val_if_nok(error, NULL_HANDLE_STRING);
  return MONO_HANDLE_NEW(MonoString, s);
}
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and return
 * NULL on error */
MonoStringHandle mono_string_from_byvalwstr_impl(const gunichar2 *data,
                                                 int max_len,
                                                 MonoError *error) {
  // FIXME This optimization ok to miss before wrapper? Or null is rare?
  if (!data)
  ...
  return mono_string_new_utf16_handle(mono_domain_get(), data,
                                      MIN(len, max_len), error);
}

gpointer mono_array_to_savearray_impl(MonoArrayHandle array, MonoError *error) {
...
gpointer mono_array_to_lparray_impl(MonoArrayHandle array_handle,
                                    MonoError *error) {
  ...
  case MONO_TYPE_CLASS:
    ...
    for (i = 0; i < nativeArraySize; ++i) {
      nativeArray[i] = mono_cominterop_get_com_interface(
          ((MonoObject **)array->vector)[i], klass_element_class, error);
      if (!is_ok(error)) {
  ...
  default:
    g_warning("type 0x%x not handled",
              m_class_get_byval_arg(klass_element_class)->type);
    g_assert_not_reached();
  }
#endif
  return array->vector;
...
void mono_free_lparray_impl(MonoArrayHandle array, gpointer *nativeArray,
                            MonoError *error) {
#ifndef DISABLE_COM
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * on error */
void mono_byvalarray_to_byte_array_impl(MonoArrayHandle arr,
                                        const char *native_arr, guint32 elnum,
                                        MonoError *error) {
  g_assert(m_class_get_element_class(mono_handle_class(arr)) ==
           mono_defaults.char_class);

  GError *gerror = NULL;
  glong items_written;
  gunichar2 *ut =
      g_utf8_to_utf16(native_arr, elnum, NULL, &items_written, &gerror);
  if (gerror) {
    // FIXME set error?
    g_error_free(gerror);
    return;
  ...
  memcpy(MONO_ARRAY_HANDLE_PIN(arr, gunichar2, 0, &gchandle), ut,
         items_written * sizeof(gunichar2));
  mono_gchandle_free_internal(gchandle);
  g_free(ut);
}
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * on error */
void mono_array_to_byte_byvalarray_impl(gpointer native_arr,
                                        MonoArrayHandle arr, guint32 elnum,
                                        MonoError *error) {
  g_assert(m_class_get_element_class(mono_handle_class(arr)) ==
           mono_defaults.char_class);
  ...
  gchandle_t gchandle = 0;
  char *as =
      g_utf16_to_utf8(MONO_ARRAY_HANDLE_PIN(arr, gunichar2, 0, &gchandle),
                      mono_array_handle_length(arr), NULL, NULL, &gerror);
  mono_gchandle_free_internal(gchandle);
  if (gerror) {
...
mono_string_builder_new(int starting_string_length, MonoError *error) {
  ...
  MonoStringBuilderHandle sb = MONO_HANDLE_CAST(
      MonoStringBuilder,
      mono_object_new_handle(mono_domain_get(), string_builder_class, error));
  mono_error_assert_ok(error);

  mono_runtime_try_invoke_handle(sb_ctor, MONO_HANDLE_CAST(MonoObject, sb),
                                 args, error);
  mono_error_assert_ok(error);
...
static void mono_string_utf16_to_builder_copy(MonoStringBuilderHandle sb,
                                              const gunichar2 *text,
                                              size_t string_len,
                                              MonoError *error) {
  MonoArrayHandle chunkChars = MONO_HANDLE_NEW(MonoArray, NULL);
  MonoStringBuilderHandle chunk =
      MONO_HANDLE_NEW(MonoStringBuilder, MONO_HANDLE_RAW(sb));
  ...
  do {
    ...
    if (maxLength > 0 && chunkOffset < string_len) {
      ...
      memcpy(MONO_HANDLE_RAW(chunkChars)->vector, text + chunkOffset,
             charsToCopy * sizeof(gunichar2));
...
static void mono_string_utf8len_to_builder(MonoStringBuilderHandle sb,
...
void mono_string_utf8_to_builder_impl(MonoStringBuilderHandle sb,
                                      const char *text, MonoError *error) {
  mono_string_utf8len_to_builder(sb, text, text ? strlen(text) : 0, error);
}

MonoStringBuilderHandle mono_string_utf8_to_builder2_impl(const char *text,
                                                          MonoError *error) {
  if (!text)
    return NULL_HANDLE_STRING_BUILDER;
...
void mono_string_utf16_to_builder_impl(MonoStringBuilderHandle sb,
                                       const gunichar2 *text,
                                       MonoError *error) {
 ...
 * NULL on error.
 */
gchar *mono_string_builder_to_utf8_impl(MonoStringBuilderHandle sb,
                                        MonoError *error) {
  char *res = NULL;
  GError *gerror = NULL;
  char *tmp = NULL;
  ...
  tmp = g_utf16_to_utf8(str_utf16, mono_string_builder_string_length(sb), NULL,
                        &byte_count, &gerror);
  if (gerror) {
    mono_error_set_execution_engine(
        error, "Failed to convert StringBuilder from utf16 to utf8");
    goto exit;
  }
 ...
 * NULL on error.
 */
gunichar2 *mono_string_builder_to_utf16_impl(MonoStringBuilderHandle sb,
                                             MonoError *error) {
  if (!MONO_HANDLE_BOOL(sb))
    return NULL;
  ...
  // Follow CoreCLR and double NULL terminate the buffer so we have more
  // protection against native code putting garbage in there.

  gunichar2 *str = (gunichar2 *)mono_marshal_alloc(
      (capacity + 2) * sizeof(gunichar2), error);
  ...
  do {
    ...
    if (chunkLength > 0) {
      ...
      g_assertf((chunkOffset + chunkLength) <= capacity,
                "A chunk in the StringBuilder had a length longer than "
                "expected from the offset.");
      memcpy(str + chunkOffset, MONO_HANDLE_RAW(chunkChars)->vector,
             chunkLength * sizeof(gunichar2));
    }
    MONO_HANDLE_GET(chunk, chunk, chunkPrevious);
  } while (MONO_HANDLE_BOOL(chunk));
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * NULL on error. */
gpointer mono_string_to_utf8str_impl(MonoStringHandle s, MonoError *error) {
  return mono_string_handle_to_utf8(s, error);
}

#endif

gpointer mono_string_to_ansibstr_impl(MonoStringHandle string_obj,
                                      MonoError *error) {
 ...
 */
void mono_string_to_byvalstr_impl(char *dst, MonoStringHandle src, int size,
                                  MonoError *error) {
  g_assert(dst != NULL);
  g_assert(size > 0);
 ...
 * \param src the \c MonoString to copy.
 * \param size the maximum number of wide characters to copy (each consumes 2
 * bytes)
 *
 ...
 */
void mono_string_to_byvalwstr_impl(gunichar2 *dst, MonoStringHandle src,
                                   int size, MonoError *error) {
  g_assert(dst);
  g_assert(size > 0);
  ...
  memcpy(dst, mono_string_handle_pin_chars(src, &gchandle),
...
MonoStringHandle mono_string_new_len_wrapper_impl(const char *text,
                                                  guint length,
                                                  MonoError *error) {
  MonoString *s =
      mono_string_new_len_checked(mono_domain_get(), text, length, error);
  return_val_if_nok(error, NULL_HANDLE_STRING);
  return MONO_HANDLE_NEW(MonoString, s);
}
 ...
 */
MonoAsyncResult *mono_delegate_begin_invoke(MonoDelegate *delegate,
                                            gpointer *params) {
#ifdef ENABLE_NETCORE
  mono_set_pending_exception(mono_exception_from_name(
      mono_defaults.corlib, "System", "PlatformNotSupportedException"));
  return NULL;
#else
  ERROR_DECL(error);
  ...
  if (delegate->target && mono_object_is_transparent_proxy(delegate->target)) {
    ...
    if (!mono_class_is_contextbound(tp->remote_class->proxy_class) ||
      ...
      */
      ...
      msg = mono_method_call_message_new(
          mono_marshal_method_from_wrapper(method), params, NULL,
          &async_callback, &state, error);
      ...
      MONO_OBJECT_SETREF_INTERNAL(ares, async_callback,
  ...
  mono_error_cleanup(begin_invoke_error); /* if we can't call BeginInvoke, fall
                                             back on Invoke */
  if (!method)
    method = mono_get_delegate_invoke_internal(klass);
  g_assert(method);

  MonoAsyncResult *result = mono_threadpool_begin_invoke(
      mono_domain_get(), (MonoObject *)delegate, method, params, error);
  mono_error_set_pending_exception(error);
  return result;
#endif
}

static char *mono_signature_to_name(MonoMethodSignature *sig,
                                    const char *prefix) {
 ...
 */
MonoMarshalNative mono_marshal_get_string_encoding(MonoMethodPInvoke *piinfo,
                                                   MonoMarshalSpec *spec) {
  /* First try the parameter marshal info */
  if (spec) {
    if (spec->native == MONO_NATIVE_LPARRAY) {
      if ((spec->data.array_data.elem_type != 0) &&
          (spec->data.array_data.elem_type != MONO_NATIVE_MAX))
...
MonoMarshalConv mono_marshal_get_string_to_ptr_conv(MonoMethodPInvoke *piinfo,
                                                    MonoMarshalSpec *spec) {
...
MonoMarshalConv
mono_marshal_get_stringbuilder_to_ptr_conv(MonoMethodPInvoke *piinfo,
                                           MonoMarshalSpec *spec) {
  MonoMarshalNative encoding = mono_marshal_get_string_encoding(piinfo, spec);
...
MonoMarshalConv mono_marshal_get_ptr_to_string_conv(MonoMethodPInvoke *piinfo,
                                                    MonoMarshalSpec *spec,
                                                    gboolean *need_free) {
  MonoMarshalNative encoding = mono_marshal_get_string_encoding(piinfo, spec);
...
MonoMarshalConv mono_marshal_get_ptr_to_stringbuilder_conv(
    MonoMethodPInvoke *piinfo, MonoMarshalSpec *spec, gboolean *need_free) {
  MonoMarshalNative encoding = mono_marshal_get_string_encoding(piinfo, spec);
 ...
 * be freed.
 */
gboolean mono_marshal_need_free(MonoType *t, MonoMethodPInvoke *piinfo,
                                MonoMarshalSpec *spec) {
 ...
 */
static GHashTable *get_cache(GHashTable **var, GHashFunc hash_func,
                             GCompareFunc equal_func) {
  if (!(*var)) {
    mono_marshal_lock();
    if (!(*var)) {
      GHashTable *cache = g_hash_table_new(hash_func, equal_func);
      mono_memory_barrier();
      *var = cache;
    }
    mono_marshal_unlock();
...
GHashTable *mono_marshal_get_cache(GHashTable **var, GHashFunc hash_func,
                                   GCompareFunc equal_func) {
 ...
 */
MonoMethod *mono_mb_create(MonoMethodBuilder *mb, MonoMethodSignature *sig,
...
MonoMethod *mono_mb_create_and_cache_full(GHashTable *cache, gpointer key,
...
MonoMethod *mono_mb_create_and_cache(GHashTable *cache, gpointer key,
                                     MonoMethodBuilder *mb,
...
MonoMethod *mono_marshal_method_from_wrapper(MonoMethod *wrapper) {
  ...
  if (wrapper_type == MONO_WRAPPER_NONE ||
      wrapper_type == MONO_WRAPPER_DYNAMIC_METHOD)
    return wrapper;
  ...
  case MONO_WRAPPER_XDOMAIN_INVOKE:
    ...
    if (wrapper->is_inflated) {
      ...
      MonoMethod *result;
      /*
       * A method cannot be inflated and a wrapper at the same time, so the
       * wrapper info contains an uninflated method.
       */
  ...
  case MONO_WRAPPER_MANAGED_TO_NATIVE:
    if (info && (info->subtype == WRAPPER_SUBTYPE_NONE ||
                 info->subtype == WRAPPER_SUBTYPE_NATIVE_FUNC_AOT ||
                 info->subtype == WRAPPER_SUBTYPE_PINVOKE))
      return info->d.managed_to_native.method;
    else
      return NULL;
  case MONO_WRAPPER_RUNTIME_INVOKE:
    if (info && (info->subtype == WRAPPER_SUBTYPE_RUNTIME_INVOKE_DIRECT ||
 ...
 */
WrapperInfo *mono_marshal_get_wrapper_info(MonoMethod *wrapper) {
...
WrapperInfo *mono_wrapper_info_create(MonoMethodBuilder *mb,
                                      WrapperSubtype subtype) {
  WrapperInfo *info;

  info = (WrapperInfo *)mono_image_alloc0(get_method_image(mb->method),
                                          sizeof(WrapperInfo));
 ...
 */
static MonoClass *get_wrapper_target_class(MonoImage *image) {
  ERROR_DECL(error);
  MonoClass *klass;
  ...
  if (image_is_dynamic(image)) {
    ...
    klass = mono_class_get_checked(
        image, mono_metadata_make_token(MONO_TABLE_TYPEDEF, 1), error);
    g_assert(is_ok(error)); /* FIXME don't swallow the error */
  }
  g_assert(klass);
...
/*
 * Wrappers for generic methods should be instances of generic wrapper methods,
 * i.e .the wrapper for Sort<int> should be an instance of the wrapper for
 * Sort<T>. This is required for full-aot to work.
 */

/*
 * check_generic_wrapper_cache:
 *
 *   Check CACHE for the wrapper of the generic instance ORIG_METHOD, and return
 * it if it is found. KEY should be the key for ORIG_METHOD in the cache, while
 * DEF_KEY should be the key of its generic method definition.
 */
static MonoMethod *check_generic_wrapper_cache(GHashTable *cache,
                                               MonoMethod *orig_method,
                                               gpointer key, gpointer def_key) {
  MonoMethod *res;
  MonoMethod *inst, *def;
...
static MonoMethod *
cache_generic_wrapper(GHashTable *cache, MonoMethod *orig_method,
                      MonoMethod *def, MonoGenericContext *ctx, gpointer key) {
  ERROR_DECL(error);
  MonoMethod *inst, *res;
...
static MonoMethod *
check_generic_delegate_wrapper_cache(GHashTable *cache, MonoMethod *orig_method,
...
static MonoMethod *cache_generic_delegate_wrapper(GHashTable *cache,
                                                  MonoMethod *orig_method,
                                                  MonoMethod *def,
                                                  MonoGenericContext *ctx) {
  ERROR_DECL(error);
  ...
  if (ginfo) {
    info = (WrapperInfo *)mono_image_alloc0(m_class_get_image(def->klass),
                                            sizeof(WrapperInfo));
    info->subtype = ginfo->subtype;
    if (info->subtype == WRAPPER_SUBTYPE_NONE) {
      info->d.delegate_invoke.method =
...
#ifndef ENABLE_ILGEN
static void emit_delegate_begin_invoke_noilgen(MonoMethodBuilder *mb,
                                               MonoMethodSignature *sig) {}
#endif
...
MonoMethod *mono_marshal_get_delegate_begin_invoke(MonoMethod *method) {
  ...
  g_assert(method &&
           m_class_get_parent(method->klass) ==
               mono_defaults.multicastdelegate_class &&
           !strcmp(method->name, "BeginInvoke"));

  /*
   * For generic delegates, create a generic wrapper, and returns an instance to
   * help AOT.
   */
   ...
   */
  if (ctx) {
    cache = get_cache(&((MonoMethodInflated *)orig_method)
                           ->owner->wrapper_caches.delegate_begin_invoke_cache,
    ...
    cache = get_cache(
        &get_method_image(method)->wrapper_caches.delegate_begin_invoke_cache,
  ...
  if (ctx)
    ...
    mb = mono_mb_new(get_wrapper_target_class(get_method_image(method)), name,
  ...
  if (ctx) {
    MonoMethod *def;
    def = mono_mb_create_and_cache_full(cache, method->klass, mb, sig,
                                        sig->param_count + 16, info, NULL);
    res = cache_generic_delegate_wrapper(cache, orig_method, def, ctx);
  } else {
    res = mono_mb_create_and_cache_full(cache, sig, mb, sig,
                                        sig->param_count + 16, info, NULL);
  }
...
MonoObject *mono_delegate_end_invoke(MonoDelegate *delegate, gpointer *params) {
  ...
  if (!delegate->method_info) {
    ...
    MonoReflectionMethod *rm =
        mono_method_get_object_checked(domain, delegate->method, NULL, error);
    if (!is_ok(error)) {
      mono_error_set_pending_exception(error);
      return NULL;
    }
  ...
  ares = (MonoAsyncResult *)mono_array_get_internal(msg->args, gpointer,
                                                    sig->param_count - 1);
  if (ares == NULL) {
    mono_error_set_remoting(
        error, "The async result object is null or of an unexpected type.");
    mono_error_set_pending_exception(error);
    return NULL;
  }
  ...
  if (exc) {
    if (((MonoException *)exc)->stack_trace) {
      ...
      char *strace = mono_string_to_utf8_checked_internal(
          ((MonoException *)exc)->stack_trace, inner_error);
      if (is_ok(inner_error)) {
        ...
        g_free(tmp);
        if (is_ok(inner_error))
          MONO_OBJECT_SETREF_INTERNAL(((MonoException *)exc), stack_trace,
                                      tmp_str);
      };
      if (!is_ok(inner_error))
        mono_error_cleanup(inner_error); /* no stack trace, but at least throw
...
MonoMethod *mono_marshal_get_delegate_end_invoke(MonoMethod *method) {
  ...
  if (ctx) {
    cache = get_cache(&((MonoMethodInflated *)orig_method)
                           ->owner->wrapper_caches.delegate_end_invoke_cache,
                      mono_aligned_addr_hash, NULL);
    res = check_generic_delegate_wrapper_cache(cache, orig_method, method, ctx);
    if (res)
      return res;
    ...
    cache = get_cache(
        &get_method_image(method)->wrapper_caches.delegate_end_invoke_cache,
        (GHashFunc)mono_signature_hash,
        (GCompareFunc)mono_metadata_signature_equal);
    if ((res = mono_marshal_find_in_cache(cache, sig)))
      return res;
...
static guint signature_pointer_pair_hash(gconstpointer data) {
...
static gboolean signature_pointer_pair_equal(gconstpointer data1,
                                             gconstpointer data2) {
  SignaturePointerPair *pair1 = (SignaturePointerPair *)data1,
                       *pair2 = (SignaturePointerPair *)data2;
  return mono_metadata_signature_equal(pair1->sig, pair2->sig) &&
         (pair1->pointer == pair2->pointer);
}

static gboolean signature_pointer_pair_matches_pointer(gpointer key,
                                                       gpointer value,
                                                       gpointer user_data) {
...
static void free_signature_pointer_pair(SignaturePointerPair *pair) {
  g_free(pair);
}

#ifndef ENABLE_ILGEN
static void mb_skip_visibility_noilgen(MonoMethodBuilder *mb) {}

static void mb_set_dynamic_noilgen(MonoMethodBuilder *mb) {}

static void mb_emit_exception_noilgen(MonoMethodBuilder *mb,
                                      const char *exc_nspace,
                                      const char *exc_name, const char *msg) {}

static void mb_emit_exception_for_error_noilgen(MonoMethodBuilder *mb,
                                                const MonoError *error) {}

static void emit_delegate_invoke_internal_noilgen(
    MonoMethodBuilder *mb, MonoMethodSignature *sig,
    MonoMethodSignature *invoke_sig,
    gboolean static_method_with_first_arg_bound, gboolean callvirt,
    gboolean closed_over_null, MonoMethod *method, MonoMethod *target_method,
    MonoClass *target_class, MonoGenericContext *ctx,
    MonoGenericContainer *container) {}
#endif

MonoMethod *mono_marshal_get_delegate_invoke_internal(
    MonoMethod *method, gboolean callvirt,
    gboolean static_method_with_first_arg_bound, MonoMethod *target_method) {
  ...
  /*
   * If the delegate target is null, and the target method is not static, a
   * virtual call is made to that method with the first delegate argument as
   * this. This is a non-documented .NET feature.
   */
  if (callvirt) {
    ...
    if (target_method->is_inflated) {
      ...
      target_type = mono_class_inflate_generic_type_checked(
          method->signature->params[0], mono_method_get_context(method), error);
    ...
    closed_over_null =
        sig->param_count ==
        mono_method_signature_internal(target_method)->param_count;
  }
  ...
  if (static_method_with_first_arg_bound) {
    ...
    if (method_is_dynamic(target_method))
      invoke_sig = mono_metadata_signature_dup_full(
          get_method_image(target_method), invoke_sig);
  }

  /*
   * For generic delegates, create a generic wrapper, and return an instance to
   * help AOT.
   */
  if (method->is_inflated && subtype == WRAPPER_SUBTYPE_NONE) {
    ...
    if (!container)
      container = mono_class_try_get_generic_container(
          method->klass); // FIXME is this a case of a try?
    g_assert(container);
  ...
  if (ctx) {
    cache = get_cache(&((MonoMethodInflated *)orig_method)
                           ->owner->wrapper_caches.delegate_invoke_cache,
                      mono_aligned_addr_hash, NULL);
    res = check_generic_delegate_wrapper_cache(cache, orig_method, method, ctx);
    if (res)
      return res;
    ...
    cache = get_cache(
        &get_method_image(target_method)->delegate_bound_static_invoke_cache,
        (GHashFunc)mono_signature_hash,
        (GCompareFunc)mono_metadata_signature_equal);
    /*
     * The wrapper is based on sig+invoke_sig, but sig can be derived from
     * invoke_sig.
     */
    ...
    cache_ptr =
        &mono_method_get_wrapper_cache(method)->delegate_abstract_invoke_cache;

    /* We need to cache the signature+method pair */
    mono_marshal_lock();
    if (!*cache_ptr)
      *cache_ptr = g_hash_table_new_full(
          signature_pointer_pair_hash, (GEqualFunc)signature_pointer_pair_equal,
          (GDestroyNotify)free_signature_pointer_pair, NULL);
    cache = *cache_ptr;
    key.sig = invoke_sig;
    ...
    // Inflated methods should not be in this cache because it's not stored on
    // the imageset.
    g_assert(!method->is_inflated);
    cache = get_cache(
        &get_method_image(method)->wrapper_caches.delegate_invoke_cache,
        (GHashFunc)mono_signature_hash,
        (GCompareFunc)mono_metadata_signature_equal);
  ...
  if (!static_method_with_first_arg_bound) {
    invoke_sig =
        mono_metadata_signature_dup_full(get_method_image(method), sig);
  ...
  get_marshal_cb()->emit_delegate_invoke_internal(
      mb, sig, invoke_sig, static_method_with_first_arg_bound, callvirt,
      closed_over_null, method, target_method, target_class, ctx, container);
  ...
  if (ctx) {
    ...
    def = mono_mb_create_and_cache_full(cache, cache_key, mb, sig,
                                        sig->param_count + 16, info, NULL);
    res = cache_generic_delegate_wrapper(cache, orig_method, def, ctx);
  } else if (callvirt) {
    ...
    *new_key = key;
    ...
    res = mono_mb_create_and_cache_full(cache, new_key, mb, sig,
                                        sig->param_count + 16, info, &found);
    if (found)
      g_free(new_key);
  } else {
    res = mono_mb_create_and_cache_full(cache, cache_key, mb, sig,
                                        sig->param_count + 16, info, NULL);
  }
  mono_mb_free(mb);
 ...
 */
MonoMethod *mono_marshal_get_delegate_invoke(MonoMethod *method,
                                             MonoDelegate *del) {
  ...
  if (del && !del->target && del->method &&
      mono_method_signature_internal(del->method)->hasthis) {
    if (!(del->method->flags & METHOD_ATTRIBUTE_VIRTUAL) &&
        !m_class_is_valuetype(del->method->klass) &&
        sig->param_count ==
            mono_method_signature_internal(del->method)->param_count + 1) {
      /* The first argument of the delegate is passed as this, the normal invoke
  ...
  if (del && del->method &&
      mono_method_signature_internal(del->method)->param_count ==
          sig->param_count + 1 &&
      (del->method->flags & METHOD_ATTRIBUTE_STATIC)) {
    static_method_with_first_arg_bound = TRUE;
    target_method = del->method;
  }

  return mono_marshal_get_delegate_invoke_internal(
      method, callvirt, static_method_with_first_arg_bound, target_method);
}
...
static MonoMethodSignature *add_string_ctor_signature(MonoMethod *method) {
  MonoMethodSignature *callsig;
  CtorSigPair *cs;

  callsig = mono_metadata_signature_dup_full(
      get_method_image(method), mono_method_signature_internal(method));
 ...
 *
 *   Return the modified signature used by string ctors (they return the newly
 * created string).
 */
MonoMethodSignature *
...
static MonoType *get_runtime_invoke_type(MonoType *t, gboolean ret) {
  if (t->byref) {
...
handle_enum:
  switch (t->type) {
  /* Can't share these as the argument needs to be loaded using sign/zero
   * extension */
  /*
  case MONO_TYPE_U1:
...
static gboolean runtime_invoke_signature_equal(MonoMethodSignature *sig1,
                                               MonoMethodSignature *sig2) {
  /* Can't share wrappers which return a vtype since it needs to be boxed */
  if (sig1->ret != sig2->ret &&
      !(MONO_TYPE_IS_REFERENCE(sig1->ret) &&
        MONO_TYPE_IS_REFERENCE(sig2->ret)) &&
      !mono_metadata_type_equal(sig1->ret, sig2->ret))
    return FALSE;
  else
...
static guint wrapper_cache_method_key_hash(MonoWrapperMethodCacheKey *key) {
  return mono_aligned_addr_hash(key->method) ^
         (((!!key->virtual_) << 17) |
          ((!!key->need_direct_wrapper) << 19) * 17);
}

static guint
wrapper_cache_signature_key_hash(MonoWrapperSignatureCacheKey *key) {
  return mono_signature_hash(key->signature) ^
         (((!!key->valuetype) << 18) * 17);
}

static gboolean
wrapper_cache_method_key_equal(MonoWrapperMethodCacheKey *key1,
                               MonoWrapperMethodCacheKey *key2) {
  if (key1->virtual_ != key2->virtual_ ||
      key1->need_direct_wrapper != key2->need_direct_wrapper)
    return FALSE;
  return key1->method == key2->method;
}

static gboolean
wrapper_cache_signature_key_equal(MonoWrapperSignatureCacheKey *key1,
                                  MonoWrapperSignatureCacheKey *key2) {
 ...
 *
 * <code>MonoObject *runtime_invoke (MonoObject *this_obj, void **params,
 * MonoObject **exc, void* method)</code>
 *
 * We also catch exceptions if \p exc is not NULL.
 * If \p virtual is TRUE, then \p method is invoked virtually on \p this. This
 * is useful since it means that the compiled code for \p method does not have
 * to be looked up before calling the runtime invoke wrapper. In this case, the
 * wrapper ignores its \p method argument.
 */
MonoMethod *mono_marshal_get_runtime_invoke_full(MonoMethod *method,
                                                 gboolean virtual_,
                                                 gboolean need_direct_wrapper) {
  ...
  cache_table =
      &mono_method_get_wrapper_cache(method)->runtime_invoke_method_cache;
  method_cache =
      get_cache(cache_table, (GHashFunc)wrapper_cache_method_key_hash,
                (GCompareFunc)wrapper_cache_method_key_equal);
  ...
  if (need_direct_wrapper || virtual_) {
    ...
    cache_table =
        &mono_method_get_wrapper_cache(method)->runtime_invoke_signature_cache;
    sig_cache =
        get_cache(cache_table, (GHashFunc)wrapper_cache_signature_key_hash,
                  (GCompareFunc)wrapper_cache_signature_key_equal);
    ...
    tmp_sig = callsig;
    callsig = mono_metadata_signature_dup_full(m_class_get_image(target_klass),
                                               callsig);
    g_free(tmp_sig);
  }
  ...
  if (m_class_is_valuetype(method->klass) &&
    ...
    csig->params[0] =
        get_runtime_invoke_type(m_class_get_this_arg(method->klass), FALSE);
  else
  ...
  name = mono_signature_to_name(
      callsig, virtual_ ? "runtime_invoke_virtual"
                        : (need_direct_wrapper ? "runtime_invoke_direct"
                                               : "runtime_invoke"));
  ...
  get_marshal_cb()->emit_runtime_invoke_body(
      mb, param_names, m_class_get_image(target_klass), method, sig, callsig,
      virtual_, need_direct_wrapper);

  method_key = g_new(MonoWrapperMethodCacheKey, 1);
  memcpy(method_key, &method_key_lookup_only,
         sizeof(MonoWrapperMethodCacheKey));

  if (need_direct_wrapper || virtual_) {
    get_marshal_cb()->mb_skip_visibility(mb);
    info = mono_wrapper_info_create(
        mb, virtual_ ? WRAPPER_SUBTYPE_RUNTIME_INVOKE_VIRTUAL
                     : WRAPPER_SUBTYPE_RUNTIME_INVOKE_DIRECT);
    info->d.runtime_invoke.method = method;
    res = mono_mb_create_and_cache_full(method_cache, method_key, mb, csig,
                                        sig->param_count + 16, info, NULL);
  } else {
    MonoWrapperSignatureCacheKey *sig_key =
        g_new0(MonoWrapperSignatureCacheKey, 1);
    sig_key->signature = callsig;
    sig_key->valuetype = m_class_is_valuetype(method->klass);
...
MonoMethod *mono_marshal_get_runtime_invoke(MonoMethod *method,
  ...
  return mono_marshal_get_runtime_invoke_full(method, virtual_,
                                              need_direct_wrapper);
}

#ifndef ENABLE_ILGEN
static void emit_runtime_invoke_body_noilgen(
    MonoMethodBuilder *mb, const char **param_names, MonoImage *image,
    MonoMethod *method, MonoMethodSignature *sig, MonoMethodSignature *callsig,
    gboolean virtual_, gboolean need_direct_wrapper) {}

static void emit_runtime_invoke_dynamic_noilgen(MonoMethodBuilder *mb) {}
#endif
 ...
 * RuntimeInvokeDynamicFunction: void runtime_invoke (void *args, MonoObject
 * **exc, void *compiled_method) ARGS should point to an architecture specific
 * structure containing the arguments and space for the return value. The other
 * arguments are the same as for runtime_invoke (), except that ARGS should
 * contain the this argument too. This wrapper serves the same purpose as the
 * runtime-invoke wrappers, but there is only one copy of it, which is useful in
 * full-aot.
 */
MonoMethod *mono_marshal_get_runtime_invoke_dynamic(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, name,
...
MonoMethod *mono_marshal_get_runtime_invoke_for_sig(MonoMethodSignature *sig) {
  ...
  get_marshal_cb()->emit_runtime_invoke_body(mb, param_names, image, NULL, sig,
                                             callsig, FALSE, FALSE);
...
static void emit_icall_wrapper_noilgen(MonoMethodBuilder *mb,
                                       ...
                                       MonoMethodSignature *csig2,
                                       gboolean check_exceptions) {}

static void emit_return_noilgen(MonoMethodBuilder *mb) {}
#endif
 ...
 */
MonoMethod *mono_marshal_get_icall_wrapper(MonoJitICallInfo *callinfo,
                                           gboolean check_exceptions) {
  ...
  GHashTable *cache = get_cache(
      &m_class_get_image(mono_defaults.object_class)->icall_wrapper_cache,
      mono_aligned_addr_hash, NULL);
  ...
  if (sig->hasthis)
    csig2 = mono_metadata_signature_dup_add_this(mono_defaults.corlib, sig,
  ...
  res = mono_mb_create_and_cache_full(cache, (gpointer)func, mb, csig,
...
const char *mono_marshal_get_aot_init_wrapper_name(MonoAotInitSubtype subtype) {
...
MonoMethod *mono_marshal_get_aot_init_wrapper(MonoAotInitSubtype subtype) {
  MonoMethodBuilder *mb;
  MonoMethod *res;
  WrapperInfo *info;
...
#ifndef ENABLE_ILGEN
static int emit_marshal_custom_noilgen(EmitMarshalContext *m, int argnum,
                                       MonoType *t, MonoMarshalSpec *spec,
...
static int emit_marshal_asany_noilgen(EmitMarshalContext *m, int argnum,
                                      MonoType *t, MonoMarshalSpec *spec,
                                      int conv_arg, MonoType **conv_arg_type,
                                      MarshalAction action) {
  return conv_arg;
...
static int emit_marshal_vtype_noilgen(EmitMarshalContext *m, int argnum,
                                      MonoType *t, MonoMarshalSpec *spec,
                                      int conv_arg, MonoType **conv_arg_type,
                                      MarshalAction action) {
  return conv_arg;
...
static int emit_marshal_string_noilgen(EmitMarshalContext *m, int argnum,
                                       MonoType *t, MonoMarshalSpec *spec,
                                       int conv_arg, MonoType **conv_arg_type,
                                       MarshalAction action) {
  MonoType *int_type = mono_get_int_type();
...
static int emit_marshal_safehandle_noilgen(EmitMarshalContext *m, int argnum,
                                           MonoType *t, MonoMarshalSpec *spec,
                                           int conv_arg,
...
static int emit_marshal_handleref_noilgen(EmitMarshalContext *m, int argnum,
                                          MonoType *t, MonoMarshalSpec *spec,
                                          int conv_arg,
                                          MonoType **conv_arg_type,
                                          MarshalAction action) {
...
static int emit_marshal_object_noilgen(EmitMarshalContext *m, int argnum,
                                       MonoType *t, MonoMarshalSpec *spec,
                                       int conv_arg, MonoType **conv_arg_type,
                                       MarshalAction action) {
  MonoType *int_type = mono_get_int_type();
...
static int emit_marshal_variant_noilgen(EmitMarshalContext *m, int argnum,
                                        MonoType *t, MonoMarshalSpec *spec,
                                        int conv_arg, MonoType **conv_arg_type,
                                        MarshalAction action) {
  g_assert_not_reached();
...
#ifndef ENABLE_ILGEN
static int emit_marshal_array_noilgen(EmitMarshalContext *m, int argnum,
                                      MonoType *t, MonoMarshalSpec *spec,
                                      int conv_arg, MonoType **conv_arg_type,
                                      MarshalAction action) {
  MonoType *int_type = mono_get_int_type();
...
MonoType *mono_marshal_boolean_conv_in_get_local_type(MonoMarshalSpec *spec,
                                                      guint8 *ldc_op /*out*/) {
  if (spec == NULL) {
    return mono_get_int32_type();
  } else {
...
MonoClass *
mono_marshal_boolean_managed_conv_in_get_conv_arg_class(MonoMarshalSpec *spec,
                                                        guint8 *ldop /*out*/) {
...
#ifndef ENABLE_ILGEN
static int emit_marshal_boolean_noilgen(EmitMarshalContext *m, int argnum,
                                        MonoType *t, MonoMarshalSpec *spec,
                                        int conv_arg, MonoType **conv_arg_type,
                                        MarshalAction action) {
  MonoType *int_type = mono_get_int_type();
  ...
  case MARSHAL_ACTION_MANAGED_CONV_IN: {
    MonoClass *conv_arg_class =
        mono_marshal_boolean_managed_conv_in_get_conv_arg_class(spec, NULL);
    if (t->byref)
...
static int emit_marshal_ptr_noilgen(EmitMarshalContext *m, int argnum,
                                    MonoType *t, MonoMarshalSpec *spec,
                                    int conv_arg, MonoType **conv_arg_type,
                                    MarshalAction action) {
  return conv_arg;
...
static int emit_marshal_char_noilgen(EmitMarshalContext *m, int argnum,
                                     MonoType *t, MonoMarshalSpec *spec,
                                     int conv_arg, MonoType **conv_arg_type,
                                     MarshalAction action) {
  return conv_arg;
...
static int emit_marshal_scalar_noilgen(EmitMarshalContext *m, int argnum,
                                       MonoType *t, MonoMarshalSpec *spec,
                                       int conv_arg, MonoType **conv_arg_type,
                                       MarshalAction action) {
  return conv_arg;
...
int mono_emit_marshal(EmitMarshalContext *m, int argnum, MonoType *t,
  ...
  if (spec && spec->native == MONO_NATIVE_CUSTOM)
    return get_marshal_cb()->emit_marshal_custom(m, argnum, t, spec, conv_arg,
                                                 conv_arg_type, action);

  if (spec && spec->native == MONO_NATIVE_ASANY)
    return get_marshal_cb()->emit_marshal_asany(m, argnum, t, spec, conv_arg,
                                                conv_arg_type, action);

  switch (t->type) {
  case MONO_TYPE_VALUETYPE:
    if (t->data.klass == mono_class_try_get_handleref_class())
      return get_marshal_cb()->emit_marshal_handleref(
          m, argnum, t, spec, conv_arg, conv_arg_type, action);

    return get_marshal_cb()->emit_marshal_vtype(m, argnum, t, spec, conv_arg,
                                                conv_arg_type, action);
  case MONO_TYPE_STRING:
    return get_marshal_cb()->emit_marshal_string(m, argnum, t, spec, conv_arg,
                                                 conv_arg_type, action);
  case MONO_TYPE_CLASS:
  case MONO_TYPE_OBJECT:
#if !defined(DISABLE_COM)
    if (spec && spec->native == MONO_NATIVE_STRUCT)
      return get_marshal_cb()->emit_marshal_variant(
          m, argnum, t, spec, conv_arg, conv_arg_type, action);
#endif
    ...
    if ((spec && (spec->native == MONO_NATIVE_IUNKNOWN ||
        ...
        (t->type == MONO_TYPE_CLASS &&
         mono_cominterop_is_interface(t->data.klass)))
      return mono_cominterop_emit_marshal_com_interface(
          m, argnum, t, spec, conv_arg, conv_arg_type, action);
    if (spec && (spec->native == MONO_NATIVE_SAFEARRAY) &&
        ...
        ((action == MARSHAL_ACTION_CONV_OUT) ||
         (action == MARSHAL_ACTION_CONV_IN) || (action == MARSHAL_ACTION_PUSH)))
      return mono_cominterop_emit_marshal_safearray(
          m, argnum, t, spec, conv_arg, conv_arg_type, action);
#endif

    if (mono_class_try_get_safehandle_class() != NULL && t->data.klass &&
        mono_class_is_subclass_of_internal(
            t->data.klass, mono_class_try_get_safehandle_class(), FALSE))
      return get_marshal_cb()->emit_marshal_safehandle(
          m, argnum, t, spec, conv_arg, conv_arg_type, action);

    return get_marshal_cb()->emit_marshal_object(m, argnum, t, spec, conv_arg,
                                                 conv_arg_type, action);
  case MONO_TYPE_ARRAY:
  case MONO_TYPE_SZARRAY:
    return get_marshal_cb()->emit_marshal_array(m, argnum, t, spec, conv_arg,
                                                conv_arg_type, action);
  case MONO_TYPE_BOOLEAN:
    return get_marshal_cb()->emit_marshal_boolean(m, argnum, t, spec, conv_arg,
                                                  conv_arg_type, action);
  case MONO_TYPE_PTR:
    return get_marshal_cb()->emit_marshal_ptr(m, argnum, t, spec, conv_arg,
                                              conv_arg_type, action);
  case MONO_TYPE_CHAR:
    return get_marshal_cb()->emit_marshal_char(m, argnum, t, spec, conv_arg,
                                               conv_arg_type, action);
  case MONO_TYPE_I1:
  case MONO_TYPE_U1:
  case MONO_TYPE_I2:
  ...
  case MONO_TYPE_U8:
  case MONO_TYPE_FNPTR:
    return get_marshal_cb()->emit_marshal_scalar(m, argnum, t, spec, conv_arg,
                                                 conv_arg_type, action);
  case MONO_TYPE_GENERICINST:
...
#ifndef ENABLE_ILGEN
static void emit_create_string_hack_noilgen(MonoMethodBuilder *mb,
                                            MonoMethodSignature *csig,
                                            MonoMethod *res) {}

static void emit_native_icall_wrapper_noilgen(
    MonoMethodBuilder *mb, MonoMethod *method, MonoMethodSignature *csig,
    gboolean check_exceptions, gboolean aot, MonoMethodPInvoke *pinfo) {}
#endif

static void mono_marshal_set_callconv_from_modopt(MonoMethod *method,
                                                  MonoMethodSignature *csig,
  ...
  for (i = 0; i < cmod_count; ++i) {
    ...
    gboolean required;
    MonoType *cmod_type =
        mono_type_get_custom_modifier(sig->ret, i, &required, error);
    mono_error_assert_ok(error);
...
MonoMethod *mono_marshal_get_native_wrapper(MonoMethod *method,
  ...
  g_assert(method != NULL);
  g_assertf(mono_method_signature_internal(method)->pinvoke,
            "%s flags:%X iflags:%X param_count:%X", method->name, method->flags,
            method->iflags,
  ...
  if (aot) {
    if (check_exceptions)
      cache_ptr = &mono_method_get_wrapper_cache(method)
                       ->native_wrapper_aot_check_cache;
    else
      cache_ptr =
          &mono_method_get_wrapper_cache(method)->native_wrapper_aot_cache;
  } else {
    if (check_exceptions)
      cache_ptr =
          &mono_method_get_wrapper_cache(method)->native_wrapper_check_cache;
    else
  ...
  if (MONO_CLASS_IS_IMPORT(method->klass)) {
    /* The COM code is not AOT compatible, it calls
     * mono_custom_attrs_get_attr_checked () */
    if (aot)
      return method;
#ifndef DISABLE_COM
  ...
  if (!piinfo->addr) {
    if (pinvoke) {
      if (method->iflags & METHOD_IMPL_ATTRIBUTE_NATIVE)
        mono_error_set_generic_error(emitted_error, "System",
   ...
   */
  if (!piinfo->addr && !aot) {
    /* if there's no code but the error isn't set, just use a fairly generic
     * exception. */
  ...
  if (method->iflags &
    ...
    if (sig->hasthis)
      csig = mono_metadata_signature_dup_add_this(get_method_image(method), sig,
                                                  method->klass);
    else
      csig = mono_metadata_signature_dup_full(get_method_image(method), sig);
  ...
  mono_marshal_emit_native_wrapper(get_method_image(mb->method), mb, csig,
                                   piinfo, mspecs, piinfo->addr, aot,
                                   check_exceptions, FALSE, skip_gc_trans);
 ...
 * \param image The image to use for memory allocation and for looking up custom
 * marshallers. \param sig The signature of the function \param func The native
 * function to wrap
 *
 * \returns a wrapper method around native functions, similar to the pinvoke
 * wrapper.
 */
MonoMethod *mono_marshal_get_native_func_wrapper(MonoImage *image,
                                                 MonoMethodSignature *sig,
                                                 MonoMethodPInvoke *piinfo,
                                                 MonoMarshalSpec **mspecs,
                                                 gpointer func) {
  ...
  cache = get_cache(&image->native_func_wrapper_cache,
                    signature_pointer_pair_hash, signature_pointer_pair_equal);
  ...
  mono_marshal_emit_native_wrapper(image, mb, sig, piinfo, mspecs, func, FALSE,
                                   TRUE, FALSE, FALSE);
  ...
  res = mono_mb_create_and_cache_full(cache, new_key, mb, csig,
                                      csig->param_count + 16, NULL, &found);
  if (found)
    g_free(new_key);
...
/*
 * The wrapper receives the native function as a boxed IntPtr as its 'this'
 * argument. This is easier to support in AOT.
 */
MonoMethod *mono_marshal_get_native_func_wrapper_aot(MonoClass *klass) {
  ...
  /*
   * The wrapper is associated with the delegate type, to pick up the
   * marshalling info etc.
   */
  cache = get_cache(
      &mono_method_get_wrapper_cache(invoke)->native_func_wrapper_aot_cache,
      mono_aligned_addr_hash, NULL);
  ...
  mono_marshal_emit_native_wrapper(image, mb, sig, piinfo, mspecs, NULL, FALSE,
                                   TRUE, TRUE, FALSE);
  ...
  g_assert(!sig->hasthis);
  csig = mono_metadata_signature_dup_add_this(image, sig,
                                              mono_defaults.object_class);
  csig->pinvoke = 0;
  res = mono_mb_create_and_cache_full(cache, invoke, mb, csig,
                                      csig->param_count + 16, info, NULL);
  mono_mb_free(mb);
 ...
 *
 *   Emit the body of a native-to-managed wrapper. INVOKE_SIG is the signature
 * of the delegate which wraps the managed method to be called. For closed
 * delegates, it could have fewer parameters than the method it wraps. THIS_LOC
 * is the memory location where the target of the delegate is stored.
 */
void mono_marshal_emit_managed_wrapper(MonoMethodBuilder *mb,
  ...
  get_marshal_cb()->emit_managed_wrapper(mb, invoke_sig, mspecs, m, method,
                                         target_handle);
}

#ifndef ENABLE_ILGEN
static void emit_managed_wrapper_noilgen(MonoMethodBuilder *mb,
                                         MonoMethodSignature *invoke_sig,
                                         MonoMarshalSpec **mspecs,
                                         EmitMarshalContext *m,
                                         MonoMethod *method,
  ...
  for (i = 0; i < sig->param_count; i++) {
    ...
    case MONO_TYPE_STRING:
    case MONO_TYPE_BOOLEAN:
      mono_emit_marshal(m, i, sig->params[i], mspecs[i + 1], 0,
                        &csig->params[i], MARSHAL_ACTION_MANAGED_CONV_IN);
    }
  }
 ...
 * If \p target_handle is \c 0, the wrapper info will be a \c WrapperInfo
 * structure.
 */
MonoMethod *mono_marshal_get_managed_wrapper(MonoMethod *method,
                                             MonoClass *delegate_klass,
                                             uint32_t target_handle,
                                             MonoError *error) {
  ...
  if (method->flags & METHOD_ATTRIBUTE_PINVOKE_IMPL) {
    mono_error_set_invalid_program(
        error,
        "Failed because method (%s) marked PInvokeCallback (managed method) "
        "and extern (unmanaged) simultaneously.",
   ...
   */
  cache =
      get_cache(&mono_method_get_wrapper_cache(method)->managed_wrapper_cache,
                mono_aligned_addr_hash, NULL);
  ...
  /*the target gchandle must be the first entry after size and the wrapper
   * itself.*/
  ...
  if (target_handle)
    ...
    csig =
        mono_metadata_signature_dup_full(get_method_image(method), invoke_sig);
  csig->hasthis = 0;
  csig->pinvoke = 1;
    ...
    if (attr) {
      ...
      for (i = 0; i < num_named_args; ++i) {
        ...
        if (!strcmp(narg->field->name, "CharSet")) {
          ...
          // throw_on_unmappable = *(MonoBoolean*)mono_object_unbox_internal
          // (o);
        } else {
          g_assert_not_reached();
        }
      ...
      m.piinfo = &piinfo;
      piinfo.piflags =
          (call_conv << 8) | (charset ? (charset - 1) * 2 : 1) | set_last_error;
  ...
  mono_marshal_emit_managed_wrapper(mb, invoke_sig, mspecs, &m, method,
                                    target_handle);
...
#ifndef ENABLE_ILGEN
static void emit_vtfixup_ftnptr_noilgen(MonoMethodBuilder *mb,
                                        MonoMethod *method, int param_count,
                                        guint16 type) {}
#endif

gpointer mono_marshal_get_vtfixup_ftnptr(MonoImage *image, guint32 token,
                                         guint16 type) {
  ERROR_DECL(error);
  MonoMethod *method;
  MonoMethodSignature *sig;
  ...
  if (!method)
    g_error("Could not load vtfixup token 0x%x due to %s", token,
            mono_error_get_message(error));
  g_assert(method);
  ...
  sig = mono_method_signature_internal(method);
  mb =
      mono_mb_new(method->klass, method->name, MONO_WRAPPER_MANAGED_TO_MANAGED);
...
#ifndef ENABLE_ILGEN
static void emit_castclass_noilgen(MonoMethodBuilder *mb) {}
#endif
...
MonoMethod *mono_marshal_get_castclass_with_cache(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, "__castclass_with_cache",
...
/* this is an icall */
MonoObject *mono_marshal_isinst_with_cache(MonoObject *obj, MonoClass *klass,
                                           uintptr_t *cache) {
  ERROR_DECL(error);
...
#ifndef ENABLE_ILGEN
static void emit_isinst_noilgen(MonoMethodBuilder *mb) {}
#endif
...
MonoMethod *mono_marshal_get_isinst_with_cache(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, "__isinst_with_cache",
                   MONO_WRAPPER_CASTCLASS);
  sig = mono_metadata_signature_alloc(mono_defaults.corlib, 3);
  // The object
  sig->params[TYPECHECK_OBJECT_ARG_POS] = object_type;
 ...
 *
 * Generates IL code for <code>StructureToPtr (object structure, IntPtr ptr,
 * bool fDeleteOld)</code>
 */
MonoMethod *mono_marshal_get_struct_to_ptr(MonoClass *klass) {
  ...
  if (!stoptr) {
    ERROR_DECL(error);
    stoptr = mono_class_get_method_from_name_checked(
        mono_defaults.marshal_class, "StructureToPtr", 3, 0, error);
    mono_error_assert_ok(error);
  }
  g_assert(stoptr);
...
#ifndef ENABLE_ILGEN
static void emit_ptr_to_struct_noilgen(MonoMethodBuilder *mb,
                                       MonoClass *klass) {}
#endif
 ...
 * \param klass \c MonoClass
 * Generates IL code for <code>PtrToStructure (IntPtr src, object
 * structure)</code>
 */
 ...
 * This is used to avoid infinite recursion since it is hard to determine where
 * to replace a method with its synchronized wrapper, and where not. The runtime
 * should execute METHOD instead of the wrapper.
 */
MonoMethod *mono_marshal_get_synchronized_inner_wrapper(MonoMethod *method) {
  ...
  get_marshal_cb()->mb_emit_exception(mb, "System", "ExecutionEngineException",
                                      "Shouldn't be called.");
  get_marshal_cb()->mb_emit_byte(mb, CEE_RET);

  sig = mono_metadata_signature_dup_full(
      get_method_image(method), mono_method_signature_internal(method));
...
#ifndef ENABLE_ILGEN
static void emit_synchronized_wrapper_noilgen(
    MonoMethodBuilder *mb, MonoMethod *method, MonoGenericContext *ctx,
    MonoGenericContainer *container, MonoMethod *enter_method,
    MonoMethod *exit_method, MonoMethod *gettypefromhandle_method) {
  if (m_class_is_valuetype(method->klass) &&
      !(method->flags & MONO_METHOD_ATTR_STATIC)) {
    /* FIXME Is this really the best way to signal an error here?  Isn't this
     * called much later after class setup? -AK */
...
MonoMethod *mono_marshal_get_synchronized_wrapper(MonoMethod *method) {
  ...
  if (ctx) {
    cache = get_cache(&((MonoMethodInflated *)orig_method)
                           ->owner->wrapper_caches.synchronized_cache,
                      mono_aligned_addr_hash, NULL);
    ...
    cache =
        get_cache(&get_method_image(method)->wrapper_caches.synchronized_cache,
                  mono_aligned_addr_hash, NULL);
    if ((res = mono_marshal_find_in_cache(cache, method)))
      return res;
  }
  ...
  if (!enter_method) {
    ...
    enter_method =
        mono_method_desc_search_in_class(desc, mono_defaults.monitor_class);
    ...
    gettypefromhandle_method =
        mono_method_desc_search_in_class(desc, mono_defaults.systemtype_class);
  ...
  get_marshal_cb()->mb_skip_visibility(mb);
  get_marshal_cb()->emit_synchronized_wrapper(mb, method, ctx, container,
                                              enter_method, exit_method,
                                              gettypefromhandle_method);

  if (ctx) {
    MonoMethod *def;
    def = mono_mb_create_and_cache_full(cache, method, mb, sig,
                                        sig->param_count + 16, info, NULL);
    res = cache_generic_wrapper(cache, orig_method, def, ctx, orig_method);
  } else {
    res = mono_mb_create_and_cache_full(cache, method, mb, sig,
                                        sig->param_count + 16, info, NULL);
  }
  mono_mb_free(mb);
...
#ifndef ENABLE_ILGEN
static void emit_unbox_wrapper_noilgen(MonoMethodBuilder *mb,
                                       MonoMethod *method) {}
#endif
...
MonoMethod *mono_marshal_get_unbox_wrapper(MonoMethod *method) {
  ...
  cache = get_cache(&mono_method_get_wrapper_cache(method)->unbox_wrapper_cache,
                    mono_aligned_addr_hash, NULL);
...
static gboolean is_monomorphic_array(MonoClass *klass) {
  MonoClass *element_class;
  if (m_class_get_rank(klass) != 1)
    return FALSE;

  element_class = m_class_get_element_class(klass);
  return mono_class_is_sealed(element_class) ||
         m_class_is_valuetype(element_class);
}

static MonoStelemrefKind get_virtual_stelemref_kind(MonoClass *element_class) {
  ...
  /* magic ifaces requires aditional checks for when the element type is an
   * array */
  if (MONO_CLASS_IS_INTERFACE_INTERNAL(element_class) &&
      m_class_is_array_special_interface(element_class))
    return STELEMREF_COMPLEX;

  /* Compressed interface bitmaps require code that is quite complex, so don't
   * optimize for it. */
  if (MONO_CLASS_IS_INTERFACE_INTERNAL(element_class) &&
...
#endif
  /*Arrays are sealed but are covariant on their element type, We can't use any
   * of the fast paths.*/
  if (mono_class_is_marshalbyref(element_class) ||
...
#ifndef ENABLE_ILGEN
static void emit_virtual_stelemref_noilgen(MonoMethodBuilder *mb,
                                           const char **param_names,
                                           MonoStelemrefKind kind) {}
#endif

static const char *strelemref_wrapper_name[] = {
    "object",    "sealed_class", "class", "class_small_idepth",
    "interface", "complex"};
...
/*
 * TODO:
 *	- Separate simple interfaces from variant interfaces or mbr types. This
 *way we can avoid the icall for them.
 *	- Emit a (new) mono bytecode that produces OP_COND_EXC_NE_UN to raise
 *ArrayTypeMismatch
 *	- Maybe mve some MonoClass field into the vtable to reduce the number of
 *loads
 *	- Add a case for arrays of arrays.
 */
static MonoMethod *get_virtual_stelemref_wrapper(MonoStelemrefKind kind) {
  static MonoMethod *cached_methods[STELEMREF_KIND_COUNT] = {
      NULL}; /*object iface sealed regular*/
  ...
  name = g_strdup_printf("virt_stelemref_%s",
                         mono_marshal_get_strelemref_wrapper_name(kind));
  mb = mono_mb_new(mono_defaults.object_class, name, MONO_WRAPPER_STELEMREF);
  g_free(name);

  if (!signature) {
    MonoMethodSignature *sig =
        mono_metadata_signature_alloc(mono_defaults.corlib, 2);
...
#ifndef ENABLE_ILGEN
static void emit_stelemref_noilgen(MonoMethodBuilder *mb) {}
#endif
...
MonoMethod *mono_marshal_get_stelemref(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, "stelemref",
...
#ifndef ENABLE_ILGEN
static void mb_emit_byte_noilgen(MonoMethodBuilder *mb, guint8 op) {}
#endif
...
MonoMethod *mono_marshal_get_gsharedvt_in_wrapper(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, "gsharedvt_in",
                   MONO_WRAPPER_OTHER);
  ...
  /*
   * The body is generated by the JIT, we use a wrapper instead of a trampoline
   * so EH works.
   */
  get_marshal_cb()->mb_emit_byte(mb, CEE_RET);
...
MonoMethod *mono_marshal_get_gsharedvt_out_wrapper(void) {
  ...
  mb = mono_mb_new(mono_defaults.object_class, "gsharedvt_out",
                   MONO_WRAPPER_OTHER);
...
#ifndef ENABLE_ILGEN
static void emit_array_address_noilgen(MonoMethodBuilder *mb, int rank,
                                       int elem_size) {}
#endif
...
MonoMethod *mono_marshal_get_array_address(int rank, int elem_size) {
  ...
  for (int i = 0; i < elem_addr_cache_next; ++i) {
    if (elem_addr_cache[i].rank == rank &&
        elem_addr_cache[i].elem_size == elem_size) {
  ...
  if (!cached) {
    if (elem_addr_cache_next >= elem_addr_cache_size) {
      ...
      memcpy(new_array, elem_addr_cache,
             elem_addr_cache_size * sizeof(ArrayElemAddr));
...
#ifndef ENABLE_ILGEN
static void emit_array_accessor_wrapper_noilgen(MonoMethodBuilder *mb,
                                                MonoMethod *method,
                                                MonoMethodSignature *sig,
                                                MonoGenericContext *ctx) {}
#endif
 ...
 *
 *   Return a wrapper which just calls METHOD, which should be an Array
 * Get/Set/Address method.
 */
MonoMethod *mono_marshal_get_array_accessor_wrapper(MonoMethod *method) {
  ...
  /*
   * These wrappers are needed to avoid the JIT replacing the calls to these
   * methods with intrinsics inside runtime invoke wrappers, thereby making the
   * wrappers not unshareable.
  ...
  if (ctx) {
    ...
    cache = get_cache(&get_method_image(method)->array_accessor_cache,
                      mono_aligned_addr_hash, NULL);
    if ((res = mono_marshal_find_in_cache(cache, method)))
      return res;
  }
...
#ifndef HOST_WIN32
static void *mono_marshal_alloc_co_task_mem(size_t size) {
  if (size == 0)
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * NULL on error. */
void *ves_icall_marshal_alloc_impl(gsize size, MonoError *error) {
  return mono_marshal_alloc(size, error);
}

#ifndef HOST_WIN32
static void mono_marshal_free_co_task_mem(void *ptr) { g_free(ptr); }
#endif

/**
 * mono_marshal_free:
 */
void mono_marshal_free(gpointer ptr) { mono_marshal_free_co_task_mem(ptr); }
...
/* This is a JIT icall, it sets the pending exception (in wrapper) and returns
 * NULL on error. */
gunichar2 *mono_marshal_string_to_utf16_copy_impl(MonoStringHandle s,
                                                  MonoError *error) {
  ...
  gunichar2 *res =
      (gunichar2 *)mono_marshal_alloc((length + 1) * sizeof(*res), error);
  return_val_if_nok(error, NULL);
  gchandle_t gchandle = 0;
  memcpy(res, mono_string_handle_pin_chars(s, &gchandle),
         length * sizeof(*res));
  mono_gchandle_free_internal(gchandle);
  res[length] = 0;
  return res;
...
static gsize copy_managed_common(MonoArrayHandle managed, gconstpointer native,
                                 gint32 start_index, gint32 length,
                                 gpointer *managed_addr, guint32 *gchandle,
                                 MonoError *error) {
  ...
  if (start_index + length > mono_array_handle_length(managed)) {
    mono_error_set_argument(error, "length",
  ...
  if (!*managed_addr)
    *managed_addr = mono_array_handle_pin_with_size(managed, element_size,
                                                    start_index, gchandle);

  return element_size * length;
}

void ves_icall_System_Runtime_InteropServices_Marshal_copy_to_unmanaged(
    MonoArrayHandle src, gint32 start_index, gpointer dest, gint32 length,
    gconstpointer managed_source_addr, MonoError *error);
...
void ves_icall_System_Runtime_InteropServices_Marshal_copy_to_unmanaged(
  ...
  guint32 gchandle = 0;
  gsize const bytes =
      copy_managed_common(src, dest, start_index, length,
                          (gpointer *)&managed_source_addr, &gchandle, error);
  if (bytes)
    memmove(dest, managed_source_addr,
            bytes); // no references should be involved
  mono_gchandle_free_internal(gchandle);
}

void ves_icall_System_Runtime_InteropServices_Marshal_copy_from_unmanaged(
    gconstpointer src, gint32 start_index, MonoArrayHandle dest, gint32 length,
    gpointer managed_dest_addr, MonoError *error);
...
void ves_icall_System_Runtime_InteropServices_Marshal_copy_from_unmanaged(
  ...
  guint32 gchandle = 0;
  gsize const bytes = copy_managed_common(dest, src, start_index, length,
                                          &managed_dest_addr, &gchandle, error);
  if (bytes)
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStringAnsi(
    const char *ptr, MonoError *error);
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStringAnsi_len(
    const char *ptr, gint32 len, MonoError *error);
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStringUni(
    const gunichar2 *ptr, MonoError *error);
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStringUni(
  ...
  MonoStringHandle res =
      mono_string_new_utf16_handle(mono_domain_get(), ptr, len, error);
  return_val_if_nok(error, NULL_HANDLE_STRING);
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStringUni_len(
    const gunichar2 *ptr, gint32 len, MonoError *error);
...
void ves_icall_System_Runtime_InteropServices_Marshal_SetLastWin32Error(
    guint32 err) {
  mono_native_tls_set_value(last_error_tls_id, GINT_TO_POINTER(err));
}

guint32 ves_icall_System_Runtime_InteropServices_Marshal_SizeOf(
    MonoReflectionTypeHandle rtype, MonoError *error) {
  ...
  guint32 const layout =
      (mono_class_get_flags(klass) & TYPE_ATTRIBUTE_LAYOUT_MASK);
  ...
  if (type->type == MONO_TYPE_PTR || type->type == MONO_TYPE_FNPTR) {
    ...
    mono_error_set_argument_format(
        error, "t", "Type %s cannot be marshaled as an unmanaged structure.",
        m_class_get_name(klass));
    return 0;
  }

  guint32 align;
  return (guint32)mono_marshal_type_size(type, NULL, &align, FALSE,
                                         m_class_is_unicode(klass));
}

guint32 ves_icall_System_Runtime_InteropServices_Marshal_SizeOfHelper(
    MonoReflectionTypeHandle rtype, MonoBoolean throwIfNotMarshalable,
    MonoError *error) {
  return ves_icall_System_Runtime_InteropServices_Marshal_SizeOf(rtype, error);
}

void ves_icall_System_Runtime_InteropServices_Marshal_StructureToPtr(
    MonoObjectHandle obj, gpointer dst, MonoBoolean delete_old,
    MonoError *error) {
  ...
  if (m_class_is_auto_layout(klass)) {
    mono_error_set_argument(error, "structure",
...
static void ptr_to_structure(gconstpointer src, MonoObjectHandle dst,
                             MonoError *error) {
  MonoMethod *method = mono_marshal_get_ptr_to_struct(mono_handle_class(dst));

  gpointer pa[] = {&src, MONO_HANDLE_RAW(dst)};

  // FIXMEcoop? mono_runtime_invoke_handle causes a GC assertion failure in
  // marshal2 with interpreter
  mono_runtime_invoke_checked(method, NULL, pa, error);
}

#ifdef ENABLE_NETCORE

void ves_icall_System_Runtime_InteropServices_Marshal_PtrToStructureInternal(
    gconstpointer src, MonoObjectHandle dst, MonoBoolean allow_vtypes,
    MonoError *error) {
  MonoType *t;
  MonoClass *klass;
...
void ves_icall_System_Runtime_InteropServices_Marshal_PtrToStructure(
    gconstpointer src, MonoObjectHandle dst, MonoError *error) {
  MonoType *t;

  MONO_CHECK_ARG_NULL(src, );
  MONO_CHECK_ARG_NULL_HANDLE(dst, );

  t = mono_type_get_underlying_type(
...
ves_icall_System_Runtime_InteropServices_Marshal_PtrToStructure_type(
    gconstpointer src, MonoReflectionTypeHandle type, MonoError *error) {
  if (src == NULL)
    return NULL_HANDLE;
...
int ves_icall_System_Runtime_InteropServices_Marshal_OffsetOf(
    MonoReflectionTypeHandle ref_type, MonoStringHandle field_name,
    MonoError *error) {
  error_init(error);
...
char *ves_icall_System_Runtime_InteropServices_Marshal_StringToHGlobalAnsi(
    const gunichar2 *s, int length, MonoError *error);
...
static void *mono_marshal_alloc_hglobal(size_t size, MonoError *error) {
...
gunichar2 *ves_icall_System_Runtime_InteropServices_Marshal_StringToHGlobalUni(
    const gunichar2 *s, int length, MonoError *error);
...
void ves_icall_System_Runtime_InteropServices_Marshal_DestroyStructure(
    gpointer src, MonoReflectionTypeHandle type, MonoError *error) {
...
void *ves_icall_System_Runtime_InteropServices_Marshal_AllocHGlobal(
    gsize size, MonoError *error) {
  if (size == 0)
    /* This returns a valid pointer for size 0 on MS.NET */
    size = 4;
...
#ifndef HOST_WIN32
static gpointer mono_marshal_realloc_hglobal(gpointer ptr, size_t size) {
  return g_try_realloc(ptr, size);
}
#endif

gpointer ves_icall_System_Runtime_InteropServices_Marshal_ReAllocHGlobal(
    gpointer ptr, gsize size, MonoError *error) {
  if (ptr == NULL) {
    mono_error_set_out_of_memory(error, "");
    return NULL;
  }
...
#ifndef HOST_WIN32
static void mono_marshal_free_hglobal(gpointer ptr) { g_free(ptr); }
#endif
...
void *ves_icall_System_Runtime_InteropServices_Marshal_AllocCoTaskMem(
    int size, MonoError *error) {
...
void *ves_icall_System_Runtime_InteropServices_Marshal_AllocCoTaskMemSize(
    gsize size, MonoError *error);
...
#ifndef HOST_WIN32
static gpointer mono_marshal_realloc_co_task_mem(gpointer ptr, size_t size) {
  return g_try_realloc(ptr, size);
}
#endif

gpointer ves_icall_System_Runtime_InteropServices_Marshal_ReAllocCoTaskMem(
    gpointer ptr, int size, MonoError *error) {
...
ves_icall_System_Runtime_InteropServices_Marshal_UnsafeAddrOfPinnedArrayElement(
    MonoArrayHandle arrayobj, int index, MonoError *error) {
  int esize = mono_array_element_size(mono_handle_class(arrayobj));
  return mono_array_addr_with_size_fast(MONO_HANDLE_RAW(arrayobj), esize,
                                        index);
}
#endif
...
ves_icall_System_Runtime_InteropServices_Marshal_GetDelegateForFunctionPointerInternal(
    void *ftn, MonoReflectionTypeHandle type, MonoError *error) {
  MonoClass *klass =
      mono_type_get_class_internal(MONO_HANDLE_GETVAL(type, type));
  if (!mono_class_init_checked(klass, error))
...
MonoBoolean ves_icall_System_Runtime_InteropServices_Marshal_IsPinnableType(
    MonoReflectionTypeHandle type_h, MonoError *error) {
  MonoClass *klass =
      mono_class_from_mono_type_internal(MONO_HANDLE_GETVAL(type_h, type));
 ...
 *
 *  Return whenever mono_marshal_load_type_info () is being executed for KLASS
 * by this thread.
 */
static gboolean mono_marshal_is_loading_type_info(MonoClass *klass) {
  GSList *loads_list =
      (GSList *)mono_native_tls_get_value(load_type_info_tls_id);
 ...
 *
 * Initialize \c klass::marshal_info using information from metadata. This
 * function can recursively call itself, and the caller is responsible to avoid
 * that by calling \c mono_marshal_is_loading_type_info beforehand.
 *
...
MonoMarshalType *mono_marshal_load_type_info(MonoClass *klass) {
  ...
  /*
   * This function can recursively call itself, so we keep the list of classes
   * which are under initialization in a TLS list.
   */
  ...
  info = (MonoMarshalType *)mono_image_alloc0(
      m_class_get_image(klass),
      MONO_SIZEOF_MARSHAL_TYPE + sizeof(MonoMarshalField) * count);
  info->num_fields = count;

  /* Try to find a size for this type in metadata */
  mono_metadata_packing_from_typedef(m_class_get_image(klass),
                                     m_class_get_type_token(klass), NULL,
                                     &native_size);
  ...
  packing =
      m_class_get_packing_size(klass) ? m_class_get_packing_size(klass) : 8;
  iter = NULL;
  j = 0;
  while ((field = mono_class_get_fields_internal(klass, &iter))) {
    int size;
    ...
    if (field->type->attrs & FIELD_ATTRIBUTE_HAS_FIELD_MARSHAL)
      mono_metadata_field_info_with_mempool(
          m_class_get_image(klass),
          mono_metadata_token_index(mono_class_get_field_token(field)) - 1,
          NULL, NULL, &info->fields[j].mspec);

    info->fields[j].field = field;

    if ((mono_class_num_fields(klass) == 1) &&
        (m_class_get_instance_size(klass) == MONO_ABI_SIZEOF(MonoObject)) &&
    ...
    case TYPE_ATTRIBUTE_SEQUENTIAL_LAYOUT:
      size = mono_marshal_type_size(field->type, info->fields[j].mspec, &align,
                                    TRUE, m_class_is_unicode(klass));
      align = m_class_get_packing_size(klass)
                  ? MIN(m_class_get_packing_size(klass), align)
                  : align;
  ...
  if (layout != TYPE_ATTRIBUTE_AUTO_LAYOUT) {
    ...
    /*
     * If the provided Size is equal or larger than the calculated size, and
     * there was no Pack attribute, we set min_align to 1 to avoid native_size
     * being increased
     */
    if (layout == TYPE_ATTRIBUTE_EXPLICIT_LAYOUT) {
      if (native_size && native_size == info->native_size &&
          m_class_get_packing_size(klass) == 0)
        min_align = 1;
      else
  ...
  if (info->native_size != mono_class_value_size(klass, NULL)) {
    mono_class_set_nonblittable(
        klass); /* FIXME - how is this justified? what if we previously thought
                   the class was blittable? */
  }
 ...
 */
int mono_type_native_stack_size(MonoType *t, guint32 *align) {
  guint32 tmp;
  ...
  case MONO_TYPE_VALUETYPE: {
    ...
    if (m_class_is_enumtype(klass))
      return mono_type_native_stack_size(
          mono_class_enum_basetype_internal(klass), align);
    else {
 ...
 */
gint32 mono_marshal_type_size(MonoType *type, MonoMarshalSpec *mspec,
                              guint32 *align, gboolean as_field,
                              gboolean unicode) {
  gint32 padded_size;
  MonoMarshalNative native_type = (MonoMarshalNative)mono_type_to_unmanaged(
      type, mspec, as_field, unicode, NULL);
  MonoClass *klass;
  ...
  case MONO_NATIVE_STRUCT:
    ...
    if (klass == mono_defaults.object_class &&
      ...
      *align = 16;
      ...
      // Special case: Managed Decimal consists of 4 int32 fields, the alignment
      // should be 8 on x64 to follow
 ...
 * NULL on error.
 */
gpointer mono_marshal_asany_impl(MonoObjectHandle o,
                                 MonoMarshalNative string_encoding,
                                 int param_attrs, MonoError *error) {
  ...
  case MONO_TYPE_STRING:
    ...
    case MONO_NATIVE_LPWSTR:
      return mono_marshal_string_to_utf16_copy_impl(
          MONO_HANDLE_CAST(MonoString, o), error);
    case MONO_NATIVE_LPSTR:
    case MONO_NATIVE_UTF8STR:
      // Same code path, because in Mono, we treated strings as Utf8
      return mono_string_to_utf8str_impl(MONO_HANDLE_CAST(MonoString, o),
                                         error);
    default:
  ...
  case MONO_TYPE_VALUETYPE: {
    ...
    if (m_class_is_valuetype(klass) &&
        (mono_class_is_explicit_layout(klass) || m_class_is_blittable(klass) ||
         m_class_is_enumtype(klass)))
      return mono_handle_unbox_unsafe(o);

    gpointer res =
        mono_marshal_alloc(mono_class_native_size(klass, NULL), error);
    return_val_if_nok(error, NULL);

    if (!((param_attrs & PARAM_ATTRIBUTE_OUT) &&
          !(param_attrs & PARAM_ATTRIBUTE_IN))) {
  ...
  mono_error_set_argument(error, "",
                          "No PInvoke conversion exists for value passed to "
 ...
 */
void mono_marshal_free_asany_impl(MonoObjectHandle o, gpointer ptr,
                                  MonoMarshalNative string_encoding,
                                  int param_attrs, MonoError *error) {
  MonoType *t;
  MonoClass *klass;
...
#ifndef ENABLE_ILGEN
static void emit_generic_array_helper_noilgen(MonoMethodBuilder *mb,
                                              MonoMethod *method,
                                              MonoMethodSignature *csig) {}
#endif
 ...
 *
 *   Return a wrapper which is used to implement the implicit interfaces on
 * arrays. The wrapper routes calls to METHOD, which is one of the
 * InternalArray_ methods in Array.
 */
MonoMethod *mono_marshal_get_generic_array_helper(MonoClass *klass,
                                                  const gchar *name,
                                                  MonoMethod *method) {
  MonoMethodSignature *sig, *csig;
  MonoMethodBuilder *mb;
  ...
  mb->method->flags = METHOD_ATTRIBUTE_PRIVATE | METHOD_ATTRIBUTE_VIRTUAL |
                      METHOD_ATTRIBUTE_NEW_SLOT | METHOD_ATTRIBUTE_HIDE_BY_SIG |
...
void mono_win32_compat_CopyMemory(gpointer dest, gconstpointer source,
                                  gsize length) {
  if (!dest || !source)
    return;
...
void mono_win32_compat_FillMemory(gpointer dest, gsize length, guchar fill) {
  memset(dest, fill, length);
}

void mono_win32_compat_MoveMemory(gpointer dest, gconstpointer source,
                                  gsize length) {
  if (!dest || !source)
    return;
...
void mono_win32_compat_ZeroMemory(gpointer dest, gsize length) {
  memset(dest, 0, length);
}

void mono_marshal_find_nonzero_bit_offset(guint8 *buf, int len,
                                          int *byte_offset, guint8 *bitmask) {
  int i;
  guint8 byte;
...
#ifndef ENABLE_ILGEN
static void emit_thunk_invoke_wrapper_noilgen(MonoMethodBuilder *mb,
                                              MonoMethod *method,
                                              MonoMethodSignature *csig) {}
#endif
...
MonoMethod *mono_marshal_get_thunk_invoke_wrapper(MonoMethod *method) {
  ...
  cache = get_cache(&mono_method_get_wrapper_cache(method)->thunk_invoke_cache,
                    mono_aligned_addr_hash, NULL);
  ...
  sig_size =
      MONO_SIZEOF_METHOD_SIGNATURE + sig->param_count * sizeof(MonoType *);
  ...
  csig->params[param_count - 1] = mono_metadata_type_dup(
      image, m_class_get_byval_arg(mono_defaults.exception_class));
...
static void clear_runtime_invoke_method_cache(GHashTable *table,
                                              MonoMethod *method) {
  MonoWrapperMethodCacheKey hash_key = {method, FALSE, FALSE};
  /*
   * Since we have a small set of possible keys, remove each one separately,
   * thus avoiding the traversal of the entire hash table, when using
   * foreach_remove.
   */
...
void mono_marshal_free_dynamic_wrappers(MonoMethod *method) {
  ...
  if (image->wrapper_caches.runtime_invoke_method_cache)
    clear_runtime_invoke_method_cache(
        image->wrapper_caches.runtime_invoke_method_cache, method);
  if (image->wrapper_caches.delegate_abstract_invoke_cache)
    g_hash_table_foreach_remove(
        image->wrapper_caches.delegate_abstract_invoke_cache,
        signature_pointer_pair_matches_pointer, method);
  // FIXME: Need to clear the caches in other images as well
  if (image->delegate_bound_static_invoke_cache)
    g_hash_table_remove(image->delegate_bound_static_invoke_cache,
...
MonoObject *mono_marshal_get_type_object(MonoClass *klass) {
  ...
  MonoObject *result = (MonoObject *)mono_type_get_object_checked(
      mono_domain_get(), type, error);
  mono_error_set_pending_exception(error);
  return result;
}
...
void mono_marshal_emit_native_wrapper(MonoImage *image, MonoMethodBuilder *mb,
                                      MonoMethodSignature *sig,
                                      MonoMethodPInvoke *piinfo,
                                      MonoMarshalSpec **mspecs, gpointer func,
                                      gboolean aot, gboolean check_exceptions,
                                      gboolean func_param,
                                      gboolean skip_gc_trans) {
  get_marshal_cb()->emit_native_wrapper(image, mb, sig, piinfo, mspecs, func,
                                        aot, check_exceptions, func_param,
                                        skip_gc_trans);
}

#ifndef ENABLE_ILGEN
static void emit_native_wrapper_noilgen(MonoImage *image, MonoMethodBuilder *mb,
                                        MonoMethodSignature *sig,
                                        MonoMethodPInvoke *piinfo,
                                        MonoMarshalSpec **mspecs, gpointer func,
                                        gboolean aot, gboolean check_exceptions,
...
#ifndef ENABLE_ILGEN
static void install_noilgen(void) {
