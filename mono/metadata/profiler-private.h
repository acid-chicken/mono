...
#define _MONO_PROFILER_EVENT(name) volatile gpointer name##_cb;
...
#define _MONO_PROFILER_EVENT(name) volatile gint32 name##_count;
#define MONO_PROFILER_EVENT_0(name, type) _MONO_PROFILER_EVENT(name)
#define MONO_PROFILER_EVENT_1(name, type, arg1_type, arg1_name)                \
  _MONO_PROFILER_EVENT(name)
#define MONO_PROFILER_EVENT_2(name, type, arg1_type, arg1_name, arg2_type,     \
...
static inline gboolean mono_profiler_installed(void) {
...
static inline gboolean mono_profiler_allocations_enabled(void) {
  return mono_profiler_state.allocations;
}

static inline gboolean mono_profiler_clauses_enabled(void) {
...
#define MONO_PROFILER_EVENT_0(name, type) _MONO_PROFILER_EVENT(name, void)
#define MONO_PROFILER_EVENT_1(name, type, arg1_type, arg1_name)                \
...
#define MONO_PROFILER_ENABLED(name) G_UNLIKELY(mono_profiler_state.name##_count)
