...
HANDLES(NDNS_1, "GetHostByAddr_icall", ves_icall_System_Net_Dns_GetHostByAddr,
        MonoBoolean, 5,
        (MonoString, MonoStringOut, MonoArrayOut, MonoArrayOut, gint32))
HANDLES(NDNS_2, "GetHostByName_icall", ves_icall_System_Net_Dns_GetHostByName,
        MonoBoolean, 5,
        (MonoString, MonoStringOut, MonoArrayOut, MonoArrayOut, gint32))
HANDLES(NDNS_3, "GetHostName_icall", ves_icall_System_Net_Dns_GetHostName,
...
ICALL_TYPE(MAC_IFACE_PROPS,
           ...
           MAC_IFACE_PROPS_1)
HANDLES(
    MAC_IFACE_PROPS_1, "ParseRouteInfo_icall",
...
NOHANDLES(ICALL(SOCK_1, "Accept_icall",
                ves_icall_System_Net_Sockets_Socket_Accept))
NOHANDLES(ICALL(SOCK_2, "Available_icall",
                ves_icall_System_Net_Sockets_Socket_Available))
HANDLES(SOCK_3, "Bind_icall", ves_icall_System_Net_Sockets_Socket_Bind, void, 3,
        (gsize, MonoObject, gint32_ref))
HANDLES(SOCK_4, "Blocking_icall", ves_icall_System_Net_Sockets_Socket_Blocking,
        void, 3, (gsize, MonoBoolean, gint32_ref))
HANDLES(SOCK_5, "Close_icall", ves_icall_System_Net_Sockets_Socket_Close, void,
        2, (gsize, gint32_ref))
HANDLES(SOCK_6, "Connect_icall", ves_icall_System_Net_Sockets_Socket_Connect,
        void, 4, (gsize, MonoObject, gint32_ref, MonoBoolean))
HANDLES(SOCK_6a, "Disconnect_icall",
        ves_icall_System_Net_Sockets_Socket_Disconnect, void, 3,
        (gsize, MonoBoolean, gint32_ref))
HANDLES(SOCK_6b, "Duplicate_icall",
        ves_icall_System_Net_Sockets_Socket_Duplicate, MonoBoolean, 4,
        (gpointer, gint32, gpointer_ref, gint32_ref))
// FIXME The array is ref but the icall does not write to it.
HANDLES(SOCK_7, "GetSocketOption_arr_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_arr, void, 5,
        (gsize, gint32, gint32, MonoArray, gint32_ref))
HANDLES(SOCK_8, "GetSocketOption_obj_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_obj, void, 5,
        (gsize, gint32, gint32, MonoObjectOut, gint32_ref))
HANDLES(SOCK_21, "IOControl_icall",
        ves_icall_System_Net_Sockets_Socket_IOControl, int, 5,
        (gsize, gint32, MonoArray, MonoArray, gint32_ref))
HANDLES(SOCK_9, "Listen_icall", ves_icall_System_Net_Sockets_Socket_Listen,
        void, 3, (gsize, guint32, gint32_ref))
HANDLES(SOCK_10, "LocalEndPoint_icall",
        ves_icall_System_Net_Sockets_Socket_LocalEndPoint, MonoObject, 3,
        (gsize, gint32, gint32_ref))
HANDLES(SOCK_11, "Poll_icall", ves_icall_System_Net_Sockets_Socket_Poll,
        MonoBoolean, 4, (gsize, int, int, gint32_ref))
HANDLES(SOCK_13, "ReceiveFrom_icall",
        ves_icall_System_Net_Sockets_Socket_ReceiveFrom, gint32, 7,
        (gsize, char_ptr, gint32, gint32, MonoObjectInOut, gint32_ref,
         MonoBoolean))
HANDLES(SOCK_11a, "Receive_array_icall",
        ves_icall_System_Net_Sockets_Socket_Receive_array, gint32, 6,
        (gsize, WSABUF_ptr, gint32, gint32, gint32_ref, MonoBoolean))
HANDLES(SOCK_12, "Receive_icall", ves_icall_System_Net_Sockets_Socket_Receive,
        gint32, 6, (gsize, char_ptr, gint32, gint32, gint32_ref, MonoBoolean))
HANDLES(SOCK_14, "RemoteEndPoint_icall",
        ves_icall_System_Net_Sockets_Socket_RemoteEndPoint, MonoObject, 3,
        (gsize, gint32, gint32_ref))
HANDLES(SOCK_15, "Select_icall", ves_icall_System_Net_Sockets_Socket_Select,
        void, 3, (MonoArrayInOut, gint32, gint32_ref))
HANDLES(SOCK_15a, "SendFile_icall",
        ves_icall_System_Net_Sockets_Socket_SendFile, MonoBoolean, 7,
        (gsize, MonoString, MonoArray, MonoArray, int, gint32_ref, MonoBoolean))
HANDLES(SOCK_16, "SendTo_icall", ves_icall_System_Net_Sockets_Socket_SendTo,
        gint32, 7,
        (gsize, char_ptr, gint32, gint32, MonoObject, gint32_ref, MonoBoolean))
HANDLES(SOCK_16a, "Send_array_icall",
        ves_icall_System_Net_Sockets_Socket_Send_array, gint32, 6,
        (gsize, WSABUF_ptr, gint32, gint32, gint32_ref, MonoBoolean))
HANDLES(SOCK_17, "Send_icall", ves_icall_System_Net_Sockets_Socket_Send, gint32,
        6, (gsize, char_ptr, gint32, gint32, gint32_ref, MonoBoolean))
HANDLES(SOCK_18, "SetSocketOption_icall",
        ves_icall_System_Net_Sockets_Socket_SetSocketOption, void, 7,
        (gsize, gint32, gint32, MonoObject, MonoArray, gint32, gint32_ref))
HANDLES(SOCK_19, "Shutdown_icall", ves_icall_System_Net_Sockets_Socket_Shutdown,
        void, 3, (gsize, gint32, gint32_ref))
HANDLES(SOCK_20, "Socket_icall",
        ves_icall_System_Net_Sockets_Socket_Socket_icall, gpointer, 4,
        (gint32, gint32, gint32, gint32_ref))
...
NOHANDLES(ICALL(SOCKEX_1, "WSAGetLastError_icall",
                ves_icall_System_Net_Sockets_SocketException_WSAGetLastError))
