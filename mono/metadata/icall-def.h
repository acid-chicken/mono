...
NOHANDLES(ICALL(COMPROX_1, "AddProxy",
                ves_icall_Mono_Interop_ComInteropProxy_AddProxy))
NOHANDLES(ICALL(COMPROX_2, "FindProxy",
...
NOHANDLES(ICALL(SOCK_2, "Available_icall",
                ves_icall_System_Net_Sockets_Socket_Available_icall))
HANDLES(SOCK_3, "Bind_icall", ves_icall_System_Net_Sockets_Socket_Bind_icall,
        void, 3, (gsize, MonoObject, gint32_ref))
NOHANDLES(ICALL(SOCK_4, "Blocking_icall",
                ves_icall_System_Net_Sockets_Socket_Blocking_icall))
NOHANDLES(ICALL(SOCK_5, "Close_icall",
                ves_icall_System_Net_Sockets_Socket_Close_icall))
HANDLES(SOCK_6, "Connect_icall",
        ves_icall_System_Net_Sockets_Socket_Connect_icall, void, 4,
        (gsize, MonoObject, gint32_ref, MonoBoolean))
NOHANDLES(ICALL(SOCK_6a, "Disconnect_icall",
                ves_icall_System_Net_Sockets_Socket_Disconnect_icall))
NOHANDLES(ICALL(SOCK_6b, "Duplicate_icall",
                ves_icall_System_Net_Sockets_Socket_Duplicate_icall))
// FIXME The array is ref but the icall does not write to it.
HANDLES(SOCK_7, "GetSocketOption_arr_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_arr_icall, void, 5,
        (gsize, gint32, gint32, MonoArray, gint32_ref))
HANDLES(SOCK_8, "GetSocketOption_obj_icall",
        ves_icall_System_Net_Sockets_Socket_GetSocketOption_obj_icall, void, 5,
        (gsize, gint32, gint32, MonoObjectOut, gint32_ref))
HANDLES(SOCK_21, "IOControl_icall",
        ves_icall_System_Net_Sockets_Socket_IOControl_icall, int, 5,
        (gsize, gint32, MonoArray, MonoArray, gint32_ref))
NOHANDLES(ICALL(SOCK_9, "Listen_icall",
                ves_icall_System_Net_Sockets_Socket_Listen_icall))
HANDLES(SOCK_10, "LocalEndPoint_icall",
        ves_icall_System_Net_Sockets_Socket_LocalEndPoint_icall, MonoObject, 3,
        (gsize, gint32, gint32_ref))
NOHANDLES(ICALL(SOCK_11, "Poll_icall",
                ves_icall_System_Net_Sockets_Socket_Poll_icall))
HANDLES(SOCK_13, "ReceiveFrom_icall",
        ves_icall_System_Net_Sockets_Socket_ReceiveFrom_icall, gint32, 7,
        (gsize, char_ptr, gint32, gint32, MonoObjectInOut, gint32_ref,
         MonoBoolean))
NOHANDLES(ICALL(SOCK_11a, "Receive_array_icall",
                ves_icall_System_Net_Sockets_Socket_Receive_array_icall))
NOHANDLES(ICALL(SOCK_12, "Receive_icall",
                ves_icall_System_Net_Sockets_Socket_Receive_icall))
HANDLES(SOCK_14, "RemoteEndPoint_icall",
        ves_icall_System_Net_Sockets_Socket_RemoteEndPoint_icall, MonoObject, 3,
        (gsize, gint32, gint32_ref))
HANDLES(SOCK_15, "Select_icall",
        ves_icall_System_Net_Sockets_Socket_Select_icall, void, 3,
        (MonoArrayInOut, gint32, gint32_ref))
HANDLES(SOCK_15a, "SendFile_icall",
        ves_icall_System_Net_Sockets_Socket_SendFile_icall, MonoBoolean, 7,
        (gsize, MonoString, MonoArray, MonoArray, int, gint32_ref, MonoBoolean))
HANDLES(SOCK_16, "SendTo_icall",
        ves_icall_System_Net_Sockets_Socket_SendTo_icall, gint32, 7,
        (gsize, char_ptr, gint32, gint32, MonoObject, gint32_ref, MonoBoolean))
NOHANDLES(ICALL(SOCK_16a, "Send_array_icall",
                ves_icall_System_Net_Sockets_Socket_Send_array_icall))
NOHANDLES(ICALL(SOCK_17, "Send_icall",
                ves_icall_System_Net_Sockets_Socket_Send_icall))
HANDLES(SOCK_18, "SetSocketOption_icall",
        ves_icall_System_Net_Sockets_Socket_SetSocketOption_icall, void, 7,
        (gsize, gint32, gint32, MonoObject, MonoArray, gint32, gint32_ref))
NOHANDLES(ICALL(SOCK_19, "Shutdown_icall",
                ves_icall_System_Net_Sockets_Socket_Shutdown_icall))
HANDLES(SOCK_20, "Socket_icall",
        ves_icall_System_Net_Sockets_Socket_Socket_icall, gpointer, 4,
        (gint32, gint32, gint32, gint32_ref))
NOHANDLES(ICALL(SOCK_20a, "SupportsPortReuse",
                ves_icall_System_Net_Sockets_Socket_SupportPortReuse_icall))
...
NOHANDLES(
    ICALL(SOCKEX_1, "WSAGetLastError_icall",
          ves_icall_System_Net_Sockets_SocketException_WSAGetLastError_icall))
...
HANDLES(GCH_5, "GetTargetHandle", ves_icall_System_GCHandle_GetTargetHandle,
        gpointer, 3, (MonoObject, gpointer, gint32))
...
#endif
NOHANDLES(
    ICALL(MARSHAL_43, "ReAllocCoTaskMem",
...
NOHANDLES(ICALL(SEMA_1, "CreateSemaphore_icall",
                ves_icall_System_Threading_Semaphore_CreateSemaphore_icall))
NOHANDLES(ICALL(SEMA_2, "OpenSemaphore_icall",
                ves_icall_System_Threading_Semaphore_OpenSemaphore_icall))
NOHANDLES(ICALL(SEMA_3, "ReleaseSemaphore_internal",
...
HANDLES(THREAD_55, "GetAbortExceptionState",
        ...
        (MonoThreadObject))
NOHANDLES(ICALL(THREAD_60, "GetCurrentThread_icall",
