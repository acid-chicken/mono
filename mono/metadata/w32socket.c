 ...
 */
void ves_icall_System_Net_Sockets_Socket_Close(gsize sock, gint32 *werror,
                                               MonoError *error) {
...
gint32 ves_icall_System_Net_Sockets_SocketException_WSAGetLastError(void) {
  LOGDEBUG(
...
gint32 ves_icall_System_Net_Sockets_Socket_Available(gsize sock,
                                                     gint32 *werror) {
  int ret;
  guint64 amount;
...
void ves_icall_System_Net_Sockets_Socket_Blocking(gsize sock, MonoBoolean block,
                                                  gint32 *werror,
                                                  MonoError *error) {
  int ret;
...
gpointer ves_icall_System_Net_Sockets_Socket_Accept(gsize sock, gint32 *werror,
...
void ves_icall_System_Net_Sockets_Socket_Listen(gsize sock, guint32 backlog,
                                                gint32 *werror,
                                                MonoError *error) {
  int ret;
...
MonoObjectHandle ves_icall_System_Net_Sockets_Socket_LocalEndPoint(
    gsize sock, gint32 af, gint32 *werror, MonoError *error) {
  return mono_w32socket_getname(sock, af, TRUE, werror, error);
}

MonoObjectHandle ves_icall_System_Net_Sockets_Socket_RemoteEndPoint(
    gsize sock, gint32 af, gint32 *werror, MonoError *error) {
...
void ves_icall_System_Net_Sockets_Socket_Bind(gsize sock,
...
MonoBoolean ves_icall_System_Net_Sockets_Socket_Poll(gsize sock, gint mode,
                                                     gint timeout,
                                                     gint32 *werror,
                                                     MonoError *error) {
...
void ves_icall_System_Net_Sockets_Socket_Connect(gsize sock,
                                                 MonoObjectHandle sockaddr,
                                                 gint32 *werror,
                                                 MonoBoolean blocking,
                                                 MonoError *error) {
...
void ves_icall_System_Net_Sockets_Socket_Disconnect(gsize sock,
                                                    MonoBoolean reuse,
                                                    gint32 *werror,
                                                    MonoError *error) {
  error_init(error);
...
MonoBoolean ves_icall_System_Net_Sockets_Socket_Duplicate(
...
gint32 ves_icall_System_Net_Sockets_Socket_Receive(gsize sock, gchar *buffer,
                                                   gint32 count, gint32 flags,
                                                   gint32 *werror,
                                                   MonoBoolean blocking,
                                                   MonoError *error) {
  int ret;
...
gint32 ves_icall_System_Net_Sockets_Socket_Receive_array(
...
gint32 ves_icall_System_Net_Sockets_Socket_ReceiveFrom(
...
gint32 ves_icall_System_Net_Sockets_Socket_Send(gsize sock, gchar *buffer,
                                                gint32 count, gint32 flags,
                                                gint32 *werror,
                                                MonoBoolean blocking,
                                                MonoError *error) {
...
gint32 ves_icall_System_Net_Sockets_Socket_Send_array(
    gsize sock, WSABUF *buffers, gint32 count, gint32 flags, gint32 *werror,
    MonoBoolean blocking, MonoError *error) {
  int ret;
  guint32 sent;
...
gint32 ves_icall_System_Net_Sockets_Socket_SendTo(gsize sock, gchar *buffer,
                                                  gint32 count, gint32 flags,
                                                  MonoObjectHandle sockaddr,
                                                  gint32 *werror,
                                                  MonoBoolean blocking,
...
void ves_icall_System_Net_Sockets_Socket_Select(MonoArrayHandleOut sockets,
                                                gint32 timeout, gint32 *werror,
                                                MonoError *error) {
  MonoInternalThread *thread = mono_thread_internal_current();
  mono_pollfd *pfds;
  int nfds, idx;
...
void ves_icall_System_Net_Sockets_Socket_GetSocketOption_obj(
...
void ves_icall_System_Net_Sockets_Socket_GetSocketOption_arr(
...
void ves_icall_System_Net_Sockets_Socket_SetSocketOption(
...
void ves_icall_System_Net_Sockets_Socket_Shutdown(gsize sock, gint32 how,
                                                  gint32 *werror,
                                                  MonoError *error) {
  int ret;
...
gint ves_icall_System_Net_Sockets_Socket_IOControl(gsize sock, gint32 code,
...
#if G_HAVE_API_SUPPORT(HAVE_CLASSIC_WINAPI_SUPPORT | HAVE_UWP_WINAPI_SUPPORT)
MonoBoolean ves_icall_System_Net_Sockets_Socket_SendFile(
