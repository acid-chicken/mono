...
gpointer ves_icall_System_Net_Sockets_Socket_Socket_icall(gint32 family,
                                                          gint32 type,
                                                          gint32 proto,
                                                          gint32 *werror,
                                                          MonoError *error) {
 ...
 */
void ves_icall_System_Net_Sockets_Socket_Close_icall(gsize sock,
                                                     gint32 *werror) {
...
gint32 ves_icall_System_Net_Sockets_Socket_Available_icall(gsize sock,
                                                           gint32 *werror) {
  int ret;
  guint64 amount;
...
void ves_icall_System_Net_Sockets_Socket_Blocking_icall(gsize sock,
                                                        MonoBoolean block,
                                                        gint32 *werror) {
  int ret;
...
gpointer
ves_icall_System_Net_Sockets_Socket_Accept_icall(gsize sock, gint32 *werror,
...
void ves_icall_System_Net_Sockets_Socket_Listen_icall(gsize sock,
                                                      guint32 backlog,
                                                      gint32 *werror) {
  int ret;
...
MonoObjectHandle ves_icall_System_Net_Sockets_Socket_LocalEndPoint_icall(
    gsize sock, gint32 af, gint32 *werror, MonoError *error) {
  return mono_w32socket_getname(sock, af, TRUE, werror, error);
}

MonoObjectHandle ves_icall_System_Net_Sockets_Socket_RemoteEndPoint_icall(
    gsize sock, gint32 af, gint32 *werror, MonoError *error) {
...
void ves_icall_System_Net_Sockets_Socket_Bind_icall(gsize sock,
...
MonoBoolean ves_icall_System_Net_Sockets_Socket_Poll_icall(gsize sock,
                                                           gint mode,
                                                           gint timeout,
                                                           gint32 *werror) {
...
void ves_icall_System_Net_Sockets_Socket_Connect_icall(
...
void ves_icall_System_Net_Sockets_Socket_Disconnect_icall(gsize sock,
                                                          MonoBoolean reuse,
                                                          gint32 *werror) {
...
gint32 ves_icall_System_Net_Sockets_Socket_Receive_icall(
...
gint32 ves_icall_System_Net_Sockets_Socket_Receive_array_icall(
...
gint32 ves_icall_System_Net_Sockets_Socket_ReceiveFrom_icall(
...
gint32 ves_icall_System_Net_Sockets_Socket_Send_icall(gsize sock, gchar *buffer,
                                                      gint32 count,
                                                      gint32 flags,
                                                      gint32 *werror,
                                                      MonoBoolean blocking) {
...
gint32 ves_icall_System_Net_Sockets_Socket_Send_array_icall(
    gsize sock, WSABUF *buffers, gint32 count, gint32 flags, gint32 *werror,
    MonoBoolean blocking) {
  int ret;
  guint32 sent;
...
gint32 ves_icall_System_Net_Sockets_Socket_SendTo_icall(
    gsize sock, gchar *buffer, gint32 count, gint32 flags,
...
void ves_icall_System_Net_Sockets_Socket_Select_icall(
...
void ves_icall_System_Net_Sockets_Socket_GetSocketOption_arr_icall(
...
void ves_icall_System_Net_Sockets_Socket_SetSocketOption_icall(
...
void ves_icall_System_Net_Sockets_Socket_Shutdown_icall(gsize sock, gint32 how,
                                                        gint32 *werror) {
  int ret;
...
gint ves_icall_System_Net_Sockets_Socket_IOControl_icall(
...
MonoBoolean ves_icall_System_Net_Dns_GetHostByName(
...
MonoBoolean ves_icall_System_Net_Dns_GetHostByAddr(
...
MonoBoolean ves_icall_System_Net_Dns_GetHostName(MonoStringHandleOut h_name,
                                                 MonoError *error) {
  gchar hostname[NI_MAXHOST] = {0};
  int ret;
...
MonoBoolean ves_icall_System_Net_Sockets_Socket_SendFile_icall(
