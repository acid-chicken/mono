...
#define STKARG (i * (sizeof(stackval))) /* Displacement of ith argument     */
...
#define s390_is_imm16(val)                                                     \
  ((glong)val >= (glong)SHRT_MIN && (glong)val <= (glong)SHRT_MAX)
#define s390_is_imm32(val)                                                     \
  ((glong)val >= (glong)INT_MIN && (glong)val <= (glong)INT_MAX)
...
#define s390_is_imm12(val)                                                     \
  ((glong)val >= (glong)-4096 && (glong)val <= (glong)4095)
...
#define s390_word(addr, value)                                                 \
  do {                                                                         \
    *(guint32 *)addr = (guint32)value;                                         \
    addr += sizeof(guint32);                                                   \
  } while (0)

#define s390_float(addr, value)                                                \
  do {                                                                         \
    *(gfloat *)addr = (gfloat)value;                                           \
    addr += sizeof(gfloat);                                                    \
  } while (0)

#define s390_llong(addr, value)                                                \
  do {                                                                         \
    *(guint64 *)addr = (guint64)value;                                         \
    addr += sizeof(guint64);                                                   \
  } while (0)

#define s390_double(addr, value)                                               \
  do {                                                                         \
...
#define s390_emit16(c, x)                                                      \
  do {                                                                         \
    *((guint16 *)c) = (guint16)x;                                              \
    c += sizeof(guint16);                                                      \
  } while (0)

#define s390_emit32(c, x)                                                      \
  do {                                                                         \
    *((guint32 *)c) = (guint32)x;                                              \
    c += sizeof(guint32);                                                      \
  } while (0)
...
#define S390_RRF_1(c, opc, g1, g2, g3)                                         \
  s390_emit32(c, (opc << 16 | (g3) << 12 | (g1) << 4 | g2))

#define S390_RRF_2(c, opc, g1, k3, g2)                                         \
  s390_emit32(c, (opc << 16 | (k3) << 12 | (g1) << 4 | g2))

#define S390_RRF_3(c, opc, g1, g2, k4, g3)                                     \
  s390_emit32(c, (opc << 16 | (g3) << 12 | (k4) << 8 | (g1) << 4 | g2))

#define S390_RRF_4(c, opc, g1, m3, g2, m4)                                     \
  s390_emit32(c, (opc << 16 | (m3) << 12 | (m4) << 8 | (g1) << 4 | g2))

#define S390_RX(c, opc, g1, n2, s2, p2)                                        \
  s390_emit32(                                                                 \
      c, (opc << 24 | (g1) << 20 | (n2) << 16 | (s2) << 12 | ((p2)&0xfff)))

#define S390_RXE(c, opc, g1, n2, s2, p2)                                       \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | (g1) << 4 | n2));                         \
    s390_emit32(c, ((s2) << 28 | (((p2)&0xfff) << 16) | (opc & 0xff)));        \
  } while (0)

#define S390_RXY(c, opc, g1, n2, s2, p2)                                       \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | (g1) << 4 | n2));                         \
    s390_emit32(c, ((s2) << 28 | (((p2)&0xfff) << 16) |                        \
                    ((((p2)&0xff000) >> 12) << 8) | (opc & 0xff)));            \
  } while (0)

#define S390_RS_1(c, opc, g1, g3, s2, p2)                                      \
  s390_emit32(                                                                 \
      c, (opc << 24 | (g1) << 20 | (g3) << 16 | (s2) << 12 | ((p2)&0xfff)))

#define S390_RS_2(c, opc, g1, k3, s2, p2)                                      \
  s390_emit32(                                                                 \
      c, (opc << 24 | (g1) << 20 | (k3) << 16 | (s2) << 12 | ((p2)&0xfff)))

#define S390_RS_3(c, opc, g1, s2, p2)                                          \
  s390_emit32(c, (opc << 24 | (g1) << 20 | (s2) << 12 | ((p2)&0xfff)))

#define S390_RSY_1(c, opc, g1, g3, s2, p2)                                     \
  do {                                                                         \
...
#define S390_RSY_2(c, opc, g1, k3, s2, p2)                                     \
  do {                                                                         \
...
#define S390_RSL(c, opc, ln, s1, p1)                                           \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | (ln) << 4));                              \
    s390_emit32(c, ((s1) << 28 | ((s1 & 0xfff) << 16) | (opc & 0xff)));        \
  } while (0)

#define S390_RSI(c, opc, g1, g3, m2)                                           \
  s390_emit32(c, (opc << 24 | (g1) << 20 | (g3) << 16 | (m2 & 0xffff)))

#define S390_RI(c, opc, g1, m2)                                                \
  s390_emit32(                                                                 \
      c, ((opc >> 4) << 24 | (g1) << 20 | (opc & 0x0f) << 16 | (m2 & 0xffff)))

#define S390_RIE_1(c, opc, g1, g3, m2)                                         \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | (g1) << 4 | g3));                         \
    s390_emit32(c, ((m2) << 16 | (opc & 0xff)));                               \
  } while (0)

#define S390_RIE_2(c, opc, g1, g2, m3, v)                                      \
  do {                                                                         \
...
#define S390_RIE_3(c, opc, g1, i, m3, d)                                       \
  do {                                                                         \
...
#define S390_RIE_4(c, opc, g1, i2, m3)                                         \
  do {                                                                         \
...
#define S390_RIL_1(c, opc, g1, m2)                                             \
  do {                                                                         \
    s390_emit16(c, ((opc >> 4) << 8 | (g1) << 4 | (opc & 0xf)));               \
    s390_emit32(c, m2);                                                        \
  } while (0)

#define S390_RIL_2(c, opc, k1, m2)                                             \
  do {                                                                         \
    s390_emit16(c, ((opc >> 4) << 8 | (k1) << 4 | (opc & 0xf)));               \
    s390_emit32(c, m2);                                                        \
  } while (0)

#define S390_RIS(c, opc, r, i, m3, b, d)                                       \
  do {                                                                         \
...
#define S390_RRS(c, opc, r1, r2, m3, b, d)                                     \
  do {                                                                         \
    s390_emit16(c, ((opc, &0xff00) | (r1) << 4) | (r2));                       \
    s390_emit16(c, ((b) << 12) | (d));                                         \
    s390_emit16(c, ((m3) << 12) | ((opc)&0xff));                               \
...
#define S390_SI(c, opc, s1, p1, m2)                                            \
  s390_emit32(c, (opc << 24 | (m2) << 16 | (s1) << 12 | ((p1)&0xfff)));

#define S390_SIY(c, opc, s1, p1, m2)                                           \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | m2));                                     \
    s390_emit32(c, ((s1) << 24 | (((p2)&0xfffff) << 8) | (opc & 0xff)));       \
  } while (0)

#define S390_SIY_1(c, opc, d1, b1, i2)                                         \
  do {                                                                         \
    s390_emit16(c, ((opc & 0xff00) | i2));                                     \
    s390_emit32(c, ((b1) << 28 | (((d1)&0xfff) << 16) |                        \
                    ((((d1)&0xff000) >> 12) << 8) | (opc & 0xff)));            \
  } while (0)

#define S390_S(c, opc, s2, p2)                                                 \
  s390_emit32(c, (opc << 16 | (s2) << 12 | ((p2)&0xfff)))

#define S390_SS_1(c, opc, ln, s1, p1, s2, p2)                                  \
  do {                                                                         \
    s390_emit32(                                                               \
        c, (opc << 24 | ((ln - 1) & 0xff) << 16 | (s1) << 12 | ((p1)&0xfff))); \
    s390_emit16(c, ((s2) << 12 | ((p2)&0xfff)));                               \
  } while (0)

#define S390_SS_2(c, opc, n1, n2, s1, p1, s2, p2)                              \
  do {                                                                         \
    s390_emit32(                                                               \
        c, (opc << 24 | (n1) << 16 | (n2) << 12 | (s1) << 12 | ((p1)&0xfff))); \
    s390_emit16(c, ((s2) << 12 | ((p2)&0xfff)));                               \
  } while (0)

#define S390_SS_3(c, opc, g1, g3, s1, p1, s2, p2)                              \
  do {                                                                         \
    s390_emit32(                                                               \
        c, (opc << 24 | (g1) << 16 | (g3) << 12 | (s1) << 12 | ((p1)&0xfff))); \
    s390_emit16(c, ((s2) << 12 | ((p2)&0xfff)));                               \
  } while (0)

#define S390_SS_4(c, opc, g1, g3, s2, p2, s4, p4)                              \
  do {                                                                         \
    s390_emit32(                                                               \
        c, (opc << 24 | (g1) << 16 | (g3) << 12 | (s2) << 12 | ((p2)&0xfff))); \
    s390_emit16(c, ((s4) << 12 | ((p4)&0xfff)));                               \
  } while (0)

#define S390_SSE(c, opc, s1, p1, s2, p2)                                       \
  do {                                                                         \
    s390_emit16(c, opc);                                                       \
...
#define S390_SSF(c, opc, r3, s1, p1, s2, p2)                                   \
  do {                                                                         \
    s390_emit16(c, (((opc)&0xff00) << 8) | ((r3) << 4) | ((opc)&0xf));         \
    s390_emit16(c, ((s1) << 12 | ((p1)&0xfff)));                               \
    s390_emit16(c, ((s2) << 12 | ((p2)&0xfff)));                               \
  } while (0)

#define S390_VRIa(c, opc, v1, i2, m3)                                          \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7);                                             \
    int vr1 = ((v1) % 16);                                                     \
...
#define S390_VRIb(c, opc, v1, i2, i3, m4)                                      \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7);                                             \
    int vr1 = ((v1) % 16);                                                     \
    s390_emit16(c, ((opc)&0xff00) | (vr1 << 4));                               \
...
#define S390_VRIc(c, opc, v1, v3, i2, m4)                                      \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5);   \
...
#define S390_VRId(c, opc, v1, v2, v3, i4, m5)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5);   \
...
#define S390_VRIe(c, opc, v1, v2, i3, m4, m5)                                  \
  do {                                                                         \
...
#define S390_VRRa(c, opc, v1, v2, m3, m4, m5)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6);                        \
    int vr1 = ((v1) % 16), vr2 = ((v2) % 16);                                  \
    s390_emit16(c, ((opc)&0xff00) | (vr1 << 4) | (vr2));                       \
...
#define S390_VRRb(c, opc, v1, v2, v3, m4, m5)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5);   \
    int vr1 = ((v1) % 16), vr2 = ((v2) % 16), vr3 = ((v3) % 16);               \
    s390_emit16(c, ((opc)&0xff00) | (vr1 << 4) | (vr2));                       \
...
#define S390_VRRc(c, opc, v1, v2, m3, m4, m5)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5);   \
    int vr1 = ((v1) % 16), vr2 = ((v2) % 16), vr3 = ((v3) % 16);               \
    s390_emit16(c, ((opc)&0xff00) | (vr1 << 4) | (vr2));                       \
...
#define S390_VRRd(c, opc, v1, v2, v3, v4, m5, m6)                              \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5) |  \
               (((v4) > 15) << 4);                                             \
    int vr1 = ((v1) % 16), vr2 = ((v2) % 16), vr3 = ((v3) % 16);               \
...
#define S390_VRRe(c, opc, v1, v2, v3, m4, m5, m6)                              \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6) | (((v3) > 15) << 5);   \
    int vr1 = ((v1) % 16), vr2 = ((v2) % 16), vr3 = ((v3) % 16);               \
...
#define S390_VRSa(c, opc, v1, v3, b2, d2, m4)                                  \
  do {                                                                         \
...
#define S390_VRSb(c, opc, v1, r3, b2, d2, m4)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7);                                             \
    int vr1 = (v1) % 16;                                                       \
...
#define S390_VRSc(c, opc, r1, v3, b2, d2, m4)                                  \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7);                                             \
    int vr3 = (v3) % 16;                                                       \
...
#define S390_VRV(c, opc, v1, v2, b2, d2, m3)                                   \
  do {                                                                         \
    char rxb = (((v1) > 15) << 7) | (((v2) > 15) << 6);                        \
...
#define S390_VRX(c, opc, v1, x2, b2, d2, m3)                                   \
  do {                                                                         \
    char rxb = ((v1) > 15) << 7;                                               \
    int vr1 = (v1) % 16;                                                       \
