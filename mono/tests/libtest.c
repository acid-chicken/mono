...
LIBTEST_API int STDCALL mono_cominterop_is_supported(void) {
...
LIBTEST_API unsigned short *STDCALL test_lpwstr_marshal(unsigned short *chars,
                                                        int length) {
  int i = 0;
  unsigned short *res;
...
LIBTEST_API void STDCALL test_lpwstr_marshal_out(unsigned short **chars) {
  int i = 0;
  const char abc[] = "ABC";
...
LIBTEST_API int STDCALL mono_union_test_1(union_test_1_type u1) {
  // printf ("Got values %d %d %d\n", u1.b, u1.a, u1.c);
  return u1.a + u1.b + u1.c;
}

LIBTEST_API int STDCALL mono_return_int(int a) {
  // printf ("Got value %d\n", a);
  return a;
}

LIBTEST_API float STDCALL mono_test_marshal_pass_return_float(float f) {
  return f + 1.0;
}
...
LIBTEST_API int STDCALL mono_return_int_ss(struct ss a) {
  // printf ("Got value %d\n", a.i);
  return a.i;
}

LIBTEST_API struct ss STDCALL mono_return_ss(struct ss a) {
  // printf ("Got value %d\n", a.i);
  a.i++;
  return a;
}
...
LIBTEST_API struct sc1 STDCALL mono_return_sc1(struct sc1 a) {
  // printf ("Got value %d\n", a.c[0]);
  a.c[0]++;
  return a;
}
...
LIBTEST_API struct sc3 STDCALL mono_return_sc3(struct sc3 a) {
  // printf ("Got values %d %d %d\n", a.c[0], a.c[1], a.c[2]);
  a.c[0]++;
  a.c[1] += 2;
  a.c[2] += 3;
...
LIBTEST_API struct sc5 STDCALL mono_return_sc5(struct sc5 a) {
...
LIBTEST_API int STDCALL mono_return_int_su(union su a) {
  // printf ("Got value %d\n", a.i1);
  return a.i1;
}
...
LIBTEST_API struct NestedFloat STDCALL mono_return_nested_float(void) {
...
LIBTEST_API char *STDCALL mono_return_struct_4_double(void *ptr,
                                                      struct Rect rect,
                                                      struct Scalar4 sc4, int a,
                                                      int b, int c) {
  char *buffer = (char *)marshal_alloc(1024 * sizeof(char));
  sprintf(buffer, "sc4 = {%.1f, %.1f, %.1f, %.1f }, a=%x, b=%x, c=%x\n",
          (float)sc4.val[0], (float)sc4.val[1], (float)sc4.val[2],
          (float)sc4.val[3], a, b, c);
  return buffer;
}

LIBTEST_API int STDCALL mono_test_many_int_arguments(int a, int b, int c, int d,
                                                     int e, int f, int g, int h,
                                                     int i, int j);
LIBTEST_API short STDCALL mono_test_many_short_arguments(short a, short b,
                                                         short c, short d,
                                                         short e, short f,
                                                         short g, short h,
                                                         short i, short j);
LIBTEST_API char STDCALL mono_test_many_char_arguments(char a, char b, char c,
...
LIBTEST_API char STDCALL mono_test_many_byte_arguments(char a, char b, char c,
                                                       char d, char e, char f,
                                                       char g, char h, char i,
                                                       char j) {
  return a + b + c + d + e + f + g + h + i + j;
...
LIBTEST_API float STDCALL mono_test_many_float_arguments(float a, float b,
                                                         float c, float d,
                                                         float e, float f,
                                                         float g, float h,
                                                         float i, float j) {
...
LIBTEST_API double STDCALL mono_test_many_double_arguments(double a, double b,
                                                           double c, double d,
                                                           double e, double f,
                                                           double g, double h,
                                                           double i, double j) {
...
LIBTEST_API double STDCALL mono_test_split_double_arguments(double a, double b,
                                                            float c, double d,
                                                            double e) {
  return a + b + c + d + e;
}

LIBTEST_API int STDCALL mono_test_puts_static(char *s) {
  // printf ("TEST %s\n", s);
  return 1;
}
...
LIBTEST_API int STDCALL mono_invoke_delegate(SimpleDelegate3 delegate) {
  int res;
...
LIBTEST_API int STDCALL mono_invoke_simple_delegate(SimpleDelegate d) {
  return d(4);
}

LIBTEST_API int STDCALL mono_test_marshal_char(short a1) {
  if (a1 == 'a')
    return 0;
...
LIBTEST_API void STDCALL mono_test_marshal_char_array(gunichar2 *s) {
  const char m[] = "abcdef";
  gunichar2 *s2;
  glong len;
...
LIBTEST_API int STDCALL mono_test_marshal_ansi_char_array(char *s) {
  const char m[] = "abcdef";
...
LIBTEST_API int STDCALL mono_test_marshal_unicode_char_array(gunichar2 *s) {
  const char m[] = "abcdef";
...
LIBTEST_API int STDCALL mono_test_empty_pinvoke(int i) { return i; }

LIBTEST_API int STDCALL mono_test_marshal_bool_byref(int a, int *b, int c) {
  int res = *b;
...
LIBTEST_API int STDCALL mono_test_marshal_bool_in_as_I1_U1(char bTrue,
                                                           char bFalse) {
  if (!bTrue)
    return 1;
  if (bFalse)
...
LIBTEST_API int STDCALL mono_test_marshal_bool_out_as_I1_U1(char *bTrue,
                                                            char *bFalse) {
  if (!bTrue || !bFalse)
    return 3;
...
LIBTEST_API int STDCALL mono_test_marshal_bool_ref_as_I1_U1(char *bTrue,
                                                            char *bFalse) {
  if (!bTrue || !bFalse)
    return 4;
...
LIBTEST_API int STDCALL mono_test_marshal_array(int *a1) {
  int i, sum = 0;
...
LIBTEST_API int STDCALL mono_test_marshal_inout_array(int *a1) {
  int i, sum = 0;
...
LIBTEST_API int STDCALL mono_test_marshal_out_array(int *a1) {
  int i;
...
LIBTEST_API simplestruct STDCALL mono_test_return_vtype(int i) {
  simplestruct res;
...
LIBTEST_API void STDCALL mono_test_delegate_struct(void) {
  // printf ("TEST\n");
}

typedef char *(STDCALL *ReturnStringDelegate)(const char *s);

LIBTEST_API char *STDCALL mono_test_return_string(ReturnStringDelegate func) {
  char *res;
...
LIBTEST_API int STDCALL mono_test_ref_vtype(int a, simplestruct *ss, int b,
...
LIBTEST_API int STDCALL mono_test_marshal_out_struct(int a, simplestruct *ss,
                                                     int b,
...
LIBTEST_API int STDCALL mono_test_marshal_in_struct(int a, simplestruct *ss,
                                                    int b,
...
LIBTEST_API int STDCALL mono_test_marshal_byref_struct(simplestruct *ss, int a,
                                                       int b, int c, char *d) {
  gboolean res =
      (ss->a == a && ss->b == b && ss->c == c && strcmp(ss->d, d) == 0);
...
LIBTEST_API int STDCALL mono_test_marshal_struct2(simplestruct2 ss) {
  if (ss.a == 0 && ss.b == 1 && ss.c == 0 && !strcmp(ss.d, "TEST") &&
...
LIBTEST_API int STDCALL mono_test_marshal_struct2_2(int i, int j, int k,
                                                    simplestruct2 ss) {
  if (i != 10 || j != 11 || k != 12)
    return 1;
  if (ss.a == 0 && ss.b == 1 && ss.c == 0 && !strcmp(ss.d, "TEST") &&
...
LIBTEST_API int STDCALL mono_test_marshal_lpstruct(simplestruct *ss) {
  if (ss->a == 0 && ss->b == 1 && ss->c == 0 && !strcmp(ss->d, "TEST"))
    return 0;
...
LIBTEST_API int STDCALL mono_test_marshal_lpstruct_blittable(point *p) {
  if (p->x == 1.0 && p->y == 2.0)
    return 0;
  else
    return 1;
...
LIBTEST_API int STDCALL mono_test_marshal_struct_array(simplestruct2 *ss) {
  if (!(ss[0].a == 0 && ss[0].b == 1 && ss[0].c == 0 &&
        !strcmp(ss[0].d, "TEST") && ss[0].e == 99 && ss[0].f == 1.5 &&
        ss[0].g == 42 && ss[0].h == (guint64)123))
    return 1;

  if (!(ss[1].a == 0 && ss[1].b == 0 && ss[1].c == 0 &&
        !strcmp(ss[1].d, "TEST2") && ss[1].e == 100 && ss[1].f == 2.5 &&
        ss[1].g == 43 && ss[1].h == (guint64)124))
    return 1;
...
LIBTEST_API simplestruct2 *STDCALL mono_test_marshal_class(int i, int j, int k,
                                                           simplestruct2 *ss,
                                                           int l) {
  simplestruct2 *res;
...
LIBTEST_API int STDCALL mono_test_marshal_byref_class(simplestruct2 **ssp) {
...
static void *get_sp(void) {
  ...
  /* Yes, this is correct, we are only trying to determine the value of the
   * stack here */
  p = &i;
  return p;
}

LIBTEST_API int STDCALL reliable_delegate(int a) { return a; }

/*
 * Checks whether get_sp() works as expected. It doesn't work with gcc-2.95.3 on
 * linux.
 */
static gboolean is_get_sp_reliable(void) {
  void *sp1, *sp2;
...
LIBTEST_API int STDCALL mono_test_marshal_delegate(SimpleDelegate delegate) {
  void *sp1, *sp2;
...
static int STDCALL inc_cb(int i) { return i + 1; }
...
static int STDCALL return_plus_one(int i) { return i + 1; }

LIBTEST_API SimpleDelegate STDCALL mono_test_marshal_return_delegate_2(void) {
  return return_plus_one;
}

typedef simplestruct(STDCALL *SimpleDelegate2)(simplestruct ss);

static gboolean is_utf16_equals(gunichar2 *s1, const char *s2) {
  char *s;
  int res;
...
LIBTEST_API int STDCALL mono_test_marshal_struct(simplestruct ss) {
  if (ss.a == 0 && ss.b == 1 && ss.c == 0 && !strcmp(ss.d, "TEST") &&
      is_utf16_equals(ss.d2, "OK"))
    return 0;

  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_delegate2(SimpleDelegate2 delegate) {
  simplestruct ss, res;
  ...
  if (!(res.a && !res.b && res.c && !strcmp(res.d, "TEST-RES") &&
        is_utf16_equals(res.d2, "TEST2-RES")))
    return 1;
...
LIBTEST_API int STDCALL mono_test_marshal_delegate4(SimpleDelegate4 delegate) {
  simplestruct ss;
  simplestruct *res;
...
LIBTEST_API int STDCALL mono_test_marshal_delegate5(SimpleDelegate5 delegate) {
  simplestruct ss;
  int res;
  simplestruct *ptr;
...
LIBTEST_API int STDCALL mono_test_marshal_delegate6(SimpleDelegate5 delegate) {
  delegate(NULL);
  return 0;
}
...
LIBTEST_API int STDCALL mono_test_marshal_delegate7(SimpleDelegate7 delegate) {
  int res;
  simplestruct *ptr;
...
LIBTEST_API int STDCALL mono_test_marshal_delegate8(SimpleDelegate8 delegate,
                                                    gunichar2 *s) {
  return delegate(s);
}
...
LIBTEST_API int STDCALL mono_test_marshal_delegate9(SimpleDelegate9 delegate,
                                                    gpointer ftn) {
  return delegate((return_int_fnt)ftn);
}

static int STDCALL return_self(int i) { return i; }

LIBTEST_API int STDCALL mono_test_marshal_delegate10(SimpleDelegate9 delegate) {
...
LIBTEST_API int STDCALL mono_test_marshal_icall_delegate(IcallDelegate del) {
  char *res = del("ABC");
  return strcmp(res, "ABC") == 0 ? 0 : 1;
}

LIBTEST_API int STDCALL mono_test_marshal_stringbuilder(char *s, int n) {
...
LIBTEST_API int STDCALL mono_test_marshal_stringbuilder_append(char *s,
                                                               int length) {
...
LIBTEST_API int STDCALL mono_test_marshal_stringbuilder_default(char *s,
                                                                int n) {
  const char m[] = "This is my message.  Isn't it nice?";
...
LIBTEST_API int STDCALL mono_test_marshal_stringbuilder_unicode(gunichar2 *s,
                                                                int n) {
  const char m[] = "This is my message.  Isn't it nice?";
  gunichar2 *s2;
  glong len;
...
LIBTEST_API void STDCALL mono_test_marshal_stringbuilder_out(char **s) {
  const char m[] = "This is my message.  Isn't it nice?";
  char *str;
...
LIBTEST_API int STDCALL mono_test_marshal_stringbuilder_ref(char **s) {
  const char m[] = "This is my message.  Isn't it nice?";
  char *str;
...
LIBTEST_API void STDCALL mono_test_marshal_stringbuilder_utf16_tolower(short *s,
                                                                       int n) {
  for (int i = 0; i < n; i++)
    s[i] = tolower(s[i]);
}
 ...
 * https://gcc.gnu.org/onlinedocs/gcc/Empty-Structures.html. This cause a little
 * dilemma since runtime build using none GCC compiler will not be compatible
 * with GCC build C libraries and the other way around. On platforms where empty
 * structs has size of 1 byte it must be represented in call and cannot be
 * dropped. On Windows x64 structs will always be represented in the call
 * meaning that an empty struct must have a representation in the callee in
 * order to correctly follow the ABI used by the C/C++ standard and the runtime.
 */
typedef struct {
...
LIBTEST_API int STDCALL mono_test_marshal_empty_string_array(char **array) {
  return (array == NULL) ? 0 : 1;
}

LIBTEST_API int STDCALL mono_test_marshal_string_array(char **array) {
...
LIBTEST_API int STDCALL mono_test_marshal_byref_string_array(char ***array) {
  if (*array == NULL)
    return 0;
...
LIBTEST_API int STDCALL mono_test_marshal_stringbuilder_array(char **array) {
  if (strcmp(array[0], "ABC"))
    return 1;
  if (strcmp(array[1], "DEF"))
    return 2;
...
LIBTEST_API int STDCALL mono_test_empty_struct(int a, EmptyStruct es, int b) {
...
LIBTEST_API EmptyStruct STDCALL mono_test_return_empty_struct(int a) {
  EmptyStruct s;
...
LIBTEST_API ByValStrStruct *STDCALL mono_test_byvalstr_gen(void) {
  ByValStrStruct *ret;
...
LIBTEST_API int STDCALL mono_test_byvalstr_check(ByValStrStruct *data,
                                                 char *correctString) {
  int ret;
  ...
  /* we need g_free because the allocation was performed by
...
mono_test_byvalstr_check_unicode(ByValStrStruct_Unicode *ref, int test) {
  ...
  if (test == 1 || test == 3) {
    if (ref->a[0] != '1' || ref->a[1] != '2' || ref->a[2] != '3')
      return 1;
    return 0;
  }
  if (test == 2) {
    if (ref->a[0] != '1' || ref->a[1] != '2')
      return 1;
    return 0;
  }
  return 10;
...
LIBTEST_API int STDCALL NameManglingAnsi(char *data) {
  return data[0] + data[1] + data[2];
}

LIBTEST_API int STDCALL NameManglingAnsiA(char *data) {
  g_assert_not_reached();
}

LIBTEST_API int STDCALL NameManglingAnsiW(char *data) {
  g_assert_not_reached();
}

LIBTEST_API int STDCALL NameManglingAnsi2A(char *data) {
  return data[0] + data[1] + data[2];
}

LIBTEST_API int STDCALL NameManglingAnsi2W(char *data) {
  g_assert_not_reached();
}

LIBTEST_API int STDCALL NameManglingUnicode(char *data) {
  g_assert_not_reached();
}

LIBTEST_API int STDCALL NameManglingUnicodeW(gunichar2 *data) {
  return data[0] + data[1] + data[2];
}

LIBTEST_API int STDCALL NameManglingUnicode2(gunichar2 *data) {
  return data[0] + data[1] + data[2];
}

LIBTEST_API int STDCALL NameManglingAutoW(char *data) {
#ifdef WIN32
...
LIBTEST_API int STDCALL NameManglingAuto(char *data) {
#ifndef WIN32
...
LIBTEST_API void STDCALL callFunction(intcharFunc f) { f("ABC"); }
...
LIBTEST_API int STDCALL class_marshal_test0(SimpleObj *obj1) {
...
LIBTEST_API int STDCALL class_marshal_test4(SimpleObj *obj1) {
  if (obj1)
    return -1;
...
LIBTEST_API void STDCALL class_marshal_test1(SimpleObj **obj1) {
...
LIBTEST_API int STDCALL class_marshal_test2(SimpleObj **obj1) {
...
LIBTEST_API int STDCALL string_marshal_test0(char *str) {
  if (strcmp(str, "TEST0"))
    return -1;
...
LIBTEST_API void STDCALL string_marshal_test1(const char **str) {
  *str = marshal_strdup("TEST1");
}

LIBTEST_API int STDCALL string_marshal_test2(char **str) {
...
LIBTEST_API int STDCALL string_marshal_test3(char *str) {
  if (str)
    return -1;
...
LIBTEST_API BlittableClass *STDCALL TestBlittableClass(BlittableClass *vl) {
  BlittableClass *res;
...
LIBTEST_API int STDCALL MyGetVersionEx(OSVERSIONINFO_STRUCT *osvi) {
...
LIBTEST_API int STDCALL BugGetVersionEx(int a, int b, int c, int d, int e,
                                        int f, int g, int h,
                                        OSVERSIONINFO_STRUCT *osvi) {
...
LIBTEST_API int STDCALL mono_test_marshal_point(point pt) {
  // printf("point %g %g\n", pt.x, pt.y);
...
LIBTEST_API int STDCALL mono_test_marshal_mixed_point(mixed_point pt) {
...
LIBTEST_API int STDCALL mono_test_marshal_mixed_point_2(mixed_point *pt) {
  if (pt->x != 5 || pt->y != 6.75)
    return 1;
...
LIBTEST_API int STDCALL marshal_test_ref_bool(int i, char *b1, short *b2,
                                              int *b3) {
  int res = 1;
  if (*b1 != 0 && *b1 != 1)
    return 1;
...
LIBTEST_API int STDCALL marshal_test_bool_struct(struct BoolStruct *s) {
  int res = 1;
  if (s->b1 != 0 && s->b1 != 1)
    return 1;
  if (s->b2 != 0 && s->b2 != -1)
...
LIBTEST_API int STDCALL mono_test_marshal_long_struct(LongStruct *s) {
  return s->i + s->l.l;
}

LIBTEST_API void STDCALL mono_test_last_error(int err) {
#ifdef WIN32
  SetLastError(err);
   ...
   * on return since we read back value directly when doing p/invoke with
   * SetLastError = true into first argument register and then pass it to Mono
   * function setting value in TLS. If there is a codegen bug reading last error
   * or the code has been incorrectly eliminated this test could still succeed
   * since expected error code could be left in argument register. Below code
   * just do something that shouldn't touch last error and won't be optimized
   * away but will change the argument registers to something different than
   * err.
   */
  char buffer[256] = {0};
  char value[] = "Dummy";
...
LIBTEST_API int STDCALL mono_test_asany(void *ptr, int what) {
  switch (what) {
  case 1:
...
LIBTEST_API int STDCALL mono_test_marshal_asany_in(void *ptr) {
...
LIBTEST_API int STDCALL mono_test_marshal_asany_inout(void *ptr) {
  AsAnyStruct *asAny = (AsAnyStruct *)ptr;
  int res = asAny->i + asAny->j + asAny->k;
...
LIBTEST_API int STDCALL mono_test_marshal_asany_out(void *ptr) {
  AsAnyStruct *asAny = (AsAnyStruct *)ptr;
  int res = asAny->i + asAny->j + asAny->k;
...
LIBTEST_API amd64_struct1 STDCALL
mono_test_marshal_amd64_pass_return_struct1_many_args(amd64_struct1 s, int i1,
...
LIBTEST_API test_struct5 STDCALL mono_test_marshal_ia64_pass_return_struct5(
    double d1, double d2, test_struct5 s, int i, double d3, double d4) {
  s.d1 += d1 + d2 + i;
  s.d2 += d3 + d4 + i;
...
LIBTEST_API test_struct6 STDCALL mono_test_marshal_ia64_pass_return_struct6(
    double d1, double d2, test_struct6 s, int i, double d3, double d4) {
  s.d1 += d1 + d2 + i;
  s.d2 += d3 + d4;
...
LIBTEST_API void *STDCALL mono_test_marshal_pass_return_custom(int i,
                                                               guint32 *ptr,
                                                               int j) {
...
LIBTEST_API int STDCALL mono_test_marshal_pass_out_custom(int i, guint32 **ptr,
                                                          int j) {
  custom_res[0] = 0;
  custom_res[1] = i + j + 10;
...
LIBTEST_API int STDCALL mono_test_marshal_pass_inout_custom(int i, guint32 *ptr,
                                                            int j) {
  ptr[0] = 0;
  ptr[1] = i + ptr[1] + j;
...
LIBTEST_API int STDCALL mono_test_marshal_pass_out_byval_custom(int i,
                                                                guint32 *ptr,
                                                                int j) {
  return ptr == NULL ? 0 : 1;
}

LIBTEST_API int STDCALL mono_test_marshal_pass_byref_custom(int i,
                                                            guint32 **ptr,
                                                            int j) {
  (*ptr)[1] += i + j;
...
LIBTEST_API void *STDCALL mono_test_marshal_pass_return_custom2(int i,
                                                                guint32 *ptr,
                                                                int j) {
  g_assert_not_reached();
...
LIBTEST_API int STDCALL mono_test_stdcall_name_mangling(int a, int b, int c) {
  return a + b + c;
}

LIBTEST_API int mono_test_stdcall_mismatch_1(int a, int b, int c) {
  return a + b + c;
}

LIBTEST_API int STDCALL mono_test_stdcall_mismatch_2(int a, int b, int c) {
  return a + b + c;
}
...
LIBTEST_API int STDCALL mono_test_marshal_array_delegate(void *arr, int len,
                                                         ArrayDelegate del) {
...
LIBTEST_API int STDCALL mono_test_marshal_array_delegate_long(
    void *arr, gint64 len, ArrayDelegateLong del) {
  return del(len, NULL, arr);
}
...
LIBTEST_API int STDCALL mono_test_marshal_out_string_array_delegate(
    char **arr, int len, ArrayDelegate del) {
  del(len, NULL, arr);
...
LIBTEST_API int STDCALL mono_test_marshal_cdecl_delegate(CdeclDelegate del) {
  int i;
...
LIBTEST_API int STDCALL add_delegate(int i, int j) { return i + j; }

LIBTEST_API gpointer STDCALL mono_test_marshal_return_fnptr(void) {
  return (gpointer)&add_delegate;
}

LIBTEST_API int STDCALL mono_xr(int code) {
  printf("codigo %x\n", code);
  return code + 1234;
}
...
LIBTEST_API HandleRef STDCALL mono_xr_as_handle(int code) {
  HandleRef ref;
...
LIBTEST_API int STDCALL mono_safe_handle_struct_ref(HandleStructs *x) {
  printf("Dingus Ref! \n");
...
LIBTEST_API int STDCALL mono_safe_handle_struct(HandleStructs x) {
...
LIBTEST_API int STDCALL mono_safe_handle_struct_simple(TrivialHandle x) {
  printf("The value is %p\n", x.a);
  return ((int)(gsize)x.a) * 2;
}

LIBTEST_API int STDCALL mono_safe_handle_return(void) { return 0x1000f00d; }

LIBTEST_API void STDCALL mono_safe_handle_ref(void **handle) {
  if (*handle != 0) {
    *handle = (void *)0x800d;
    return;
  }
...
LIBTEST_API void *STDCALL mono_safe_handle_ref_nomod(void **handle) {
  return *handle;
}

LIBTEST_API double STDCALL mono_test_marshal_date_time(double d, double *d2) {
  *d2 = d;
  return d;
}
...
typedef enum { VARIANT_TRUE = -1, VARIANT_FALSE = 0 } VariantBool;
...
void VariantInit(VARIANT *vt) { vt->vt = VT_EMPTY; }
...
LIBTEST_API int STDCALL mono_test_marshal_bstr_in(gunichar2 *bstr) {
  gint32 result = 0;
...
LIBTEST_API int STDCALL mono_test_marshal_bstr_out(gunichar2 **bstr) {
  *bstr = marshal_bstr_alloc("mono_test_marshal_bstr_out");
  return 0;
}

LIBTEST_API int STDCALL mono_test_marshal_bstr_in_null(gunichar2 *bstr) {
  if (!bstr)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_bstr_out_null(gunichar2 **bstr) {
  *bstr = NULL;
  return 0;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_sbyte(VARIANT variant) {
  if (variant.vt == VT_I1 && variant.cVal == 100)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_byte(VARIANT variant) {
  if (variant.vt == VT_UI1 && variant.bVal == 100)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_short(VARIANT variant) {
  if (variant.vt == VT_I2 && variant.iVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_ushort(VARIANT variant) {
  if (variant.vt == VT_UI2 && variant.uiVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_int(VARIANT variant) {
  if (variant.vt == VT_I4 && variant.lVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_uint(VARIANT variant) {
  if (variant.vt == VT_UI4 && variant.ulVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_long(VARIANT variant) {
  if (variant.vt == VT_I8 && variant.llVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_ulong(VARIANT variant) {
  if (variant.vt == VT_UI8 && variant.ullVal == 314)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_float(VARIANT variant) {
  if (variant.vt == VT_R4 && (variant.fltVal - 3.14) / 3.14 < .001)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_double(VARIANT variant) {
  if (variant.vt == VT_R8 && (variant.dblVal - 3.14) / 3.14 < .001)
    return 0;
  return 1;
}

LIBTEST_API int STDCALL mono_test_marshal_variant_in_bstr(VARIANT variant) {
  gint32 result = 0;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_sbyte(VARIANT *variant) {
  variant->vt = VT_I1;
  variant->cVal = 100;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_byte(VARIANT *variant) {
  variant->vt = VT_UI1;
  variant->bVal = 100;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_short(VARIANT *variant) {
  variant->vt = VT_I2;
  variant->iVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_ushort(VARIANT *variant) {
  variant->vt = VT_UI2;
  variant->uiVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_int(VARIANT *variant) {
  variant->vt = VT_I4;
  variant->lVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_uint(VARIANT *variant) {
  variant->vt = VT_UI4;
  variant->ulVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_long(VARIANT *variant) {
  variant->vt = VT_I8;
  variant->llVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_ulong(VARIANT *variant) {
  variant->vt = VT_UI8;
  variant->ullVal = 314;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_float(VARIANT *variant) {
  variant->vt = VT_R4;
  variant->fltVal = 3.14;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_double(VARIANT *variant) {
  variant->vt = VT_R8;
  variant->dblVal = 3.14;
...
LIBTEST_API int STDCALL mono_test_marshal_variant_out_bstr(VARIANT *variant) {
  variant->vt = VT_BSTR;
...
typedef struct {
  int(STDCALL *QueryInterface)(MonoDefItfObject *pUnk, gpointer riid,
                               gpointer *ppv);
...
typedef struct {
  int(STDCALL *QueryInterface)(MonoComObject *pUnk, gpointer riid,
                               gpointer *ppv);
...
static GUID IID_IMonoDispatch = {
    0x00020400, 0, 0, {0xc0, 0, 0, 0, 0, 0, 0, 0x46}};
static GUID IID_INotImplemented = {
    0x12345678, 0, 0, {0x9a, 0xbc, 0xde, 0xf0, 0, 0, 0, 0}};

LIBTEST_API int STDCALL MonoQueryInterface(MonoComObject *pUnk, gpointer riid,
                                           gpointer *ppv) {
...
LIBTEST_API int STDCALL MonoAddRef(MonoComObject *pUnk) {
  return ++(pUnk->m_ref);
}

LIBTEST_API int STDCALL MonoRelease(MonoComObject *pUnk) {
  return --(pUnk->m_ref);
}

LIBTEST_API int STDCALL SByteIn(MonoComObject *pUnk, char a) { return S_OK; }

LIBTEST_API int STDCALL ByteIn(MonoComObject *pUnk, unsigned char a) {
  return S_OK;
}

LIBTEST_API int STDCALL ShortIn(MonoComObject *pUnk, short a) { return S_OK; }

LIBTEST_API int STDCALL UShortIn(MonoComObject *pUnk, unsigned short a) {
  return S_OK;
}

LIBTEST_API int STDCALL IntIn(MonoComObject *pUnk, int a) { return S_OK; }

LIBTEST_API int STDCALL UIntIn(MonoComObject *pUnk, unsigned int a) {
  return S_OK;
}

LIBTEST_API int STDCALL LongIn(MonoComObject *pUnk, gint64 a) { return S_OK; }

LIBTEST_API int STDCALL ULongIn(MonoComObject *pUnk, guint64 a) { return S_OK; }

LIBTEST_API int STDCALL FloatIn(MonoComObject *pUnk, float a) { return S_OK; }

LIBTEST_API int STDCALL DoubleIn(MonoComObject *pUnk, double a) { return S_OK; }

LIBTEST_API int STDCALL ITestIn(MonoComObject *pUnk, MonoComObject *pUnk2) {
  return S_OK;
}

LIBTEST_API int STDCALL ITestOut(MonoComObject *pUnk, MonoComObject **ppUnk) {
  return S_OK;
}

LIBTEST_API int STDCALL Return22NoICall(MonoComObject *pUnk) { return 22; }

LIBTEST_API int STDCALL IntOut(MonoComObject *pUnk, int *a) { return S_OK; }

LIBTEST_API int STDCALL ArrayIn(MonoComObject *pUnk, void *array) {
  return S_OK;
}

LIBTEST_API int STDCALL ArrayIn2(MonoComObject *pUnk, void *array) {
  return S_OK;
}

LIBTEST_API int STDCALL ArrayIn3(MonoComObject *pUnk, void *array) {
  return S_OK;
}

LIBTEST_API int STDCALL GetDefInterface1(MonoComObject *pUnk,
                                         MonoDefItfObject **obj) {
  return S_OK;
}

LIBTEST_API int STDCALL GetDefInterface2(MonoComObject *pUnk,
                                         MonoDefItfObject **obj) {
  return S_OK;
}
...
LIBTEST_API int STDCALL get_ITest(MonoComObject *pUnk, MonoComObject **ppUnk) {
...
LIBTEST_API int STDCALL mono_test_marshal_ccw_itest(MonoComObject *pUnk) {
  int hr = 0;
  MonoComObject *pTest;
...
LIBTEST_API int STDCALL mono_test_marshal_retval_ccw_itest(MonoComObject *pUnk,
                                                           int test_null) {
  int hr = 0, i = 0;
...
LIBTEST_API int STDCALL mono_test_default_interface_ccw(MonoComObject *pUnk) {
  MonoDefItfObject *obj;
  int ret, value;
...
#if defined(__GNUC__) &&                                                       \
    ((defined(__i386__) && (defined(__linux__) || defined(__APPLE__)) ||       \
...
static gpointer lookup_mono_symbol(const char *symbol_name) {
...
#define MONO_BEGIN_EFRAME                                                      \
  {                                                                            \
    void *__dummy;                                                             \
    void *__region_cookie =                                                    \
        mono_threads_enter_gc_unsafe_region                                    \
            ? mono_threads_enter_gc_unsafe_region(&__dummy)                    \
            : NULL;
#define MONO_END_EFRAME                                                        \
  if (mono_threads_exit_gc_unsafe_region)                                      \
    mono_threads_exit_gc_unsafe_region(__region_cookie, &__dummy);             \
  }
 ...
 */
LIBTEST_API int STDCALL
test_method_thunk(int test_id, gpointer test_method_handle,
                  gpointer create_object_method_handle) {
  int ret = 0;

  // FIXME use runtime headers
  gpointer (*mono_method_get_unmanaged_thunk)(gpointer) = (gpointer(*)(
      gpointer))lookup_mono_symbol("mono_method_get_unmanaged_thunk");
  ...
  // FIXME use runtime headers
  gpointer (*mono_threads_enter_gc_unsafe_region)(gpointer) = (gpointer(*)(
      gpointer))lookup_mono_symbol("mono_threads_enter_gc_unsafe_region");

  // FIXME use runtime headers
  void (*mono_threads_exit_gc_unsafe_region)(gpointer, gpointer) =
      (void (*)(gpointer, gpointer))lookup_mono_symbol(
  ...
  CreateObject = (gpointer(STDCALL *)(
      gpointer *))mono_method_get_unmanaged_thunk(create_object_method_handle);
  if (!CreateObject) {
    ret = 3;
    goto done;
  }
  ...
  case 2: {
    ...
    gpointer(STDCALL * F)(gpointer, gpointer *) =
        (gpointer(STDCALL *)(gpointer, gpointer *))test_method;
  ...
  case 6: {
    ...
    F = (int(STDCALL *)(gpointer, guint8, gint16, gint32, gint64, float, double,
  ...
  case 7: {
    ...
    gint64(STDCALL * F)(gpointer *) =
        (gint64(STDCALL *)(gpointer *))test_method;
    if (F(&ex) != G_MAXINT64) {
      ret = 4;
      goto done;
    }
  ...
  case 8: {
    ...
    F = (void(STDCALL *)(guint8 *, gint16 *, gint32 *, gint64 *, float *,
                         double *, gpointer *, gpointer *))test_method;
    ...
    if (!(a1 == 254 && a2 == 32700 && a3 == -245378 && a4 == 6789600 &&
          (fabs(a5 - 3.1415) < 0.001) && (fabs(a6 - 3.1415) < 0.001) &&
...
LIBTEST_API int STDCALL mono_test_Winx64_struct1_in(winx64_struct1 var) {
  if (var.a != 123)
    return 1;
  return 0;
}
...
LIBTEST_API int STDCALL mono_test_Winx64_struct2_in(winx64_struct2 var) {
  if (var.a != 4)
    return 1;
  if (var.b != 5)
    return 2;
...
LIBTEST_API int STDCALL mono_test_Winx64_struct3_in(winx64_struct3 var) {
  if (var.a != 4)
    return 1;
  if (var.b != 5)
    return 2;
...
LIBTEST_API int STDCALL mono_test_Winx64_struct4_in(winx64_struct4 var) {
  if (var.a != 4)
    return 1;
  if (var.b != 5)
    return 2;
...
LIBTEST_API int STDCALL mono_test_Winx64_struct5_in(winx64_struct5 var) {
  if (var.a != 4)
    return 1;
  if (var.b != 5)
    return 2;
...
LIBTEST_API int STDCALL mono_test_Winx64_struct6_in(winx64_struct6 var) {
  if (var.a.a != 4)
    return 1;
  if (var.b != 5)
    return 2;
...
LIBTEST_API int STDCALL mono_test_Winx64_structs_in1(winx64_struct1 var1,
                                                     winx64_struct2 var2,
                                                     winx64_struct3 var3,
                                                     winx64_struct4 var4) {
  if (var1.a != 123)
...
LIBTEST_API int STDCALL mono_test_Winx64_structs_in2(winx64_struct1 var1,
                                                     winx64_struct1 var2,
                                                     winx64_struct1 var3,
                                                     winx64_struct1 var4,
                                                     winx64_struct1 var5) {
...
LIBTEST_API int STDCALL mono_test_Winx64_structs_in3(
    winx64_struct1 var1, winx64_struct5 var2, winx64_struct1 var3,
    winx64_struct5 var4, winx64_struct1 var5, winx64_struct5 var6) {
  if (var1.a != 1)
    return 1;
...
LIBTEST_API winx64_struct1 STDCALL mono_test_Winx64_struct1_ret(void) {
  winx64_struct1 ret;
  ret.a = 123;
  return ret;
}

LIBTEST_API winx64_struct2 STDCALL mono_test_Winx64_struct2_ret(void) {
  winx64_struct2 ret;
  ret.a = 4;
  ret.b = 5;
  return ret;
...
LIBTEST_API winx64_struct3 STDCALL mono_test_Winx64_struct3_ret(void) {
  winx64_struct3 ret;
  ret.a = 4;
  ret.b = 5;
  ret.c = 0x1234;
...
LIBTEST_API winx64_struct4 STDCALL mono_test_Winx64_struct4_ret(void) {
  winx64_struct4 ret;
  ret.a = 4;
  ret.b = 5;
  ret.c = 0x1234;
...
LIBTEST_API winx64_struct5 STDCALL mono_test_Winx64_struct5_ret(void) {
  winx64_struct5 ret;
  ret.a = 4;
  ret.b = 5;
  ret.c = 6;
...
LIBTEST_API int STDCALL mono_test_Winx64_floatStruct(winx64_floatStruct a) {
  if (a.a > 5.6 || a.a < 5.4)
    return 1;
...
LIBTEST_API int STDCALL mono_test_Winx64_doubleStruct(winx64_doubleStruct a) {
  if (a.a > 5.6 || a.a < 5.4)
    return 1;
...
typedef int(STDCALL *managed_struct1_struct5_delegate)(
    winx64_struct1 a, winx64_struct5 b, winx64_struct1 c, winx64_struct5 d,
    winx64_struct1 e, winx64_struct5 f);

LIBTEST_API int STDCALL mono_test_managed_Winx64_struct1_struct5_in(
    managed_struct1_struct5_delegate func) {
...
LIBTEST_API int STDCALL mono_test_marshal_bool_in(
    int arg, unsigned int expected, unsigned int bDefaultMarsh,
...
LIBTEST_API int STDCALL mono_test_marshal_bool_out(
    int arg, unsigned int testVal, unsigned int *bDefaultMarsh,
    unsigned int *bBoolCustMarsh, char *bI1CustMarsh,
    unsigned char *bU1CustMarsh, unsigned short *bVBCustMarsh) {
  switch (arg) {
  case 1:
    if (!bDefaultMarsh)
      return 1;
...
LIBTEST_API int STDCALL mono_test_marshal_bool_ref(
    int arg, unsigned int expected, unsigned int testVal,
    unsigned int *bDefaultMarsh, unsigned int *bBoolCustMarsh,
    char *bI1CustMarsh, unsigned char *bU1CustMarsh,
...
typedef int(STDCALL *MarshalBoolInDelegate)(int arg, unsigned int expected,
...
LIBTEST_API int STDCALL mono_test_managed_marshal_bool_in(
    int arg, unsigned int expected, unsigned int testVal,
...
typedef int(STDCALL *MarshalBoolOutDelegate)(int arg, unsigned int expected,
                                             unsigned int *bDefaultMarsh,
                                             unsigned int *bBoolCustMarsh,
                                             char *bI1CustMarsh,
                                             unsigned char *bU1CustMarsh,
...
LIBTEST_API int STDCALL mono_test_managed_marshal_bool_out(
    int arg, unsigned int expected, unsigned int testVal,
  ...
  case 1: {
    ...
    ret = pfcn(arg, testVal, &ltVal, &lBoolCustMarsh, &lI1CustMarsh,
               &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0100 + ret;
    if (expected != ltVal)
      return 0x0200;
  ...
  case 2: {
    unsigned int ltVal = 0;
    ret = pfcn(arg, testVal, &lDefaultMarsh, &ltVal, &lI1CustMarsh,
               &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0300 + ret;
    if (expected != ltVal)
  ...
  case 3: {
    char ltVal = 0;
    ret = pfcn(arg, testVal, &lDefaultMarsh, &lBoolCustMarsh, &ltVal,
               &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0500 + ret;
    if (expected != ltVal)
  ...
  case 4: {
    ...
    ret = pfcn(arg, testVal, &lDefaultMarsh, &lBoolCustMarsh, &lI1CustMarsh,
               &ltVal, &lVBCustMarsh);
    if (ret)
      return 0x0700 + ret;
    if (expected != ltVal)
...
typedef int(STDCALL *MarshalBoolRefDelegate)(int arg, unsigned int expected,
...
LIBTEST_API int STDCALL mono_test_managed_marshal_bool_ref(
    int arg, unsigned int expected, unsigned int testVal,
    unsigned int outExpected, unsigned int outTestVal,
  ...
  case 1: {
    ...
    ret = pfcn(arg, expected, outTestVal, &ltestVal, &lBoolCustMarsh,
               &lI1CustMarsh, &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0100 + ret;
  ...
  case 2: {
    unsigned int ltestVal = testVal;
    ret = pfcn(arg, expected, outTestVal, &lDefaultMarsh, &ltestVal,
               &lI1CustMarsh, &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0300 + ret;
    if (outExpected != ltestVal)
  ...
  case 3: {
    ...
    ret = pfcn(arg, expected, outTestVal, &lDefaultMarsh, &lBoolCustMarsh,
               &ltestVal, &lU1CustMarsh, &lVBCustMarsh);
    if (ret)
      return 0x0500 + ret;
    if (outExpected != ltestVal)
      return 0x0600;
  ...
  case 4: {
    ...
    ret = pfcn(arg, expected, outTestVal, &lDefaultMarsh, &lBoolCustMarsh,
               &lI1CustMarsh, &ltestVal, &lVBCustMarsh);
    if (ret)
      return 0x0700 + ret;
    if (outExpected != ltestVal)
      return 0x0800;
  ...
  case 5: {
    ...
    ret = pfcn(arg, expected, outTestVal, &lDefaultMarsh, &lBoolCustMarsh,
               &lI1CustMarsh, &lU1CustMarsh, &ltestVal);
    if (ret)
      return 0x0900 + ret;
    if (outExpected != ltestVal)
      return 0x1000;
...
mono_test_marshal_safearray_out_1dim_vt_bstr(SAFEARRAY **safearray) {
  ...
  pSA = SafeArrayCreate(VT_VARIANT, 1, dimensions);
  for (i = dimensions[0].lLbound;
       i < (dimensions[0].cElements + dimensions[0].lLbound); i++) {
    VARIANT vOut;
    VariantInit(&vOut);
    vOut.vt = VT_BSTR;
    _ltoa(i, buffer, 10);
...
mono_test_marshal_safearray_out_2dim_vt_i4(SAFEARRAY **safearray) {
  ...
  for (i = dimensions[0].lLbound;
       i < (dimensions[0].cElements + dimensions[0].lLbound); i++) {
    for (j = dimensions[1].lLbound;
         j < (dimensions[1].cElements + dimensions[1].lLbound); j++) {
      VARIANT vOut;
      VariantInit(&vOut);
      vOut.vt = VT_I4;
...
mono_test_marshal_safearray_out_4dim_vt_i4(SAFEARRAY **safearray) {
  /* Create a four-dimensional array of 10x3x6x7 variants filled with their
   * indices */
...
mono_test_marshal_safearray_in_byval_1dim_vt_i4(SAFEARRAY *safearray) {
  ...
  for (i = lbound; i <= ubound; i++) {
    if ((VariantChangeType(&pData[i], &pData[i], VARIANT_NOUSEROVERRIDE,
                           VT_I4) != S_OK) ||
        (pData[i].lVal != i + 1))
      result = 1;
  }
...
mono_test_marshal_safearray_in_byval_1dim_vt_mixed(SAFEARRAY *safearray) {
  /* Check that array is one dimensional containing integers mixed with strings
   * from 0 to 12 */
  ...
  /* Change the first element of the array to verify that [in] parameters are
   * not marshalled back to the managed side */
  ...
  for (i = lbound1; i <= ubound1; i++) {
    ...
    for (j = lbound2; j <= ubound2; j++) {
      ...
      if (SafeArrayGetElement(safearray, indices, &element) != S_OK)
        return 1;
      failed =
          ((element.vt != VT_I4) || (element.lVal != 10 * (i + 1) + (j + 1)));
      VariantClear(&element);
      if (failed)
        return 1;
    }
    ...
    for (j = lbound2; j <= ubound2; j++) {
      ...
      for (k = lbound3; k <= ubound3; k++) {
        ...
        failed = ((element.vt != VT_BSTR) ||
                  (VariantChangeType(&element, &element, VARIANT_NOUSEROVERRIDE,
                                     VT_I4) != S_OK) ||
...
mono_test_marshal_safearray_in_out_byref_1dim_empty(SAFEARRAY **safearray) {
  /* Check that the input array is what is expected and change it so the caller
   * can check */
  ...
  /* Re-dimension the array and return a one-dimensional array of 8 variants
   * filled with "0" to "7" */
  ...
  for (i = dimensions[0].lLbound;
       i < (dimensions[0].lLbound + dimensions[0].cElements); i++) {
    VARIANT vOut;
    VariantInit(&vOut);
    vOut.vt = VT_BSTR;
    _ltow(i, buffer, 10);
...
mono_test_marshal_safearray_in_out_byref_1dim_vt_i4(SAFEARRAY **safearray) {
  ...
  /* Change one of the elements of the array to verify that [out] parameter is
   * marshalled back to the managed side */
...
mono_test_marshal_safearray_in_out_byval_1dim_vt_i4(SAFEARRAY *safearray) {
  ...
  /* Change the array to verify how [out] parameter is marshalled back to the
   * managed side */
...
mono_test_marshal_safearray_in_out_byval_3dim_vt_bstr(SAFEARRAY *safearray) {
  ...
  /* Change the elements of the array to verify that [out] parameter is
   * marshalled back to the managed side */
...
LIBTEST_API int STDCALL mono_test_marshal_safearray_mixed(
    SAFEARRAY *safearray1, SAFEARRAY **safearray2, SAFEARRAY *safearray3,
  ...
  *safearray2 = NULL;
  ...
  /* array1: Check that in array is one dimensional and contains the expected
   * value */
  ...
  /* array3: Check that in array is one dimensional and contains the expected
   * value */
  if (hr == S_OK)
    hr = mono_test_marshal_safearray_in_byval_1dim_vt_mixed(safearray3);

  /* array4: Check input values and fill in with some values to check on the
   * managed side */
  if (hr == S_OK)
...
static void call_managed(gpointer arg) {
  SimpleDelegate del = (SimpleDelegate)arg;

  call_managed_res = del(42);
}

LIBTEST_API int STDCALL mono_test_marshal_thread_attach(SimpleDelegate del) {
#ifdef WIN32
  return 43;
#else
  int res;
...
static void call_managed_large_vt(gpointer arg) {
...
mono_test_marshal_thread_attach_large_vt(SimpleDelegate del) {
  ...
  res = pthread_create(&t, NULL, (gpointer(*)(gpointer))call_managed_large_vt,
                       (gpointer)del);
  g_assert(res == 0);
  pthread_join(t, NULL);
...
LIBTEST_API void STDCALL mono_test_marshal_set_callback(Callback cb) {
  callback = cb;
}

LIBTEST_API int STDCALL mono_test_marshal_call_callback(void) {
  return callback();
}

LIBTEST_API int STDCALL mono_test_marshal_lpstr(char *str) {
  return strcmp("ABC", str);
}

LIBTEST_API int STDCALL mono_test_marshal_lpwstr(gunichar2 *str) {
  char *s;
  int res;
...
LIBTEST_API char *STDCALL mono_test_marshal_return_lpstr(void) {
  char *res = (char *)marshal_alloc(4);
  strcpy(res, "XYZ");
  return res;
}

LIBTEST_API gunichar2 *STDCALL mono_test_marshal_return_lpwstr(void) {
...
LIBTEST_API int STDCALL mono_test_has_thiscall_globals(void) {
// Visual C++ does not accept __thiscall on global functions, only
// member function and function pointers. Gcc accepts it also on global
// functions.
...
LIBTEST_API int STDCALL mono_test_has_thiscall_pointers(void) {
...
LIBTEST_API ThiscallFunction STDCALL mono_test_get_native_thiscall2(void) {
  return _mono_test_native_thiscall2;
}

LIBTEST_API int STDCALL _mono_test_managed_thiscall1(int(__thiscall *fn)(int),
                                                     int arg) {
  return fn(arg);
}

LIBTEST_API int STDCALL _mono_test_managed_thiscall2(int(__thiscall *fn)(int,
                                                                         int),
                                                     int arg, int arg2) {
  return fn(arg, arg2);
}

LIBTEST_API int STDCALL _mono_test_managed_thiscall3(
    int(__thiscall *fn)(int, int, int), int arg, int arg2, int arg3) {
...
LIBTEST_API sbyte1 STDCALL mono_return_sbyte1(sbyte1 s1, int addend) {
  if (s1.f1 != 1) {
...
LIBTEST_API sbyte2 STDCALL mono_return_sbyte2(sbyte2 s2, int addend) {
  if (s2.f1 != 1) {
...
LIBTEST_API sbyte3 STDCALL mono_return_sbyte3(sbyte3 s3, int addend) {
  if (s3.f1 != 1) {
...
LIBTEST_API sbyte4 STDCALL mono_return_sbyte4(sbyte4 s4, int addend) {
  if (s4.f1 != 1) {
...
LIBTEST_API sbyte5 STDCALL mono_return_sbyte5(sbyte5 s5, int addend) {
  if (s5.f1 != 1) {
...
LIBTEST_API sbyte6 STDCALL mono_return_sbyte6(sbyte6 s6, int addend) {
  if (s6.f1 != 1) {
...
LIBTEST_API sbyte7 STDCALL mono_return_sbyte7(sbyte7 s7, int addend) {
  if (s7.f1 != 1) {
...
LIBTEST_API sbyte8 STDCALL mono_return_sbyte8(sbyte8 s8, int addend) {
  if (s8.f1 != 1) {
...
LIBTEST_API sbyte9 STDCALL mono_return_sbyte9(sbyte9 s9, int addend) {
  if (s9.f1 != 1) {
...
LIBTEST_API sbyte10 STDCALL mono_return_sbyte10(sbyte10 s10, int addend) {
  if (s10.f1 != 1) {
...
LIBTEST_API sbyte11 STDCALL mono_return_sbyte11(sbyte11 s11, int addend) {
  if (s11.f1 != 1) {
...
LIBTEST_API sbyte12 STDCALL mono_return_sbyte12(sbyte12 s12, int addend) {
  if (s12.f1 != 1) {
...
LIBTEST_API sbyte13 STDCALL mono_return_sbyte13(sbyte13 s13, int addend) {
  if (s13.f1 != 1) {
...
LIBTEST_API sbyte14 STDCALL mono_return_sbyte14(sbyte14 s14, int addend) {
  if (s14.f1 != 1) {
...
LIBTEST_API sbyte15 STDCALL mono_return_sbyte15(sbyte15 s15, int addend) {
  if (s15.f1 != 1) {
...
LIBTEST_API sbyte16 STDCALL mono_return_sbyte16(sbyte16 s16, int addend) {
  if (s16.f1 != 1) {
...
LIBTEST_API sbyte17 STDCALL mono_return_sbyte17(sbyte17 s17, int addend) {
  if (s17.f1 != 1) {
...
LIBTEST_API short1 STDCALL mono_return_short1(short1 s1, int addend) {
  if (s1.f1 != 1) {
...
LIBTEST_API short2 STDCALL mono_return_short2(short2 s2, int addend) {
  if (s2.f1 != 1) {
...
LIBTEST_API short3 STDCALL mono_return_short3(short3 s3, int addend) {
  if (s3.f1 != 1) {
...
LIBTEST_API short4 STDCALL mono_return_short4(short4 s4, int addend) {
  if (s4.f1 != 1) {
...
LIBTEST_API short5 STDCALL mono_return_short5(short5 s5, int addend) {
  if (s5.f1 != 1) {
...
LIBTEST_API short6 STDCALL mono_return_short6(short6 s6, int addend) {
  if (s6.f1 != 1) {
...
LIBTEST_API short7 STDCALL mono_return_short7(short7 s7, int addend) {
  if (s7.f1 != 1) {
...
LIBTEST_API short8 STDCALL mono_return_short8(short8 s8, int addend) {
  if (s8.f1 != 1) {
...
LIBTEST_API short9 STDCALL mono_return_short9(short9 s9, int addend) {
  if (s9.f1 != 1) {
...
LIBTEST_API short8_nested STDCALL mono_return_short8_nested(short8_nested sn8,
                                                            int addend) {
  if (sn8.nested1.f1 != 1) {
    fprintf(
        stderr,
...
LIBTEST_API int1 STDCALL mono_return_int1(int1 s1, int addend) {
  if (s1.f1 != 1) {
...
LIBTEST_API int2 STDCALL mono_return_int2(int2 s2, int addend) {
  if (s2.f1 != 1) {
...
LIBTEST_API int3 STDCALL mono_return_int3(int3 s3, int addend) {
  if (s3.f1 != 1) {
...
LIBTEST_API int4 STDCALL mono_return_int4(int4 s4, int addend) {
  if (s4.f1 != 1) {
...
LIBTEST_API int5 STDCALL mono_return_int5(int5 s5, int addend) {
  if (s5.f1 != 1) {
...
LIBTEST_API int4_nested STDCALL mono_return_int4_nested(int4_nested sn4,
                                                        int addend) {
  if (sn4.nested1.f1 != 1) {
    fprintf(stderr,
  ...
  sn4.nested1.f1 += addend;
  sn4.f2 += addend;
  sn4.f3 += addend;
  sn4.nested2.f4 += addend;
  return sn4;
}
...
LIBTEST_API float1 STDCALL mono_return_float1(float1 s1, int addend) {
  if (s1.f1 != 1) {
...
LIBTEST_API float2 STDCALL mono_return_float2(float2 s2, int addend) {
  if (s2.f1 != 1) {
...
LIBTEST_API float3 STDCALL mono_return_float3(float3 s3, int addend) {
  if (s3.f1 != 1) {
...
LIBTEST_API float4 STDCALL mono_return_float4(float4 s4, int addend) {
  if (s4.f1 != 1) {
...
LIBTEST_API float5 STDCALL mono_return_float5(float5 s5, int addend) {
  if (s5.f1 != 1) {
...
LIBTEST_API float6 STDCALL mono_return_float6(float6 s6, int addend) {
  if (s6.f1 != 1) {
...
LIBTEST_API float7 STDCALL mono_return_float7(float7 s7, int addend) {
  if (s7.f1 != 1) {
...
LIBTEST_API float8 STDCALL mono_return_float8(float8 s8, int addend) {
  if (s8.f1 != 1) {
...
LIBTEST_API float9 STDCALL mono_return_float9(float9 s9, int addend) {
  if (s9.f1 != 1) {
...
LIBTEST_API float4_nested STDCALL mono_return_float4_nested(float4_nested sn4,
                                                            int addend) {
  if (sn4.nested1.f1 != 1) {
    fprintf(
        stderr,
...
LIBTEST_API double1 STDCALL mono_return_double1(double1 s1, int addend) {
  if (s1.f1 != 1) {
...
LIBTEST_API double2 STDCALL mono_return_double2(double2 s2, int addend) {
  if (s2.f1 != 1) {
...
LIBTEST_API double3 STDCALL mono_return_double3(double3 s3, int addend) {
  if (s3.f1 != 1) {
...
LIBTEST_API double4 STDCALL mono_return_double4(double4 s4, int addend) {
  if (s4.f1 != 1) {
...
LIBTEST_API double5 STDCALL mono_return_double5(double5 s5, int addend) {
  if (s5.f1 != 1) {
...
LIBTEST_API double6 STDCALL mono_return_double6(double6 s6, int addend) {
  if (s6.f1 != 1) {
...
LIBTEST_API double7 STDCALL mono_return_double7(double7 s7, int addend) {
  if (s7.f1 != 1) {
...
LIBTEST_API double8 STDCALL mono_return_double8(double8 s8, int addend) {
  if (s8.f1 != 1) {
...
LIBTEST_API double9 STDCALL mono_return_double9(double9 s9, int addend) {
  if (s9.f1 != 1) {
...
mono_return_double2_nested(double2_nested sn2, int addend) {
  ...
  sn2.nested1.f1 += addend;
  sn2.nested2.f2 += addend;
  return sn2;
}
...
LIBTEST_API double_array4 STDCALL mono_return_double_array4(double_array4 sa4,
                                                            int addend) {
  if (sa4.f1[0] != 1) {
    fprintf(stderr,
...
LIBTEST_API int STDCALL mono_test_marshal_fixed_array(FixedArrayStruct s) {
...
mono_test_marshal_fixed_buffer_char(FixedBufferChar *s) {
  if (!(s->array[0] == 'A' && s->array[1] == 'B' && s->array[2] == 'C' &&
        s->c == 'D'))
    return 1;
  s->array[0] = 'E';
  s->array[1] = 'F';
...
const char *utf8Strings[] = {
    ...
    "我能吞下玻璃而不伤身体",
    "ღმერთსი შემვედრე,შემვედრე, ნუთუ კვლა დამხსნას შემვედრე,სოფლისა შემვედრე, "
    "შემვედრე,შემვედრე,შემვედრე,შრომასა, ცეცხლს, წყალსა და მიწასა, ჰაერთა თანა "
    "მრომასა; მომცნეს ფრთენი და აღვფრინდე, მივჰხვდე მას ჩემსა ნდომასა, დღისით "
    "და ღამით ვჰხედვიდე მზისა ელვათა კრთომაასაშემვედრე,შემვედრე,",
    "Τη γλώσσα μου έδωσαν ελληνική",
    "\0"};

LIBTEST_API char *build_return_string(const char *pReturn) {
  char *ret = 0;
...
LIBTEST_API char *StringParameterInOut(/*[In,Out]*/ char *s, int index) {
  // return a copy
  return build_return_string(s);
}

LIBTEST_API void StringParameterRefOut(/*out*/ char **s, int index) {
...
LIBTEST_API void StringParameterRef(/*ref*/ char **s, int index) {
  char *pszTextutf8 = (char *)utf8Strings[index];
  size_t strLength = strlen(pszTextutf8);
...
LIBTEST_API void StringBuilderParameterInOut(/*[In,Out] StringBuilder*/ char *s,
                                             int index) {
  // if string.empty
  if (s == 0 || *s == 0)
    return;
...
// out string builder
LIBTEST_API void StringBuilderParameterOut(/*[Out] StringBuilder*/ char *s,
                                           int index) {
  char *pszTextutf8 = (char *)utf8Strings[index];
...
LIBTEST_API char *StringParameterOut(/*[Out]*/ char *s, int index) {
  // return a copy
  return build_return_string(s);
}
...
// utf8 struct field
LIBTEST_API void TestStructWithUtf8Field(struct FieldWithUtf8 fieldStruct) {
...
LIBTEST_API void Utf8DelegateAsParameter(Callback2 managedCallback) {
...
LIBTEST_API char *StringBuilderParameterReturn(int index) {
  char *pszTextutf8 = (char *)utf8Strings[index];
  size_t strLength = strlen(pszTextutf8);
...
LIBTEST_API int STDCALL mono_test_marshal_pointer_array(int *arr[]) {
  int i;
...
void *mono_test_native_to_managed_exception_rethrow_thread(void *arg) {
  NativeToManagedExceptionRethrowFunc func =
      (NativeToManagedExceptionRethrowFunc)arg;
  func();
  return NULL;
}

LIBTEST_API void STDCALL mono_test_native_to_managed_exception_rethrow(
    NativeToManagedExceptionRethrowFunc func) {
  pthread_t t;
  pthread_create(&t, NULL, mono_test_native_to_managed_exception_rethrow_thread,
                 (gpointer)func);
  pthread_join(t, NULL);
}
#endif
...
static void (*sym_mono_threads_exit_gc_safe_region_unbalanced)(gpointer,
                                                               gpointer *);
static void (*null_function_ptr)(void);

static void mono_test_init_symbols(void) {
  if (sym_inited)
    return;

  sym_mono_install_ftnptr_eh_callback = (void (*)(MonoFtnPtrEHCallback))(
      lookup_mono_symbol("mono_install_ftnptr_eh_callback"));

  sym_mono_gchandle_get_target = (MonoObject * (*)(guint32 gchandle))(
      lookup_mono_symbol("mono_gchandle_get_target"));

  sym_mono_gchandle_new = (guint32(*)(MonoObject *, mono_bool))(
      lookup_mono_symbol("mono_gchandle_new"));

  sym_mono_gchandle_free =
      (void (*)(guint32 gchandle))(lookup_mono_symbol("mono_gchandle_free"));

  sym_mono_raise_exception =
      (void (*)(MonoException *))(lookup_mono_symbol("mono_raise_exception"));

  sym_mono_domain_unload =
      (void (*)(gpointer))(lookup_mono_symbol("mono_domain_unload"));

  sym_mono_threads_exit_gc_safe_region_unbalanced =
...
static void mono_test_longjmp_callback(guint32 gchandle) {
  test_gchandle = gchandle;
  longjmp(test_jmp_buf, 1);
}

LIBTEST_API void STDCALL mono_test_setjmp_and_call(
    VoidVoidCallback managedCallback, intptr_t *out_handle) {
...
LIBTEST_API void STDCALL mono_test_marshal_bstr(void *ptr) {}

static void (*mono_test_capture_throw_callback)(guint32 gchandle,
                                                guint32 *exception_out);

static void mono_test_ftnptr_eh_callback(guint32 gchandle) {
...
LIBTEST_API void STDCALL mono_test_setup_ftnptr_eh_callback(
    VoidVoidCallback managed_entry,
    void (*capture_throw_callback)(guint32, guint32 *)) {
  mono_test_init_symbols();
...
LIBTEST_API void STDCALL mono_test_cleanup_ftptr_eh_callback(void) {
  mono_test_init_symbols();
  sym_mono_install_ftnptr_eh_callback(NULL);
}
...
static void *ccw_qi_foreign_thread(void *arg) {
...
#else
  pthread_t t;
  ccw_qi_shared_data *shared =
      (ccw_qi_shared_data *)malloc(sizeof(ccw_qi_shared_data));
  if (!shared)
    abort();
  shared->pUnk = pUnk;
  shared->i = 1;
...
static void *ccw_itest_foreign_thread(void *arg) {
  ccw_qi_shared_data *shared = (ccw_qi_shared_data *)arg;
  MonoComObject *pUnk = shared->pUnk;
...
LIBTEST_API void STDCALL mono_test_MerpCrashSnprintf(void) {
  ...
  g_snprintf((char *)GINT_TO_POINTER(-1), sizeof(buff) * 10,
             "THISSHOULDOVERRUNTERRIBLY%s", overflow);
}

LIBTEST_API void STDCALL mono_test_MerpCrashDladdr(void) {
#ifndef HOST_WIN32
  dlopen(GINT_TO_POINTER(-1), -1);
#endif
}

LIBTEST_API void STDCALL mono_test_MerpCrashMalloc(void) {
...
LIBTEST_API void STDCALL mono_test_MerpCrashNullFp(void) {
  null_function_ptr();
}

LIBTEST_API void STDCALL mono_test_MerpCrashDomainUnload(void) {
  mono_test_init_symbols();
  sym_mono_domain_unload(GINT_TO_POINTER(-1));
}

LIBTEST_API void STDCALL mono_test_MerpCrashUnbalancedGCSafe(void) {
  mono_test_init_symbols();
...
LIBTEST_API void STDCALL mono_test_MerpCrashUnhandledExceptionHook(void) {
  g_assert_not_reached();
}

LIBTEST_API void STDCALL mono_test_MerpCrashSignalTerm(void) { raise(SIGTERM); }

// for the rest of the signal tests, we use SIGTERM as a fallback

LIBTEST_API void STDCALL mono_test_MerpCrashSignalAbrt(void) {
#if defined(SIGABRT)
  raise(SIGABRT);
#else
  raise(SIGTERM);
...
LIBTEST_API void STDCALL mono_test_MerpCrashSignalFpe(void) {
#if defined(SIGFPE)
  raise(SIGFPE);
#else
  raise(SIGTERM);
...
LIBTEST_API void STDCALL mono_test_MerpCrashSignalBus(void) {
#if defined(SIGBUS)
  raise(SIGBUS);
#else
  raise(SIGTERM);
...
LIBTEST_API void STDCALL mono_test_MerpCrashSignalSegv(void) {
#if defined(SIGSEGV)
  raise(SIGSEGV);
#else
  raise(SIGTERM);
...
LIBTEST_API void STDCALL mono_test_MerpCrashSignalIll(void) {
#if defined(SIGILL)
  raise(SIGILL);
#else
  raise(SIGTERM);
