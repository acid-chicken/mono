...
public unsafe class Tests {
  ...
  public int delegate_test_instance(int a) { return int_field + a; }
  ...
  public struct TinyStruct {
    public TinyStruct(int i) { this.i = i; }
    public int i;
  }
  ...
  [StructLayout(LayoutKind.Sequential)] struct AsAnyStruct {
    public int i;
    public int j;
    public int k;
    public String s;
  ...
  public static extern int
  mono_test_marshal_char_2(char a1);

  [DllImport("test", EntryPoint = "mono_test_marshal_char")]
  public static extern int
  mono_test_marshal_char_3(char a1);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_char")]
  public static extern int
  mono_test_marshal_char(char a1);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_char_array",
             CharSet = CharSet.Unicode)]
  public static extern int
  mono_test_marshal_char_array(char[] a1);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_byref")]
  public static extern int
  mono_test_marshal_bool_byref(int a, ref bool b, int c);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_in_as_I1_U1")]
  public static extern int
  mono_test_marshal_bool_in_as_I1([ MarshalAs(UnmanagedType.I1) ] bool bTrue,
                                  [ MarshalAs(UnmanagedType.I1) ] bool bFalse);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_in_as_I1_U1")]
  public static extern int
  mono_test_marshal_bool_in_as_U1([ MarshalAs(UnmanagedType.U1) ] bool bTrue,
  ...
  [DllImport("libtest", EntryPoint = "mono_test_marshal_unicode_string_array",
             CharSet = CharSet.Unicode)]
  ...
  public static extern int
      mono_test_marshal_stringbuilder_array(StringBuilder[] a1);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_inout_array")]
  public static extern int
  mono_test_marshal_inout_array([ In, Out ] int[] a1);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_out_array")]
  public static extern int
  mono_test_marshal_out_array(
      [ Out ]
      [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] int[] a1,
      int n);

  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_out_byref_array_out_size_param")]
  public static extern int
  mono_test_marshal_out_byref_array_out_size_param(
      [ Out ]
      [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] out int[] a1,
      out int n);

  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_out_lparray_out_size_param")]
  public static extern int
  ...
  [DllImport("libtest",
             ...
             CharSet = CharSet.Unicode)]
  public static extern int
  mono_test_marshal_inout_nonblittable_array([ In, Out ] char[] a1);
  ...
  [DllImport("libtest", EntryPoint = "mono_test_marshal_struct")]
  public static extern int
  mono_test_marshal_struct_gen(SimpleStructGen<string>ss);
  ...
  public static extern int
  mono_test_marshal_byref_struct(ref SimpleStruct ss, bool a, bool b, bool c,
                                 String d);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_byref_struct")]
  public static extern int
  mono_test_marshal_byref_struct_in([ In ] ref SimpleStruct ss, bool a, bool b,
                                    bool c, String d);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_byref_struct")]
  public static extern int
  mono_test_marshal_byref_struct_inout([ In, Out ] ref SimpleStruct ss, bool a,
                                       bool b, bool c, String d);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_point")]
  public static extern int
  mono_test_marshal_point(Point p);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_mixed_point")]
  public static extern int
  mono_test_marshal_mixed_point(MixedPoint p);
  ...
  public static extern EmptyStruct
  mono_test_return_empty_struct(int a);

  [DllImport("libtest", EntryPoint = "mono_test_return_empty_struct")]
  public static extern EmptyStructCpp
  ...
  public static extern int
      mono_test_marshal_long_align_struct_array(LongAlignStruct[] ss);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_class")]
  public static extern SimpleClass
  mono_test_marshal_class(int i, int j, int k, SimpleClass ss, int l);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_byref_class")]
  public static extern int
  mono_test_marshal_byref_class(ref SimpleClass ss);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_delegate")]
  public static extern int
  mono_test_marshal_delegate(SimpleDelegate d);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_delegate_struct")]
  public static extern DelegateStruct
  mono_test_marshal_delegate_struct(DelegateStruct d);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_return_delegate")]
  public static extern SimpleDelegate
  mono_test_marshal_return_delegate(SimpleDelegate d);

  [DllImport("libtest", EntryPoint = "mono_test_return_vtype")]
  public static extern SimpleStruct
  mono_test_return_vtype(IntPtr i);

  [DllImport("libtest", EntryPoint = "mono_test_return_vtype")]
  public static extern SimpleStructGen<string>
  mono_test_return_vtype_gen(IntPtr i);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder")]
  public static extern void
  mono_test_marshal_stringbuilder(StringBuilder sb, int len);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder_default")]
  public static extern void
  mono_test_marshal_stringbuilder_default(StringBuilder sb, int len);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder_append")]
  public static extern void
  mono_test_marshal_stringbuilder_append(StringBuilder sb, int len);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder_unicode",
             CharSet = CharSet.Unicode)]
  public static extern void
  mono_test_marshal_stringbuilder_unicode(StringBuilder sb, int len);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder_out")]
  public static extern void
  mono_test_marshal_stringbuilder_out(out StringBuilder sb);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_stringbuilder_ref")]
  public static extern int
  mono_test_marshal_stringbuilder_ref(ref StringBuilder sb);

  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_stringbuilder_out_unicode",
             CharSet = CharSet.Unicode)]
  public static extern void
  mono_test_marshal_stringbuilder_out_unicode(out StringBuilder sb);

  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_stringbuilder_utf16_tolower",
             CharSet = CharSet.Unicode)]
  public static extern void
  mono_test_marshal_stringbuilder_utf16_tolower(StringBuilder sb, int len);

  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_stringbuilder_utf16_tolower",
             CharSet = CharSet.Unicode)]
  public static extern void
  mono_test_marshal_stringbuilder_utf16_tolower_in([ In ] StringBuilder sb,
                                                   int len);

  [DllImport("libtest", EntryPoint = "mono_test_asany")]
  public static extern int
  mono_test_asany([ MarshalAs(UnmanagedType.AsAny) ] object o, int what);

  [DllImport("libtest", EntryPoint = "mono_test_asany",
             CharSet = CharSet.Unicode)]
  public static extern int
  mono_test_asany_unicode([ MarshalAs(UnmanagedType.AsAny) ] object o,
                          int what);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_asany_in")]
  static extern void
  mono_test_asany_in([ MarshalAs(UnmanagedType.AsAny) ]
                     [In] object obj);

  [DllImport("libtest", EntryPoint = "mono_test_marshal_asany_out")]
  static extern void
  mono_test_asany_out([ MarshalAs(UnmanagedType.AsAny) ]
                      [Out] object obj);
  [DllImport("libtest", EntryPoint = "mono_test_marshal_asany_inout")]
  static extern void
  mono_test_asany_inout([ MarshalAs(UnmanagedType.AsAny) ]
                        [In, Out] object obj);

  [DllImport("libtest")]
  static extern int
  class_marshal_test0(SimpleObj obj);

  [DllImport("libtest")]
  static extern void
  class_marshal_test1(out SimpleObj obj);

  [DllImport("libtest")]
  static extern int
  class_marshal_test4(SimpleObj obj);

  [DllImport("libtest")]
  static extern int
  string_marshal_test0(string str);

  [DllImport("libtest")]
  static extern void
  string_marshal_test1(out string str);

  [DllImport("libtest")]
  static extern int
  string_marshal_test2(ref string str);

  [DllImport("libtest")]
  static extern int
  string_marshal_test3(string str);
  ...
  */
  ...
  public static int test_0_marshal_class() {
    ...
    if (res == null)
      return 1;
    if (!(res.a == ss.a && res.b == ss.b && res.c == ss.c && res.d == ss.d &&
          res.e == ss.e && res.f == ss.f && res.g == ss.g && res.h == ss.h))
      return 2;
  ...
  public static extern int
  mono_test_marshal_out_delegate(out SimpleDelegate d);
  ...
  public static int test_0_marshal_byref_struct_in() {
    ...
    int res =
        mono_test_marshal_byref_struct_in(ref s, true, false, true, "ABC");
    if (res != 0)
      return 1;
  ...
  public static int test_0_marshal_byref_struct_inout() {
    ...
    int res =
        mono_test_marshal_byref_struct_inout(ref s, true, false, true, "ABC");
    if (res != 0)
      return 1;
    if (s.a != false || s.b != true || s.c != false || s.d != "DEF")
      return 2;
  ...
  public static int test_0_marshal_stringbuilder_array() {
    ...
    int res =
        mono_test_marshal_stringbuilder_array(new StringBuilder[]{sb1, sb2});
    if (res != 0)
      return res;
    if (sb1.ToString() != "DEF")
      return 5;
  ...
  public static extern int
  mono_test_marshal_byref_string_array(ref string[] data);
  ...
  public static extern Amd64Struct1
  ...
  public static extern Amd64Struct1
  mono_test_marshal_amd64_pass_return_struct1_many_args(Amd64Struct1 s, int i1,
  ...
  public static int test_0_amd64_struct1() {
    ...
    return ((s2.i == 6) && (s2.j == -4) && (s2.k == 0x1000000) &&
            (s2.l == 0x10000000))
               ? 0
               : 1;
  }
  ...
  public static extern Amd64Struct2
  ...
  public static extern Amd64Struct3
  ...
  public static extern Amd64Struct4
  ...
  mono_test_marshal_ia64_pass_return_struct5(double d1, double d2,
                                             TestStruct5 s, int i, double f3,
                                             double f4);
  ...
  public static int test_0_ia64_struct5() {
    ...
    TestStruct5 s2 =
        mono_test_marshal_ia64_pass_return_struct5(1.0, 2.0, s, 5, 3.0, 4.0);
  ...
  public static extern TestStruct6
  mono_test_marshal_ia64_pass_return_struct6(double d1, double d2,
                                             TestStruct6 s, int i, double f3,
                                             double f4);
  ...
  public static int test_0_ia64_struct6() {
    ...
    TestStruct6 s2 =
        mono_test_marshal_ia64_pass_return_struct6(1.0, 2.0, s, 3, 4.0, 5.0);
  ...
  /* Blittable class */
  [DllImport("libtest")]
  private static extern BlittableClass
  ...
  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_amd64_pass_return_struct1")]
  public static extern Amd64Struct1Gen<int>
  mono_test_marshal_amd64_pass_return_struct1_gen(Amd64Struct1Gen<int>s);
...
#if FALSE
  [DllImport("libtest", EntryPoint = "mono_test_stdcall_mismatch_1",
  ...
  [DllImport("libtest", EntryPoint = "mono_test_stdcall_mismatch_2",
  ...
  [DllImport("libtest", EntryPoint = "mono_test_stdcall_name_mangling",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  ...
  [DllImport ("libtest", EntryPoint="mono_test_marshal_struct")]
  public static unsafe extern int mono_test_marshal_ptr_to_struct (CharInfo
  *ptr);
  ...
  */
  ...
  mono_test_marshal_lpwstr_marshal([ MarshalAs(UnmanagedType.LPWStr) ] string s,
                                   int length);

  [DllImport("libtest", EntryPoint = "test_lpwstr_marshal",
             CharSet = CharSet.Unicode)]
  private static extern string
  mono_test_marshal_lpwstr_marshal2(string s, int length);
  ...
  [DllImport("libtest", EntryPoint = "test_lpwstr_marshal_out",
             CharSet = CharSet.Unicode)]
  private static extern void
  mono_test_marshal_lpwstr_out_marshal2(out string s);
  ...
  [DllImport("libtest")] extern static int
  marshal_test_ref_bool(int i, [ MarshalAs(UnmanagedType.I1) ] ref bool b1,
  ...
  [DllImport("libtest")] extern static int
  marshal_test_bool_struct(ref BoolStruct s);
  ...
  [DllImport("libtest")] extern static int
  mono_test_marshal_long_struct(ref LongStruct s);
  ...
  public class T {
    ...
    public virtual object MyClone() { return null; }
  }

  public class T2 : T {
    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    public override extern object
    MyClone();
  }
  ...
  [DllImport("libtest", EntryPoint = "mono_test_marshal_class")]
  public static extern SimpleClass
  mono_test_marshal_object(int i, int j, int k, object ss, int l);
  ...
  mono_test_marshal_date_time(DateTime d, out DateTime d2);
  ...
  public static int test_0_calli_dynamic() {
    /* we need the cdecl version because the icall convention demands it under
     * Windows */
    IntPtr func =
        mono_test_marshal_lookup_symbol("mono_test_marshal_inout_array_cdecl");

    DynamicMethod dm = new DynamicMethod(
        "calli", typeof (void), new Type[]{typeof (IntPtr), typeof (int[])});

    var il = dm.GetILGenerator();
    var signature = SignatureHelper.GetMethodSigHelper(CallingConvention.Cdecl,
                                                       typeof (void));
  ...
  [DllImport("libtest", EntryPoint = "mono_test_marshal_ansi_char_array",
             CharSet = CharSet.Ansi)]
  public static extern int
  mono_test_marshal_ansi_char_array(char[] a1);
  ...
  /*char array marshaling */
  [DllImport("libtest", EntryPoint = "mono_test_marshal_unicode_char_array",
             CharSet = CharSet.Unicode)]
  public static extern int
  mono_test_marshal_unicode_char_array(char[] a1);
  ...
  public static extern int
  mono_test_marshal_lpstr([ MarshalAs(UnmanagedType.LPStr) ] string str);
  ...
  public static extern int
  mono_test_marshal_lpwstr([ MarshalAs(UnmanagedType.LPWStr) ] string str);
  ...
  [method : DllImport("libtest",
                      EntryPoint = "mono_test_marshal_return_lpwstr")]
  [return : MarshalAs(UnmanagedType.LPWStr)]
  public static extern string
  ...
  public static extern int
  mono_test_has_thiscall_globals();

  [DllImport("libtest", EntryPoint = "mono_test_has_thiscall_pointers")]
  public static extern int
  mono_test_has_thiscall_pointers();

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall1",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(int a);

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall2",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(int a, int b);

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall3",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(int a, int b, int c);

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall1",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(TinyStruct a);

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall2",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(TinyStruct a, int b);

  [DllImport("libtest", EntryPoint = "_mono_test_native_thiscall3",
             CallingConvention = CallingConvention.ThisCall)]
  public static extern int
  mono_test_native_thiscall(TinyStruct a, int b, int c);
  ...
  public static int test_0_native_thiscall() {
    ...
    if (mono_test_native_thiscall(1288082683, -421187449, -1733670329) !=
        -866775098)
      return 3;
    ...
    if (mono_test_native_thiscall(new TinyStruct(268894549), 1212675791) !=
        1481570339)
      return 5;

    if (mono_test_native_thiscall(new TinyStruct(1288082683), -421187449,
                                  -1733670329) != -866775098)
      return 6;
  ...
  [DllImport("libtest",
             EntryPoint = "mono_test_marshal_return_single_double_struct")]
  public static extern SingleDoubleStruct
  ...
  public delegate int
  ThisCallDelegate1(int a);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall1",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegate1 fn, int a);

  [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
  public delegate int
  ThisCallDelegate2(int a, int b);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall2",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegate2 fn, int a, int b);

  [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
  public delegate int
  ThisCallDelegate3(int a, int b, int c);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall3",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegate3 fn, int a, int b, int c);

  [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
  public delegate int
  ThisCallDelegateS1(TinyStruct a);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall1",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegateS1 fn, int a);

  [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
  public delegate int
  ThisCallDelegateS2(TinyStruct a, int b);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall2",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegateS2 fn, int a, int b);

  [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
  public delegate int
  ThisCallDelegateS3(TinyStruct a, int b, int c);

  [DllImport("libtest", EntryPoint = "_mono_test_managed_thiscall3",
             CallingConvention = CallingConvention.StdCall)]
  public static extern int
  mono_test_managed_thiscall(ThisCallDelegateS3 fn, int a, int b, int c);
  ...
  public static int test_0_managed_thiscall() {
    ...
    if (mono_test_managed_thiscall(new ThisCallDelegate1(thiscall_test_fn1),
                                   517457506) != 263895844)
      return 1;

    if (mono_test_managed_thiscall(new ThisCallDelegate2(thiscall_test_fn2),
                                   562348159, -1982007353) != -1877791296)
      return 2;

    if (mono_test_managed_thiscall(new ThisCallDelegate3(thiscall_test_fn3),
                                   -316986071, 1233912683,
                                   1244266772) != 1545254036)
      return 3;

    if (mono_test_managed_thiscall(new ThisCallDelegateS1(thiscall_test_fn1),
                                   517457506) != 263895844)
      return 4;

    if (mono_test_managed_thiscall(new ThisCallDelegateS2(thiscall_test_fn2),
                                   562348159, -1982007353) != -1877791296)
      return 5;

    if (mono_test_managed_thiscall(new ThisCallDelegateS3(thiscall_test_fn3),
                                   -316986071, 1233912683,
                                   1244266772) != 1545254036)
      return 6;
  ...
  public static unsafe int test_0_pointer_array() {
    ...
    for (int i = 0; i < arr2.Length; i++) {
      ...
      fixed(int *ptr = &arr[i]) { arr2[i] = ptr; }
    }
  ...
  public static extern int
  mono_test_marshal_fixed_buffer_char(ref FixedBufferChar s);
  ...
  public static extern int
  mono_test_marshal_fixed_buffer_unicode(ref FixedBufferUnicode s);
  ...
  public static extern int
  mono_test_marshal_bstr([ In ] ref BStrStruct p);
