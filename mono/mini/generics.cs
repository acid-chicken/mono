...
#endif
{
  ...
  class Enumerator<T>: MyIEnumerator<T> {
    ...
    bool MyIEnumerator<T>.MoveNext() { return true; }
  }

  class Comparer<T>: IComparer<T> {
    bool IComparer<T>.Compare(T x, T y) { return true; }
  }
#endif
  ...
  public static int test_1_nullable_box() { return (int) Box < int ? > (1); }
  ...
  public static void stelem_any<T>(T[] arr, T elem) { arr[0] = elem; }

  public static T ldelem_any<T>(T[] arr) { return arr[0]; }
  ...
  public static T return_ref<T>(ref T t) { return t; }

  public static T ldelema_any<T>(T[] arr) { return return_ref<T>(ref arr[0]); }
  ...
  public static T[, ] newarr_multi<T>() { return new T[1, 1]; }
  ...
  [Category("!FULLAOT")]
  public static int
  test_0_generic_get_value_optimization_int() {
  ...
  struct ImplementGenericInterface<T>: GenericInterface<T> {
    ...
    public T not_used() { return arr_t[0]; }

    public int return_field() { return arr_t.Length; }
  }
  ...
  public static int test_0_generic_get_value_optimization_vtype() {
    TestStruct[] arr =
        new TestStruct[]{new TestStruct(100, 200), new TestStruct(300, 400)};
  ...
  public struct GenericStruct<T> {
    ...
    public GenericStruct(T t) { this.t = t; }
  }
  ...
  public class GenericClass<T> {
    ...
    public String toString(T t) { return t.ToString(); }

    public static IEnumerator<T>Y(IEnumerable<T>x) { return x.GetEnumerator(); }
  ...
  [Category("!FULLAOT")]
  public static int
  test_0_generic_virtual_call_on_vtype_unbox() {
    object o = new Object();
  ...
  public static int test_0_variance_reflection() {
    ...
    if (!typeof (MyIEnumerator<object>)
             .IsAssignableFrom(typeof (MyIEnumerator<string>)))
      return 1;
    ...
    if (!typeof (MyIEnumerator<object>)
             .IsAssignableFrom(typeof (Enumerator<string>)))
      return 3;

    // contravariance on IComparer
    if (!typeof (IComparer<string>)
             .IsAssignableFrom(typeof (IComparer<object>)))
      return 4;
    ...
    if (!typeof (IComparer<string>[])
             .IsAssignableFrom(typeof (IKeyComparer<object>[])))
      return 6;
    return 0;
  }
#endif
  ...
  [Category("!FULLAOT")]
  public static int
  test_0_generic_virtual_on_interfaces() {
    Foo<string>.count1 = 0;
    Foo<string>.count2 = 0;
    Foo<string>.count3 = 0;
  ...
  enum MyEnumUlong : ulong { Value_2 = 2 }
  ...
  static bool Pan<T>(T a, T b) { return a.Equals(b); }
  ...
  class ServiceController<T> {
    static ServiceController() { cctor_count2++; }

    public ServiceController() {}
  }

  static ServiceController<T>Create<T>() { return new ServiceController<T>(); }
  ...
  public static Type get_type<T>() { return typeof (T); }
  ...
  public static int test_0_marshalbyref_call_from_gshared_virt_elim() {
    /* Calling a virtual method from gshared code which is changed to a nonvirt
     * call */
  ...
  public static int test_0_infinite_generic_recursion() {
    // Check that the AOT compile can deal with infinite generic recursion
  ...
  public class Class1<T> {
    ...
    public virtual object Foo<U>(T t) { return new Class1<U>(); }
  }

  public interface IFace1<T> { void Foo(); }
  ...
  public class Foo<T1>: IFoo {
    ...
    public T1 get_default() { return default(T1); }
    ...
    public void fire() { GenericEvent(this); }

    public static int count1, count2, count3, count4;

    public void NonGeneric() { count3++; }
  ...
  struct Handler : IFoo {
    ...
    public Handler(object o) { this.o = o; }

    public void NonGeneric() {}

    public object Bar<T>() { return o; }
  }
  ...
  static object Box<T>(T t) { return t; }

  static T Unbox<T>(object o) { return (T) o; }
  ...
  class DefaultRetriever
      : IDefaultRetriever{[MethodImpl(MethodImplOptions.Synchronized)]
...
[Category("!BITCODE")]
public static int
test_0_regress_668095_synchronized_gshared() {
...
class SyncClass<T>{[MethodImpl(MethodImplOptions.Synchronized)]
                   public Type getInstance(){return typeof(T);
}
}

[Category("GSHAREDVT")]
static int
test_0_synchronized_gshared() {
...
test_0_fullaot_sflda_cctor() {
  ...
  foreach(DocType cat in categories) {
    List<Doc>catDocs =
        documents.Where(d => d.Type == cat).OrderBy(d => d.Name).ToList<Doc>();
  }
  return 0;
}
...
struct Record : Foo2<Record>.IRecord {
  int counter;
  int Foo2<Record>.IRecord.DoSomething() { return counter++; }
}

class Foo2<T>where T : Foo2<T>.IRecord {
  public interface IRecord { int DoSomething(); }

  public static int Extract(T[] t) { return t[0].DoSomething(); }
}
...
public interface IFoo2 { void MoveNext(); }

public struct Foo2 : IFoo2 {
  public void MoveNext() {}
}

public static Action Dingus(ref Foo2 f) { return new Action(f.MoveNext); }
...
// FIXME: Doesn't work with --regression as Interlocked.Add(ref long) is only
// implemented as an intrinsic
#if FALSE
public static async Task<T>FooAsync<T>(int i, int j) {
  Task<int>t = new Task<int>(delegate() {
...
public static int test_0_delegate_callvirt_fullaot() {
  ...
  var f2 = (Func<Func<string>, string>)
               Delegate.CreateDelegate(typeof (Func<Func<string>, string>),
                                       null, f.GetType().GetMethod("Invoke"));
...
constrained_tostring<T>(T t) {
  return t.ToString();
}

[MethodImplAttribute(MethodImplOptions.NoInlining)]
public static bool
constrained_equals<T>(T t1, T t2) {
...
public static int test_0_delegate_8_args() {
  ...
  Action<string, string, string, string, string, string, string, string>test =
      (a, b, c, d, e, f, g, h) => { delegate_8_args_res = h; };
...
[MethodImplAttribute(MethodImplOptions.NoInlining)]
public static bool
is_ref_or_contains_refs_gen_ref<T>() {
  return RuntimeHelpers.IsReferenceOrContainsReferences<GenStruct<T>>();
}

[MethodImplAttribute(MethodImplOptions.NoInlining)]
public static bool
is_ref_or_contains_refs_gen_noref<T>() {
...
public interface ICompletion { Type UnsafeOnCompleted(); }
...
public struct AStruct {
  public Type Caller<TAwaiter>(ref TAwaiter awaiter) where TAwaiter
      : ICompletion {
...
class ThreadLocalClass<T> {
  ...
  public T Value {
    [MethodImpl(MethodImplOptions.NoInlining)] get { return v; }
    [MethodImpl(MethodImplOptions.NoInlining)] set { v = value; }
  }
}
