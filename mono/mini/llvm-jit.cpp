...
static void init_mono_llvm_jit() {}
...
public:
  ...
  void initPassManager() {
    ...
    const char *default_opts =
        " -simplifycfg -sroa -lower-expect -instcombine -loop-rotate -licm "
        "-simplifycfg -lcssa -loop-idiom -indvars -loop-deletion -gvn "
        "-memcpyopt -sccp -bdce -instcombine -dse -simplifycfg "
...
static void init_mono_llvm_jit() { mono_mm = new MonoJitMemoryManager(); }
...
MonoEERef mono_llvm_create_ee(AllocCodeMemoryCb *alloc_cb,
