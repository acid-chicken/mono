...
guchar *mono_arch_create_generic_trampoline(MonoTrampolineType tramp_type,
  ...
  if (aot) {
    ...
    amd64_alu_reg_imm_size(code, X86_ADD, AMD64_RAX, 7 + sizeof(target_mgreg_t),
                           sizeof(target_mgreg_t));
    /* Compute the address of the GOT slot */
    amd64_alu_reg_reg_size(code, X86_ADD, AMD64_R11, AMD64_RAX,
                           sizeof(target_mgreg_t));
    /* Load the value */
    amd64_mov_reg_membase(code, AMD64_R11, AMD64_R11, 0,
                          sizeof(target_mgreg_t));
  } else {
    amd64_mov_reg_membase(code, AMD64_R11, AMD64_RBP, tramp_offset,
                          sizeof(target_mgreg_t));
