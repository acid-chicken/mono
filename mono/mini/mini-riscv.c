...
static gboolean riscv_stdext_a, riscv_stdext_b, riscv_stdext_c, riscv_stdext_d,
    riscv_stdext_f, riscv_stdext_j, riscv_stdext_l, riscv_stdext_m,
    riscv_stdext_n, riscv_stdext_p, riscv_stdext_q, riscv_stdext_t,
    riscv_stdext_v;
...
void mono_arch_dyn_call_free(MonoDynCallInfo *info) { NOT_IMPLEMENTED; }
...
gboolean mono_arch_is_soft_float(void) { return !riscv_stdext_d; }
...
void mono_arch_create_vars(MonoCompile *cfg) { NOT_IMPLEMENTED; }
...
void mono_arch_allocate_vars(MonoCompile *cfg) { NOT_IMPLEMENTED; }
...
guint8 *mono_riscv_emit_imm(guint8 *code, int rd, gsize imm) {
#ifdef TARGET_RISCV64
...
guint8 *mono_riscv_emit_load(guint8 *code, int rd, int rs1, gint32 imm) {
  if (RISCV_VALID_I_IMM(imm)) {
#ifdef TARGET_RISCV64
...
guint8 *mono_riscv_emit_store(guint8 *code, int rs1, int rs2, gint32 imm) {
...
guint8 *mono_arch_emit_prolog(MonoCompile *cfg) { NOT_IMPLEMENTED; }

void mono_arch_emit_epilog(MonoCompile *cfg) { NOT_IMPLEMENTED; }

void mono_arch_output_basic_block(MonoCompile *cfg, MonoBasicBlock *bb) {
  NOT_IMPLEMENTED;
}

void mono_arch_emit_exceptions(MonoCompile *cfg) { NOT_IMPLEMENTED; }
...
void mono_arch_set_breakpoint(MonoJitInfo *ji, guint8 *ip) { NOT_IMPLEMENTED; }

void mono_arch_clear_breakpoint(MonoJitInfo *ji, guint8 *ip) {
  NOT_IMPLEMENTED;
}

void mono_arch_start_single_stepping(void) { NOT_IMPLEMENTED; }

void mono_arch_stop_single_stepping(void) { NOT_IMPLEMENTED; }
...
void mono_arch_skip_single_step(MonoContext *ctx) { NOT_IMPLEMENTED; }
