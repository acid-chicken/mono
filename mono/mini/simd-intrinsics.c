...
static const SimdIntrinsic vector4f_intrinsics[] = {
    ...
    {SN_CompareEqual, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_EQ},
    {SN_CompareLessEqual, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_LE},
    {SN_CompareLessThan, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_LT},
    {SN_CompareNotEqual, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NEQ},
    {SN_CompareNotLessEqual, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NLE},
    {SN_CompareNotLessThan, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NLT},
    {SN_CompareOrdered, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_ORD},
    {SN_CompareUnordered, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_UNORD},
    ...
    {SN_ConvertToIntTruncated, OP_CVTTPS2DQ, MONO_CPU_X86_SSE2,
     SIMD_EMIT_UNARY},
    ...
    {SN_PrefetchTemporalAllCacheLevels, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_0},
    {SN_PrefetchTemporal1stLevelCache, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_1},
    {SN_PrefetchTemporal2ndLevelCache, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_2},
    {SN_PrefetchNonTemporal, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
    ...
    {SN_StoreAligned, OP_STOREX_ALIGNED_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    {SN_StoreNonTemporal, OP_STOREX_NTA_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    ...
    {SN_op_Equality, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_EQ},
    {SN_op_ExclusiveOr, OP_XORPS, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Explicit, 0, MONO_CPU_X86_SSE, SIMD_EMIT_CAST},
    {SN_op_Inequality, OP_COMPPS, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_NEQ},
...
static const SimdIntrinsic vector2d_intrinsics[] = {
    ...
    {SN_CompareEqual, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_EQ},
    {SN_CompareLessEqual, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_LE},
    {SN_CompareLessThan, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_LT},
    {SN_CompareNotEqual, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NEQ},
    {SN_CompareNotLessEqual, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NLE},
    {SN_CompareNotLessThan, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_NLT},
    {SN_CompareOrdered, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_ORD},
    {SN_CompareUnordered, OP_COMPPD, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY,
     SIMD_COMP_UNORD},
    ...
    {SN_ConvertToIntTruncated, OP_CVTTPD2DQ, MONO_CPU_X86_SSE2,
     SIMD_EMIT_UNARY},
...
static const SimdIntrinsic vector4ui_intrinsics[] = {
    ...
    {SN_PrefetchNonTemporal, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_NTA},
    {SN_Shuffle, OP_PSHUFLED, MONO_CPU_X86_SSE, SIMD_EMIT_SHUFFLE},
    {SN_SignedPackWithSignedSaturation, OP_PACKD, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_SignedPackWithUnsignedSaturation, OP_PACKD_UN, MONO_CPU_X86_SSE41,
     SIMD_EMIT_BINARY},
    {SN_StoreAligned, OP_STOREX_ALIGNED_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    ...
    {SN_op_BitwiseAnd, OP_PAND, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_BitwiseOr, OP_POR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Equality, OP_PCMPEQD, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_EQ},
    {SN_op_ExclusiveOr, OP_PXOR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Explicit, 0, MONO_CPU_X86_SSE, SIMD_EMIT_CAST},
    {SN_op_Inequality, OP_PCMPEQD, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_NEQ},
...
static const SimdIntrinsic vector4i_intrinsics[] = {
    ...
    {SN_PackWithUnsignedSaturation, OP_PACKD_UN, MONO_CPU_X86_SSE41,
     SIMD_EMIT_BINARY},
    {SN_PrefetchTemporalAllCacheLevels, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_0},
    {SN_PrefetchTemporal1stLevelCache, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
...
static const SimdIntrinsic vector8us_intrinsics[] = {
    ...
    {SN_MultiplyStoreHigh, OP_PMULW_HIGH_UN, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_PrefetchTemporalAllCacheLevels, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_0},
    {SN_PrefetchTemporal1stLevelCache, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
    ...
    {SN_SignedPackWithSignedSaturation, OP_PACKW, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_SignedPackWithUnsignedSaturation, OP_PACKW_UN, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_StoreAligned, OP_STOREX_ALIGNED_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    {SN_SubtractWithSaturation, OP_PSUBW_SAT_UN, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    ...
    {SN_op_BitwiseAnd, OP_PAND, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_BitwiseOr, OP_POR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Equality, OP_PCMPEQW, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_EQ},
    {SN_op_ExclusiveOr, OP_PXOR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Explicit, 0, MONO_CPU_X86_SSE, SIMD_EMIT_CAST},
    {SN_op_Inequality, OP_PCMPEQW, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_NEQ},
...
static const SimdIntrinsic vector8s_intrinsics[] = {
    ...
    {SN_PackWithUnsignedSaturation, OP_PACKW_UN, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_PrefetchTemporalAllCacheLevels, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
     SIMD_PREFETCH_MODE_0},
    {SN_PrefetchTemporal1stLevelCache, 0, MONO_CPU_X86_SSE, SIMD_EMIT_PREFETCH,
...
static const SimdIntrinsic vector16b_intrinsics[] = {
    ...
    {SN_StoreAligned, OP_STOREX_ALIGNED_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    {SN_SubtractWithSaturation, OP_PSUBB_SAT_UN, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_SumOfAbsoluteDifferences, OP_PSUM_ABS_DIFF, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    ...
    {SN_op_BitwiseAnd, OP_PAND, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_BitwiseOr, OP_POR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Equality, OP_PCMPEQB, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_EQ},
    {SN_op_ExclusiveOr, OP_PXOR, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_op_Explicit, 0, MONO_CPU_X86_SSE, SIMD_EMIT_CAST},
    {SN_op_Inequality, OP_PCMPEQB, MONO_CPU_X86_SSE, SIMD_EMIT_EQUALITY,
     SIMD_COMP_NEQ},
...
static const SimdIntrinsic vector16sb_intrinsics[] = {
    ...
    {SN_StoreAligned, OP_STOREX_ALIGNED_MEMBASE_REG, MONO_CPU_X86_SSE,
     SIMD_EMIT_STORE},
    {SN_SubtractWithSaturation, OP_PSUBB_SAT, MONO_CPU_X86_SSE,
     SIMD_EMIT_BINARY},
    {SN_UnpackHigh, OP_UNPACK_HIGHB, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_UnpackLow, OP_UNPACK_LOWB, MONO_CPU_X86_SSE, SIMD_EMIT_BINARY},
    {SN_get_V0, 0, MONO_CPU_X86_SSE, SIMD_EMIT_GETTER},
...
static guint32 get_simd_supported_versions(MonoCompile *cfg) {
  MonoCPUFeatures features = mini_get_cpu_features(cfg);
  guint32 versions = 0;
