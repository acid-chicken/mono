...
static void register_icalls(void) {
  ...
  register_icall(mini_llvm_init_gshared_method_this,
                 mono_icall_sig_void_ptr_ptr_int_object, TRUE);
  register_icall(mini_llvm_init_gshared_method_mrgctx,
                 mono_icall_sig_void_ptr_ptr_int_ptr, TRUE);
  register_icall(mini_llvm_init_gshared_method_vtable,
                 mono_icall_sig_void_ptr_ptr_int_ptr, TRUE);
  ...
  register_icall(mini_llvmonly_throw_nullref_exception, mono_icall_sig_void,
                 TRUE);
  register_icall(mini_llvmonly_throw_missing_method_exception,
                 mono_icall_sig_void, TRUE);
