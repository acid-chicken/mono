...
static void inline s390_patch_rel(guchar *code, guint64 target) {
...
static void inline s390_patch_addr(guchar *code, guint64 target) {
...
#define restoreLMF(code, frame_reg, stack_usage)                               \
  do {                                                                         \
    int lmfOffset = 0;                                                         \
                                                                               \
