...
emit_x86_intrinsics (MonoCompile *cfg, MonoMethod *cmethod, MonoMethodSignature *fsig, MonoInst **args)
{
    ...
    if (is_hw_intrinsics_class (klass, "Sse2", &is_64bit)) {
        ...
        case SN_Max:
            ...
            case MONO_TYPE_R8:
                return emit_simd_ins_for_sig (cfg, klass, OP_XOP_X_X_X, SIMD_OP_SSE_MAXPD, arg0_type, fsig, args);
            default:
                g_assert_not_reached ();
                break;
            }
        ...
        case SN_Min:
            ...
            case MONO_TYPE_R8:
                return emit_simd_ins_for_sig (cfg, klass, OP_XOP_X_X_X, SIMD_OP_SSE_MINPD, arg0_type, fsig, args);
            default:
                g_assert_not_reached ();
                break;
            }
