...
static MonoInst *emit_x86_intrinsics(MonoCompile *cfg, MonoMethod *cmethod,
  ...
  if (!strcmp(class_name, "Popcnt") ||
      (!strcmp(class_name, "X64") && cmethod->klass->nested_in &&
       !strcmp(m_class_get_name(cmethod->klass->nested_in), "Popcnt"))) {
  ...
  if (!strcmp(class_name, "Lzcnt") ||
      (!strcmp(class_name, "X64") && cmethod->klass->nested_in &&
       !strcmp(m_class_get_name(cmethod->klass->nested_in), "Lzcnt"))) {
  ...
  if (!strcmp(class_name, "Bmi1") ||
      (!strcmp(class_name, "X64") && cmethod->klass->nested_in &&
       !strcmp(m_class_get_name(cmethod->klass->nested_in), "Bmi1"))) {
    if (!COMPILE_LLVM(cfg))
      return NULL;
  ...
  if (!strcmp(class_name, "Bmi2") ||
      (!strcmp(class_name, "X64") && cmethod->klass->nested_in &&
       !strcmp(m_class_get_name(cmethod->klass->nested_in), "Bmi2"))) {
    if (!COMPILE_LLVM(cfg))
      return NULL;
...
MonoInst *mono_emit_simd_intrinsics(MonoCompile *cfg, MonoMethod *cmethod,
  ...
  if (cmethod->klass->nested_in)
    class_ns = m_class_get_name_space(cmethod->klass->nested_in), class_name,
    cmethod->klass->nested_in;
