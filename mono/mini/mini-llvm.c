 ...
 */
static LLVMValueRef emit_init_icall_wrapper(MonoLLVMModule *module,
  ...
  icall_sig = LLVMFunctionType4(LLVMVoidType(), IntPtrType(), IntPtrType(),
                                LLVMInt32Type(), IntPtrType(), FALSE);
  callee =
 ...
 */
static void emit_init_icall_wrappers(MonoLLVMModule *module) {
  module->init_method = emit_init_icall_wrapper(module, AOT_INIT_METHOD);
  module->init_method_gshared_mrgctx =
      emit_init_icall_wrapper(module, AOT_INIT_METHOD_GSHARED_MRGCTX);
  module->init_method_gshared_this =
      emit_init_icall_wrapper(module, AOT_INIT_METHOD_GSHARED_THIS);
  module->init_method_gshared_vtable =
      emit_init_icall_wrapper(module, AOT_INIT_METHOD_GSHARED_VTABLE);
}

static LLVMValueRef get_init_icall_wrapper(MonoLLVMModule *module,
                                           MonoAotInitSubtype subtype) {
  switch (subtype) {
  case AOT_INIT_METHOD:
 ...
 */
static void emit_init_method(EmitContext *ctx) {
