...
#define ARM64_ATOMIC_FENCE_FIX
    ...
    case OP_SSE_MOVSD: {
      LLVMValueRef addr =
          convert(ctx, lhs, LLVMPointerType(LLVMDoubleType(), 0));
      LLVMValueRef val = mono_llvm_build_load(builder, addr, "", FALSE);
      values[ins->dreg] = LLVMBuildInsertElement(
          builder, LLVMConstNull(type_to_sse_type(ins->inst_c1)), val,
          LLVMConstInt(LLVMInt32Type(), 0, FALSE), "");
    ...
    case OP_SSE_MOVNTPS: {
      LLVMValueRef store =
          mono_llvm_build_aligned_store(builder, rhs, lhs, FALSE, ins->inst_c0);
    ...
    case OP_XOP_X_X: {
      ...
      case SIMD_OP_SSE_RSQRTPS:
        ...
        break;
      case SIMD_OP_SSE_SQRTSS:
        id = INTRINS_SSE_SQRT_SS;
        break;
      case SIMD_OP_SSE_RCPSS:
        id = INTRINS_SSE_RCP_SS;
        break;
      case SIMD_OP_SSE_RSQRTSS:
        id = INTRINS_SSE_RSQRT_SS;
        break;
      case SIMD_OP_SSE_SQRTPD:
        id = INTRINS_SSE_SQRT_PD;
        break;
      case SIMD_OP_SSE_SQRTSD:
        id = INTRINS_SSE_SQRT_SD;
        break;
    ...
    case OP_XOP_X_X_I8: {
      ...
      case SIMD_OP_SSE_CVTSI2SS:
        id = INTRINS_SSE_CVTSI2SS;
        break;
      case SIMD_OP_SSE_CVTSI2SS64:
        id = INTRINS_SSE_CVTSI2SS64;
        break;
      case SIMD_OP_SSE_CVTSI2SD:
        id = INTRINS_SSE_CVTSI2SD;
        break;
      case SIMD_OP_SSE_CVTSI2SD64:
        id = INTRINS_SSE_CVTSI2SD64;
        break;
      ...
      case SIMD_OP_SSE_PMULHUW:
        ...
        break;
      case SIMD_OP_SSE_PMULUDQ:
        id = INTRINS_SSE_PMULUDQ;
        break;
      ...
      case SIMD_OP_SSE_PSRAD:
        ...
        break;
      case SIMD_OP_SSE_PSUBSB:
        id = INTRINS_SSE_PSUBSB;
        break;
      case SIMD_OP_SSE_PSUBSW:
        id = INTRINS_SSE_PSUBSW;
        break;
      case SIMD_OP_SSE_PSUBUSB:
        id = INTRINS_SSE_PSUBUSB;
        break;
      case SIMD_OP_SSE_PSUBUSW:
        id = INTRINS_SSE_PSUBUSW;
        break;
    ...
    case OP_XOP_X_X_X_I: {
      ...
      IntrinsicId id = (IntrinsicId)0;
      switch (ins->inst_c0) {
      case SIMD_OP_SSE_MASKMOVDQU:
        id = INTRINS_SSE_MASKMOVDQU;
        break;
      default:
        g_assert_not_reached();
        break;
    ...
    case OP_SSE2_ADDS: {
      ...
      values[ins->dreg] = convert(ctx, call_intrins(ctx, id, args, dname),
                                  type_to_sse_type(ins->inst_c1));
      break;
    }
    ...
    case OP_CREATE_SCALAR_UNSAFE: {
      ...
      values[ins->dreg] =
          LLVMBuildInsertElement(builder, vector, lhs, insert_pos, "");
      break;
    }
