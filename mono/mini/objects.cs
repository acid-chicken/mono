...
class Tests {
    ...
    public static int test_42_vtype_delegate () {
        var s = new VtypeVirtualDelStruct () {
            f = 42
        };
    ...
    public static int test_42_vtype_virtual_delegate () {
        IFaceVirtualDel s = new VtypeVirtualDelStruct () {
            f = 42
        };
    ...
    public static int test_0_vtype_arg_soft_float () {
        return pass_vtype_return_float (new AStruct2 () {
            i = 2, j = 4
        }) > 0.0 ? 0 : 1;
    }
    ...
    */
    ...
    public static int test_42_pass_16byte_struct_split () {
        return pass_struct16 (null, null, null, null, null, new Struct16 () {
            a = 42
        });
    }
