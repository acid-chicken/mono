 ...
 * 	the test methods (this is useful mostly to check that the tests are
 * correct)
...
class Sample {
  public int a;
  public Sample(int v) { a = v; }
}

[StructLayout(LayoutKind.Explicit)] struct StructWithBigOffsets {
  [FieldOffset(10000)]
  public byte b;
  [FieldOffset(10001)]
  public sbyte sb;
...
class Tests {
  ...
  public virtual Simple v_get_simple(int v) { return get_simple(v); }
  ...
  static int receive_small_sparc_many_args(int a, int a2, int a3, int a4,
                                           int a5, int a6, Small v, int b) {
    if (v.b1 != 1)
      return 1;
    if (v.b2 != 2)
      return 2;
  ...
  static int pass_struct1(struct1 x) { return check_struct1(x); }
  ...
  static int pass_struct2(struct2 x) { return check_struct2(x); }
  ...
  static int pass_struct3(int i, int j, int k, int l, int m, int n, int o,
                          int p, Struct3 s, int q) {
  ...
  public static int test_0_vector_array_cast() {
    ...
    Array arr5 =
        Array.CreateInstance(typeof (string), new int[]{1}, new int[]{10});
  ...
  public static IEnumerable<string>GetStringValues() {
    foreach(string val in StringValues) yield return val;
  }
  ...
  private static int[] daysmonthleap = {0,  31, 29, 31, 30, 31, 30,
                                        31, 31, 30, 31, 30, 31};
  ...
  class InstanceDelegateTest {
    ...
    public int return_field() { return a; }
  }
  ...
  struct VtypeVirtualDelStruct : IFaceVirtualDel {
    public int f;
    public int return_field_nonvirt() { return f; }
    public int return_field() { return f; }
  }
  ...
  static int llmult(int a, int b, int c, int d) { return a + b + c + d; }
  ...
  static ulong X() { return 0x1234567887654321; }

  static ulong Y() { return dum_de_dum; }
  ...
  public static int[] foo() { return new int[3]; }
  ...
  enum FlagsEnum { None = 0, A = 1, B = 2, C = 4 }
  ...
  sealed class Bar2 : Foo2 {
    public override int foo() { return 0; }
  }
  ...
  public static float return_float() { return 1.4e-45f; }

#if !NO_BITCODE
  [Category("!BITCODE")] // bug #59953
      public static int
      test_0_float_return_spill() {
   ...
   * This only happens because the call in middle forces the temp for
   * "(float)obj" to be spilled.
   */
  ...
  */
  ...
  class Del<T> {
    public static BStruct foo() { return new BStruct(){t = typeof (T)}; }
  }
  ...
  public static void do_throw() { throw new Exception(); }
  ...
  // #25487
  static int test_0_int_to_r4() { return int_to_r4_inner(255); }
  ...
  static double arm64_hfa_on_stack_inner(double d1, double d2, double d3,
                                         double d4, double d5, double d6,
                                         double d7, double d8, HFA4D s) {
  ...
  class MulOvfClass {
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public unsafe void
    EncodeIntoBuffer(char *value, int valueLength, char *buffer,
                     int bufferLength) {}
  }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  static int
  pass_struct16(object o0, object o2, object o3, object o4, object o5,
                object o6, object o7, Struct16 o8) {
    // This disables LLVM
    try {
    } catch {
    }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  static int
  pass_struct16(object o0, object o2, object o3, object o6, object o7,
                Struct16 o8) {
  ...
  public interface IComparer2 { Type foo<T>(); }

  public class AClass : IComparer2 {
    public Type foo<T>() { return typeof (T); }
  }
  ...
  public enum ByteEnum2 : byte { High = 142 }

  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  enum_arg_zero_extend(ByteEnum2 b) {
    return (int) b;
  }
  ...
  public class IFooImpl : IFoo { public int MyInt => 0; }
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  gh_11378_inner_1(Vec3 p1, Vec3 p2) {
    p1.X -= p2.X;
    p1.Y -= p2.Y;
    p1.Z -= p2.Z;
  ...
  [MethodImplAttribute(MethodImplOptions.NoInlining)]
  public static int
  gh_11378_inner_2(Vec3 c, Vec3 pos) {
  ...
  public static int test_0_cfold_with_non_constant_ternary_op() {
    ...
    var old = System.Threading.Interlocked.CompareExchange(
        ref variable_with_constant_address, 1, 0);
  ...
  class ClassAggressiveInline {
    static ClassAggressiveInline() { cctor_called = true; }
