...
ICALL_EXTERN_C void mono_helper_stelem_ref_check(MonoArray *array,
                                                 MonoObject *val);
...
// For param_count > 4.
ICALL_EXTERN_C MonoArray *
mono_array_new_n_icall(MonoMethod *cm, gint32 param_count, intptr_t *params);

ICALL_EXTERN_C MonoArray *mono_array_new_1(MonoMethod *cm, guint32 length);

ICALL_EXTERN_C MonoArray *mono_array_new_2(MonoMethod *cm, guint32 length1,
                                           guint32 length2);

ICALL_EXTERN_C MonoArray *mono_array_new_3(MonoMethod *cm, guint32 length1,
                                           guint32 length2, guint32 length3);

ICALL_EXTERN_C MonoArray *mono_array_new_4(MonoMethod *cm, guint32 length1,
                                           guint32 length2, guint32 length3,
                                           guint32 length4);

ICALL_EXTERN_C gpointer mono_class_static_field_address(MonoDomain *domain,
                                                        MonoClassField *field);

ICALL_EXTERN_C gpointer mono_ldtoken_wrapper(MonoImage *image, int token,
                                             MonoGenericContext *context);

ICALL_EXTERN_C gpointer mono_ldtoken_wrapper_generic_shared(MonoImage *image,
                                                            int token,
                                                            MonoMethod *method);
...
ICALL_EXTERN_C gpointer mono_helper_compile_generic_method(MonoObject *obj,
                                                           MonoMethod *method,
                                                           gpointer *this_arg);
...
ICALL_EXTERN_C MonoException *mono_create_corlib_exception_1(guint32 token,
                                                             MonoString *arg);

ICALL_EXTERN_C MonoException *mono_create_corlib_exception_2(guint32 token,
                                                             MonoString *arg1,
                                                             MonoString *arg2);

ICALL_EXTERN_C MonoObject *mono_object_castclass_unbox(MonoObject *obj,
                                                       MonoClass *klass);

ICALL_EXTERN_C gpointer mono_get_native_calli_wrapper(MonoImage *image,
                                                      MonoMethodSignature *sig,
                                                      gpointer func);

ICALL_EXTERN_C MonoObject *mono_object_isinst_with_cache(MonoObject *obj,
                                                         MonoClass *klass,
                                                         gpointer *cache);

ICALL_EXTERN_C MonoObject *mono_object_castclass_with_cache(MonoObject *obj,
                                                            MonoClass *klass,
                                                            gpointer *cache);
...
ICALL_EXTERN_C void mono_generic_class_init(MonoVTable *vtable);

ICALL_EXPORT
void ves_icall_mono_delegate_ctor(MonoObject *this_obj, MonoObject *target,
                                  gpointer addr);

ICALL_EXPORT
void ves_icall_mono_delegate_ctor_interp(MonoObject *this_obj,
                                         MonoObject *target, gpointer addr);

ICALL_EXTERN_C MonoObject *mono_gsharedvt_constrained_call(gpointer mp,
                                                           MonoMethod *cmethod,
                                                           MonoClass *klass,
                                                           gboolean deref_arg,
                                                           gpointer *args);

ICALL_EXTERN_C void mono_gsharedvt_value_copy(gpointer dest, gpointer src,
                                              MonoClass *klass);

ICALL_EXTERN_C gpointer mono_fill_class_rgctx(MonoVTable *vtable, int index);

ICALL_EXTERN_C gpointer
...
ICALL_EXTERN_C void mono_throw_method_access(MonoMethod *caller,
                                             MonoMethod *callee);
