...
#ifdef MONOTOUCH
#define USE_PAGE_TRAMPOLINES                                                   \
  (mono_defaults.corlib->aot_module->use_page_trampolines)
#else
...
void mono_aot_patch_plt_entry(guint8 *code, guint8 *plt_entry, gpointer *got,
 ...
 */
gpointer mono_aot_plt_resolve(gpointer aot_module, guint32 plt_info_offset,
 ...
 */
gpointer mono_aot_create_specific_trampoline(MonoImage *image, gpointer arg1,
