...
#define MONO_GC_CONCURRENT_UPDATE_FINISH_BEGIN(generation,                     \
...
#define MONO_GC_OBJ_MOVED(dest, src, dest_gen, src_gen, size, ns_name,         \
                          class_name)
...
#define MONO_GC_FINALIZE_ENQUEUE(addr, size, ns_name, class_name, generation,  \
                                 is_critical)
...
#define MONO_GC_WEAK_UPDATE(ref_addr, new_addr, size, ns_name, class_name,     \
                            track)
