...
typedef struct {
  ...
  uint8_t
      cazm : 1; // 138 - Configuration-z/Architecture-arcitectural -mode Faciliy
  uint8_t
      mef : 1; // 139 - Multiple-epoch Facility ture-arcitectural -mode Faciliy
