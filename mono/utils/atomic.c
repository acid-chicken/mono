...
gint32 mono_atomic_cas_i32(volatile gint32 *dest, gint32 exch, gint32 comp) {
  gint32 old;
  int ret;

  pthread_cleanup_push((void (*)(void *))pthread_mutex_unlock, (void *)&spin);
...
gpointer mono_atomic_cas_ptr(volatile gpointer *dest, gpointer exch,
                             gpointer comp) {
  gpointer old;
  int ret;
...
#elif defined(__arm__) && defined(HAVE_ARMV7) &&                               \
...
gint64 mono_atomic_cas_i64(volatile gint64 *dest, gint64 exch, gint64 comp) {
  ...
  return (old);
    ...
    !defined(BROKEN_64BIT_ATOMICS_INTRINSIC) &&                                \
    !defined(NEED_64BIT_CMPXCHG_FALLBACK)
