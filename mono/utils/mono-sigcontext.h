...
#define UCONTEXT_REG_XMM0(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm0)
#define UCONTEXT_REG_XMM1(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm1)
#define UCONTEXT_REG_XMM2(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm2)
#define UCONTEXT_REG_XMM3(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm3)
#define UCONTEXT_REG_XMM4(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm4)
#define UCONTEXT_REG_XMM5(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm5)
#define UCONTEXT_REG_XMM6(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm6)
#define UCONTEXT_REG_XMM7(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm7)
#else
...
#define UCONTEXT_REG_EAX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_EAX])
#define UCONTEXT_REG_EBX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_EBX])
#define UCONTEXT_REG_ECX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_ECX])
#define UCONTEXT_REG_EDX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_EDX])
#define UCONTEXT_REG_EBP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_EBP])
#define UCONTEXT_REG_ESP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_ESP])
#define UCONTEXT_REG_ESI(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_ESI])
...
#define UCONTEXT_REG_EAX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EAX])
#define UCONTEXT_REG_EBX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EBX])
#define UCONTEXT_REG_ECX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_ECX])
#define UCONTEXT_REG_EDX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EDX])
#define UCONTEXT_REG_EBP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EBP])
#define UCONTEXT_REG_ESP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_ESP])
#define UCONTEXT_REG_ESI(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_ESI])
#define UCONTEXT_REG_EDI(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EDI])
#define UCONTEXT_REG_EIP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.gregs[REG_EIP])
#endif
...
#define UCONTEXT_REG_XMM7(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm7)
#define UCONTEXT_REG_XMM8(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm8)
#define UCONTEXT_REG_XMM9(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm9)
#define UCONTEXT_REG_XMM10(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm10)
#define UCONTEXT_REG_XMM11(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm11)
#define UCONTEXT_REG_XMM12(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm12)
#define UCONTEXT_REG_XMM13(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm13)
#define UCONTEXT_REG_XMM14(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm14)
#define UCONTEXT_REG_XMM15(ctx)                                                \
  (((ucontext_t *)(ctx))->uc_mcontext->__fs.__fpu_xmm15)
...
#define UCONTEXT_REG_RCX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RCX])
#define UCONTEXT_REG_RDX(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RDX])
#define UCONTEXT_REG_RBP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RBP])
#define UCONTEXT_REG_RSP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RSP])
#define UCONTEXT_REG_RSI(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RSI])
#define UCONTEXT_REG_RDI(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RDI])
#define UCONTEXT_REG_RIP(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_RIP])
#define UCONTEXT_REG_R8(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R8])
#define UCONTEXT_REG_R9(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R9])
#define UCONTEXT_REG_R10(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R10])
#define UCONTEXT_REG_R11(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R11])
#define UCONTEXT_REG_R12(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R12])
#define UCONTEXT_REG_R13(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R13])
#define UCONTEXT_REG_R14(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R14])
#define UCONTEXT_REG_R15(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R15])
#elif defined(__OpenBSD__)
...
#define UCONTEXT_GREGS(ctx)                                                    \
  ((guint64 *)&(((ucontext_t *)(ctx))->uc_mcontext.gregs))
...
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext.fp_regs[(n)])
#define UCONTEXT_REG_NIP(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.gp_regs[PT_NIP])
#define UCONTEXT_REG_LNK(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.gp_regs[PT_LNK])
#else
#define UCONTEXT_REG_Rn(ctx, n)                                                \
  (((os_ucontext *)(ctx))->uc_mcontext.uc_regs->gregs[(n)])
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext.uc_regs->fpregs.fpregs[(n)])
#define UCONTEXT_REG_NIP(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.uc_regs->gregs[PT_NIP])
#define UCONTEXT_REG_LNK(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.uc_regs->gregs[PT_LNK])
#endif
#elif defined(__APPLE__) && defined(_STRUCT_MCONTEXT)
typedef struct __darwin_ucontext os_ucontext;

#define UCONTEXT_REG_Rn(ctx, n)                                                \
  ((&((os_ucontext *)(ctx))->uc_mcontext->__ss.__r0)[(n)])
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext->__fs.__fpregs[(n)])
...
#define UCONTEXT_REG_Rn(ctx, n)                                                \
  ((&((os_ucontext *)(ctx))->uc_mcontext->ss.r0)[(n)])
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext->fs.fpregs[(n)])
...
#define UCONTEXT_REG_Rn(ctx, n)                                                \
  (((os_ucontext *)(ctx))->uc_mcontext.__gregs[(n)])
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext.__fpregs.__fpu_regs[(n)])
#define UCONTEXT_REG_NIP(ctx) _UC_MACHINE_PC(ctx)
#define UCONTEXT_REG_LNK(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.__gregs[_REG_LR])
...
#define UCONTEXT_REG_Rn(ctx, n)                                                \
  (((os_ucontext *)(ctx))->uc_mcontext.jmp_context.gpr[(n)])
#define UCONTEXT_REG_FPRn(ctx, n)                                              \
  (((os_ucontext *)(ctx))->uc_mcontext.jmp_context.fpr[(n)])
#define UCONTEXT_REG_NIP(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.jmp_context.iar)
#define UCONTEXT_REG_LNK(ctx)                                                  \
  (((os_ucontext *)(ctx))->uc_mcontext.jmp_context.lr)
#endif
...
#define UCONTEXT_REG_VFPREGS(ctx)                                              \
...
#define UCONTEXT_REG_PC(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_PC])
#define UCONTEXT_REG_SP(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_SP])
#define UCONTEXT_REG_LR(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_LR])
#define UCONTEXT_REG_R0(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R0])
#define UCONTEXT_REG_R1(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R1])
#define UCONTEXT_REG_R2(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R2])
#define UCONTEXT_REG_R3(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R3])
#define UCONTEXT_REG_R4(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R4])
#define UCONTEXT_REG_R5(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R5])
#define UCONTEXT_REG_R6(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R6])
#define UCONTEXT_REG_R7(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R7])
#define UCONTEXT_REG_R8(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R8])
#define UCONTEXT_REG_R9(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R9])
...
#define UCONTEXT_REG_R12(ctx)                                                  \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_R12])
#define UCONTEXT_REG_CPSR(ctx)                                                 \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_CPSR])
#define UCONTEXT_REG_VFPREGS(ctx)                                              \
  (((ucontext_t *)(ctx))->uc_mcontext.__gregs[_REG_VFPREGS])
#endif
...
#define UCONTEXT_REG_R0(ctx)                                                   \
  (((ucontext64_t *)(ctx))->uc_mcontext64->__ss.__x[ARMREG_R0])
#define UCONTEXT_GREGS(ctx)                                                    \
  (&(((ucontext64_t *)(ctx))->uc_mcontext64->__ss.__x))
#elif defined(__FreeBSD__)
#include <ucontext.h>
/* https://lists.freebsd.org/pipermail/freebsd-arm/2017-February/015611.html */
#define UCONTEXT_REG_PC(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.mc_gpregs.gp_elr)
#define UCONTEXT_REG_SP(ctx)                                                   \
...
#define UCONTEXT_REG_R0(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.regs[ARMREG_R0])
...
#define UCONTEXT_FPREGS(ctx)                                                   \
  (((ucontext_t *)(ctx))->uc_mcontext.fpregs.fp_r.fp_dregs)
#define UCONTEXT_REG_PC(ctx) (((ucontext_t *)(ctx))->uc_mcontext.pc)
