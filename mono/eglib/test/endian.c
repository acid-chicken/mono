...
static RESULT test_swap(void) {
  ...
  if (res64 != b_expect)
    return FAILED("GUINT64_SWAP_LE_BE returned 0x%" PRIx64 " (had=0x%" PRIx64
                  ")",
                  (guint64)res64, (guint64)b);
...
static Test endian_tests[] = {{"swap", test_swap}, {NULL, NULL}};
