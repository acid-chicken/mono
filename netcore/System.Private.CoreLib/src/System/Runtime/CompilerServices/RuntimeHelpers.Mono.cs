...
namespace System.Runtime.CompilerServices {
  partial class RuntimeHelpers {
    ...
    public static int OffsetToStringData {
      [Intrinsic] get => OffsetToStringData;
    }

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern int
    InternalGetHashCode(object o);

    public static int GetHashCode(object o) { return InternalGetHashCode(o); }
    ...
    public static void PrepareMethod(RuntimeMethodHandle method) {
      ...
      unsafe { PrepareMethod(method.Value, null, 0); }
    }
    ...
    IsBitwiseEquatable<T>() => IsBitwiseEquatable<T>();

    [Intrinsic]
    internal static bool
    ObjectHasComponentSize(object obj) => ObjectHasComponentSize(obj);

    [Intrinsic]
    internal static bool
    ObjectHasReferences(object obj) {
    ...
    static object GetUninitializedObjectInternal(Type type) {
      return GetUninitializedObjectInternal(
          new RuntimeTypeHandle((RuntimeType) type).Value);
    }

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern unsafe void
    PrepareMethod(IntPtr method, IntPtr *instantiations, int ninst);

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern object
    GetUninitializedObjectInternal(IntPtr type);

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern void
    InitializeArray(Array array, IntPtr fldHandle);

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern void
    RunClassConstructor(IntPtr type);

    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static extern void
    RunModuleConstructor(IntPtr module);
