...
partial class String {
  ...
  public int Length { [Intrinsic] get => _stringLength; }

  [IndexerName("Chars")]
  public char this[int index] {
    [Intrinsic] get => this[index];
  }
...
#region Runtime method - to - ir dependencies
  ...
  internal static unsafe void memcpy_aligned_1(byte *dest, byte *src,
                                               int size) {
    ((byte *) dest)[0] = ((byte *) src)[0];
  }

  internal static unsafe void memcpy_aligned_2(byte *dest, byte *src,
                                               int size) {
    ((short *) dest)[0] = ((short *) src)[0];
  }

  internal static unsafe void memcpy_aligned_4(byte *dest, byte *src,
                                               int size) {
    ((int *) dest)[0] = ((int *) src)[0];
  }

  internal static unsafe void memcpy_aligned_8(byte *dest, byte *src,
                                               int size) {
  ...
  unsafe String CreateString(sbyte *value) { return Ctor(value); }

  unsafe String CreateString(sbyte *value, int startIndex, int length) {
    return Ctor(value, startIndex, length);
  }

  unsafe String CreateString(char *value) { return Ctor(value); }
  ...
  String CreateString(char[] val) { return Ctor(val); }

  String CreateString(char c, int count) { return Ctor(c, count); }
  ...
  String CreateString(ReadOnlySpan<char>value) { return Ctor(value); }
}
}
