...
#region keep in sync with object - internals.h
  ...
  internal bool
  IsRuntimeImplemented() => this.UnderlyingSystemType is RuntimeType;

  internal virtual bool IsTypeBuilder() => false;

  public bool IsInterface{
      get{if(this is RuntimeType rt) return RuntimeTypeHandle.IsInterface(rt);
...
[System.Security.DynamicSecurityMethod] // Methods containing StackCrawlMark
                                        // local var has to be marked
                                        // DynamicSecurityMethod
    public static Type
    GetType(string typeName, bool throwOnError, bool ignoreCase) {
  StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
  return RuntimeType.GetType(typeName, throwOnError, ignoreCase, false,
                             ref stackMark);
}
...
[System.Security.DynamicSecurityMethod] // Methods containing StackCrawlMark
  ...
  StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
  return RuntimeType.GetType(typeName, throwOnError, false, false,
                             ref stackMark);
}
...
[System.Security.DynamicSecurityMethod] // Methods containing StackCrawlMark
                                        ...
                                        // DynamicSecurityMethod
    public static Type
    GetType(string typeName, Func<AssemblyName, Assembly>assemblyResolver,
            Func<Assembly, string, bool, Type>typeResolver) {
  StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
  return RuntimeType.GetType(typeName, assemblyResolver, typeResolver, false,
                             false, ref stackMark);
}
...
[System.Security.DynamicSecurityMethod] // Methods containing StackCrawlMark
  ...
  StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller;
  return RuntimeType.GetType(typeName, assemblyResolver, typeResolver,
...
internal virtual Type InternalResolve() { return UnderlyingSystemType; }

// Called from the runtime to return the corresponding finished Type object
internal virtual Type RuntimeResolve() { throw new NotImplementedException(); }
...
internal virtual ConstructorInfo
...
[Intrinsic]
public static bool
operator ==(Type? left, Type? right) => left == right;
