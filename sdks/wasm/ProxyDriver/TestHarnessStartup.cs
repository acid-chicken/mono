...
public class TestHarnessStartup {
      ...
      var response =
          new JArray(
              JObject.FromObject(new {
                  ...
                  devtoolsFrontendUrl =
                      "chrome-devtools://devtools/bundled/inspector.html?experiments=true&v8only=true&ws=localhost:9300/91d87807-8a81-4f49-878c-a5604103b0a4",
                  faviconUrl = "https://nodejs.org/static/favicon.ico",
                  id = "91d87807-8a81-4f49-878c-a5604103b0a4", title = "foo.js",
                  type = "node",
                  webSocketDebuggerUrl =
                      "ws://localhost:9300/91d87807-8a81-4f49-878c-a5604103b0a4"}))
              .ToString();
  ...
  public async Task LaunchAndServe(ProcessStartInfo psi, HttpContext context,
    ...
    try {
      proc.ErrorDataReceived += (sender, e) => {
        ...
        if (str.Contains("listening on", StringComparison.Ordinal)) {
          var res =
              str.Substring(str.IndexOf("ws://", StringComparison.Ordinal));
          if (res != null)
      ...
      proc.OutputDataReceived +=
          (sender, e) => { Console.WriteLine($"stdout: {e.Data}"); };
      ...
      var con_str =
          extract_conn_url != null ? await extract_conn_url(line) : line;
  ...
  public void Configure(IApplicationBuilder app,
    ...
    app.UseStaticFiles(new StaticFileOptions{
        ...
        ServeUnknownFileTypes =
            true, // Cuz .wasm is not a known file type :cry:
        RequestPath = "", ContentTypeProvider = provider});

    var devToolsUrl = options.DevToolsUrl;
    var psi = new ProcessStartInfo();

    psi.Arguments =
        $"--headless --disable-gpu --remote-debugging-port={devToolsUrl.Port} http://{TestHarnessProxy.Endpoint.Authority}/{options.PagePath}";
      ...
      router.MapGet("launch-chrome-and-connect", async context => {
        ...
        await LaunchAndServe(psi, context, async (str) => {
          ...
          while (res == null) {
            ...
            res = await client.GetStringAsync(
