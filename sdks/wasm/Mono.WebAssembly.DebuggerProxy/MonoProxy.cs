...
namespace WebAssembly.Net.Debugging {
  ...
  public class MonoProxy : DevToolsProxy {
    ...
    async Task<DebugStore>LoadStore(SessionId sessionId,
      ...
      if (Interlocked.CompareExchange(ref context.store, new DebugStore(),
                                      null) != null) {
    ...
    async Task SetBreakPoint(MessageId msg_id, BreakpointRequest req,
                             CancellationToken token) {
      var context = GetContext(msg_id);
      ...
      var ok = new {
          ...
          locations = new[]{new {scriptId = bp_loc.Id.ToString(),
    ...
    bool GetPossibleBreakpoints(MessageId msg_id, SourceLocation start,
                                SourceLocation end, CancellationToken token) {
