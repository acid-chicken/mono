...
namespace WebAssembly.Net.Debugging {
  ...
  internal struct SessionId {
    ...
    public static bool operator ==(SessionId a, SessionId b) => a.sessionId
                                                                == b.sessionId;
  ...
  internal class MonoCommands {
    ...
    public static MonoCommands
    GetObjectProperties(int objectId, bool expandValueTypes) => new MonoCommands(
        $"MONO.mono_wasm_get_object_properties({objectId}, { (expandValueTypes ? " true " : " false ") })");

    public static MonoCommands GetArrayValues(int objectId) =>
        new MonoCommands($"MONO.mono_wasm_get_array_values({objectId})");

    public static MonoCommands
    GetArrayValueExpanded(int objectId, int idx) => new MonoCommands(
        $"MONO.mono_wasm_get_array_value_expanded({objectId}, {idx})");
  ...
  internal class ExecutionContext {
    ...
    public Dictionary<string, JToken>ValueTypesCache =
        new Dictionary<string, JToken>();
    public Dictionary<string, JToken>LocalsCache =
        new Dictionary<string, JToken>();
