...
namespace WebAssembly.Net.Debugging {
  ...
  internal class MonoCommands {
    ...
    public static MonoCommands
    GetObjectProperties(DotnetObjectId objectId, bool expandValueTypes) => new MonoCommands(
        $"MONO.mono_wasm_get_object_properties({int.Parse (objectId.Value)}, { (expandValueTypes ? " true " : " false ") })");
