...
namespace WebAssembly.Net.Debugging {
  internal class BreakPointRequest {
    ...
    public static BreakPointRequest Parse(JObject args, DebugStore store) {
      ...
      if (url != null &&
          !url.StartsWith("dotnet://", StringComparison.InvariantCulture)) {
  ...
  internal class SourceLocation {
    ...
    internal JObject ToJObject() {
      return JObject.FromObject(new {scriptId = id.ToString(),
  ...
  internal class AssemblyInfo {
    ...
    public AssemblyInfo(string url, byte[] assembly, byte[] pdb) {
      lock(typeof (AssemblyInfo)) { this.id = ++next_id; }
      ...
      foreach(var url in asm_files) {
        try {
          ...
          var o = JObject.FromObject(
              new {entry = new {source = "other", level = "warning",
