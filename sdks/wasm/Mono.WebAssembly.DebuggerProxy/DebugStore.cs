...
namespace WebAssembly.Net.Debugging {
  ...
  internal class SourceId {
    ...
    public override int
    GetHashCode() => assembly.GetHashCode() ^ document.GetHashCode();

    public static bool operator ==(SourceId a,
                                   SourceId b) => ((object) a == null)
                                                      ? (object) b == null
                                                      : a.Equals(b);
  ...
  class AssemblyInfo {
    ...
    Dictionary<string, TypeInfo>typesByName =
  ...
  internal class SourceFile {
    ...
    byte[] ComputePdbHash(Stream sourceStream) {
      ...
      if (algorithm != null)
        using(algorithm) return algorithm.ComputeHash(sourceStream);

      return Array.Empty<byte>();
    }

    public async Task<Stream>
    GetSourceAsync(bool checkHash,
    ...
    public object ToScriptSource(int executionContextId,
      ...
      return new {
          ...
          // hash:  should be the v8 hash algo, managed implementation is
          // pending
          dotNetUrl = DotNetUrl,
      };
    }
