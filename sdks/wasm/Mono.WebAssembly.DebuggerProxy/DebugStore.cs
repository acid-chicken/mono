...
internal class BreakPointRequest {
  ...
  public static BreakPointRequest Parse(JObject args, DebugStore store) {
    ...
    return new BreakPointRequest(){Assembly = parts.Assembly,
                                   File = parts.DocumentPath, Line = line.Value,
                                   Column = column.Value};
  }
...
internal class VarInfo {
  ...
  public override string ToString() { return $"(var-info [{Index}] '{Name}')"; }
}
...
internal class SourceLocation {
  ...
  internal JObject ToJObject() {
    return JObject.FromObject(new {scriptId = id.ToString(), lineNumber = line,
                                   columnNumber = column});
  }
}
...
internal class DebugStore {
  ...
  public DebugStore(MonoProxy proxy) { this.proxy = proxy; }
  ...
  public IEnumerable<SourceFile>AllSources() {
    foreach(var a in assemblies) { foreach(var s in a.Sources) yield return s; }
  }
  ...
  */
  ...
  public SourceFile GetFileByUrlRegex(string urlRegex) {
    ...
    return AllSources().FirstOrDefault(file =>
                                           regex.IsMatch(file.Url.ToString()));
  }
