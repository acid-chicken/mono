...
public class Math { // Only append content to this class as the test suite
                    // depends on line info
  ...
  public static int DelegatesTest() {
    ...
    Func<Math, bool>[] fn_func_arr =
        new Func<Math, bool>[]{(Math m) => m == null};
    ...
    bool res = fn_func(m_obj) && fn_del(m_obj) && fn_del_arr[0](m_obj) &&
               fn_del_null == null && fn_func_null == null &&
               fn_func_arr[0] != null;
    ...
    Func<Math, bool>[] fn_func_arr_unused =
        new Func<Math, bool>[]{(Math m) => m == null};

    Math.IsMathNull fn_del_unused = Math.IsMathNullDelegateTarget;
    Math.IsMathNull fn_del_null_unused = null;
    var fn_del_arr_unused =
        new Math.IsMathNull[]{Math.IsMathNullDelegateTarget};
  ...
  public static int GenericTypesTest() {
    ...
    var list_arr =
        new System.Collections.Generic.Dictionary<Math[], IsMathNull>[]{
            new System.Collections.Generic.Dictionary<Math[], IsMathNull>()};
    System.Collections.Generic.Dictionary<Math[], IsMathNull>[] list_arr_null =
        null;

    Console.WriteLine(
        $"list_arr.Length: {list_arr.Length}, list.Count: {list.Count}");

    // Unused locals

    var list_unused =
        new System.Collections.Generic.Dictionary<Math[], IsMathNull>();
    System.Collections.Generic.Dictionary<Math[], IsMathNull>list_null_unused =
        null;
    ...
    System.Collections.Generic
        .Dictionary<Math[], IsMathNull>[] list_arr_null_unused = null;
  ...
  public static void OuterMethod() {
    ...
    Console.WriteLine(
        $"-- InnerMethod returned: {new_i}, nim: {nim}, text: {text}");
    int k = 19;
  ...
  class NestedInMath {
    ...
    Math m = new Math();
    public async System.Threading.Tasks.Task<bool>AsyncMethod0(string s,
                                                               int i) {
    ...
    public async System.Threading.Tasks.Task AsyncMethodNoReturn() {
      ...
      Console.WriteLine(
          $"Using the struct: {ss.dt}, {ss.gs.StringField}, ss_arr: {ss_arr.Length}");
    ...
    public static async System.Threading.Tasks.Task<bool>AsyncTest(string s,
                                                                   int i) {
    ...
    public static void MethodWithStructs() {
      ...
      Math m = new Math();
      Console.WriteLine(
          $"Using the struct: {ss.dt}, {ss.gs.StringField}, ss_arr: {ss_arr.Length}, gs: {gs.StringField}");
    }
  }
