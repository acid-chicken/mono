...
public class SourceList : DebuggerTestBase {
  ...
  InspectLocalsAtBreakpointSite(bool use_cfo) =>
      await CheckInspectLocalsAtBreakpointSite(
          "dotnet://debugger-test.dll/debugger-test.cs", 5, 2, "IntAdd",
          "window.setTimeout(function() { invoke_add(); }, 1);", use_cfo
          : use_cfo, test_fn
          : (locals) => {
  ...
  InspectPrimitiveTypeLocalsAtBreakpointSite() =>
      await CheckInspectLocalsAtBreakpointSite(
          "dotnet://debugger-test.dll/debugger-test.cs", 145, 2,
          "PrimitiveTypesTest",
  ...
  InspectLocalsWithGenericTypesAtBreakpointSite(bool use_cfo) =>
      await CheckInspectLocalsAtBreakpointSite(
          "dotnet://debugger-test.dll/debugger-test.cs", 65, 2,
          "GenericTypesTest",
  ...
  InspectLocalsInPreviousFramesDuringSteppingIn2(bool use_cfo) {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var props = await GetObjectOnFrame(pause_location ["callFrames"]
                                         [0],
                                         "this");
      ...
      var locals_m1 =
          await GetLocalsForFrame(pause_location ["callFrames"]
                                  [3],
                                  debugger_test_loc, 17, 2, "UseComplex");
      ...
      props = await GetObjectOnFrame(pause_location ["callFrames"]
                                     [3],
                                     "complex");
      Assert.Equal(3, props.Count());
      CheckNumber(props, "A", 10);
  ...
  InspectLocalsInPreviousFramesDuringSteppingIn(bool use_cfo) {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var wait_res = await EvaluateAndCheck(
          ...
          debugger_test_loc, 102, 3, "InnerMethod", locals_fn
          : (locals) => {
      ...
      var this_props = await GetObjectOnFrame(wait_res ["callFrames"]
                                              [0],
                                              "this");
      ...
      var locals_m1 =
          await GetLocalsForFrame(wait_res ["callFrames"]
                                  [1],
                                  debugger_test_loc, 78, 2, "OuterMethod");
      ...
      await StepAndCheck(StepKind.Over, debugger_test_loc, 82, 2, "OuterMethod",
                         times : 9, locals_fn
                         : (locals) => {
      ...
      await StepAndCheck(StepKind.Into,
                         "dotnet://debugger-test.dll/debugger-test.cs", 87, 1,
      ...
      await StepAndCheck(StepKind.Over,
                         "dotnet://debugger-test.dll/debugger-test.cs", 91, 1,
      ...
      await StepAndCheck(StepKind.Over,
                         "dotnet://debugger-test.dll/debugger-test.cs", 83, 2,
  ...
  InspectLocalsDuringSteppingIn() {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      await StepAndCheck(StepKind.Over,
                         "dotnet://debugger-test.dll/debugger-test.cs", 78, 2,
      ...
      await StepAndCheck(StepKind.Into,
                         "dotnet://debugger-test.dll/debugger-test.cs", 96, 2,
                         "InnerMethod");
      await StepAndCheck(StepKind.Over,
                         "dotnet://debugger-test.dll/debugger-test.cs", 100, 3,
      ...
      await StepAndCheck(StepKind.Over,
                         "dotnet://debugger-test.dll/debugger-test.cs", 79, 2,
  ...
  InspectLocalsInAsyncMethods(bool use_cfo) {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var pause_loc = await SendCommandAndCheck(
          null, "Debugger.resume", debugger_test_loc, 126, 3,
      ...
      var this_props = await GetObjectOnFrame(pause_loc ["callFrames"]
                                              [0],
                                              "this");
      Assert.Equal(2, this_props.Count());
      CheckObject(this_props, "m", "Math");
  ...
  InspectLocalsWithStructs(bool use_cfo) {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var ss_local_props = await GetObjectOnFrame(pause_location ["callFrames"]
                                                  [0],
                                                  "ss_local");
      await CheckProps(
          ss_local_props,
...

      {
        ...
        CheckString(
            gs_props, "StringField",
            "set in MethodWithLocalStructs#SimpleStruct#gs#StringField");
        CheckObject(gs_props, "List",
                    "System.Collections.Generic.List<System.DateTime>");
      }

      // Check gs_local's properties
      var gs_local_props = await GetObjectOnFrame(pause_location ["callFrames"]
                                                  [0],
                                                  "gs_local");
      await CheckProps(
          gs_local_props,
      ...
      var vt_local_props = await GetObjectOnFrame(pause_location ["callFrames"]
                                                  [0],
                                                  "vt_local");
      Assert.Equal(5, vt_local_props.Count());

      CheckString(vt_local_props, "StringField", "string#0");
      CheckValueType(vt_local_props, "SimpleStructField",
                     "DebuggerTests.ValueTypesTest.SimpleStruct");
      CheckValueType(vt_local_props, "SimpleStructProperty",
                     "DebuggerTests.ValueTypesTest.SimpleStruct");
      await CheckDateTime(vt_local_props, "DT",
  ...
  InspectValueTypeMethodArgs(bool use_cfo) {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var ss_arg_props = await GetObjectOnFrame(pause_location ["callFrames"]
                                                [0],
                                                "ss_arg");
      ...
      ss_arg_props = await GetObjectOnFrame(pause_location ["callFrames"]
                                            [0],
                                            "ss_arg");
      ...
      var locals = await GetProperties(pause_location ["callFrames"]
                                       ...
                                       ["callFrameId"]
                                           .Value<string>());
      await CheckProps(locals,
                       new {ss_local = TValueType(
                                "DebuggerTests.ValueTypesTest.SimpleStruct"),
                            ss_ret = TValueType(
                                "DebuggerTests.ValueTypesTest.SimpleStruct")},
                       "locals#0");
  ...
  InspectLocalsForToStringDescriptions(int line, int col, string method_name,
    ...
    await insp.Ready(async (cli, token) => {
      ...
      var frame_locals = await GetProperties(pause_location ["callFrames"]
                                             [frame_idx]
                                             ["callFrameId"]
                                                 .Value<string>());
      await CheckProps(
  ...
  InspectLocalsWithPointers(bool use_cfo) =>
      await CheckInspectLocalsAtBreakpointSite(
          "dotnet://debugger-test.dll/debugger-test.cs", 294, 2, "PointersTest",
          "window.setTimeout(function() { invoke_static_method_async ('[debugger-test] Math:PointersTest'); })",
          use_cfo
          : use_cfo, wait_for_event_fn
          : async (pause_location) => {
            var locals = await GetProperties(pause_location ["callFrames"]
                                             [0]
                                             ["callFrameId"]
            ...
            await CheckProps(
                locals,
                new {ivalue0 = TNumber(5), ivalue1 = TNumber(10),
                     ip = TPointer("int*"),
                     ip_null = TPointer("int*", is_null
                                        : true),
                     ipp = TPointer("int**"),

                     ipa = TArray("int*[]", 3), cvalue0 = TSymbol("113 'q'"),
                     cp = TPointer("char*"),
                     dt = TValueType("System.DateTime", dt.ToString()),
                     vp = TPointer("void*"),
                     vp_null = TPointer("void*", is_null
                                        : true),
                     dtp = TPointer("System.DateTime*"),
                     dtp_null = TPointer("System.DateTime*", is_null
                                         : true)},
                "locals");
          });
  ...
  InspectLocalsForStructInstanceMethod(bool use_cfo) =>
      await CheckInspectLocalsAtBreakpointSite(
          ...
          : async (pause_location) => {
            ...
            await CompareObjectPropertiesFor(
                frame_locals, "sc_arg",
                TSimpleClass(10, 45, "sc_arg#Id", "Blue"), label
                : "sc_arg#0");
