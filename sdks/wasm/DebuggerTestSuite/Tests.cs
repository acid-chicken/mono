...
public class SourceList : DebuggerTestBase {
  ...
  InspectLocalsWithDelegatesAtBreakpointSite() =>
      await CheckInspectLocalsAtBreakpointSite(
          ...
          : (locals) => {
            ...
            CheckObject(locals, "fn_del_unused", "Math.IsMathNull", is_null
                        : true);
  ...
  InspectLocalsWithStructs() {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      {
        // Check ss_local.dt
        await CheckDateTime(ss_local_props, "dt",
  ...
  InspectValueTypeMethodArgs() {
    ...
    await insp.Ready(async (cli, token) => {
      ...
      {
        // Check ss_local.dt
        await CheckDateTime(ss_arg_props, "dt",
  ...
  static JObject TValueType(string className, object members = null) =>
      JObject.FromObject(new {type = "object", isValueType = true,
                              className = className, description = className});
