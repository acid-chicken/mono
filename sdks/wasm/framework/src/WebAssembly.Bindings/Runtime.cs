...
/// <summary>
///   Provides access to the Mono/WebAssembly runtime to perform tasks like
///   invoking JavaScript functions and retrieving global variables.
/// </summary>
public sealed class Runtime {
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  static extern string
  InvokeJS(string str, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  static extern object
  CompileFunction(string str, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  InvokeJSWithArgs(int js_obj_handle, string method, object[] _params,
                   out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  GetObjectProperty(int js_obj_handle, string propertyName,
                    out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  SetObjectProperty(int js_obj_handle, string propertyName, object value,
                    bool createIfNotExists, bool hasOwnProperty,
                    out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  GetByIndex(int js_obj_handle, int index, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  SetByIndex(int js_obj_handle, int index, object value,
             out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  GetGlobalObject(string globalName, out int exceptional_result);

  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  ReleaseHandle(int js_obj_handle, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  ReleaseObject(int js_obj_handle, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  NewObjectJS(int js_obj_handle, object[] _params, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  BindCoreObject(int js_obj_handle, int gc_handle, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  BindHostObject(int js_obj_handle, int gc_handle, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  New(string className, object[] _params, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  TypedArrayToArray(int js_obj_handle, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  TypedArrayCopyTo(int js_obj_handle, int array_ptr, int begin, int end,
                   int bytes_per_element, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  TypedArrayFrom(int array_ptr, int begin, int end, int bytes_per_element,
                 int type, out int exceptional_result);
  [MethodImplAttribute(MethodImplOptions.InternalCall)]
  internal static extern object
  TypedArrayCopyFrom(int js_obj_handle, int array_ptr, int begin, int end,
                     int bytes_per_element, out int exceptional_result);
  ...
  /// The code snippet is not a function definition. Instead it must create and
  ...
  static Dictionary<int, JSObject>bound_objects =
      new Dictionary<int, JSObject>();
  static Dictionary<object, JSObject>raw_to_js =
      new Dictionary<object, JSObject>();
  ...
  /// <param name="_params">Parameters.</param>
  public static JSObject NewJSObject(JSObject js_func_ptr = null,
                                     params object[] _params) {
    var res =
        NewObjectJS(js_func_ptr?.JSHandle ?? 0, _params, out int exception);
    if (exception != 0)
      throw new JSException((string) res);
  ...
  static int BindCoreCLRObject(int js_id, int gcHandle) {
    // Console.WriteLine ($"Registering CLR Object {js_id} with handle
    // {gcHandle}");
  ...
  static int BindJSType(int js_id, Type mappedType) {
    if (!bound_objects.TryGetValue(js_id, out JSObject obj)) {
      ...
      bound_objects[js_id] = obj =
          (JSObject) jsobjectnew.Invoke(new object[]{(IntPtr) js_id});
    }
    return (int)(IntPtr) obj.Handle;
  }
  ...
  static void UnBindRawJSObjectAndFree(int gcHandle) {
    ...
    if (obj != null && obj.RawObject != null) {
      ...
      // Calling Release Handle above only removes the reference from the
      // JavaScript side but does not release the bridged JSObject associated
      // with the raw object so we have to do that ourselves.
      obj.JSHandle = -1;
      obj.IsDisposed = true;
      obj.RawObject = null;
  ...
  static void SetTaskSourceResult(TaskCompletionSource<object>tcs,
                                  object result) {
    tcs.SetResult(result);
  }

  static void SetTaskSourceFailure(TaskCompletionSource<object>tcs,
                                   string reason) {
  ...
  static object BoxInt(int i) { return i; }
  static object BoxDouble(double d) { return d; }

  static object BoxBool(int b) { return b == 0 ? false : true; }
  ...
  /// <summary>
  ///   Fetches a global object from the Javascript world, either from the
  ///   current brower window or from the node.js global context.
  /// </summary>
  /// <remarks>
  ///   This method returns the value of a global object marshalled for
  ///   consumption in C#.
  /// </remarks>
  /// <returns>
  ///   <para>
  ...
  ///     <see cref="T:System.Threading.Tasks.Task"/>(object) for JavaScript
  ///     promises, an array of a byte, int or double (for Javascript objects
  ///     typed as ArrayBuffer) or a <see cref="T:System.Func"/> to represent
  ///     JavaScript functions.  The specific version of the Func that will be
  ///     returned depends on the parameters of the Javascript function and
  ///     return value.
  ///   </para>
  ///   <para>
  ///     The value of a returned promise (The Task(object) return) can in turn
  ///     be any of the above valuews.
  ///   </para>
  /// </returns>
  /// <param name="str">The name of the global object, or null if you want to
  /// retrieve the 'global' object itself. On a browser, this is the 'window'
  /// object, on node.js it is the 'global' object.
  /// </param>
  ...
  static Uri CreateUri(string uri) { return new Uri(uri); }
    ...
    if (value is string) {
      ...
      foreach(var fi in fields) {
        ...
        case ConvertEnum.Numeric:
          contractName =
              (int) Enum.Parse(value.GetType(), contractName.ToString());
          break;
        default:
  ...
  public static object EnumToExportContract(Enum value) {
    ...
    ExportAttribute[] attributes = (ExportAttribute[]) fi.GetCustomAttributes(
        typeof (ExportAttribute), false);
  ...
  // Called by the AOT profiler to save profile data into
  // Module.aot_profile_data
  internal unsafe static void DumpAotProfileData(ref byte buf, int len,
                                                 string s) {
    ...
    fixed(void *p = &buf) {
      ...
      js_dump.SetObjectProperty("aot_profile_data",
