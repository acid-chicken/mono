...
int main(void) {
  ...
  MonoDomain *domain;
  int argc = 2;
  char *argv[] = {(char *)"test-mono-embed.exe", (char *)"test-embed.exe",
                  NULL};
  const char *file;
  int retval;
  ...
  MonoAllocatorVTable mem_vtable = {MONO_ALLOCATOR_VTABLE_VERSION,
                                    custom_malloc, NULL, NULL, NULL};
